...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPRFTP))
    ...
    Me.ImageList1.Images.SetKeyName(2, "scroll.ico")
    '
    'SbMain
    '
...
#End Region
  ...
  Private Sub FrmPRFTP_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    Me.SbpPgmID.Text = "PRFTP"
    TBarProcess.Enabled = True
    set_security() '#set
    If myTOWN._TOWNBR = 108 Then 'Oxford
      MyLibraryName = "GEMSDTAC"
    Else
      MyLibraryName = "GEMSDTAB"
    End If
    MyFrmPRFTPB = New FrmPRFTPB
    MyFrmPRFTPB.MdiParent = Me
    MyFrmPRFTPB.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
  Private Sub FrmPRFTP_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnPrint()
    MyFrmPRFTP.TBarProcess.Enabled = False
    MyFrmPRFTPB.RunProcess()
    MyFrmPRFTP.TBarProcess.Enabled = True
  End Sub
  Private Sub DoBtnSettings()
    With MyFrmPRFTPB
      MyAppSettings.FileMode = .RbChkSup.Checked
      MyAppSettings.Host = .TxtHost.Text
      MyAppSettings.User = .TxtUser.Text
      MyAppSettings.Password = SetPassword(.TxtPassword.Text)
    End With
    SaveAppSettings()
  End Sub

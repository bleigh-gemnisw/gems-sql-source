...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPRA02))
...
Me.Text = "Maintain PR G/L Accts Mappings"
...
#End Region
  ...
  Private Sub FrmPRA02_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmPRA02B = New FrmPRA02B
    MyFrmPRA02B.MdiParent = Me
    MyFrmPRA02B.Show()
  End Sub
...
Private Sub FrmPRA02_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
End Sub
  Private Sub DoBtnDelete()
    ...
    MyFrmPRA02C.DeleteData(Cancel)
    If Cancel Then Exit Sub

  End Sub
Private Sub DoBtnNew()
  MyFrmPRA02C = New FrmPRA02C
  MyFrmPRA02C.MdiParent = MyFrmPRA02B.ParentForm
  MyFrmPRA02C.WrkFdnbr = 0
  MyFrmPRA02C.WrkSfund = 0
  MyFrmPRA02C.WrkDpnbr = 0
  MyFrmPRA02C.WrkObnbr = 0
  MyFrmPRA02C.WrkFnpgm = 0
  MyFrmPRA02C.WrkSubfn = 0
  MyFrmPRA02C.Show()
  MyFrmPRA02B.Hide()
End Sub

...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPRA02B))
...
#End Region
  ...
  Private Sub FrmPRA02B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  End Sub
  Private Sub FrmPRA02B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmPRA02.SbpScreen.Text = "PRA02B"
  ...
  Private Sub C1DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
    ...
    MyFrmPRA02C = New FrmPRA02C
    MyFrmPRA02C.MdiParent = Me.ParentForm
    MyFrmPRA02C.WrkFdnbr = C1DataGrdList.Item(C1DataGrdList.Row, 0)
    MyFrmPRA02C.WrkSfund = C1DataGrdList.Item(C1DataGrdList.Row, 1)
    MyFrmPRA02C.WrkDpnbr = C1DataGrdList.Item(C1DataGrdList.Row, 2)
    MyFrmPRA02C.WrkObnbr = C1DataGrdList.Item(C1DataGrdList.Row, 3)
    MyFrmPRA02C.WrkFnpgm = C1DataGrdList.Item(C1DataGrdList.Row, 4)
    MyFrmPRA02C.WrkSubfn = C1DataGrdList.Item(C1DataGrdList.Row, 5)
    MyFrmPRA02C.WrkDesc = C1DataGrdList.Item(C1DataGrdList.Row, 6)
    MyFrmPRA02C.Show()
    Me.Hide()

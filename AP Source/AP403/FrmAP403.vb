...
Friend WithEvents TBarManual As System.Windows.Forms.ToolBarButton
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
		<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
Me.components = New System.ComponentModel.Container
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP403))
...
Me.TBarManual = New System.Windows.Forms.ToolBarButton
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarPrint, Me.TBarManual})
...
'TBarManual
'
Me.TBarManual.ImageIndex = 2
Me.TBarManual.Name = "TbManual"
Me.TBarManual.Text = "Manual Check "
'
'ImageList1
'
...
Me.Text = "Print A/P Checks and Register "
...
Private Sub FrmAP403_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmAP403B = New FrmAP403B
  MyFrmAP403B.MdiParent = Me
  MyFrmAP403B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  If e.Button Is TBarPrint Then
    DoBtnPrint()
  End If
	If e.Button Is TBarManual Then
		DoBtnManual()
	End If
End Sub
Private Sub FrmAP403_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
	 ...
	 If MyCheckType = "R" Then
		 MyFrmAP403B.RunReport()
	 Else
		 MyFrmAP403C.RunReport()
	 End If
	 TBarPrint.Enabled = True
End Sub
Private Sub DoBtnManual()
	MyFrmAP403B.Hide()
	TBarManual.Enabled = False

	MyFrmAP403C = New FrmAP403C
	MyFrmAP403C.MdiParent = Me
	MyFrmAP403C.Show()
End Sub

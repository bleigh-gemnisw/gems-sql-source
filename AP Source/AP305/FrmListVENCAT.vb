...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(6, 55)
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = myVENCAT.PosData(TxtPos.Text)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()

  End Sub
  Private Sub FrmListDept_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmAP305.SbpScreen.Text = "ListVencat"
  End Sub
 ...
 Private Sub FrmListVENCAT_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
   MyFrmAP305B.Show()
 End Sub
  Private Sub FrmListDept_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myVENCAT = New VENCAT.MyData()
    myVENCAT.MyDBConn = myDBConnect
    LblCurrent.Text = "(Category =" & WrkCode & ")"
    FormatGrid()
  End Sub
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmAP305B
      .TxtVncat.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .TTp1.SetToolTip(.TxtVncat, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With

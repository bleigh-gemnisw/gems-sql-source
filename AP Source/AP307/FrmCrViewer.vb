...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtAP307.rpt", myTOWN._TOWNBR)
   ...
   With myreport
    ...
    If MyFrmAP307B.TxtChkFrom.Text <> String.Empty Then
      .SetParameterValue("myreportTitle", "A/P History Check Range")
    Else
      .SetParameterValue("myreportTitle", "A/P History Date Range")
    End If
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyBankcd", MyFrmAP307B.TxtBank.Text)
    .SetParameterValue("MyFrom", MyFrmAP307B.DtPckFrom.Value)
    .SetParameterValue("MyTo", MyFrmAP307B.DtPckTo.Value)
    .SetParameterValue("MyChkFrom", MyUtils.CnvSng(MyFrmAP307B.TxtChkFrom.Text))
    .SetParameterValue("MyChkTo", MyUtils.CnvSng(MyFrmAP307B.TxtChkTo.Text))
  End With
   With Crv1
     .DisplayToolbar = True

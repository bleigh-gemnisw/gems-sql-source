...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP504))
...
Private Sub FrmAP504_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "AP504"
  TBarProcess.Enabled = True
  set_security() '#set
  GetReportOrientation()
  ShowReportOrientation()

  MyFrmAP504B = New FrmAP504B
  MyFrmAP504B.MdiParent = Me
  MyFrmAP504B.Show()
End Sub
...
End Sub
Private Sub FrmAP504_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmAP504.TBarProcess.Enabled = False
   MyFrmAP504B.RunReport()
   MyFrmAP504.TBarProcess.Enabled = True
End Sub

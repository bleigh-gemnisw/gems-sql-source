...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.Crv1.Size = New System.Drawing.Size(746, 452)
    Me.Crv1.TabIndex = 3
...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtAP504.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      ...
      End If
      .SetDataSource(ds)
      .SetParameterValue("myreportTitle", "Accounts Payable Check Listing")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyBankcd", MyFrmAP504B.TxtBank.Text)
      .SetParameterValue("MyFrom", MyFrmAP504B.DtPckFrom.Value)
      .SetParameterValue("MyTo", MyFrmAP504B.DtPckTo.Value)
      .SetParameterValue("MyChkFrom", MyUtils.CnvSng(MyFrmAP504B.TxtChkFrom.Text))
      .SetParameterValue("MyChkTo", MyUtils.CnvSng(MyFrmAP504B.TxtChkTo.Text))
    End With
    With Crv1
      .DisplayToolbar = True

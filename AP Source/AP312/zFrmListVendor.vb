...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(482, 260)
    Me.DataGrdView.TabIndex = 201
    '
    'FrmListVendor
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(506, 343)
...
#End Region
  ...
  Public Sub FormatGrid()
    ...
    With DataGrdView
      ...
      .RowHeadersWidth = 25
      .Columns(0).HeaderText = "Vend #"
      .Columns(0).Width = 50
      .Columns(1).HeaderText = "Name"
      .Columns(1).Width = 175
      .Columns(2).HeaderText = "Addr 1"
      .Columns(2).Width = 150
      .Columns(3).HeaderText = "Sort"
      .Columns(3).Width = 60
    End With
  End Sub
  Public Sub ShowGrid()
  ...
  Private Sub FrmListVendor_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmAP312.SbpScreen.Text = "ListVendor"
  End Sub
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmAP312B
      If WrkField = "From" Then
        .TxtVndFrom.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .LblVennmFrom.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
      Else
        .TxtVndTo.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .LblVennmTo.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
      End If
      .Show()
    End With

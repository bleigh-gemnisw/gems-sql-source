...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(115, 4)
    ...
    Me.TxtPos.Size = New System.Drawing.Size(37, 20)
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(294, 278)
    Me.DataGrdView.TabIndex = 35
    '
    'FrmListFund
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(318, 326)
...
#End Region
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
 Private Sub FrmListFund_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
   MyFrmAP312B.Show()
 End Sub
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmAP312B
      If WrkField = "From" Then
        .TxtFromFund.Text = MyUtils.CnvSng(DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
        .TTp1.SetToolTip(.TxtFromFund, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtToFund.Text = MyUtils.CnvSng(DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
        .TTp1.SetToolTip(.TxtToFund, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

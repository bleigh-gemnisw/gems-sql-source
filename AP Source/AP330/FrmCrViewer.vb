...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtAP330.rpt", myTOWN._TOWNBR)
   ...
   With myreport
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "A/P Fixed Asset List")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFrom", MyFrmAP330B.DtPckFrom.Value)
    .SetParameterValue("MyTo", MyFrmAP330B.DtPckTo.Value)
  End With
   With Crv1
     .DisplayToolbar = True

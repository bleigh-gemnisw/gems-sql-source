...
#End Region
  ...
  Private Sub RunReport()
    ...
    ReportPath = MyUtils.GetReportPath("PrtAP401.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      ...
      .SetParameterValue("MyReportTitle", "Cash Requirements")
    End With
    With Crv1
      .DisplayToolbar = True
  ...
  Private Sub RunReportErr()
    ...
    With myreport2
      ...
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyReportTitle", "Cash Requirements Errors")
    End With
    With Crv2
      .DisplayToolbar = True
      .ShowGroupTreeButton = False

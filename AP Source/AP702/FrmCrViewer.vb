...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtAP702.rpt", myTOWN._TOWNBR)
   ...
   With myreport
    ...
    End If
    .SetDataSource(wrkds)
       .SetParameterValue("myreportTitle", "A/P 1099 List")
   
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmAP702B.TxtYear.Text))
  End With
   With Crv1
     .DisplayToolbar = True

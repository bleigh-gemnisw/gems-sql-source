...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP702))
...
Private Sub FrmAP702_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "AP702"
  TBarProcess.Enabled = True
  set_security() '#set
  GetReportOrientation()
  ShowReportOrientation()

  MyFrmAP702B = New FrmAP702B
  MyFrmAP702B.MdiParent = Me
  MyFrmAP702B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmAP702_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmAP702.TBarProcess.Enabled = False
   MyFrmAP702B.RunReport()
   MyFrmAP702.TBarProcess.Enabled = True
End Sub

...
Friend WithEvents TbarNew As System.Windows.Forms.ToolBarButton
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP101))
    ...
    Me.TBarAttach = New System.Windows.Forms.ToolBarButton()
        ...
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarDelete, Me.TbarNew, Me.TBarSave, Me.TBarSep1, Me.TBarPS, Me.TBarAttach, Me.TBarComments})
        Me.TbMain.DropDownArrows = True
        Me.TbMain.ImageList = Me.ImageList1
        Me.TbMain.Location = New System.Drawing.Point(0, 0)
        Me.TbMain.Name = "TbMain"
        Me.TbMain.ShowToolTips = True
        Me.TbMain.Size = New System.Drawing.Size(1212, 50)
        ...
        Me.ImageList1.Images.SetKeyName(7, "Report.ico")
        '
        'SbMain
        '
        Me.SbMain.Location = New System.Drawing.Point(0, 726)
        ...
        Me.SbMain.Size = New System.Drawing.Size(1212, 28)
        ...
        Me.ClientSize = New System.Drawing.Size(1212, 754)
        ...
        Me.Text = "Maintain/Inquiry Vendors"
...
#End Region
    ...
    Private Sub FrmAP101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmAP101B = New FrmAP101B
    MyFrmAP101B.MdiParent = Me
    MyFrmAP101B.Show()
  End Sub
...
Private Sub FrmAP101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
    ...
    Select Case Me.SbpScreen.Text
      ...
      Case "ListVencat"
        MyFrmListVENCAT.Close()
    End Select

  End Sub
Private Sub DoBtnNew()
  MyFrmAP101C = New FrmAP101C
  MyFrmAP101C.MdiParent = MyFrmAP101B.ParentForm
  MyFrmAP101C.WrkVndnr = ""
  MyFrmAP101C.Show()
  MyFrmAP101B.Hide()
End Sub
  Private Sub DoBtnSave()
    Select Case Me.SbpScreen.Text
      ...
      Case "AP101C"
        MyFrmAP101C.SaveData()
      Case "AP101D"
        MyFrmAP101D.SaveData()
    End Select
  End Sub
  Private Sub DoBtnPS()
  ...
  Private Sub DoBtnComments()
    Dim WrkTHEKEY As String
    Dim WrkAPPL As String

    WrkAPPL = "VENDOR"

    WrkTHEKEY = MyFrmAP101C.TxtVndnr.Text

    MyFrmAP101C.Hide()


    MyFrmComments = New FrmComments
    MyFrmComments.MdiParent = MyFrmAP101B.ParentForm
    MyFrmComments.WrkTHEKEY = WrkTHEKEY
    MyFrmComments.WrkAPPL = WrkAPPL
    MyFrmComments.WrkDESC = MyFrmAP101C.TxtVennm.Text
    MyFrmComments.WrkPrevScreen = MyFrmAP101.SbpScreen.Text
    MyFrmComments.Show()
  End Sub

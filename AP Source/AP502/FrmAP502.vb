...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP502))
...
Private Sub FrmAP502_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "AP502"
  TBarProcess.Enabled = True
  set_security() '#set
  GetReportOrientation()
  ShowReportOrientation()

  MyFrmAP502B = New FrmAP502B
  MyFrmAP502B.MdiParent = Me
  MyFrmAP502B.Show()
End Sub
...
End Sub
Private Sub FrmAP502_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmAP502.TBarProcess.Enabled = False
   MyFrmAP502B.RunReport()
   MyFrmAP502.TBarProcess.Enabled = True
End Sub

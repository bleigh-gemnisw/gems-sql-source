...
Friend WithEvents TBarSep1 As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP304))
    ...
    Me.TbMain.Size = New System.Drawing.Size(544, 50)
    ...
    Me.TBarPrint.Text = "&Print/Process"
    '
    'ImageList1
    '
    ...
    Me.ImageList1.Images.SetKeyName(2, "export_png_194.png")
    '
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 373)
    ...
    Me.SbMain.Size = New System.Drawing.Size(544, 28)
    ...
    'TsOrient
    '
    Me.TsOrient.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.TsOrientLandscape})
    ...
    Me.Text = "Print/Download Vendor List"
...
Private Sub FrmAP304_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmAP304B = New FrmAP304B
  MyFrmAP304B.MdiParent = Me
  MyFrmAP304B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmAP304_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmAP304.TBarPrint.Enabled = False
   MyFrmAP304B.RunReport()
   MyFrmAP304.TBarPrint.Enabled = True
End Sub

...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtAP202.rpt", myTOWN._TOWNBR)
   ...
   With myreport
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "List Open Payables")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromFund", MyUtils.CnvSng(MyFrmAP202B.TxtFromFund.Text))
    .SetParameterValue("MyToFund", MyUtils.CnvSng(MyFrmAP202B.TxtToFund.Text))
    .SetParameterValue("MyDetail", MyFrmAP202B.ChkDetail.Checked)
  End With
   With Crv1
     .DisplayToolbar = True

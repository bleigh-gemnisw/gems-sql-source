Public Class FrmCrViewer
  ...
  Friend wrkdsNec As DataSet = New DataSet
  Friend wrkdsMisc As DataSet = New DataSet
  Friend WrkCopyB As Boolean
  Friend WithEvents TabControl1 As System.Windows.Forms.TabControl
  Friend WithEvents TpNEC As System.Windows.Forms.TabPage
...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.TpNEC = New System.Windows.Forms.TabPage()
    ...
    Me.TabControl1.Controls.Add(Me.TpNEC)
    Me.TabControl1.Controls.Add(Me.TpMisc)
    ...
    'TpNEC
    '
    Me.TpNEC.Controls.Add(Me.Crv1)
    Me.TpNEC.Location = New System.Drawing.Point(4, 22)
    Me.TpNEC.Name = "TpNEC"
    Me.TpNEC.Size = New System.Drawing.Size(636, 350)
    Me.TpNEC.TabIndex = 2
    Me.TpNEC.Text = "NEC"
    Me.TpNEC.UseVisualStyleBackColor = True
    '
    'Crv1
    '
    ...
    'TpMisc
    '
    Me.TpMisc.Controls.Add(Me.Crv2)
    Me.TpMisc.Location = New System.Drawing.Point(4, 22)
    Me.TpMisc.Name = "TpMisc"
    Me.TpMisc.Size = New System.Drawing.Size(636, 350)
...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtAP703Nec.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      .SetDataSource(wrkdsNec)
    End With
    With Crv1
      .DisplayToolbar = True
  ...
  Private Sub RunReport2()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtAP703Misc.rpt", myTOWN._TOWNBR)
    With myreport2
      .Load(ReportPath)
      .SetDataSource(wrkdsMisc)
    End With
    With Crv2
      .DisplayToolbar = True
      .ShowGroupTreeButton = False
  ...
  Private Sub RunReport3()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtAP703.rpt", myTOWN._TOWNBR)
    With myreport3
      .Load(ReportPath)
      .SetDataSource(wrkds)
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyReportTitle", "1099 Edit List")
    End With
    With Crv3
      .DisplayToolbar = True
      .ShowGroupTreeButton = False

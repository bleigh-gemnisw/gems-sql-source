...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP706))
...
Private Sub FrmAP706_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmAP706B = New FrmAP706B
  MyFrmAP706B.MdiParent = Me
  MyFrmAP706B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmAP706_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "AP706B" Then
    MyFrmAP706.Close()
  Else
    MyFrmAP706C.Close()
    MyFrmAP706B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmAP706C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmAP706C.MdiParent = MyFrmAP706B.ParentForm
  MyFrmAP706C.WrkYear = 0
  MyFrmAP706C.WrkAcct = ""
  MyFrmAP706C.Show()
  MyFrmAP706B.Hide()
End Sub

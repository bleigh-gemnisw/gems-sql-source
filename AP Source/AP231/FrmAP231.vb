...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP231))
...
Me.SbpVersion.Text = "About Program"
    ...
    Me.Text = "Create P-Card Vendor Import file"
...
#End Region
  ...
  Private Sub FrmAP231_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmAP231B = New FrmAP231B
    MyFrmAP231B.MdiParent = Me
    MyFrmAP231B.Show()
  End Sub

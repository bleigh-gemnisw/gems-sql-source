...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP404))
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarProcess, Me.TBarSep2, Me.TBarLayout})
    ...
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 337)
    ...
    Me.Text = "Post Accounts Payable Checks"
...
Private Sub FrmAP404_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "AP404"
  TBarProcess.Enabled = True
  set_security() '#set
  

  MyFrmAP404B = New FrmAP404B
  MyFrmAP404B.MdiParent = Me
  MyFrmAP404B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmAP404_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmAP404.TBarProcess.Enabled = False
   MyFrmAP404B.RunReport()
   MyFrmAP404B.ChkContinue.Checked = False
   MyFrmAP404B.lblpost.Visible = False
   MyFrmAP404B.DtPckPost.Visible = False
   MyFrmAP404.TBarProcess.Enabled = True
End Sub

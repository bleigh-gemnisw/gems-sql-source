...
Friend WithEvents ToolTip1 As System.Windows.Forms.ToolTip
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP201B))
    ...
    Me.ToolTip1 = New System.Windows.Forms.ToolTip(Me.components)
        ...
        Me.C1DataGrdList.Size = New System.Drawing.Size(377, 303)
...
Public Sub FormatGrid()
  ...
  With C1DataGrdList
    ...
    .Columns(2).Caption = "No Recs"
    .Splits(0).DisplayColumns(2).Width = 50
    .Columns(3).Caption = "Last User"
    .Splits(0).DisplayColumns(3).Width = 100
    .Columns(4).Caption = "Post Date"
...
End Sub
  ...
  Private Sub FrmAP201B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmAP201.SbpScreen.Text = "AP201B"
    With MyFrmAP201
  ...
  Private Sub C1DataGrdList_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
    ...
    '    PassSecurity = GetFNDSEC(MyFrmAP201B.C1DataGrdList.Item(MyFrmAP201B.C1DataGrdList.Row, 5))
    ...
    MyFrmAP201D.WrkBatchNo = WrkBatchNo
    MyFrmAP201D.Show()
    Me.Hide()
...
Public Sub DeleteData(ByRef Cancel As Boolean)
  ...
  MyFrmDltBch.MdiParent = MyFrmAP201B.ParentForm
...
Private Sub C1DataGrdList_FetchRowStyle(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.FetchRowStyleEventArgs) Handles C1DataGrdList.FetchRowStyle
   ...
   End If
End Sub
Private Sub FrmAP201B_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  'Memory Cleanup
  myBCHHDR = Nothing
  MyFrmAP201B = Nothing
End Sub
...
Private Sub CreateDS(ByVal ds2 As DataSet)
  ...
  For I = 0 To (ds2.Tables(0).Rows.Count - 1)
    With ds2.Tables(0).Rows(I)
      ...
      ds3 = myAPEBCHL1.GetViewbyInvno(WrkBatchNo, "", "", 0)

...
Friend WithEvents HelpProvider1 As System.Windows.Forms.HelpProvider
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP201))
    ...
    Me.ToolStripLabel1 = New System.Windows.Forms.ToolStripLabel()
        ...
        'SbMain
        '
        Me.SbMain.Location = New System.Drawing.Point(0, 615)
...
#End Region
    ...
    Private Sub FrmAP201_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      MyFrmAP201B = New FrmAP201B
      MyFrmAP201B.MdiParent = Me
      MyFrmAP201B.Show()
...
End Sub
    ...
    Private Sub tbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
      ...
      If e.Button Is TBarSave Then
        If SbpScreen.Text = "AP201E" Then
        MyFrmAP201E.SaveData(True, True, "")
        Exit Sub
        End If
      End If
     ...
     End If
      ...
      If MyFrmAP201B.C1DataGrdList.VisibleRows = 0 Then Exit Sub

      If e.Button Is TBarDelete Then
'        PassSecurity = GetFNDSEC(MyFrmAP201B.C1DataGrdList.Item(MyFrmAP201B.C1DataGrdList.Row, 4))
...
'        If Not PassSecurity Then Exit Sub
        ...
        WrkBatchNo = MyFrmAP201B.C1DataGrdList.Item(MyFrmAP201B.C1DataGrdList.Row, 0)
...
'        If Not PassSecurity Then Exit Sub
  ...
  Private Sub FrmAP201_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    Dim Cancel As Boolean

    If MyFrmAP201.SbpScreen.Text = "AP201C" Then
      If Cancel Then
        e.Cancel = True
      End If
      Exit Sub
...
Private Sub DoBtnDelete()
  ...
  Select Case Me.SbpScreen.Text
  Case "AP201B"
    MyFrmAP201B.DeleteData(Cancel)
  Case "AP201E"
    MyFrmAP201E.DeleteData(Cancel)
...
Private Sub DoBtnNew()
 Select Case Me.SbpScreen.Text
 Case "AP201B"
  MyFrmAP201B_New = New FrmAP201B_New
  MyFrmAP201B_New.MdiParent = MyFrmAP201B.ParentForm
  MyFrmAP201B_New.Show()
  MyFrmAP201B.Hide()
 Case "AP201D"
  MyFrmAP201E = New FrmAP201E
  MyFrmAP201E.MdiParent = MyFrmAP201D.ParentForm
  MyFrmAP201E.WrkBatchNo = MyFrmAP201D.WrkBatchNo
  MyFrmAP201E.WrkSeqno = 0
  MyFrmAP201E.Show()
  MyFrmAP201D.Hide()
 End Select
End Sub
...
End Function
  ...
  Private Sub FrmAP201_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

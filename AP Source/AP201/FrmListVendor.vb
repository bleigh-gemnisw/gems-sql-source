...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(489, 279)
...
#End Region
  ...
  Private Sub FrmListVendor_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmAP201.SbpScreen.Text = "ListVendor"
  End Sub
  ...
  Private Sub FrmListVendor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    WrkSave = MyFrmAP201.TBarSave.Enabled
    WrkDelete = MyFrmAP201.TBarDelete.Enabled
  ...
  Private Sub FrmListVendor_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    MyFrmAP201.TBarSave.Enabled = WrkSave
    MyFrmAP201.TBarDelete.Enabled = WrkDelete
    MyFrmAP201E.Show()
  End Sub
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    Dim Wrk1099 As String
    With MyFrmAP201E
      .TxtVndnr.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .LblVennm.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value

      If .TxtVndnr.Text > "" Then
        Wrk1099 = .GetVendor1099(.TxtVndnr.Text)
        If Wrk1099 = "Y" Then

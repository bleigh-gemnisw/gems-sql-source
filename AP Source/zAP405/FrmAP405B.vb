...
Me.RbPRTD.Location = New System.Drawing.Point(178, 146)
...
Me.RbPRBOA.Location = New System.Drawing.Point(178, 169)
...
Me.RbPRBOAShort.Location = New System.Drawing.Point(178, 192)
...
Me.LblChkNum.Location = New System.Drawing.Point(-4, 354)
...
Me.RbPRWebster.Location = New System.Drawing.Point(178, 215)
...
Me.RbPRCSV.Location = New System.Drawing.Point(178, 238)
...
Me.GroupBox2.Location = New System.Drawing.Point(178, 100)
...
#End Region
 ...
 End Sub
Private Sub FrmAP405B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  MyFrmAP405.SbpPgmID.Text = "AP405B"
  MyFrmAP405.SbpEnvironment.Text = myDBConnect.pgmDB.DBName
  DtPckFrom.Value = Date.Today
  DtPckTo.Value = Date.Today
  MyAP = True
End Sub
Private Sub FrmAP405B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
 MyFrmAP405.SbpScreen.Text = "AP405B"
End Sub
Private Sub FrmAP405B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
 Me.Refresh()
End Sub
 ...
 Private Sub EditChecks(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
  ...
  End If
 End Sub
Private Sub FrmAP405B_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub RbAPTD_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RbAPTD.CheckedChanged

End Sub

Private Sub RbAPCSV_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RbAPCSV.CheckedChanged

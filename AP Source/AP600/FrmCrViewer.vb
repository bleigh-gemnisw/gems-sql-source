...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtAP600.rpt", myTOWN._TOWNBR)
   ...
   With myreport
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Purge A/P History")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyAsofDate", WrkAsofDate)
    .SetParameterValue("MyPost", MyFrmAP600B.ChkUpdate.Checked)
   End With
   With Crv1
     .DisplayToolbar = True

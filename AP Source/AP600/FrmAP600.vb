...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAP600))
...
Private Sub FrmAP600_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "AP600"
  TBarProcess.Enabled = True
  set_security() '#set

  MyFrmAP600B = New FrmAP600B
  MyFrmAP600B.MdiParent = Me
  MyFrmAP600B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmAP600_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmAP600.TBarProcess.Enabled = False
   MyFrmAP600B.RunReport()
   MyFrmAP600.TBarProcess.Enabled = True
End Sub

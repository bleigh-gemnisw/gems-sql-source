...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX402))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarRemove, Me.TBarSep1, Me.TBarPrint, Me.TBarSep2, Me.TBarPost})
...
Me.Text = "Multiple Back Tax Update"
...
#End Region
  ...
  Private Sub FrmTX402_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmTX402B = New FrmTX402B
    MyFrmTX402B.MdiParent = Me
    MyFrmTX402B.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
Private Sub FrmTX402_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnRemove()
  MyFrmTX402B.RemoveData()
End Sub
Private Sub DoBtnPrint()
  MyFrmTX402.TBarPrint.Enabled = False
  PrtReport(False)
  MyFrmTX402.TBarPrint.Enabled = True
End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX113))
...
Me.Text = "Tax Form - Statement & Lien Information"
...
#End Region
 ...
 Private Sub FrmTX113_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  TBarSave.Enabled = False
   ...
   set_security() '#set
   MyFrmTX113B = New FrmTX113B
   MyFrmTX113B.MdiParent = Me
   MyFrmTX113B.Show()
 End Sub
...
Private Sub FrmTX113_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX113B" Then
    MyFrmTX113.Close()
  Else
    MyFrmTX113C.Close()
    MyFrmTX113B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX113C.DeleteData()
  MyFrmTX113C.Close()
  MyFrmTX113B.Show()
End Sub
Private Sub DoBtnNew()
  MyFrmTX113C = New FrmTX113C
  MyFrmTX113C.MdiParent = MyFrmTX113B.ParentForm
  MyFrmTX113C.Wrktype = ""
  MyFrmTX113C.WrkAddMode = True
  MyFrmTX113C.Show()
  MyFrmTX113B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX113B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX113C.SaveData()
End Sub

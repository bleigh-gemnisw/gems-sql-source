...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Me.Text = "Bill Type Information Master"
...
#End Region
 ...
 Private Sub FrmTX101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmTX101B = New FrmTX101B
   MyFrmTX101B.MdiParent = Me
   MyFrmTX101B.Show()
 End Sub
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX101B" Then
    MyFrmTX101.Close()
  Else
    MyFrmTX101C.Close()
    MyFrmTX101B.Show()
...
Private Sub DoBtnCopy()
  MyFrmTX101B.CopyData()
End Sub
Private Sub DoBtnDelete()
  MyFrmTX101C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmTX101C = New FrmTX101C
  MyFrmTX101C.MdiParent = MyFrmTX101B.ParentForm
  MyFrmTX101C.Wrkprtype = String.Empty
  MyFrmTX101C.WrkCopyMode = False
  MyFrmTX101C.Show()
  MyFrmTX101B.Hide()
End Sub
Private Sub DoBtnPrint()
  MyFrmTX101B.PrintData()
End Sub
Private Sub DoBtnSave()
  MyFrmTX101C.SaveData()
End Sub

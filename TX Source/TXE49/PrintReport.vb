      ...
      With myTXINVQ
        ...
        Select Case WrkFamily
          Case "R"
            ...
            '  Wrksearchname = Trim(myTXREAL._SNAME)
            '  If Wrksearchname.StartsWith("/") Then
            '    If My2NDNO Then
            '      WrkSname = Wrksearchname.Trim().Substring(1).TrimStart() & " N/O"
            '    Else
            '      WrkSname = "N/O " & Wrksearchname.Trim().Substring(1).TrimStart()
            '    End If
            '    GoTo AvonPassRE
            '  End If
            '  If Trim(myTXREAL._ADD1) = Trim(._ADD1) And Trim(myTXREAL._ADD2) = Trim(._ADD2) _
            ...
            If Trim(myTXREAL._NAME) = Trim(._NAME) _
...
AvonPassRE:
          ...
          Case "A", "U"
            ...
            ' AVON 
            'If myTOWN._TOWNBR = 4 Then
            '  Wrksearchname = Trim(myUTCUST._CUNAM2)
            '  If Wrksearchname.StartsWith("/") Then
            '    If My2NDNO Then
            '      WrkSname = Wrksearchname.Trim().Substring(1).TrimStart() & " N/O"
            '    Else
...
AvonPassUB:
            ...
            If WrkPost Then
              ...
              If Len(Trim(myUTCUST._CUZIP)) > 5 Then
                ...
                myTXINV._ZIP4 = MyUtils.CnvSng(Mid(myUTCUST._CUZIP, 7, 4))
              Else
                myTXINV._ZIP4 = 0
              End If
              myTXINV.UpdateOneRecordP()

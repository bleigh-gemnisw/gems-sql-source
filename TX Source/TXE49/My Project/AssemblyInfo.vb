...
'12/12/24 Avon - search RE 2nd name for a /  and if so then it N/O in txinv 2nd name
' 2/21/25 Comment out Avon 12/12/24 code
'MK 9/10/26 Make zip code numeric for TXINV update
Imports System

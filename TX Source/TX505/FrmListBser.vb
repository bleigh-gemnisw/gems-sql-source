...
#End Region
  ...
  Private Sub FrmListBser_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTX505.SbpScreen.Text = "ListBser"
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTX505B
      .TxtBankSv.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .TTp1.SetToolTip(.TxtBankSv, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With

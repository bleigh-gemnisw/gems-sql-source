...
#End Region
    ...
    Private Sub FrmSelSts_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      MyFrmTXE24.TBarPrint.Enabled = False
      BuildDS()
      RefreshDS()
      Call FormatGrid()
...
Private Sub RefreshDS()
  ...
  Dim Pos As Integer
    ...
    For I = 0 To ds.Tables(0).Rows.Count - 1
      ...
      Pos = InStr(MySts, ds.Tables(0).Rows(I).Item("stcode"))
      If Pos > 0 Then
        myDr("select") = True
      Else
        myDr("select") = False
...
End Sub
  ...
  For I = 0 To (C1DataGrdList.Splits(0).Rows.Count - 1)
    If C1DataGrdList.Item(I, 0) Then
      MySts = MySts + C1DataGrdList.Item(I, 1)
    End If
  Next
...
Private Sub FrmSelSts_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
     ...
     MyFrmTXE24.SbpScreen.Text = "SelSts"
  End Sub
...
Private Sub FrmSelSts_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  MyFrmTXE24.TBarPrint.Enabled = True
  MyFrmTXE24B.TxtSts.Text = MySts
  MyFrmTXE24B.Show()
End Sub
End Class

Public Class FrmCrViewer
  ...
  Friend WithEvents TpBalances As System.Windows.Forms.TabPage
...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents Cr1 As CrystalDecisions.Windows.Forms.CrystalReportViewer
    ...
    Me.TpBalances = New System.Windows.Forms.TabPage()
    Me.crv2 = New CrystalDecisions.Windows.Forms.CrystalReportViewer()
    Me.TabCtl1.SuspendLayout()
    Me.TpList.SuspendLayout()
    Me.TpBalances.SuspendLayout()
    Me.SuspendLayout()
    '
    'TabCtl1
    '
    ...
    Me.TabCtl1.Controls.Add(Me.TpBalances)
    ...
    Me.TpList.Size = New System.Drawing.Size(636, 350)
    ...
    'TpBalances
    '
    Me.TpBalances.Controls.Add(Me.crv2)
    Me.TpBalances.Location = New System.Drawing.Point(4, 22)
    Me.TpBalances.Name = "TpBalances"
    Me.TpBalances.Size = New System.Drawing.Size(636, 350)
    Me.TpBalances.TabIndex = 2
    Me.TpBalances.Text = "Balances"
    Me.TpBalances.UseVisualStyleBackColor = True
    '
    'crv2
    '
    ...
    Me.TpBalances.ResumeLayout(False)
...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    WrkStatus = MyFrmTXE24B.TxtSts.Text
...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTXE24.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Accounts List for Status Codes by " & WrkSortBy)
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTXE24B.TxtFromGLYear.Text))
    .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTXE24B.TxtToGLYear.Text))
    .SetParameterValue("MyTypes", MyTypes)
    .SetParameterValue("MyStatus", WrkStatus)
    .SetParameterValue("MyBalances", MyFrmTXE24B.ChkBalances.Checked)
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTXE24B.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Accounts Balance for Status Codes by " & WrkSortBy)
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTXE24B.TxtFromGLYear.Text))
    .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTXE24B.TxtToGLYear.Text))

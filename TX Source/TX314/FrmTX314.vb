...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX314))
    ...
    Me.Text = "Payments for Status Code"
...
Private Sub FrmTX314_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "TX314"
  TBarProcess.Enabled = True
  set_security() '#set
  GetReportOrientation()
  ShowReportOrientation()

  MyFrmTX314B = New FrmTX314B
  MyFrmTX314B.MdiParent = Me
  MyFrmTX314B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTX314_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub TsOrientPortrait_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
  MyReportLandscape = False
  SetReportOrientation()
  ShowReportOrientation()
End Sub

Private Sub TsOrientLandscape_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
   MyReportLandscape = True
   SetReportOrientation()
   ShowReportOrientation()
End Sub

...
End Sub
  Private Sub RunReportTotals()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTX314Tot.rpt", myTOWN._TOWNBR)
   ...
   With myreport
    ...
    .SetParameterValue("myreportTitle", "Payments for Status Code Totals")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTX314B.TxtFromGLYear.Text))
    .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTX314B.TxtToGLYear.Text))
  ...
  Private Sub RunReport()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTX314.rpt", myTOWN._TOWNBR)
   ...
   With myreport2
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Payments for Status Code")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTX314B.TxtFromGLYear.Text))
    .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTX314B.TxtToGLYear.Text))

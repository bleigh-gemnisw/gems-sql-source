...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXE42))
...
Private Sub FrmTXE42_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTXE42B = New FrmTXE42B
  MyFrmTXE42B.MdiParent = Me
  MyFrmTXE42B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTXE42_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
    ...
    If MyFrmTXE42B.ChkPost.Checked = True Then
      Dim result As DialogResult = MessageBox.Show("Are you sure you want to post ?",
                                                 "Confirmation",
                                                 MessageBoxButtons.YesNo,
                                                 MessageBoxIcon.Question)
      If result = DialogResult.Yes Then
        ' Logic to proceed with the action
        MyFrmTXE42.TBarPrint.Enabled = False
        MyFrmTXE42B.RunReport()
        MyFrmTXE42.TBarPrint.Enabled = True
      Else
        ' Logic if user chooses No (optional)

...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXE57))
    ...
    Me.Text = "Create Current Year and Delinquent File"
...
Private Sub FrmTXE57_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
 Me.SbpPgmID.Text = "TXE57"
 TBarProcess.Enabled = True
 set_security() '#set
 If MyAutomate Then
  PrtReport()
 Else
  MyFrmTXE57B = New FrmTXE57B
  MyFrmTXE57B.MdiParent = Me
  MyFrmTXE57B.Show()
 End If
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
 ...
 End If
End Sub
Private Sub FrmTXE57_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
  MyFrmTXE57.TBarProcess.Enabled = False
  MyFrmTXE57B.RunReport()
  MyFrmTXE57.TBarProcess.Enabled = True
End Sub
Private Sub DoBtnSettings()
    With MyFrmTXE57B
      MyAppSettings.Types = .TxtTypes.Text
      MyAppSettings.FilePath = .TxtFilePath.Text
      MyAppSettings.FileName = .TxtFileName.Text

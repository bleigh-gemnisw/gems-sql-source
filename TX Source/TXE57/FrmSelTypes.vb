...
Private Sub RefreshDS()
	...
	Dim Pos As Integer
      ...
      Pos = InStr(WrkTypes, ds.Tables(0).Rows(I).Item("tycode"))
			If Pos > 0 Then
				myDr("select") = True
			Else
				myDr("select") = False
...
End Sub
  ...
  WrkTypes = ""
	...
	For I = 0 To (C1DataGrdList.Splits(0).Rows.Count - 1)
      ...
      WrkTypes = WrkTypes + C1DataGrdList.Item(I, 1)
		Else
			WrkAllTypes = False
		End If
	Next
...
Private Sub FrmSelTypes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
     MyFrmTXE57.SbpScreen.Text = "SelTypes"
	End Sub
...
Private Sub FrmSelTypes_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  ...
  MyFrmTXE57B.TxtTypes.Text = WrkTypes
End Sub
End Class

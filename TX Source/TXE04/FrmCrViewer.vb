...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTXE04.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "List Open Accounts")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyAsofDate", MyFrmTXE04B.DtPckAsof.Value)
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTXE04B.TxtFromGLYear.Text))
    .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTXE04B.TxtToGLYear.Text))
    .SetParameterValue("MySuspense", MyFrmTXE04B.ChkSuspense.Checked)
    .SetParameterValue("MyDist", MyUtils.CnvSng(MyFrmTXE04B.TxtDist.Text))
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTXE04Tot.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
    ...
    .SetParameterValue("myreportTitle", "List Open Accounts Totals")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyAsofDate", MyFrmTXE04B.DtPckAsof.Value)
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTXE04B.TxtFromGLYear.Text))
    .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTXE04B.TxtToGLYear.Text))
    .SetParameterValue("MySuspense", MyFrmTXE04B.ChkSuspense.Checked)
    .SetParameterValue("MyLetter", MyFrmTXE04B.ChkLetter.Checked)
    .SetParameterValue("MyDist", MyUtils.CnvSng(MyFrmTXE04B.TxtDist.Text))
   End With
   With crv2
     .DisplayToolbar = True

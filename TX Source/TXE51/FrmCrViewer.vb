Public Class FrmCrViewer
  ...
  Friend WrkRefundTotal As Double
  Friend WrkGrandTotal As Double
  Friend WrkSelection As String
...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTXE51.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Payment History Breakout List")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmTXE51B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmTXE51B.DtPckTo.Value)
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTXE51B.TxtFromGLYear.Text))
    .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTXE51B.TxtToGLYear.Text))
    .SetParameterValue("MyTypes", MyTypes)
    .SetParameterValue("MySelection", WrkSelection)
    .SetParameterValue("MyDist", MyUtils.CnvSng(MyFrmTXE51B.TxtDist.Text))
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTXE51Tot.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
    ...
    .SetParameterValue("myreportTitle", "Payment History Breakout Totals")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmTXE51B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmTXE51B.DtPckTo.Value)

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX801))
...
Me.Text = "Create Bank Service Pre-Billing File"
...
#End Region
  ...
  Private Sub FrmTX801_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmTX801B = New FrmTX801B
    MyFrmTX801B.MdiParent = Me
    MyFrmTX801B.Show()
  End Sub

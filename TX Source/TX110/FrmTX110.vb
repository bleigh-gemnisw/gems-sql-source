...
Private Sub FrmTX110_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTX110B = New FrmTX110B
  MyFrmTX110B.MdiParent = Me
  MyFrmTX110B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
 ...
 End If
End Sub
Private Sub FrmTX110_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX110B" Then
    MyFrmTX110.Close()
  Else
    MyFrmTX110C.Close()
    MyFrmTX110B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX110C.DeleteData()
  MyFrmTX110C.Close()
  MyFrmTX110B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTX110C = New FrmTX110C
  MyFrmTX110C.MdiParent = MyFrmTX110B.ParentForm
  MyFrmTX110C.wrkzip5 = 0
  MyFrmTX110C.Show()
  MyFrmTX110B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX110B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX110C.SaveData()
End Sub

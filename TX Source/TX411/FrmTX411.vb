...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX411))
    ...
    Me.Text = "Name and Address update"
...
Private Sub FrmTX411_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTX411B = New FrmTX411B
  MyFrmTX411B.MdiParent = Me
  MyFrmTX411B.Show()
End Sub
...
End Sub
Private Sub FrmTX411_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX401))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSave, Me.TBarSep1, Me.TBarComments})
...
Me.Text = "Billing File Maintenance"
...
#End Region
  ...
  Private Sub FrmTX401_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security()   '#sec
    MyFrmTX401B = New FrmTX401B
    MyFrmTX401B.MdiParent = Me
    MyFrmTX401B.Show()
  End Sub
  ...
  Private Sub FrmTX401_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    Select Case Me.SbpScreen.Text
      ...
      Case "TX401RE"
				MyFrmTX401RE.Close()
				If IsNothing(MyFrmTX401RE) Then
					TBarComments.Enabled = False
			...
			Case "TX401PP"
				MyFrmTX401PP.Close()
				If IsNothing(MyFrmTX401PP) Then
					TBarComments.Enabled = False
					MyFrmTX401B.FormatGrid(False)
					MyFrmTX401.Show()
				End If
			Case "TX401MV"
				MyFrmTX401MV.Close()
				If IsNothing(MyFrmTX401MV) Then
					TBarComments.Enabled = False
					MyFrmTX401B.FormatGrid(False)
					MyFrmTX401.Show()
				End If
			Case "TX401SU"
				MyFrmTX401SU.Close()
				If IsNothing(MyFrmTX401SU) Then
					TBarComments.Enabled = False
					MyFrmTX401B.FormatGrid(False)
					MyFrmTX401.Show()
				End If
  ...
  Private Sub DoBtnSave()
    Select Case Me.SbpScreen.Text
      Case "Comments"
        ...
        TBarComments.Enabled = False
      Case "TX401RE"
        MyFrmTX401RE.SaveData()
			Case "TX401PP"
				MyFrmTX401PP.SaveData()
			Case "TX401MV"
				MyFrmTX401MV.SaveData()
			Case "TX401SU"
				MyFrmTX401SU.SaveData()
		End Select
  End Sub
  Private Sub DoBtnComments()
    ...
    WrkType = ""
    Select Case MyFrmTX401.SbpScreen.Text
    Case "TX401MV"
      WrkListNo = MyUtils.CnvSng(MyFrmTX401MV.TxtListNo.Text)
      WrkType = "M"
      MyFrmTX401MV.Hide()
    Case "TX401PP"
      WrkListNo = MyUtils.CnvSng(MyFrmTX401PP.TxtListNo.Text)
      WrkType = "P"
      MyFrmTX401PP.Hide()
    Case "TX401RE"
      WrkListNo = MyUtils.CnvSng(MyFrmTX401RE.TxtListNo.Text)
      WrkType = "R"
      MyFrmTX401RE.Hide()
    Case "TX401SU"
      WrkListNo = MyUtils.CnvSng(MyFrmTX401SU.TxtListNo.Text)
      WrkType = "S"
      MyFrmTX401SU.Hide()
    End Select

    MyFrmComments = New FrmComments
    MyFrmComments.MdiParent = MyFrmTX401B.ParentForm
    MyFrmComments.WrkListNo = WrkListNo
    MyFrmComments.WrkType = WrkType
    MyFrmComments.WrkYear = 0
    MyFrmComments.WrkPrevScreen = MyFrmTX401.SbpScreen.Text
    MyFrmComments.Show()
  End Sub

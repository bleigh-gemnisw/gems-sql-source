      ...
      With myTXINVQ
        If SaveList > 0 Then
          If SaveList <> drinv.Item("list#") Or SaveYear <> drinv.Item("year") Then
            ...
            If WrkInt1 <> WrkIntOrig1 And WrkIntOrig1 < WrkMinInt Then
              dr.Item("Interest") = Format(WrkMinInt, "fixed")
              WrkTotal1 = WrkTax1 + WrkMinInt + WrkFee1 + WrkLien1 + WrkBond1
            Else
              dr.Item("Interest") = Format(WrkIntOrig1, "fixed")
              WrkTotal1 = WrkTax1 + WrkIntOrig1 + WrkFee1 + WrkLien1 + WrkBond1
            End If
            ...
            If WrkInt2 <> WrkIntOrig2 And WrkIntOrig2 < WrkMinInt Then
              dr.Item("Interest") = Format(WrkMinInt, "fixed")
              WrkTotal2 = WrkTax2 + WrkMinInt + WrkFee2 + WrkLien2 + WrkBond2
            Else
              dr.Item("Interest") = Format(WrkIntOrig2, "fixed")
              WrkTotal2 = WrkTax2 + WrkIntOrig2 + WrkFee2 + WrkLien2 + WrkBond2
            End If
            ...
            If WrkBillDate3 <> "" Then
              ...
              If WrkInt3 <> WrkIntOrig3 And WrkIntOrig3 < WrkMinInt Then
                dr.Item("Interest") = Format(WrkMinInt, "fixed")
                WrkTotal3 = WrkTax3 + WrkMinInt + WrkFee3 + WrkLien3 + WrkBond3
              Else
                dr.Item("Interest") = Format(WrkIntOrig3, "fixed")
                WrkTotal3 = WrkTax3 + WrkIntOrig3 + WrkFee3 + WrkLien3 + WrkBond3
              End If
            ...
            If WrkBillDate4 <> "" Then
              ...
              If WrkInt4 <> WrkIntOrig4 And WrkIntOrig4 < WrkMinInt Then
                dr.Item("Interest") = Format(WrkMinInt, "fixed")
                WrkTotal4 = WrkTax4 + WrkMinInt + WrkFee4 + WrkLien4 + WrkBond4
              Else
                dr.Item("Interest") = Format(WrkIntOrig4, "fixed")
                WrkTotal4 = WrkTax4 + WrkIntOrig4 + WrkFee4 + WrkLien4 + WrkBond4
              End If
        ...
        WrkInt1 = WrkInt1 + myCASHINT.Out_Int1
        WrkIntOrig1 = WrkIntOrig1 + myCASHINT.Out_IntOrig1
        ...
        WrkInt2 = WrkInt2 + myCASHINT.Out_Int2
        WrkIntOrig2 = WrkIntOrig2 + myCASHINT.Out_IntOrig2
        ...
        WrkInt3 = WrkInt3 + myCASHINT.Out_Int3
        WrkIntOrig3 = WrkIntOrig3 + myCASHINT.Out_IntOrig3
        ...
        WrkInt4 = WrkInt4 + myCASHINT.Out_Int4
        WrkIntOrig4 = WrkIntOrig4 + myCASHINT.Out_IntOrig4

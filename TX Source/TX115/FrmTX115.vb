...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX115))
...
Me.Text = "Tax Billing Type Codes"
...
Private Sub FrmTX115_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTX115B = New FrmTX115B
  MyFrmTX115B.MdiParent = Me
  MyFrmTX115B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTX115_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If MyFrmTX115.SbpScreen.Text = "TX115B" Then
     MyFrmTX115.Close()
  Else
    MyFrmTX115C.Close()
    MyFrmTX115B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTX115C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmTX115C.Close()
  MyFrmTX115B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTX115C = New FrmTX115C
  MyFrmTX115C.MdiParent = MyFrmTX115B.ParentForm
  MyFrmTX115C.WrkCode = ""
  MyFrmTX115C.Show()
  MyFrmTX115B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX115B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX115C.SaveData()
End Sub

...
#End Region
  ...
  Private Sub FrmTX311_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    'Print not allowed in program
    TBarPrint.Visible = False
    MyFrmTX311B = New FrmTX311B
    MyFrmTX311B.MdiParent = Me
    MyFrmTX311B.Show()
  End Sub
...
Private Sub FrmTX311_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnNew()
  ...
  MyFrmTX311C.MdiParent = MyFrmTX311B.ParentForm
  MyFrmTX311C.WrkListNo = 0
  MyFrmTX311C.Show()
  MyFrmTX311B.Hide()

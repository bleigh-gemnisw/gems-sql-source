...
If WrkAddress <> "" Then
  Select Case MyFormat
  Case "VP"
    PutFile(WrkFilePath, "mpermit.csv")
  Case Else
    PutFile(WrkFilePath, "taxdelq.csv")
  End Select
End If
...
End Sub
  ...
  ByRef OutDue As Decimal, ByRef OutGracePeriod As Boolean)
    ...
    End With
  End Sub
  Private Function BuildFile(ByVal WrkType As String, ByVal WrkLoc As String, ByVal WrkLocNo As String, _
  ...
  End With
End Function
Private Function BuildFileView(ByVal WrkType As String, ByVal WrkLoc As String, ByVal WrkLocNo As String, _

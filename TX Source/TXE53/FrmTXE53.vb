...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXE53))
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarProcess, Me.TBarSettings})
    ...
    'ToolStrip1
    '
    Me.ToolStrip1.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.TsOrientDesc, Me.ToolStripLabel1})
    ...
    Me.Text = "Create Delinquent File"
...
Private Sub FrmTXE53_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
 Me.SbpPgmID.Text = "TXE53"
 TBarProcess.Enabled = True
 set_security() '#set
 If MyAutomate Then
  PrtReport()
 Else
  MyFrmTXE53B = New FrmTXE53B
  MyFrmTXE53B.MdiParent = Me
  MyFrmTXE53B.Show()
 End If
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
 ...
 End If
End Sub
Private Sub FrmTXE53_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
  MyFrmTXE53.TBarProcess.Enabled = False
  MyFrmTXE53B.RunReport()
  MyFrmTXE53.TBarProcess.Enabled = True
End Sub
Private Sub DoBtnSettings()
    With MyFrmTXE53B
      MyAppSettings.Types = .TxtTypes.Text
      MyAppSettings.FilePath = .LblFilePath.Text
      If .RbView.Checked Then
        MyAppSettings.Format = "VP"
      Else
        MyAppSettings.Format = ""
      End If
      If .ChkHeader.Checked Then
        MyAppSettings.Header = True
      Else
        MyAppSettings.Header = False
      End If
      If .ChkImplicit.Checked Then
        MyAppSettings.Implicit = True
      Else
        MyAppSettings.Implicit = False
      End If
      MyAppSettings.Port = MyUtils.CnvSng(.TxtPort.Text)
      MyAppSettings.Address = .TxtAddress.Text
      MyAppSettings.User = .TxtUser.Text
      MyAppSettings.Password = .TxtPassword.Text
    End With
    SaveAppSettings()
End Sub

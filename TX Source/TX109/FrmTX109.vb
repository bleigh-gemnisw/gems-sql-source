...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX110))
...
Me.Text = "District Code Maintenance"
...
#End Region
Private Sub FrmTX109_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmTX109B = New FrmTX109B
   MyFrmTX109B.MdiParent = Me
   MyFrmTX109B.Show()
End Sub
Private Sub set_security()
 ...
 End If
End Sub
Private Sub FrmTX109_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX109B" Then
    MyFrmTX109.Close()
  Else
    MyFrmTX109C.Close()
    MyFrmTX109B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX109C.DeleteData()
  MyFrmTX109C.Close()
  MyFrmTX109B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTX109C = New FrmTX109C
  MyFrmTX109C.MdiParent = MyFrmTX109B.ParentForm
  MyFrmTX109C.wrkddist = 0
  MyFrmTX109C.Show()
  MyFrmTX109B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX109B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX109C.SaveData()
End Sub

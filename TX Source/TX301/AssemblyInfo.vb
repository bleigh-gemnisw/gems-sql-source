...
'MK 4/29/25 Write all records to Invoice file including Zero bills and Tax Exempt
'MK 5/ 1/25 Add Local Defer and Freeze processing (TXDEFER/TXFREEZE)
'MK 7/10/25 Winchester: Add Real Estate Bill totals for Deferred
'MK 9/29/25 Change TXSUPPCQ to TXSUPPCQ
'MK 10/2/25 Defer/Freeze: Condition routines with ALLOW="Y" 
'MK 11/17/25 Suppl MV Before Bill C/C's
'LL  5/11/26 Add Qrcode
'MK  5/27/26 Modify qrcode: qrcode field, default to gemsnt.com (TX830.xml)
Imports System

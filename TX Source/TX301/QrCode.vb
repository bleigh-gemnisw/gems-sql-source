...
Module QrCode
  ...
  Public ReadOnly Property QrBaseUrl As String
    Get
      ...
      Dim qrcode As Boolean = Trim(MyAppSettings.QRCode)
      ...
      ' Build the town path part (e.g. "southington-webtax")
      Dim townPath As String = town & "-webtax"

      ' If there is no prefix, just return "southington-webtax/qr_add.php"
      If prefix = "" Then
        Return townPath & "/" & script.TrimStart("/"c)
      End If

      ' Normal case: "https://gemsnt.com/" + "southington-webtax" + "/qr_add.php"
  ...
  ' Lou - removed parameters except for account number
  ...
  Public Function BuildQrUrl(acctId As String) As String

...
NextRec:
  ...
  Private Function DownloadCSV(ByVal I As Integer) As String
    ...
    With DsTXPPRPC.Tables(0).Rows(I)
      ...
      ''''''''''''''''''Dim productId_PP As String = WrkType & WrkGLYear.ToString("0000")
      ...
      ''''''''''''''''''Dim ownerName_PP As String = CStr(.Item("name")) & " " & CStr(.Item("sname"))

      '''''''''''''''''''SPEC: Type Is a desc of the code that comes from the txtype table i believe (prob already have a lookup in the SU code)
      '''''''''''''''''''''my Comments
      '''''''''''''''''''''WrkType = "P"  'was hardcoded in the above existing code as like in the SU code. 
      ...
      '''''''''''''''''''''sb.Append(.Item("vol"))
      '''''''''''''''''''''sb.Append(.Item("pge"))
      '''''''''''''''''''''Dim desc_RE As String = WrkPropDescFile - this will use the prop desc fo this field if we determine that we need it later
      '''''''''''''''''''''  for WrkPropDescFile
      ''''''''''''''''''Dim desc_PP As String = CStr(.Item("loc#")) & " " & CStr(.Item("loc"))
      ...
      '''''''''''''''''''''Dim qrUrl_PP As String = BuildQrUrl(
      '''''''''''''''''''''  acctId:=QRaccountNmber,
      '''''''''''''''''''''  productId:=productId_PP,
      '''''''''''''''''''''  price:=WrkTaxTotal,
      '''''''''''''''''''''  txName:=ownerName_PP,

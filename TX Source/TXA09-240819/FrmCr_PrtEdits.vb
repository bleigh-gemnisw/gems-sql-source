Public Class FrmCr_PrtEdits
  ...
  Dim myreportQ As New PrtTXA09Q
  Dim myreportS As New PrtTXA09S
  Dim myreportT As New PrtTXA09T
  Dim myreportV As New PrtTXA09V
  Dim myreportW As New PrtTXA09W
  Dim myreportY As New PrtTXA09Y
  Dim myreportZ As New PrtTXA09Z
  Dim myreportZB As New PrtTXA09ZB
  Dim myreportVoid As New PrtTXA09Void

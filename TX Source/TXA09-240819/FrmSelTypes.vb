...
#End Region
Private Sub FrmSelTypes_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
	Me.Dispose()
End Sub
...
Private Sub RefreshDS()
  ...
  Dim Pos As Integer
    ...
    For I = 0 To ds.Tables(0).Rows.Count - 1
      ...
      Pos = InStr(MySelTypes, ds.Tables(0).Rows(I).Item("tycode"))
      If MySelTypes = "" Or Pos > 0 Then
        myDr("select") = True
      Else
        myDr("select") = False
      End If
...
End Sub
  ...
  For I = 0 To (C1DataGrdList.Splits(0).Rows.Count - 1)
    If C1DataGrdList.Item(I, 0) Then
      MySelTypes = MySelTypes + C1DataGrdList.Item(I, 1)
    Else
      WrkAllTypes = False
    End If
  Next

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX112))
...
Me.Text = "Tax Form - Bill Information"
...
#End Region
 ...
 Private Sub FrmTX112_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  TBarSave.Enabled = False
   ...
   set_security() '#set
   MyFrmTX112B = New FrmTX112B
   MyFrmTX112B.MdiParent = Me
   MyFrmTX112B.Show()
 End Sub
...
Private Sub FrmTX112_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX112B" Then
    MyFrmTX112.Close()
  Else
    MyFrmTX112C.Close()
    MyFrmTX112B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX112C.DeleteData()
  MyFrmTX112C.Close()
  MyFrmTX112B.Show()
End Sub
Private Sub DoBtnNew()
  MyFrmTX112C = New FrmTX112C
  MyFrmTX112C.MdiParent = MyFrmTX112B.ParentForm
  MyFrmTX112C.Wrktype = ""
  MyFrmTX112C.WrkAddMode = True
  MyFrmTX112C.Show()
  MyFrmTX112B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX112B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX112C.SaveData()
End Sub

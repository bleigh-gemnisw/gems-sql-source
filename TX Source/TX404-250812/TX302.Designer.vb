...
Partial Public Class TX302
    ...
    Partial Public Class mytableDataTable
        ...
        Public Overloads Function AddmytableRow( _
                    ...
                    ByVal ACCTID As String) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {SORTDATA, LISTNO, YEAR, TYPE, TYPEDESC, ADDR1, ADDR2, ADDR3, ADDR4, ADDR5, PROPDESC, PROPDESC2, BALANCE, AMTDUE, INTEREST, FEES, LIENS, BOND, TOTAL, VOLPAGE, ACCTID}

...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXE12))
    ...
    Me.Text = "Print Payment Reminder/Labels"
...
Private Sub FrmTXE12_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTXE12B = New FrmTXE12B
  MyFrmTXE12B.MdiParent = Me
  MyFrmTXE12B.Show()
End Sub
...
End Sub
Private Sub FrmTXE12_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

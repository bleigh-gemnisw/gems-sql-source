Public Class FrmCrViewer
  ...
  Dim WrkReportHeading As String
...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    With MyFrmTX406B
      If .RbBalance.Checked Then
        WrkReportHeading = "balances up to " & Format(MyUtils.CnvSng(.TxtAmount.Text), "Fixed")
      Else
        WrkReportHeading = "15 Year Purge"
      End If
    End With
...
End Sub
  Private Sub RunReportTotals()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTX406Tot.rpt", myTOWN._TOWNBR)
   ...
   With myreport
    ...
    .SetParameterValue("myreportTitle", "Purge Tax Invoice Accounts Totals")
    .SetParameterValue("myreportheading", WrkReportHeading)
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyGLYear", WrkGLYear)
    .SetParameterValue("MyTypes", MyTypes)
    .SetParameterValue("MyAsofDate", WrkAsofDate)
    .SetParameterValue("MyPost", MyFrmTX406B.ChkUpdate.Checked)
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTX406.rpt", myTOWN._TOWNBR)
   ...
   With myreport2
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Purge Tax Invoice Accounts List")
    .SetParameterValue("myreportheading", WrkReportHeading)
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyGLYear", WrkGLYear)

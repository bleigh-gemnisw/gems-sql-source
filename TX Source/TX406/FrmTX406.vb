...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX406))
...
Me.Text = "Purge Tax Invoice Accounts"
...
Private Sub FrmTX406_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "TX406"
  TBarProcess.Enabled = True
  set_security() '#set
  GetReportOrientation()
  ShowReportOrientation()

  MyFrmTX406B = New FrmTX406B
  MyFrmTX406B.MdiParent = Me
  MyFrmTX406B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTX406_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  ...
  Case "TX406B"
    MyFrmTX406.Close()
  Case "SelStatus"
    MyFrmSelStatus.Close()
  Case "SelTypes"
    MyFrmSelTypes.Close()
  End Select
End Sub
Private Sub DoBtnPrint()
   MyFrmTX406.TBarProcess.Enabled = False
   MyFrmTX406B.RunReport()
   MyFrmTX406.TBarProcess.Enabled = True
End Sub

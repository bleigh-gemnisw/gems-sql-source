...
Public Class FrmTXA09H
  ...
  Dim myTXHSTL2 As TXHSTL2.MyData
  ...
  Friend WithEvents BtnCash As Button         ''' Lou reprint
  Friend WithEvents Label3 As Label
  Friend WithEvents TxtList As TextBox
  Dim dsTXHSTL2 As DataSet = New DataSet     ''' Lou reprint 

  Dim amtOfreceiptsThatWillPrint As Integer
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    'Label34
    '
    Me.Label34.Location = New System.Drawing.Point(13, 30)
    ...
    Me.DtPckEnd.Location = New System.Drawing.Point(94, 30)
    ...
    Me.BtnCheck.Location = New System.Drawing.Point(377, 8)
    Me.BtnCheck.Name = "BtnCheck"
    Me.BtnCheck.Size = New System.Drawing.Size(51, 38)
    Me.BtnCheck.TabIndex = 3
    Me.BtnCheck.TabStop = False
    Me.BtnCheck.Text = "&Show Checks"
    '
    'TxtRef
    '
    ...
    Me.TxtRef.Location = New System.Drawing.Point(267, 14)
    ...
    Me.DtPckStart.Location = New System.Drawing.Point(81, 4)
    ...
    Me.BtnReprintReceipt.Location = New System.Drawing.Point(684, 8)
    Me.BtnReprintReceipt.Name = "BtnReprintReceipt"
    Me.BtnReprintReceipt.Size = New System.Drawing.Size(79, 36)
    Me.BtnReprintReceipt.TabIndex = 202
    Me.BtnReprintReceipt.TabStop = False
    Me.BtnReprintReceipt.Text = "Reprint Receipt"
    '
    'BtnCash
    '
    Me.BtnCash.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
    Me.BtnCash.Location = New System.Drawing.Point(560, 6)
    Me.BtnCash.Name = "BtnCash"
    Me.BtnCash.Size = New System.Drawing.Size(48, 36)
    Me.BtnCash.TabIndex = 203
    Me.BtnCash.TabStop = False
    Me.BtnCash.Text = "&Show Cash"
    '
    'Label3
    '
    ...
    Me.TxtList.Location = New System.Drawing.Point(487, 14)
    Me.TxtList.MaxLength = 7
    Me.TxtList.Name = "TxtList"
    Me.TxtList.Size = New System.Drawing.Size(55, 20)
    Me.TxtList.TabIndex = 204
    '
    'FrmTXA09H
    '
...
#End Region
  Private Sub FrmTXA09H_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    myTXHSTL2.CloseFile() ''Lou
    myTXHSTL2 = Nothing   ''Lou
  ...
  Private Sub FrmTXA09H_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    myTXHSTL2 = New TXHSTL2.MyData(myDBConnect)
  ...
  Private Sub TxtRef_TextChanged(sender As Object, e As EventArgs) Handles TxtRef.TextChanged
    ' If the user types in TextBox1, clear TextBox2
    If TxtRef.Focused AndAlso TxtRef.Text.Length > 0 Then
      TxtList.Clear()
    End If

    BtnCash.Enabled = False
    BtnCheck.Enabled = True
    BtnReprintReceipt.Enabled = True
    BtnReprintReceipt.Enabled = True
    C1DataGrdList.DataSource = Nothing


  End Sub

  Private Sub TxtList_TextChanged(sender As Object, e As EventArgs) Handles TxtList.TextChanged
    ' If the user types in TextBox2, clear TextBox1
    If TxtList.Focused AndAlso TxtList.Text.Length > 0 Then
      TxtRef.Clear()
  ...
  Private Sub TxtList_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtList.KeyPress
    ...
    BtnCheck.Enabled = False
    If TxtList.Text = String.Empty Then Exit Sub
  ...
  Public Sub ShowGridCash()
    ...
    End If
    Windows.Forms.Cursor.Current = Cursors.WaitCursor
    ds = myTXHSTL2.GetAllRowsByCash(MyUtils.CnvSng(TxtList.Text), WrkAsof, WrkCutoff)
  ...
  Private Sub BtnReprintReceipt_Click(sender As Object, e As EventArgs) Handles BtnReprintReceipt.Click
    ...
    If C1DataGrdList.Splits(0).Rows.Count > 0 Then
      Answer = MsgBox("This reprint may reprint a large amount of receipts. Are you sure?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "Confirm reprint")
  ...
  Sub GetAllTxhistRecords()
    ...
    If BtnCheck.Enabled = True Then
      dsTXHSTL2 = myTXHSTL2.GetAllRowsByCheckRef(TxtRef.Text, WrkAsof, WrkCutoff)
    Else
      dsTXHSTL2 = myTXHSTL2.GetAllRowsByCash(TxtList.Text, WrkAsof, WrkCutoff)
    End If

  End Sub

  Private Sub ReprintAllReceipts()

    Application.UseWaitCursor = True

    Dim dt As DataTable = dsTXHSTL2.Tables(0)

    For Each row As DataRow In dt.Rows
      Dim myDr As Data.DataRow
      myDr = dsReprint.Tables(0).NewRow

      myDr("ListNo") = row("list#")
      myDr("Type") = row("type")
      myDr("TypeDesc") = row("list#")
      myDr("Year") = row("year")
      myDr("seq") = 0
      myDr("Name") = ""
      myDr("SName") = ""
      myDr("PropDesc") = ""
      myDr("PropDesc2") = ""
      myDr("Principal") = row("pamt")
      myDr("Liens") = row("lamt")
      myDr("Fees") = 0
      myDr("Bond") = 0
      myDr("Total") = row("pamt")
      myDr("Cash") = row("cash")
      myDr("Check") = row("check")
      myDr("Credit") = row("credit")
      myDr("batch") = ""
      myDr("batchno") = 0
      ...
      ' 1. Call the print/view routine
      PrtReceiptReprint(dsReprint, False, True)

      ' 2. Allow Windows to finish rendering the viewer window before continuing
      Application.DoEvents()

      ' 3. Brief pause (750ms) to ensure the UI thread settles and the viewer retains focus

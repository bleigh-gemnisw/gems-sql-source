...
End Sub
  ...
  Private Sub BuildDS2()
    ...
    With myTable
      ...
      .Columns.Add("GrdDt1", Type.GetType("System.String"))
      .Columns.Add("GrdDt2", Type.GetType("System.String"))
      .Columns.Add("GrdDt3", Type.GetType("System.String"))
      .Columns.Add("GrdDt4", Type.GetType("System.String"))
 ...
 ByVal WrkInterestDate As Date)
    ...
    If myTXINV._TYPE = "X" Then
      ...
      WrkGraceDate = MyUtils.GetDBDate(myTXINV._PDAT)
      WrkGraceDate = DateAdd(DateInterval.Month, 1, WrkGraceDate)
      myDr("grddt1") = Format(WrkGraceDate, "M/d/yyyy")
    Else
      myDr("duedt1") = Format(MyUtils.GetDBDateMDY(myTXPROF._PRDUE1), "M/d/yyyy")
      myDr("grddt1") = Format(MyUtils.GetDBDateMDY(myTXPROF._PRGRD1), "M/d/yyyy")
    End If
    If myTXPROF._PRDUE2 > 0 Then
      myDr("duedt2") = Format(MyUtils.GetDBDateMDY(myTXPROF._PRDUE2), "M/d/yyyy")
      myDr("grddt2") = Format(MyUtils.GetDBDateMDY(myTXPROF._PRGRD2), "M/d/yyyy")
    End If
    If myTXPROF._PRDUE3 > 0 Then
      myDr("duedt3") = Format(MyUtils.GetDBDateMDY(myTXPROF._PRDUE3), "M/d/yyyy")
      myDr("grddt3") = Format(MyUtils.GetDBDateMDY(myTXPROF._PRGRD3), "M/d/yyyy")
    End If
    If myTXPROF._PRDUE4 > 0 Then
      myDr("duedt4") = Format(MyUtils.GetDBDateMDY(myTXPROF._PRDUE4), "M/d/yyyy")
      myDr("grddt4") = Format(MyUtils.GetDBDateMDY(myTXPROF._PRGRD4), "M/d/yyyy")
    End If
...
Public Function BuildBarCode(ByVal WrkList As Integer, ByVal WrkType As String, _
  ...
  Return WrkBarCode
End Function
  Public Sub PrtReceiptReprint(ByVal Wrkds As DataSet, ByVal WrkValidation As Boolean, ByVal WrkReceipt As Boolean)
    Dim myreportK2 As New CrystalDecisions.CrystalReports.Engine.ReportDocument
    Dim ReportPath As String
    Dim WrkHeading As String
    Dim WrkHeading2 As String
    ...
    ReportPath = MyUtils.GetReportPath("PrtTXA09R.rpt", myTOWN._TOWNBR)
    ...
    If WrkReceipt Then
      With myreportK2
        ...
        ' IF PRINTING DIRECTLY TO PRINTER:
        .PrintToPrinter(1, False, 0, 0)

        ' IF DISPLAYING TO USER IN A VIEWER FORM (Uncomment below if using a Viewer Form):
        ' Dim frmViewer As New FormReportViewer() ' Replace with your actual Viewer Form name
        ' frmViewer.CrystalReportViewer1.ReportSource = myreportK2
        ' frmViewer.ShowDialog() ' <--- ShowDialog pauses the loop until closed by user

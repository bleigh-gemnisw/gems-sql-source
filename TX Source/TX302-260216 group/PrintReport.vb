  ...
  Public Sub PrtReport()
    ...
    With MyFrmTX302B
      ...
      If .RbSortLoc.Checked Then
        WrkSortBy = "Location"
      End If
      If .RbGroupSname.Checked Then
        WrkGroupBy = "SName"
      End If
      If .RbGroupDOB.Checked Then
        WrkGroupBy = "DOB"
      End If
      If .RbGroupList.Checked Then
        WrkGroupBy = "List"
      End If
...
Done:
  ...
  Private Sub GetDetail()
    ...
    WrkSort = ""
    Select Case WrkGroupBy
      Case "SName"
        WrkSort = "NAME, SNAME, ADD1"
      Case "DOB"
        WrkSort = "NAME, ADD1, DOB"
      Case "List"
        WrkSort = "LIST#"
    End Select
    WrkSort = WrkSort & ", TYPE, YEAR desc, DIST"

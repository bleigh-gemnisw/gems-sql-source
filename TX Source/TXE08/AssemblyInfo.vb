...
' 6/1/25  add code to optimize the speed  with txinv and  txhst
'MK 11/26/25 Audit Overpaid: Remove C/C reduction so it will match Overpaid Balance Sheet, Add New Susp credits
'MK 12/ 1/25 Summary Report: Add Total Credit Balance (Ending Balance CR)
Imports System

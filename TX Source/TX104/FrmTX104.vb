...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX104))
...
Me.Text = "Status Codes Maintenance"
...
#End Region
 ...
 Private Sub FrmTX104_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmTX104B = New FrmTX104B
   MyFrmTX104B.MdiParent = Me
   MyFrmTX104B.Show()
 End Sub
...
Private Sub FrmTX104_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX104B" Then
    MyFrmTX104.Close()
  Else
    MyFrmTX104C.Close()
    MyFrmTX104B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX104C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmTX104C = New FrmTX104C
  MyFrmTX104C.MdiParent = MyFrmTX104B.ParentForm
  MyFrmTX104C.Wrkstcode = ""
  MyFrmTX104C.Show()
  MyFrmTX104B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX104B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX104C.SaveData()
End Sub

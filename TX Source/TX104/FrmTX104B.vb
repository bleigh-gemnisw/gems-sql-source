...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(392, 274)
...
#End Region
Private Sub FrmTX104B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myTXSTS = New TXSTS.mydata(MyDBConnect)
  Wrkstcode = ""
  Call FormatGrid()
End Sub
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
  Wrkstcode = TxtPos.Text
  FormatGrid()
  Wrkstcode = ""
  Wrkstdesc = ""
  TxtPos.Text = ""
...
Public Sub ShowGrid()
  ...
  DataGrdView.Refresh()
End Sub
Private Sub FrmTX104B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTX104.SbpScreen.Text = "TX104B"
  MyFrmTX104.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTX104C.MdiParent = Me.ParentForm
  MyFrmTX104C.Wrkstcode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTX104C.Wrkstdesc = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
  MyFrmTX104C.Show()
  Me.Hide()
End Sub
End Class

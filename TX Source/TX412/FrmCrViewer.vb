Public Class FrmCrViewer
  ...
  Friend WrkCountName As Integer
  Friend WrkCountAddr As Integer
  Friend WrkCountMatch As Integer
  Friend WrkCountNoMatch As Integer
	Friend WrkCountNamesDiff As Integer
	Friend WrkCountNoZip As Integer
...
End Sub
  Private Sub RunReport()
   Dim ReportPath As String
    Dim Wrknameoraddr As String

    If MyFrmTX412B.RbName.Checked Then      'added ken 5/29/26
      Wrknameoraddr = "N"
    Else
      Wrknameoraddr = "A"
    End If
    ...
    ReportPath = MyUtils.GetReportPath("PrtTX412.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      ...
      End If
      .SetDataSource(Wrkds)
      .SetParameterValue("myreportTitle", MyFrmTX412.Text)
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyCountName", WrkCountName)
      .SetParameterValue("MyCountAddr", WrkCountAddr)
      .SetParameterValue("MyCountMatch", WrkCountMatch)
      .SetParameterValue("MyCountNoMatch", WrkCountNoMatch)
      .SetParameterValue("MyCountNamesDiff", WrkCountNamesDiff)
      .SetParameterValue("MyCountNoZip", WrkCountNoZip)
      .SetParameterValue("MyPost", WrkPost)
      .SetParameterValue("MyNameOrAddr", Wrknameoraddr)  'added ken 5/29/26

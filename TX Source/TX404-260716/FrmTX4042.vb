...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.C1DataGrdList.Size = New System.Drawing.Size(810, 176)
    ...
    Me.TbMain.Location = New System.Drawing.Point(14, 316)
    ...
    Me.ClientSize = New System.Drawing.Size(815, 374)
    Me.ControlBox = False
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    With C1DataGrdList
      ...
      For I = 30 To 40
        .Splits(0).DisplayColumns(I).Visible = False
      Next
      .Columns(41).ValueItems.Values.Clear()
      .Columns(41).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("B", "Back Tax"))
      .Columns(41).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("D", "Deferred"))
      .Columns(41).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("E", "Defer Expire"))
      .Columns(41).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("F", "Foreclose"))
      .Columns(41).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("I", "Inactive"))
      .Columns(41).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("M", "Mail Rtn"))
      .Columns(41).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("S", "Suspend"))
      .Columns(41).ValueItems.Translate = True
      .Columns(41).Caption = "Rec Cd"        ' added 10-3-25 Ken
      .Splits(0).DisplayColumns(41).Width = 60  'added 10-3-25 Ken
    End With
  ...
  Private Sub BuildDS()
    ...
    With myTable
      ...
      .Columns.Add("RecCd", Type.GetType("System.String")) 'added 10/3/25 ken
    End With
  ...
  Private Sub RefreshDS()
    ...
    For I = 0 To (myds.Tables(0).Rows.Count - 1)
      ...
      With myds.Tables(0).Rows(I)
        ...
        End If
        .Item("RecCd") = Trim(MyTXINV._ICODE)      'added 10-3-25   ken

...
Me.Text = "Status Codes (5 Maximum)"
...
End Sub
 ...
 If Len(MySts) > 5 Then
   MsgBox("Exceeded Maximum Codes Allowed", MsgBoxStyle.Exclamation, "")
   Exit Sub
 End If
...
Private Sub FrmSelStatus_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   MyFrmTX405.SbpScreen.Text = "SelStatus"
 End Sub
...
Private Sub FrmSelStatus_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
 MyFrmTX405C.TxtStatus.Text = MySts
End Sub
End Class

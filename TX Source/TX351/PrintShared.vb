...
Public Sub BuildDSTot(ByRef ds As DataSet)
    ...
    With myTable
      ...
      .Columns.Add("twaiveredgross", Type.GetType("System.Int64"))
      .Columns.Add("twaiveredexempt", Type.GetType("System.Int64"))
      .Columns.Add("twaiverednet", Type.GetType("System.Int64"))

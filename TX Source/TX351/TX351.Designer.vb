...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("TX351"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class TX351
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As TX351 = CType(MyBase.Clone,TX351)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "TX351"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/TX351.xsd"
    ...
    Partial Public Class mytableDataTable
        ...
        Public Overloads Function AddmytableRow( _
                    ...
                    ByVal NET As Long,  _
                    ByVal TAXTOT As Decimal) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {LETTER, LISTNO, YEAR, TYPEDESC, ADDR1, ADDR2, ADDR3, ADDR4, ADDR5, BANK, PROPDESC, PROPDESC2, GROSS, EXEMPTION, PRORATE, CREDIT, NET, TAXTOT}

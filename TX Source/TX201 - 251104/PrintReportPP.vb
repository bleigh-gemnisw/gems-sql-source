...
Done:
  ...
  Private Sub GetDetail()
    ...
    GetMillRate(WrkGLYear, "P", WrkDist)
    ...
    For I = 0 To (DsTXPPRPC.Tables(0).Rows.Count - 1)
      ...
      .Item("city"), .Item("state"), .Item("zip5"), .Item("zip4"))
        ...
        WrkPropDesc = ""
        If WrkCode(4) > 0 Then
          WrkPropDesc = LookupPPDesc(WrkCode(4))
        End If
        If WrkCode(5) > 0 Then
          WrkPropDesc = WrkPropDesc & "," & LookupPPDesc(WrkCode(5))
        End If
        If WrkCode(6) > 0 Then
          WrkPropDesc = WrkPropDesc & "," & LookupPPDesc(WrkCode(6))
        End If
        If WrkCode(7) > 0 Then
          WrkPropDesc = WrkPropDesc & "," & LookupPPDesc(WrkCode(7))
        End If

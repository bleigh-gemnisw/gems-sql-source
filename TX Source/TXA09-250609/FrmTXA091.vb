...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.C1DataGrdList.Location = New System.Drawing.Point(2, 6)
    ...
    Me.C1DataGrdList.Size = New System.Drawing.Size(656, 275)
    ...
    Me.ClientSize = New System.Drawing.Size(659, 282)
    Me.ControlBox = False
...
#End Region
  ...
  Public Sub FormatGrid()
    ...
    With C1DataGrdList
      ...
      .Columns(10).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("O", "Open"))
      .Columns(10).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("C", "Closed"))
      .Columns(10).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("P", "Posting"))
      .Columns(10).ValueItems.Translate = True
      .Columns(10).Caption = "Status"
      .Splits(0).DisplayColumns(10).Width = 45
      .Splits(0).DisplayColumns(10).Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
      .Columns(11).Caption = "Drawer Total"
      .Splits(0).DisplayColumns(11).Width = 75
      .Columns(11).NumberFormat = "Fixed"
    End With

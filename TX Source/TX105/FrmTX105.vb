...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX105))
...
#End Region
 ...
 Private Sub FrmTX105_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmTX105B = New FrmTX105B
   MyFrmTX105B.MdiParent = Me
   MyFrmTX105B.Show()
 End Sub
...
Private Sub FrmTX105_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX105B" Then
    MyFrmTX105.Close()
  Else
    MyFrmTX105C.Close()
    MyFrmTX105B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX105C.DeleteData()
  MyFrmTX105C.Close()
End Sub
Private Sub DoBtnNew()
  MyFrmTX105C = New FrmTX105C
  MyFrmTX105C.MdiParent = MyFrmTX105B.ParentForm
  MyFrmTX105C.wrkpncode = ""
  MyFrmTX105C.Show()
  MyFrmTX105B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX105B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX105C.SaveData()
End Sub

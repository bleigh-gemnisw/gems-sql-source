...
#End Region
Private Sub FrmTX105B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myTXPEN = New TXPEN.mydata(MyDBConnect)
  wrkpncode = ""
  Call FormatGrid()
End Sub
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
  wrkpncode = TxtPos.Text
  FormatGrid()
  TxtPos.Text = ""
End Sub
...
Public Sub ShowGrid()
  ...
  DataGrdView.Refresh()
End Sub
Private Sub FrmTX105B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTX105.SbpScreen.Text = "TX105B"
  MyFrmTX105.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTX105C.MdiParent = Me.ParentForm
  MyFrmTX105C.wrkpncode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTX105C.wrkpndesc = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
  MyFrmTX105C.Show()
  Me.Hide()
End Sub
End Class

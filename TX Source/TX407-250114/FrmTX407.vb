...
Friend WithEvents TBarContinue As System.Windows.Forms.ToolBarButton
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX407))
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarProcess, Me.TBarContinue, Me.TBarPrint, Me.TBarPS})
    ...
    Me.ImageList1.Images.SetKeyName(2, "print_24.png")
    Me.ImageList1.Images.SetKeyName(3, "Report.ico")
    '
    'SbMain
    '
    ...
    'TBarPrint
    '
    Me.TBarPrint.ImageKey = "Report.ico"
...
Private Sub FrmTX407_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  TBarContinue.Enabled = False
  set_security() '#set
  GetReportOrientation()
  ShowReportOrientation()

  MyFrmTX407B = New FrmTX407B
  MyFrmTX407B.MdiParent = Me
  MyFrmTX407B.Show()
End Sub
...
End Sub
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
  Private Sub FrmTX407_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

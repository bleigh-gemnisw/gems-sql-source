...
Module PrintShared
  ...
  Public Sub CalcInterest(ByVal InListNo As Integer, ByVal InType As String,
    ...
    ByRef OutDue As Decimal, ByRef OutGracePeriod As Boolean, ByRef OutDays As Integer,
    ...
    End With
  End Sub
  Public Sub CalcDue(ByVal InListNo As Integer, ByVal InType As String,
    ByVal InYear As Integer, ByRef OutFee As Decimal, ByRef OutLien As Decimal, ByRef OutBond As Decimal, ByRef OutTax As Decimal,
    ByRef OutDue As Decimal, ByRef OutGracePeriod As Boolean, ByRef OutDays As Integer,
    ByRef OutMethod As String)
    With myCASHDUE
      .In_Date = Date.Today
      ...
      OutDue = Format(.Out_Tot(), "standard")
      OutGracePeriod = .Out_GracePeriod
      OutDays = DateDiff(DateInterval.Day, .Out_Date, Today.Date)
      OutMethod = .Out_Method
    End With
  End Sub
End Module

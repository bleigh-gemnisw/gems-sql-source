Public Class FrmCrViewer
  ...
  Friend WrkTransfer As Boolean
  Friend WrkTransferTotal As Decimal
  Friend WrkTransferTotalOther As Decimal
  Friend WrkShowTransfer As Boolean
...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents TpAdjust As System.Windows.Forms.TabPage
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.TpAdjust = New System.Windows.Forms.TabPage()
    Me.crv2 = New CrystalDecisions.Windows.Forms.CrystalReportViewer()
    Me.TabCtl1.SuspendLayout()
    Me.TpRegular.SuspendLayout()
    Me.TpAdjust.SuspendLayout()
    Me.SuspendLayout()
    '
    'TabCtl1
    '
    ...
    Me.TabCtl1.Controls.Add(Me.TpAdjust)
    ...
    'TpAdjust
    '
    Me.TpAdjust.Controls.Add(Me.crv2)
    Me.TpAdjust.Location = New System.Drawing.Point(4, 22)
    Me.TpAdjust.Name = "TpAdjust"
    Me.TpAdjust.Size = New System.Drawing.Size(636, 350)
    Me.TpAdjust.TabIndex = 1
    Me.TpAdjust.Text = "Adjust/Refund/Transfer"
    Me.TpAdjust.UseVisualStyleBackColor = True
    '
    'crv2
    '
    ...
    Me.TpAdjust.ResumeLayout(False)
...
#End Region
  ...
  Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    If wrkds.Tables(0).Rows.Count = 0 Then
      TabCtl1.TabPages.Remove(TpAdjust)
    Else
      RunReport2()
    End If
  End Sub
  ...
  Private Sub RunReport()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTXE561.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      .SetDataSource(wrkds2)
      .SetParameterValue("myreportTitle", "Treasurer report")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyFromDate", MyFrmTXE56B.DtPckFrom.Value)
      .SetParameterValue("MyToDate", MyFrmTXE56B.DtPckTo.Value)
      ...
      .SetParameterValue("MyTransfer", WrkTransfer)
      .SetParameterValue("MyTransferTotal", WrkTransferTotal)
      .SetParameterValue("MyShowTransfer", WrkShowTransfer)
      .SetParameterValue("MyTypes", MyFrmTXE56B.TxtTypes.Text)
      .SetParameterValue("MyOtherBreak", MyFrmTXE56B.ChkOtherBreak.Checked)
      .SetParameterValue("MyDist", MyUtils.CnvSng(MyFrmTXE56B.TxtDist.Text))
    End With
    With Crv1
      .DisplayToolbar = True
  ...
  Private Sub RunReport2()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtTXE562.rpt", myTOWN._TOWNBR)
    With myreport2
      .Load(ReportPath)
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", "Treasurer report")

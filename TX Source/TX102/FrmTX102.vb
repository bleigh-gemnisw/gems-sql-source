...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX102))
...
Me.TbMain.Size = New System.Drawing.Size(533, 50)
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 456)
...
Me.SbMain.Size = New System.Drawing.Size(533, 28)
...
Private Sub FrmTX102_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTX102B = New FrmTX102B
  MyFrmTX102B.MdiParent = Me
  MyFrmTX102B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTX102_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX102B" Then
    MyFrmTX102.Close()
  Else
    MyFrmTX102C.Close()
  End If
...
Private Sub DoBtnDelete()
  MyFrmTX102C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmTX102C = New FrmTX102C
  MyFrmTX102C.MdiParent = MyFrmTX102B.ParentForm
  MyFrmTX102C.Wrkyear = 0
  MyFrmTX102C.Show()
  MyFrmTX102B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX102B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX102C.SaveData()
End Sub

...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(106, 4)
    ...
    Me.TxtPos.Size = New System.Drawing.Size(28, 20)
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(236, 260)
    Me.DataGrdView.TabIndex = 39
    '
    'FrmListTypes
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(258, 326)
...
#End Region
  ...
  Private Sub FrmListTypes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTXA31.SbpScreen.Text = "ListTypes"
  End Sub
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTXA31B
      If WrkField = "From" Then
        .TxtFromType.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtFromType, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtToType.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtToType, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

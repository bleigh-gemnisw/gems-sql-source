          ...
          If Not myTXVEH.RecordNotFound Then
            ...
            If Not WrkFlagged Then
              ...
              If drSel.GetUpperBound(0) = -1 Then
                ...
                sw.WriteLine(CreateDMV(myTXVEH._PCUST, myTXVEH._LEASE, myTXVEH._VEHID))
              End If
            Else
            ...
            If myTXVEH._SCUST > 0 Then
              ...
              If Not WrkFlagged Then
                ...
                If drSel.GetUpperBound(0) = -1 Then
                  ...
                  dr.Item("dob") = ._DOB
                  mydsDMV.Tables(0).Rows.Add(dr)
                  sw.WriteLine(CreateDMV(myTXVEH._SCUST, myTXVEH._LEASE, myTXVEH._VEHID))
                End If
              Else
            ...
            End If
          End If
          If WrkPost And Good Then FlagPutons(._LISTNo, ._TYPE, ._YEAR)
          GoTo NextRec
        End If
          ...
          If ds3.Tables(0).Rows.Count > 0 Then
            ...
            If Not WrkFlagged Then
              ...
              If drSel.GetUpperBound(0) = -1 Then
                ...
                dr = mydsDMV.Tables(0).NewRow
                dr.Item("sel") = True
                dr.Item("pcust") = ds3.Tables(0).Rows(0).Item("pcust")
                dr.Item("vehid") = ds3.Tables(0).Rows(0).Item("vehid")
                With myTXVCUS
                  .GetOneRecordP(ds3.Tables(0).Rows(0).Item("pcust"))
                  dr.Item("dmvname") = Trim(._NAME)
                  dr.Item("dmvaddr") = Trim(._ADD1)
                  dr.Item("dmvcity") = Trim(._CITY)
                  dr.Item("dmvst") = Trim(._STATE)
                ...
                dr.Item("dob") = ._DOB
                mydsDMV.Tables(0).Rows.Add(dr)
                sw.WriteLine(CreateDMV(ds3.Tables(0).Rows(0).Item("pcust"), ds3.Tables(0).Rows(0).Item("lease"),
              ds3.Tables(0).Rows(0).Item("vehid")))
              End If
            Else
              WriteStatus(._IMVREG, ._LISTNo, ._TYPE, ._YEAR, ._NAME, ._ADD1, "Set Put On")
            End If
            ...
            If ds3.Tables(0).Rows(I).Item("scust") > 0 Then
              ...
              If Not WrkFlagged Then
                WrkSelect = "pcust=" & ds3.Tables(0).Rows(I).Item("scust")
                drSel = mydsDMV.Tables(0).Select(WrkSelect)
                If drSel.GetUpperBound(0) = -1 Then
                  WriteStatus(._IMVREG, ._LISTNo, ._TYPE, ._YEAR, ._NAME, ._ADD1, "DMV Put On2")
                  dr = mydsDMV.Tables(0).NewRow
                  dr.Item("sel") = True
                  dr.Item("pcust") = ds3.Tables(0).Rows(0).Item("scust")
                  dr.Item("vehid") = ds3.Tables(0).Rows(0).Item("vehid")
                  With myTXVCUS
                    .GetOneRecordP(ds3.Tables(0).Rows(0).Item("scust"))
                    dr.Item("dmvname") = Trim(._NAME)
                    dr.Item("dmvaddr") = Trim(._ADD1)
                    dr.Item("dmvcity") = Trim(._CITY)
                    dr.Item("dmvst") = Trim(._STATE)
                  ...
                  dr.Item("dob") = ._DOB
                  mydsDMV.Tables(0).Rows.Add(dr)
                  sw.WriteLine(CreateDMV(ds3.Tables(0).Rows(0).Item("scust"), ds3.Tables(0).Rows(0).Item("lease"),
                ds3.Tables(0).Rows(0).Item("vehid")))
                End If
              Else
                WriteStatus(._IMVREG, ._LISTNo, ._TYPE, ._YEAR, ._NAME, ._ADD1, "Set Put On2")
...
NextRec:
  ...
  End Sub
  Private Sub FlagPutons(ByVal WrkListNo As Integer, ByVal WrkType As String, ByVal WrkYear As Integer)
    Dim ds2 As DataSet = New DataSet

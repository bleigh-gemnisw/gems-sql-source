...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmListDist))
...
#End Region
  ...
  Private Sub FrmListDist_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTXE13.SbpScreen.Text = "ListDist"
  ...
  Private Sub FrmListDist_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    FormatGrid()
    LblCurrent.Text = "(District = " & WrkDist & ")"
  End Sub
Private Sub C1DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
  ...
  With MyFrmTXE13B
    .TxtDist.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
    .TTp1.SetToolTip(.TxtDist, C1DataGrdList.Item(C1DataGrdList.Row, 2))
  End With

Public Class FrmCrViewer
  ...
  Friend WrkPaidCount As Integer
...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTX809.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    If Trim(MyFrmTX809B.TxtLease.Text) > "" Then
      .SetParameterValue("myreportTitle", "Leasing Company: " + MyFrmTX809B.TxtLease.Text)
    Else
      .SetParameterValue("myreportTitle", "Leasing Company List")
    End If
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyPayment", "Pymt: " + Mypayment)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyPaid", MyFrmTX809B.ChkPaid.Checked)
    .SetParameterValue("MyPaidCount", WrkPaidCount)
   End With
   With Crv1
     .DisplayToolbar = True

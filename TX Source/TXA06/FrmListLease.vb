...
#End Region
  ...
  Private Sub FrmListLease_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTXA06.SbpScreen.Text = "ListLease"
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTXA06B
      .TxtLease.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .TTp1.SetToolTip(.TxtLease, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With

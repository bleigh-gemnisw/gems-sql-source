...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTXE15.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Back Tax Update Report")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTXE15B.TxtFromGLYear.Text))
    .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTXE15B.TxtToGLYear.Text))
    .SetParameterValue("MyTypeDescription", MyTypeD)
    If MyType = "S" Then
      .SetParameterValue("Mysupptitle", "Supp#")
    Else
      .SetParameterValue("Mysupptitle", "")
    End If

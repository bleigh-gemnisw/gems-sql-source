...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX114))
...
Private Sub FrmTX114_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  WrkProgName = MyUtils.GetProgramName(False)
	...
	set_security() '#set
	MyFrmTX114B = New FrmTX114B
	MyFrmTX114B.MdiParent = Me
	MyFrmTX114B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
	...
	End If
End Sub
Private Sub FrmTX114_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
	If Me.SbpScreen.Text = "TX114B" Then
		MyFrmTX114.Close()
	Else
		MyFrmTX114B.Show()
	End If

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXE45))
...
Me.Text = "Load Real Estate (Pre Billing) Bank Code from Invoice File"
...
Private Sub FrmTXE45_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  HelpProvider1.HelpNamespace = MyUtils.GetHelpFile(WrkProgName)
	...
	MyFrmTXE45B = New FrmTXE45B
	MyFrmTXE45B.MdiParent = Me
	MyFrmTXE45B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
	...
	End If
End Sub
Private Sub FrmTXE45_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
	 MyFrmTXE45.TBarPrint.Enabled = False
	 MyFrmTXE45B.RunReport()
	 MyFrmTXE45.TBarPrint.Enabled = True
End Sub

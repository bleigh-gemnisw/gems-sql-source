...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(200, 358)
    Me.DataGrdView.TabIndex = 37
    '
    'FrmTX118B
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(224, 408)
    Me.ControlBox = False
...
#End Region
  ...
  Private Sub FrmTX118B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
Public Sub ShowGrid()
  ds = myTXPAYID.PosData(TxtPos.Text)
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
End Sub
Private Sub FrmTX118B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTX118.SbpScreen.Text = "TX118B"
  MyFrmTX118.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTX118C.MdiParent = Me.ParentForm
  MyFrmTX118C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTX118C.AddMode = False
  MyFrmTX118C.Show()
  Me.Hide()
End Sub

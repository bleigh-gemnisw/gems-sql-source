...
Friend WithEvents HelpProvider1 As System.Windows.Forms.HelpProvider
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX118))
    ...
    'SbMain
    '
    Me.SbMain.Font = New System.Drawing.Font("Arial Narrow", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
    ...
    Me.SbMain.Size = New System.Drawing.Size(500, 32)
    ...
    Me.ClientSize = New System.Drawing.Size(500, 614)
...
#End Region
  ...
  Private Sub FrmTX118_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Dim WrkProgName As String
  WrkProgName = MyUtils.GetProgramName(False)

  SbpPgmID.Text = WrkProgName
  SbpEnvironment.Text = myDBConnect.PgmDB
  HelpProvider1.HelpNamespace = MyUtils.GetDataPath() & "gemshelp\" & WrkProgName & ".chm"

  TBarSave.Enabled = False
  TBarDelete.Enabled = False
  TBarPrint.Enabled = True
  set_security() '#set
  MyFrmTX118B = New FrmTX118B
  MyFrmTX118B.MdiParent = Me
  MyFrmTX118B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTX118_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If MyFrmTX118.SbpScreen.Text = "TX118B" Then
     MyFrmTX118.Close()
  Else
    MyFrmTX118C.Close()
    MyFrmTX118B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTX118C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmTX118C.Close()
  MyFrmTX118B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTX118C = New FrmTX118C
  MyFrmTX118C.MdiParent = MyFrmTX118B.ParentForm
  MyFrmTX118C.WrkCode = ""
  MyFrmTX118C.AddMode = True
  MyFrmTX118C.Show()
  MyFrmTX118B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX118B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX118C.SaveData()
End Sub

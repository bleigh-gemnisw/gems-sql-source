...
End Sub
  ...
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTX600.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "MUNIS Bridge G/L Entries")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyCurrYear", MyUtils.CnvSng(MyFrmTX600B.TxtCurrYear.Text))
    .SetParameterValue("MyCurrYearSU", MyUtils.CnvSng(MyFrmTX600B.TxtCurrYearSU.Text))
    .SetParameterValue("MyBatch", MyUtils.CnvSng(MyFrmTX600B.TxtBatch.Text))
    .SetParameterValue("MyPostDate", WrkPostDate)
   End With
   With Crv1
     .DisplayToolbar = True

...
#End Region
    ...
    Private Sub FrmSelSts_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      MyFrmTX816.TBarProcess.Enabled = False
      BuildDS()
      RefreshDS()
      Call FormatGrid()
...
Private Sub FrmSelSts_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
     ...
     MyFrmTX816.SbpScreen.Text = "SelSts"
  End Sub
...
Private Sub FrmSelSts_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  MyFrmTX816.TBarProcess.Enabled = True
  MyFrmTX816B.TxtOmit.Text = MyStsOmit
  MyFrmTX816B.Show()
End Sub
End Class

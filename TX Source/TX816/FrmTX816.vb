...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX816))
...
Me.Text = "Create  Tax Payment History (WEBHIST) File"
...
Private Sub FrmTX816_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "TX816"
  TBarProcess.Enabled = True
  set_security() '#set
  GetReportOrientation()
  ShowReportOrientation()

  MyFrmTX816B = New FrmTX816B
  MyFrmTX816B.MdiParent = Me
  MyFrmTX816B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTX816_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

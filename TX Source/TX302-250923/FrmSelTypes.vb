...
#End Region
    ...
    Private Sub FrmSelTypes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      MyFrmTX302.TBarPrint.Enabled = False
      BuildDS()
      RefreshDS()
      Call FormatGrid()
...
Private Sub RefreshDS()
  ...
  Dim Pos As Integer
    ...
    For I = 0 To ds.Tables(0).Rows.Count - 1
      If MyFrmTX302B.RbPrtBalDueUB.Checked = True Then
        If ds.Tables(0).Rows(I).Item("txfam") <> "U" Then
          GoTo skipme
        End If
      End If
      If MyFrmTX302B.RbPrtShutOff.Checked = True Then
        If ds.Tables(0).Rows(I).Item("txfam") <> "U" Then
          GoTo skipme
        End If
      End If
...
Private Sub FrmSelTypes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
     MyFrmTX302.SbpScreen.Text = "SelTypes"
  End Sub
...
Private Sub FrmSelTypes_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  MyFrmTX302.TBarPrint.Enabled = True
  MyFrmTX302B.TxtTypes.Text = MyTypes
End Sub
End Class

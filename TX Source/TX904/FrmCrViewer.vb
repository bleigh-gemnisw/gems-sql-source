...
End Sub
  ...
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTX904.rpt", myTOWN._TOWNBR)
   ...
   With myreport
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Collection Agency Report")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyIntDate", MyFrmTX904B.DtPckInt.Value)
   End With
   With crv2
     .DisplayToolbar = True

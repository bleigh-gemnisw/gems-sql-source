...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTXE02.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      ...
      End If
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", "Payment History/Refunds List")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyFromDate", MyFrmTXE02B.DtPckFrom.Value)
      .SetParameterValue("MyToDate", MyFrmTXE02B.DtPckTo.Value)
      .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTXE02B.TxtFromGLYear.Text))
      .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTXE02B.TxtToGLYear.Text))
      .SetParameterValue("MyTypes", MyTypes)
      .SetParameterValue("MyStatus", MyFrmTXE02B.TxtStatus.Text)
      .SetParameterValue("MySelection", WrkSelection)
      .SetParameterValue("MyBatchDesc", WrkBatchDesc)
      .SetParameterValue("MyDist", MyUtils.CnvSng(MyFrmTXE02B.TxtDist.Text))
    End With
    With Crv1
      .DisplayToolbar = True
  ...
  Private Sub RunReport2()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtTXE02Tot.rpt", myTOWN._TOWNBR)
    With myreport2
      .Load(ReportPath)
      If MyReportLandscape Then
        .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
      ...
      .SetParameterValue("myreportTitle", "Payment History/Refunds Totals")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyFromDate", MyFrmTXE02B.DtPckFrom.Value)
      .SetParameterValue("MyToDate", MyFrmTXE02B.DtPckTo.Value)

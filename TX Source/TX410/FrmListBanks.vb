...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(346, 263)
...
#End Region
  ...
  Private Sub FrmListBANKSption_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTX410.SbpScreen.Text = "ListBank"
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTX410B
      If WrkField = "1" Then
        .TxtBankCd.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtBankCd, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtBankCd2.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtBankCd2, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

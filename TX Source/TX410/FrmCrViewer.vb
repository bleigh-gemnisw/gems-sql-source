Public Class FrmCrViewer
  ...
  Friend WrkBankCd As String
  Friend WrkBankSvc As String
  Friend WrkBankCd2 As String
...
End Sub
  ...
  Private Sub RunReport()
   Dim ReportPath As String
    ...
    ReportPath = MyUtils.GetReportPath("PrtTX410.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      ...
      .SetDataSource(wrkds)
      If WrkBankCd2 = "" Then
        .SetParameterValue("myreportTitle", "Remove Bank Codes")
      Else
        .SetParameterValue("myreportTitle", "Change Bank Codes")
      End If
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyBankCd", WrkBankCd)
      .SetParameterValue("MyBankSvc", WrkBankSvc)
      .SetParameterValue("MyBankCd2", WrkBankCd2)

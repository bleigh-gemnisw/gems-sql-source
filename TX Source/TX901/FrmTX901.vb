...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX901))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSave, Me.TBarNew, Me.TBarSep1, Me.TBarChange, Me.TBarDelete, Me.TBarSep2, Me.TBarPrtEdits, Me.TBarPost})
...
Private Sub FrmTX901_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTX901B = New FrmTX901B
  MyFrmTX901B.MdiParent = Me
  MyFrmTX901B.Show()
...
Private Sub tbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  If e.Button Is TBarPrtEdits Then
    ...
    WrkBatchNo = MyFrmTX901B.C1DataGrdList.Item(MyFrmTX901B.C1DataGrdList.Row, 1)
...
End Sub
  ...
  Private Sub FrmTX901_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    Dim Cancel As Boolean

    If MyFrmTX901.SbpScreen.Text = "TX901C" Then
      If Cancel Then
        e.Cancel = True
      End If
      Exit Sub
...
Private Sub DoBtnBack()
  ...
  Case "TX901D"
    MyFrmTX901D.Close()
  Case "ListSResn"
    MyFrmListSResn.Close()
  Case "SelInv"
    MyFrmSelInv.Close()
  End Select
End Sub
Private Sub DoBtnChange()
  MyFrmTX901B.changebatch()
End Sub
Private Sub DoBtnDelete()
  Dim Cancel As Boolean
  Select Case Me.SbpScreen.Text
  Case "TX901B"
    MyFrmTX901B.DeleteData(Cancel)
  Case "TX901D"
    MyFrmTX901D.DeleteData(Cancel)
...
Private Sub DoBtnNew()
  ...
  Case "TX901B"
    ...
    MyFrmTX901B.Hide()
  Case "TX901C"
    MyFrmSelInv = New FrmSelInv
    MyFrmSelInv.MdiParent = MyFrmTX901C.ParentForm
    MyFrmSelInv.WrkBatchNo = MyFrmTX901C.WrkBatchNo
    MyFrmSelInv.Show()
    MyFrmTX901C.Hide()
  End Select
End Sub
Private Function DoBtnPrtEdits(ByVal Post As Boolean) As Boolean
  ...
  If Post Then
    MyFrmTX901.TBarPost.Enabled = False
  Else
    MyFrmTX901.TBarPrtEdits.Enabled = False
  End If
  WrkBatchNo = MyFrmTX901B.C1DataGrdList.Item(MyFrmTX901B.C1DataGrdList.Row, 1)
  WrkBatchDate = MyFrmTX901B.C1DataGrdList.Item(MyFrmTX901B.C1DataGrdList.Row, 17)
  Errors = PrtEdits(WrkBatchNo, Post, WrkBatchDate)
  If Post Then
    MyFrmTX901.TBarPost.Enabled = True
  Else
    MyFrmTX901.TBarPrtEdits.Enabled = True
  End If
  Return Errors
End Function
Private Sub DoBtnSave()
   ...
   Case Is = "TX901_BCH"
     MyFrmTX901_BCH.SaveData()
   Case Is = "TX901D"
     MyFrmTX901D.SaveData()
   End Select

End Sub
  Private Sub FrmTX901_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

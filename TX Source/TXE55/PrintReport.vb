  ...
  Public Sub PrtReport()
    ...
    Else
      With MyFrmTXE55B
        ...
        WrkFilePath = MyFrmTXE55B.TxtFilePath.Text
        WrkFileName = MyFrmTXE55B.TxtFileName.Text
        WrkAddress = MyFrmTXE55B.TxtAddress.Text
        WrkUser = MyFrmTXE55B.TxtUser.Text
        WrkPasssword = MyFrmTXE55B.TxtPassword.Text
      End With
    End If

    WrkFileName = Replace(WrkFileName, "Account_ID", WrkUser)
    WrkFile = WrkFileName & ".D" & Format(Date.Now, "MMddyyyy") &
  ".T" & Format(TimeOfDay, "hhmmssff") & ".txt"
...
WrkQry2 = "icode<>'I'" & WrkAnd & "icode<>'D'" & WrkAnd & _
...
If MyAutomate Then
  myFrmProgress.Text = "TXE55 - Creating file..."
End If
myFrmProgress.Show()

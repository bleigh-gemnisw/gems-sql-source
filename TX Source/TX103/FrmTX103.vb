...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX101))
...
Me.Text = "Check Endorsement Master"
...
#End Region
 ...
 Private Sub FrmTX103_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  TBarSave.Enabled = False
   ...
   set_security() '#set
   MyFrmTX103B = New FrmTX103B
   MyFrmTX103B.MdiParent = Me
   MyFrmTX103B.Show()
 End Sub
...
Private Sub FrmTX103_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX103B" Then
    MyFrmTX103.Close()
  Else
    MyFrmTX103C.Close()
    MyFrmTX103B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX103C.DeleteData()
  MyFrmTX103C.Close()
  MyFrmTX103B.Show()
End Sub
Private Sub DoBtnNew()
  MyFrmTX103C = New FrmTX103C
  MyFrmTX103C.MdiParent = MyFrmTX103B.ParentForm
  MyFrmTX103C.Wrktype = ""
  MyFrmTX103C.WrkAddMode = True
  MyFrmTX103C.Show()
  MyFrmTX103B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX103B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX103C.SaveData()
End Sub

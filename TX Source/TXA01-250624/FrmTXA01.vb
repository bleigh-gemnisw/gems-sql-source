...
Friend WithEvents HelpProvider1 As System.Windows.Forms.HelpProvider
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXA01))
    ...
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 557)
    ...
    Me.Text = "Edit and Post Electronic Receipts"
...
#End Region
    ...
    Private Sub FrmTXA01_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      MyFrmTXA01B = New FrmTXA01B
      MyFrmTXA01B.MdiParent = Me
      MyFrmTXA01B.Show()
...
End Sub
  ...
  Private Sub tbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    If e.Button Is TBarSave Then
      If SbpScreen.Text = "TXA01D" Then
        MyFrmTXA01D.SaveData()
        Exit Sub
      End If
    End If
    ...
    If e.Button Is TBarDelete Then
      If MyFrmTXA01B.DataGrdView.Rows.Count > 0 Then
        DoBtnDelete()
        Exit Sub
      End If
    End If
    ...
    If e.Button Is TBarPrtEdits Then
      If MyFrmTXA01B.DataGrdView.Rows.Count > 0 Then
        ...
        WrkBatchNo = MyFrmTXA01B.DataGrdView.Item(1, MyFrmTXA01B.DataGrdView.CurrentRow.Index).Value
    ...
    If e.Button Is TBarPost Then
      If MyFrmTXA01B.DataGrdView.Rows.Count > 0 Then
        ...
        WrkStatus = MyFrmTXA01B.DataGrdView.Item(2, MyFrmTXA01B.DataGrdView.CurrentRow.Index).Value
        If WrkStatus = "I" Then
          MsgBox("Batch is missing records. Delete batch and rerun.", MsgBoxStyle.Exclamation, "Incomplete batch")
          TBarNew.Enabled = True
          TBarDelete.Enabled = True
          TBarPost.Enabled = True
          TBarPrtEdits.Enabled = True
  ...
  Private Sub FrmTXA01_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    Dim Cancel As Boolean

    If MyFrmTXA01.SbpScreen.Text = "TXA01C" Then
      If Cancel Then
        e.Cancel = True
      End If
      Exit Sub
...
Private Sub DoBtnDelete()
  ...
  Select Case Me.SbpScreen.Text
  Case "TXA01B"
    MyFrmTXA01B.DeleteData(Cancel)
  Case "TXA01D"
    MyFrmTXA01D.DeleteData(Cancel)
...
Private Sub DoBtnNew()
  Select Case Me.SbpScreen.Text
	Case "TXA01B"
		MyFrmTXA01B_New = New FrmTXA01B_New
		MyFrmTXA01B_New.MdiParent = MyFrmTXA01B.ParentForm
		MyFrmTXA01B_New.Show()
		MyFrmTXA01B.Hide()
	Case "TXA01C"
		MyFrmTXA01D = New FrmTXA01D
		MyFrmTXA01D.MdiParent = MyFrmTXA01B.ParentForm
		MyFrmTXA01D.WrkBatchNo = MyFrmTXA01C.WrkBatchNo
		MyFrmTXA01D.WrkSeq = 0
		MyFrmTXA01D.Show()
		MyFrmTXA01C.Hide()
	End Select
End Sub
  Private Function DoBtnPrtEdits(ByVal Post As Boolean) As Boolean
    ...
    WrkBatchNo = MyFrmTXA01B.DataGrdView.Item(1, MyFrmTXA01B.DataGrdView.CurrentRow.Index).Value
    WrkBatchType = MyFrmTXA01B.DataGrdView.Item(3, MyFrmTXA01B.DataGrdView.CurrentRow.Index).Value
    WrkReceiptDate = MyFrmTXA01B.DataGrdView.Item(17, MyFrmTXA01B.DataGrdView.CurrentRow.Index).Value
    myBCHHDR.GetOneRecordP(MyBatch, WrkBatchNo)
    If myBCHHDR._STRDT > 0 Then
      WrkInterestDate = MyUtils.GetDBDate(myBCHHDR._STRDT)
    Else
      WrkInterestDate = WrkReceiptDate
    End If
    WrkBatchTypeDesc = GetBatchTypeDesc(WrkBatchType)
    Errors = PrtEdits(WrkBatchNo, WrkBatchTypeDesc, WrkReceiptDate, WrkInterestDate, Post)

    Return Errors
  End Function

  Private Sub FrmTXA01_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

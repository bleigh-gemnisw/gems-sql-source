...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXE48))
    ...
    Me.Text = "Refresh Delinquent Status by Account"
...
Private Sub FrmTXE48_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
 Me.SbpPgmID.Text = "TXE48"
 TBarProcess.Enabled = True
 set_security() '#set
 If MyAutomate Or MyFTP Then
  PrtReport()
 Else
  MyFrmTXE48B = New FrmTXE48B
  MyFrmTXE48B.MdiParent = Me
  MyFrmTXE48B.Show()
 End If
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
 ...
 End If
End Sub
Private Sub FrmTXE48_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
  MyFrmTXE48.TBarProcess.Enabled = False
  MyFrmTXE48B.RunReport()
  MyFrmTXE48.TBarProcess.Enabled = True
End Sub
Private Sub DoBtnSettings()
    With MyFrmTXE48B
      MyAppSettings.FileMode = .RbFile.Checked

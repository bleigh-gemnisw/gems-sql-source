...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmSelSts))
...
#End Region
    ...
    Private Sub FrmSelSts_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Private Sub RefreshDS()
  ...
  Dim Pos As Integer
    ...
    For I = 0 To ds.Tables(0).Rows.Count - 1
      ...
      Case "Blocked"
        Pos = InStr(MyStsBlocked, ds.Tables(0).Rows(I).Item("stcode"))
      Case "Liened"
        Pos = InStr(MyStsLiened, ds.Tables(0).Rows(I).Item("stcode"))
      Case Else
        Pos = InStr(MyStsOmit, ds.Tables(0).Rows(I).Item("stcode"))
      End Select
      If Pos > 0 Then
        myDr("select") = True
      Else
        myDr("select") = False
      End If
			myDr("type") = ds.Tables(0).Rows(I).Item("stcode")
...
End Sub
  ...
  Windows.Forms.Cursor.Current = Cursors.WaitCursor()
	For I = 0 To (C1DataGrdList.Splits(0).Rows.Count - 1)
      ...
      Select Case WrkField
      Case "Blocked"
        MyStsBlocked = MyStsBlocked + C1DataGrdList.Item(I, 1)
      Case "Liened"
        MyStsLiened = MyStsLiened + C1DataGrdList.Item(I, 1)
      Case Else
        MyStsOmit = MyStsOmit + C1DataGrdList.Item(I, 1)
      End Select
    End If
  Next
  ...
  Windows.Forms.Cursor.Current = Cursors.Default
	End Sub
Private Sub FrmSelSts_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
     MyUtils.CenterForm(Me.ParentForm, Me)
		 MyFrmTX830.SbpScreen.Text = "SelSts"
  End Sub
  ...
  Private Sub FrmSelSts_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub FrmSelSts_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
	MyFrmTX830.TBarProcess.Enabled = True
  Select Case WrkField
  Case "Blocked"
    MyFrmTX830B.TxtBlocked.Text = MyStsBlocked
  Case "Liened"
    MyFrmTX830B.TxtLiened.Text = MyStsLiened
  Case Else
    MyFrmTX830B.TxtOmit.Text = MyStsOmit
  End Select
  MyFrmTX830B.Show()
End Sub
End Class

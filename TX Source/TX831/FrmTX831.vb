...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX831))
    ...
    Me.ImageList1.Images.SetKeyName(2, "checked_24.png")
    '
    'SbMain
    '
    ...
    Me.Text = "Create Web New Additions File"
...
#End Region
  ...
  Private Sub FrmTX831_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    Me.SbpPgmID.Text = "TX831"
    TBarProcess.Enabled = True
    set_security() '#set
    If MyAutomate Then
      PrtReport()
    Else
      MyFrmTX831B = New FrmTX831B
      MyFrmTX831B.MdiParent = Me
      MyFrmTX831B.Show()
    End If
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
  Private Sub FrmTX831_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnPrint()
    MyFrmTX831.TBarProcess.Enabled = False
    MyFrmTX831B.RunReport()
    MyFrmTX831.TBarProcess.Enabled = True
  End Sub
  Private Sub DoBtnSettings()
    With MyFrmTX831B
      MyAppSettings2.FilePath = .TxtFilePath.Text
      MyAppSettings2.FileName = .TxtFileName.Text
      MyAppSettings2.Address = .TxtAddress.Text
      MyAppSettings2.User = .TxtUser.Text
      MyAppSettings2.Password = .TxtPassword.Text
      MyAppSettings2.Days = .TxtDays.Text
    End With
    SaveAppSettings2()
  End Sub

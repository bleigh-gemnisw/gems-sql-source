...
#End Region
  ...
  Private Sub FrmListAltID_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTX304.SbpScreen.Text = "ListAltID"
  ...
  Dim I As Integer
   ...
   WrkAltID = Chr(65 + I)
   WrkReportName = ""
   If MyFrmTX304B.RbPrtNotice.Checked Then
     WrkReportName = "PrtTX3043" & WrkAltID & ".rpt"
   End If
   If MyFrmTX304B.RbPrtTownClerk.Checked Then
     WrkReportName = "PrtTX3044" & WrkAltID & ".rpt" 'Chr 65=A
   End If
   If MyFrmTX304B.RbPrtBlanket.Checked Then
     WrkReportName = "PrtTX3046" & WrkAltID & ".rpt" 'Chr 65=A
   End If

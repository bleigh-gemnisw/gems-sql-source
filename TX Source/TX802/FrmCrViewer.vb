Public Class FrmCrViewer
  ...
  Friend wrkcount As Int32
  Friend wrkerrorcount As Int32
...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTX802.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Bank Service Update")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyCount", wrkcount)
    .SetParameterValue("MyPost", Wrkpost)
    .SetParameterValue("MyErrorCount", wrkerrorcount)
   End With
   With Crv1
     .DisplayToolbar = True

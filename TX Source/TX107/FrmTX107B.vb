...
#Region " Windows Form Designer generated code "
    ...
    Me.TxtBank.Location = New System.Drawing.Point(80, 8)
    Me.TxtBank.MaxLength = 2
    Me.TxtBank.Name = "TxtBank"
    Me.TxtBank.Size = New System.Drawing.Size(29, 20)
    Me.TxtBank.TabIndex = 0
    '
    'BtnShow
    '
    Me.BtnShow.Location = New System.Drawing.Point(115, 5)
    Me.BtnShow.Name = "BtnShow"
    Me.BtnShow.Size = New System.Drawing.Size(53, 24)
...
Private Sub FrmTX107B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myTXBANKS = New TXBANKS.mydata(MyDBConnect)
  Call FormatGrid()
End Sub
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnShow.Click
  MyFrmTX107C = New FrmTX107C
  MyFrmTX107C.MdiParent = Me.ParentForm
  MyFrmTX107C.Wrkbkcode = TxtBank.Text
  MyFrmTX107C.Show()
  Me.Hide()
End Sub
Public Sub FormatGrid()
  ...
  With DataGrdView
    ...
    .Columns(1).Width = 200
    .Columns(2).HeaderText = "Print"
    .Columns(2).Width = 35
    .Columns(3).Visible = False
    .Columns(4).Visible = False
    .Columns(5).Visible = False
    .Columns(6).HeaderText = "City"
    .Columns(6).Width = 120
    .Columns(7).HeaderText = "State"
    .Columns(7).Width = 35
    .Columns(8).HeaderText = "ZIP Code"
    .Columns(8).DefaultCellStyle.Format = ("00000-0000")
    .Columns(8).Width = 75
  End With
End Sub
Public Sub ShowGrid()
  ...
  If MyFrmTX107B.RbCode.Checked Then
  ...
  dv = Nothing
End Sub
Private Sub FrmTX107B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTX107.SbpScreen.Text = "TX107B"
  MyFrmTX107.TBarPrint.Enabled = True
  MyUtils.CenterForm(Me.ParentForm, Me)
End Sub
Private Sub TxtBank_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtBank.KeyPress
  ...
  End If
End Sub
Private Sub DataGrdList_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmTX107C = New FrmTX107C
  MyFrmTX107C.MdiParent = Me.ParentForm
  MyFrmTX107C.Wrkbkcode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTX107C.Show()
  Me.Hide()
End Sub

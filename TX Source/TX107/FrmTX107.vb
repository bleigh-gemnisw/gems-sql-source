...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX107))
...
#End Region
 Private Sub FrmTX107_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmTX107B = New FrmTX107B
   MyFrmTX107B.MdiParent = Me
   MyFrmTX107B.Show()
 End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
 ...
 End If
End Sub
Private Sub FrmTX107_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX107B" Then
    MyFrmTX107.Close()
  Else
    MyFrmTX107C.Close()
    MyFrmTX107B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX107C.DeleteData()
  MyFrmTX107C.Close()
End Sub
Private Sub DoBtnNew()
  MyFrmTX107C = New FrmTX107C
  MyFrmTX107C.MdiParent = MyFrmTX107B.ParentForm
  MyFrmTX107C.Wrkbkcode = ""
  MyFrmTX107C.Show()
  MyFrmTX107B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX107B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX107C.SaveData()
End Sub

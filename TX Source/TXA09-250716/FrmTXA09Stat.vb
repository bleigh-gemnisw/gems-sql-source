...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXA09Stat))
...
Me.C1DataGrdList.Size = New System.Drawing.Size(244, 100)
...
#End Region
	...
	Private Sub FrmTXA09Stat_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
 ...
 End Sub
	...
	Private Sub FrmTXA09Stat_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
'    MyFrmTXA09B.TBarSave.Enabled = False
		myTXSTS.CloseFile()
		MyFrmTXA09B.Show()

	End Sub
	Private Sub FrmTXA09Stat_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
		MyFrmTXA09.SbpScreen.Text = "TXA09Stat"
...
Private Sub CreateGrid()
	...
	For I = 1 To 5
		...
		WrkCode = Mid(MyFrmTXA09B.LblStatus.Text, I, 1)
		 myDr("Code") = WrkCode
		myTXSTS.GetOneRecordP(WrkCode)
		If Not myTXSTS.RecordNotFound Then
			myDr("Descr") = Trim(myTXSTS._STDESC)
		Else

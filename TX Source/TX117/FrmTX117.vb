...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX117))
    ...
    Me.Text = "Leasing Company Maintenance"
...
#End Region
 Private Sub FrmTX117_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmTX117B = New FrmTX117B
   MyFrmTX117B.MdiParent = Me
   MyFrmTX117B.Show()
 End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
 ...
 End If
End Sub
Private Sub FrmTX117_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX117B" Then
    MyFrmTX117.Close()
  Else
    MyFrmTX117C.Close()
    MyFrmTX117B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX117C.DeleteData()
  MyFrmTX117C.Close()
End Sub
Private Sub DoBtnNew()
  MyFrmTX117C = New FrmTX117C
  MyFrmTX117C.MdiParent = MyFrmTX117B.ParentForm
  MyFrmTX117C.WrkCode = ""
  MyFrmTX117C.Show()
  MyFrmTX117B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX117B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX117C.SaveData()
End Sub

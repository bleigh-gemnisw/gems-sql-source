...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(111, 6)
    ...
    Me.TxtPos.Size = New System.Drawing.Size(33, 20)
    ...
    Me.Name = "FrmListCCReason"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Select C/C Reason Code"
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    Else
      ds = myTXCRESN.PosData(TxtPos.Text)
    End If
  ...
  Private Sub FrmListCCReason_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTX702.SbpScreen.Text = "ListCCReason"
  End Sub
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTX702B
      If WrkField = "From" Then
        .TxtFromReason.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtFromReason, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtToReason.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtToReason, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

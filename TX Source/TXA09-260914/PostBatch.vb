      ...
      With myTXINV
        ...
        If BchPcamt > 0 And BchPencd <> "BI" And BchPencd <> "MV" Then
          If BchPencd = Trim(._FEC1) Then
            ...
            End If
            WrkSet = WrkSet & ",fec1='" & ._FEC1 & "'" & ",fed1=" & ._FED1
          End If
          If BchPencd = Trim(._FEC2) Then
            ...
            End If
            WrkSet = WrkSet & ",fec2='" & ._FEC2 & "'" & ",fed2=" & ._FED2
          End If
          If BchPencd = Trim(._FEC3) Then
            ...
            End If
            WrkSet = WrkSet & ",fec3='" & ._FEC3 & "'" & ",fed3=" & ._FED3
          End If
          If BchPencd = Trim(._FEC4) Then
            ...
            End If
            WrkSet = WrkSet & ",fec4='" & ._FEC4 & "'" & ",fed4=" & ._FED4
          End If
...
UpdateTXINV:
      ...
      Catch ex As Exception
        Answer = MsgBox("Do you want to retry the update? Answering NO will end the program", MsgBoxStyle.YesNo, "Unable to perform update")
        ...
        If Not myTXINV_NY.RecordNotFound And WrkBald <= 0 Then
          With myTXINV_NY
            If Trim(._ICODE) = "B" Then
              ...
              'MK 8/14/25 Begin
              '.UpdateOneRecordP()
              .UpdateIcode(._LISTNo, ._YEAR, ._TYPE, ._ICODE)
              'MK 8/14/25 End
            End If
          End With
        End If

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXA09CCUB))
...
Me.LblName.Location = New System.Drawing.Point(192, 24)
...
Me.LblType.Location = New System.Drawing.Point(288, 4)
...
Me.Label3.Location = New System.Drawing.Point(312, 4)
...
Me.LblYear.Location = New System.Drawing.Point(344, 4)
...
Me.LblList.Location = New System.Drawing.Point(192, 4)
...
Me.C1DataGrdList.Size = New System.Drawing.Size(460, 248)
...
Me.C1DataGrdList.PropBag = resources.GetString("C1DataGrdList.PropBag")
    ...
    Me.Name = "FrmTXA09CCUB"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "U/B Adjustment History"
...
#End Region
  ...
  Private Sub FrmTXA09CCUB_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  Public Sub ShowGrid()
    ...
    ds = myUTCOEAL1.GetViewbyList(WrkListNo, WrkYear, WrkType, 50)
  ...
  Private Sub GridList()
    With C1DataGrdList
      ...
      .Columns(8).Caption = "C/C Tax"
      .Columns(8).NumberFormat = "Standard"
      .Splits(0).DisplayColumns(8).Width = 70
    End With

  End Sub
  Private Sub FrmTXA09CCUB_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ds.Clear()
    ds = Nothing

    'Memory Cleanup
    myUTCOEAL1.CloseFile()
    myUTCOEAL1 = Nothing
    MyFrmTXA09CCUB = Nothing

    MyFrmTXA09B.Show()
  End Sub
  Private Sub FrmTXA09CCUB_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTXA09.SbpScreen.Text = "TXA09CCUB"

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmListPenCd))
...
#End Region
  ...
  Private Sub FrmListCCReason_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTXA09.SbpScreen.Text = "ListPenCd"
  End Sub
  ...
  Private Sub BtnNext_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    TxtPos.Text = C1DataGrdList.Item(I, 0)
    FormatGrid()
    TxtPos.Text = ""
  End Sub
...
Private Sub C1DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
    ...
    With MyFrmTXA099
		 ...
		 Case "Fee1"
			 .TxtFeeCd1.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
			 .Ttp1.SetToolTip(.TxtFeeCd1, C1DataGrdList.Item(C1DataGrdList.Row, 1))
		 Case "Fee2"
			 .TxtFeeCd2.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
			 .Ttp1.SetToolTip(.TxtFeeCd2, C1DataGrdList.Item(C1DataGrdList.Row, 1))
		 Case "Fee3"
			 .TxtFeeCd3.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
			 .Ttp1.SetToolTip(.TxtFeeCd3, C1DataGrdList.Item(C1DataGrdList.Row, 1))
		 Case "Fee4"
			 .TxtFeeCd4.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
			 .Ttp1.SetToolTip(.TxtFeeCd4, C1DataGrdList.Item(C1DataGrdList.Row, 1))
		 Case "Fee5"
			 .TxtFeeCd5.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
			 .Ttp1.SetToolTip(.TxtFeeCd5, C1DataGrdList.Item(C1DataGrdList.Row, 1))
		 End Select
		End With

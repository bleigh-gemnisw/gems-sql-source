...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.ClientSize = New System.Drawing.Size(285, 326)
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    'filter datagrid to show only the ones Kim asked for 
    ' Assuming your DataGridView is named "DataGridView1"
    Dim dv As New DataView(DirectCast(DataGrdView.DataSource, DataTable))

    ' Set the RowFilter based on column 3 ("Status") where the value should be "R," "A," or "U"
    dv.RowFilter = "(TYCODE = 'R' OR TXFAM = 'A' OR TXFAM= 'U') AND TYCODE <> 'X'"

    ' Apply the filtered DataView back to the DataGridView
    DataGrdView.DataSource = dv.ToTable()
  ...
  Private Sub FrmListTypes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTXE46.SbpScreen.Text = "ListTypes"
  ...
  Private Sub FrmListTypes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    FormatGrid()
  End Sub
  Private Sub FrmListTypes_Closing(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Closing
    MyFrmTXE46B.Show()
  End Sub
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTXE46B
      ...
      .TTp1.SetToolTip(.TxtType, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
    End With
    Me.Close()

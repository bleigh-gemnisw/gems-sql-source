...
Friend WithEvents TBarSetPrinter As System.Windows.Forms.ToolBarButton
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    Me.components = New System.ComponentModel.Container()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX404))
    ...
    Me.TBarSetPrinter = New System.Windows.Forms.ToolBarButton()
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarPrint, Me.TBarSetPrinter, Me.TBarSep1, Me.TBarSettings})
    ...
    Me.TBarPrint.Text = "Quick &Print"
    '
    'TBarSetPrinter
    '
    Me.TBarSetPrinter.ImageIndex = 2
    Me.TBarSetPrinter.Name = "TBarSetPrinter"
    Me.TBarSetPrinter.Text = "Set Printer"
    '
    'TBarSep1
    '
    ...
    Me.ImageList1.Images.SetKeyName(2, "select type_24.png")
    '
    'SbMain
    '
...
#End Region
	...
	Private Sub FrmTX404_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    HelpProvider1.HelpNamespace = MyUtils.GetHelpFile(WrkProgName)
		...
		MyQrySelect = ""
		MyFrmTX4042 = New FrmTX4042
		MyFrmTX4042.MdiParent = Me
		MyFrmTX4042.Show()
	End Sub
	...
	Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
		...
		If e.Button Is TBarSetPrinter Then
			DoBtnSetPrinter()
		End If
	...
	End Sub
  Private Sub FrmTX404_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
	PrtReport()
End Sub
Private Sub DoBtnSetPrinter()
	MyFrmSetPrinter = New FrmSetPrinter
	MyFrmSetPrinter.ShowDialog()
End Sub

...
Private Sub FrmStatus_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
     MyFrmTXE52.SbpScreen.Text = "Status"
  End Sub
  ...
  Private Sub FrmStatus_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub FrmStatus_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  MyFrmTXE52.TBarPrint.Enabled = True
  MyFrmTXE52B.TxtStatus.Text = MySts
End Sub
End Class

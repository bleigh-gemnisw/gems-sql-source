...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmListBser))
...
#End Region
  ...
  Public Sub ShowGrid()
		If TxtPos.Text = "" Then
			ds = myTXBSER.GetAllData
		Else
			ds = myTXBSER.PosData(TxtPos.Text)
		End If
    C1DataGrdList.DataSource = ds.Tables(0)
    C1DataGrdList.Refresh()

  End Sub
  Private Sub FrmListBser_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTX401.SbpScreen.Text = "ListBser"
    MyUtils.CenterForm(Me.ParentForm, Me)
  End Sub
 Private Sub FrmListBser_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		myTXBSER = New TXBSER.mydata(MyDBConnect)
    LblCurrent.Text = "(Bank Serv = " & WrkCode & ")"
    FormatGrid()
  End Sub
...
Private Sub C1DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
    ...
    With MyFrmTX401RE
      .txtbksv.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
      .Ttp1.SetToolTip(.txtbksv, C1DataGrdList.Item(C1DataGrdList.Row, 1))
      .Show()
    End With
...
Private Sub FrmListBser_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  'Memory Cleanup
  myTXBSER = Nothing
  MyFrmListBser = Nothing
End Sub

...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("TXA02"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class TXA02
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As TXA02 = CType(MyBase.Clone,TXA02)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "TXA02"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/TXA02.xsd"
    ...
    Partial Public Class mytableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddmytableRow(ByVal COUNT As Long, ByVal PAMT As Decimal, ByVal IAMT As Decimal, ByVal LAMT As Decimal, ByVal PCAMT As Decimal, ByVal TOTAL As Decimal) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {COUNT, PAMT, IAMT, LAMT, PCAMT, TOTAL}

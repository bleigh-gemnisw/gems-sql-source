...
Partial Public Class TX3028
    ...
    Partial Public Class mytableDataTable
        ...
        Public Overloads Function AddmytableRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {SORTDATA, BACKTAX, LISTNO, YEAR, TYPE, TYPEDESC, ADDR1, ADDR2, ADDR3, ADDR4, ADDR5, PROPDESC, PROPDESC2, BALANCE, AMTDUE, INTEREST, FEES, LIENS, BOND, TOTAL, VOLPAGE, ACCTID, STATUS, LastPaid, BillNo, BillDate}
    ...
    Partial Public Class mytableRow
        ...
        Public Property BillNo() As Long
            Get
                Return CType(Me(Me.tablemytable.BillNoColumn),Long)
            End Get
            Set
                Me(Me.tablemytable.BillNoColumn) = value
            End Set
        End Property

...
Friend WithEvents TBarSep1 As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXA30))
    ...
    Me.Text = "Void Posted Batch or Change Batch Date"
...
Private Sub FrmTXA30_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  HelpProvider1.HelpNamespace = MyUtils.GetHelpFile(WrkProgName)
	...
	MyFrmTXA30B = New FrmTXA30B
	MyFrmTXA30B.MdiParent = Me
	MyFrmTXA30B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
	...
	End If
End Sub
Private Sub FrmTXA30_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
	 MyFrmTXA30.TBarPrint.Enabled = False
	 MyFrmTXA30B.RunReport()
	 MyFrmTXA30.TBarPrint.Enabled = True
End Sub

...
End Sub
   ...
   ReportPath = MyUtils.GetReportPath("PrtTXA30.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds)
    .SetParameterValue("myreportTitle", WrkMode & " Posted Batch")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyBatchNo", MyUtils.CnvSng(MyFrmTXA30B.TxtBatch.Text))
    .SetParameterValue("MyBatchTypeDesc", WrkBatchTypeDesc)
    .SetParameterValue("MyBatchDate", MyFrmTXA30B.DtPckBatch.Value)
    .SetParameterValue("MyNewDate", Format(MyFrmTXA30B.DTPckNew.Value, "M/d/yy"))
 ...
 End With
  ...
  Private Sub RunReportTot()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTXA30Tot.rpt", myTOWN._TOWNBR)
   With myreportTot
    .Load(ReportPath)
    .SetDataSource(Wrkds)
    .SetParameterValue("myreportTitle", WrkMode & " Posted Batch Totals")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyBatchNo", MyUtils.CnvSng(MyFrmTXA30B.TxtBatch.Text))
    .SetParameterValue("MyBatchTypeDesc", WrkBatchTypeDesc)

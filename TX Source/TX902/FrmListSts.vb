...
Private Sub C1DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
    ...
    With MyFrmTX902B
      ...
      Case 1
        .TxtStatus1.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
        .Ttp1.SetToolTip(.TxtStatus1, C1DataGrdList.Item(C1DataGrdList.Row, 1))
      Case 2
        .TxtStatus2.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
        .Ttp1.SetToolTip(.TxtStatus2, C1DataGrdList.Item(C1DataGrdList.Row, 1))
      Case 3
        .TxtStatus3.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
        .Ttp1.SetToolTip(.TxtStatus3, C1DataGrdList.Item(C1DataGrdList.Row, 1))
      Case 4
        .TxtStatus4.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
        .Ttp1.SetToolTip(.TxtStatus4, C1DataGrdList.Item(C1DataGrdList.Row, 1))
      End Select
      .Show()
    End With

...
Done:
  ...
  Private Sub GetDetail()
    ...
    SaveYear = 0
    SaveType = ""
    WrkFields = "icode,list#,year,type,name,dist,phase,taxt,pdat,ccno,cdate,suscd,susdt"
    WrkRecovery = False
    ClearTotals()
...
ReadNext:
    ...
    If Not myTXINVQ.IsEOF Then
      With myTXINVQ
        Counter = Counter + 1
        myTXHSTL1.SetRange(._LISTNo, ._YEAR, ._TYPE, 0, False)
        If SaveYear > 0 Then
...
DoTotals:
      ...
      If Good Then
        ...
        If WrkBegBal < 0 And WrkEndBal < WrkBegBal Then

...
Private Sub CheckInt()
  ...
  CalcInterest(DtPckPost.Value, MyUtils.CnvSng(TxtToList.Text), TxtToType.Text, MyUtils.CnvSng(TxtToYear.Text), _
    ...
    'MK 8/18/25 Begin
    LblTransferLien.Text = Format(OutLien, "fixed")
    'MK 8/18/25 End
    LblTransferTax.Text = Format(WrkPaid, "fixed")

    WrkTransferTot = WrkPaid + OutInterest + OutFee + OutLien
...
Private Sub TxtTransfer_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtTransfer.TextChanged
 ...
 End If
End Sub
  Private Sub ChkInterest_Click(sender As Object, e As EventArgs) Handles ChkInterest.Click
    CheckInt()
  End Sub
  Private Sub ChkFee_Click(sender As Object, e As EventArgs) Handles ChkFee.Click
    CheckInt()
  End Sub

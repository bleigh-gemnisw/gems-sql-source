...
Friend WithEvents TBarSingleTransfer As System.Windows.Forms.ToolBarButton
Friend WithEvents TBarMassTransfer As System.Windows.Forms.ToolBarButton
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
Me.components = New System.ComponentModel.Container
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXA12))
...
Me.TBarMassTransfer = New System.Windows.Forms.ToolBarButton
Me.TBarSingleTransfer = New System.Windows.Forms.ToolBarButton
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarMassTransfer, Me.TBarSingleTransfer})
...
'TBarMassTransfer
'
Me.TBarMassTransfer.ImageIndex = 1
Me.TBarMassTransfer.Name = "TBarMassTransfer"
Me.TBarMassTransfer.Text = "Process Mass Transfer"
'
'TBarSingleTransfer
'
Me.TBarSingleTransfer.ImageIndex = 2
Me.TBarSingleTransfer.Name = "TBarSingleTransfer"
Me.TBarSingleTransfer.Text = "Single Transfer Mode"
'
'ImageList1
'
...
Me.Text = "Transfer Credit Balances"
...
Private Sub FrmTXA12_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  TBarMassTransfer.Enabled = True
  set_security() '#set
  MyFrmTXA12B = New FrmTXA12B
  MyFrmTXA12B.MdiParent = Me
  MyFrmTXA12B.Show()
End Sub
...
' change is difficult as the save button will need to be disabled for it but enabled for add
  ...
  If s_edit = False Then
    TBarMassTransfer.Visible = False
  End If
End Sub
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  If e.Button Is TBarBack Then
    DoBtnBack()
  End If
  If e.Button Is TBarMassTransfer Then
    DoBtnMass()
  End If
  If e.Button Is TBarSingleTransfer Then
    DoBtnSingle()
  End If
End Sub
Private Sub FrmTXA12_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnMass()
   TBarMassTransfer.Enabled = False
   TBarSingleTransfer.Enabled = False
   Application.DoEvents()
   MyFrmTXA12B.RunReport()
   TBarMassTransfer.Enabled = True
   TBarSingleTransfer.Enabled = True
End Sub
Private Sub DoBtnSingle()
  TBarMassTransfer.Enabled = False
  TBarSingleTransfer.Enabled = False
  MyFrmTXA12C = New FrmTXA12C
  MyFrmTXA12C.MdiParent = Me
  MyFrmTXA12C.Show()
  MyFrmTXA12B.Hide()
End Sub

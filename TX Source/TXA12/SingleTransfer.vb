...
Done:
  ...
  Private Sub GetDetail()
    ...
    'MK 8/18/25 Begin
    dr.Item("ToTransferLien") = Math.Abs(MyUtils.CnvSng(MyFrmTXA12C.LblTransferLien.Text))
    'MK 8/18/25 End
  ...
  Private Sub WriteFiles()
    ...
    'MK 8/18/25 Begin
    Dim WrkTransferLien As Decimal
    'MK 8/18/25 End
    ...
    'MK 8/18/25 Begin
    WrkTransferLien = MyUtils.CnvSng(MyFrmTXA12C.LblTransferLien.Text)
    'MK 8/18/25 End
    WrkFirstTime = True
    ...
    If WrkFromTaxBal > 0 Then
      ...
      With myTXINVTo
        ...
        'MK 8/18/25 Begin
        ._LNPD = ._LNPD + WrkTransferLien
        If ._LNPD > 0 Then
          myTXPROF.GetOneRecordP(WrkToType, WrkToYear, String.Empty, 0)

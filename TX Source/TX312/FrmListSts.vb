...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(108, 2)
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(15, 51)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(342, 259)
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListSts_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myTXSTS = New TXSTS.mydata(MyDBConnect)
    LblCurrent.Text = "(Status Code = " & WrkCode & ")"
    FormatGrid()
  End Sub
  Private Sub FrmListSts_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTX312.SbpScreen.Text = "ListSts"
  End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX108))
...
Me.Text = "Bank Service Code Maintenance"
...
#End Region
Private Sub FrmTX108_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTX108B = New FrmTX108B
  MyFrmTX108B.MdiParent = Me
  MyFrmTX108B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
 ...
 End If
End Sub
Private Sub FrmTX108_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX108B" Then
    MyFrmTX108.Close()
  Else
    MyFrmTX108C.Close()
    MyFrmTX108B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX108C.DeleteData()
  MyFrmTX108C.Close()
End Sub
Private Sub DoBtnNew()
  MyFrmTX108C = New FrmTX108C
  MyFrmTX108C.MdiParent = MyFrmTX108B.ParentForm
  MyFrmTX108C.Wrkbksr = ""
  MyFrmTX108C.Show()
  MyFrmTX108B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX108B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX108C.SaveData()
End Sub

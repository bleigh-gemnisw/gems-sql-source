...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX702))
...
Private Sub FrmTX702_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTX702B = New FrmTX702B
  MyFrmTX702B.MdiParent = Me
  MyFrmTX702B.Show()
End Sub
...
Private Sub DoBtnBack()
  ...
  Case "TX702B"
    MyFrmTX702.Close()
  Case "ListCCReason"
    MyFrmListCCReason.Close()
  Case "ListTypes"
    MyFrmListTypes.Close()
  End Select
End Sub
Private Sub DoBtnPrint()
   MyFrmTX702.TBarPrint.Enabled = False
   MyFrmTX702B.RunReport()
   MyFrmTX702.TBarPrint.Enabled = True
End Sub

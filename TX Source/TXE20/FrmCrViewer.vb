Public Class FrmCrViewer
  ...
  Friend WithEvents TpBatch As System.Windows.Forms.TabPage
  Friend WithEvents crv2 As CrystalDecisions.Windows.Forms.CrystalReportViewer
  Friend WrkRefunds As Boolean
	Friend WrkBatchType As String
	Friend WrkPayType As String
	Dim WrkBatchDesc As String
	Dim WrkPayDesc As String
...
Me.TpBatch = New System.Windows.Forms.TabPage
Me.crv2 = New CrystalDecisions.Windows.Forms.CrystalReportViewer
Me.TabControl1.SuspendLayout()
Me.TpDate.SuspendLayout()
Me.TpTotals.SuspendLayout()
Me.TpBatch.SuspendLayout()
Me.SuspendLayout()
'
'TabControl1
'
...
Me.TabControl1.Controls.Add(Me.TpDate)
Me.TabControl1.Controls.Add(Me.TpBatch)
...
'TpDate
'
Me.TpDate.Controls.Add(Me.Crv1)
Me.TpDate.Location = New System.Drawing.Point(4, 22)
Me.TpDate.Name = "TpDate"
Me.TpDate.Size = New System.Drawing.Size(667, 367)
Me.TpDate.TabIndex = 0
Me.TpDate.Text = "By Date"
...
Me.Crv1.Size = New System.Drawing.Size(664, 364)
Me.Crv1.TabIndex = 1
Me.Crv1.ViewTimeSelectionFormula = ""
'
'TpTotals
'
Me.TpTotals.Controls.Add(Me.crv3)
Me.TpTotals.Location = New System.Drawing.Point(4, 22)
Me.TpTotals.Name = "TpTotals"
Me.TpTotals.Size = New System.Drawing.Size(667, 367)
...
Me.crv3.Size = New System.Drawing.Size(671, 369)
Me.crv3.TabIndex = 2
Me.crv3.ViewTimeSelectionFormula = ""
'
'TpBatch
'
Me.TpBatch.Controls.Add(Me.crv2)
Me.TpBatch.Location = New System.Drawing.Point(4, 22)
Me.TpBatch.Name = "TpBatch"
Me.TpBatch.Size = New System.Drawing.Size(667, 367)
Me.TpBatch.TabIndex = 2
Me.TpBatch.Text = "By Batch"
Me.TpBatch.UseVisualStyleBackColor = True
'
'crv2
'
...
Me.crv2.Size = New System.Drawing.Size(671, 369)
Me.crv2.TabIndex = 3
...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    End With
		...
		Case "P"
			WrkBatchDesc = "PC"
		Case "K"
			WrkBatchDesc = "Bank Service"
		Case "E"
			WrkBatchDesc = "Escrow"
		Case "L"
			WrkBatchDesc = "Liened"
		Case "B"
			WrkBatchDesc = "Lock Box"
		Case "R"
			WrkBatchDesc = "Regular"
		Case "S"
			WrkBatchDesc = "Suspense"
		Case "W"
			WrkBatchDesc = "Web Payment"
		Case Else
			WrkBatchDesc = "All"
		End Select
...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTXE20.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Batch Summary Report by Date")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyFromDate", MyFrmTXE20B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmTXE20B.DtPckTo.Value)
    .SetParameterValue("MyTypes", MyTypes)
    .SetParameterValue("MyRefunds", WrkRefunds)
		.SetParameterValue("MyBatchDesc", WrkBatchDesc)
		.SetParameterValue("MyPayDesc", WrkPayDesc)
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTXE20B.TxtFromGLYear.Text))
    .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTXE20B.TxtToGLYear.Text))
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTXE20B.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Batch Summary Report by Batch")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmTXE20B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmTXE20B.DtPckTo.Value)
  ...
  Private Sub RunReportTot()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTXE20Tot.rpt", myTOWN._TOWNBR)
   With myreport3
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Batch Summary Totals")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmTXE20B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmTXE20B.DtPckTo.Value)

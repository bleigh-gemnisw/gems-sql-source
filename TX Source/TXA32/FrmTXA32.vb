...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTXA32))
    ...
    Me.Text = "Copy Comments (Year to Year)"
...
#End Region
  ...
  Private Sub FrmTXA32_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmTXA32B = New FrmTXA32B
    MyFrmTXA32B.MdiParent = Me
    MyFrmTXA32B.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
  Private Sub FrmTXA32_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    ...
    End Select
  End Sub
  Private Sub DoBtnProc()
    TBarProcess.Enabled = False
    Application.DoEvents()
    MyFrmTXA32B.RunReport()
    TBarProcess.Enabled = True
  End Sub

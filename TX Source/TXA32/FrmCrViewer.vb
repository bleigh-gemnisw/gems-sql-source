...
#End Region
  ...
  Private Sub RunReport()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTXA32.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", "Copy Comments")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyType", MyFrmTXA32B.TxtType.Text)
      .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTXA32B.TxtFromGLYear.Text))
      .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmTXA32B.TxtToGLYear.Text))
    End With
    With crv1
      .DisplayToolbar = True
  ...
  Private Sub RunReport2()
    ...
    With myreport2
      ...
      .SetParameterValue("myreportTitle", "Copy Comments Errors")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyType", MyFrmTXA32B.TxtType.Text)
      .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmTXA32B.TxtFromGLYear.Text))

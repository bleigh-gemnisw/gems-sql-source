...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		With MyFrmTXE47B
			WrkFrom = String.Empty
			WrkTo = String.Empty
			If .DtPckFrom.Checked Then
				WrkFrom = Format(.DtPckFrom.Value, "M/d/yyyy")
			End If
			If .DtPckTo.Checked Then
				WrkTo = Format(.DtPckTo.Value, "M/d/yyyy")
			End If
		End With
...
End Sub
   ...
   ReportPath = MyUtils.GetReportPath("PrtTXE47.rpt", myTOWN._TOWNBR)
	 With myreport
		.Load(ReportPath)
      ...
      .PrintOptions.DissociatePageSizeAndPrinterPaperSize = False
		...
		End If
		.SetDataSource(wrkds)
		.SetParameterValue("myreportTitle", "Billed Prorates")
		.SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyGLYear", MyUtils.CnvSng(MyFrmTXE47B.TxtGLYear.Text))
		.SetParameterValue("MyFrom", WrkFrom)
		.SetParameterValue("MyTo", WrkTo)
	 End With
	 With Crv1
     .DisplayToolbar = True

...
Private Sub CrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    If Not MyFrmTX210B.RbAll.Checked Then
      GetMillRate(Val(MyFrmTX210B.TxtGLYear.Text), MyFrmTX210B.TxtType.Text, 0)
    End If
    RunReport1()
    If Not MyFrmTX210B.RbAll.Checked Then
      RunReport2()
...
Public Sub GetMillRate(ByVal WrkGLYear As Integer, ByVal WrkType As String, ByVal WrkDist As Integer)
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTX210.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    ...
    .SetParameterValue("myreportTitle", "Posted Ratebook")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmTX210B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmTX210B.DtPckTo.Value)
    If MyFrmTX210B.ChkHeaders.Checked Then
      .SetParameterValue("MyPrtHeader", True)
    Else
      .SetParameterValue("MyPrtHeader", False)
    End If
    .SetParameterValue("MyMillRate", WrkMillRate)
    .SetParameterValue("MyDist", MyUtils.CnvSng(MyFrmTX210B.TxtDist.Text))
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTX210Tot.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
    ...
    .SetParameterValue("myreportTitle", "Posted Ratebook Totals")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmTX210B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmTX210B.DtPckTo.Value)
    .SetParameterValue("MyYear", MyFrmTX210B.TxtGLYear.Text)
    .SetParameterValue("MyTypeDesc", GetTXTypeDesc(MyFrmTX210B.TxtType.Text))
    .SetParameterValue("MyMillRate", WrkMillRate)
    .SetParameterValue("MyDist", MyUtils.CnvSng(MyFrmTX210B.TxtDist.Text))
   End With
   With Crv2

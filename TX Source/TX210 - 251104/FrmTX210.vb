...
Friend WithEvents TBarMargins As System.Windows.Forms.ToolBarButton
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
Me.components = New System.ComponentModel.Container
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX210))
...
Me.TBarMargins = New System.Windows.Forms.ToolBarButton
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarPrint, Me.TBarSep2, Me.TBarMargins})
...
Me.TsOrientPortrait.Size = New System.Drawing.Size(152, 22)
Me.TsOrientPortrait.Text = "Portrait"
'
'TsOrientLandscape
'
Me.TsOrientLandscape.Name = "TsOrientLandscape"
Me.TsOrientLandscape.Size = New System.Drawing.Size(152, 22)
...
'TBarMargins
'
Me.TBarMargins.ImageIndex = 1
Me.TBarMargins.Name = "TBarMargins"
Me.TBarMargins.Text = "Set Margins"
'
'FrmTX210
'
...
Me.Text = "Print Posted Ratebooks"
...
Private Sub FrmTX210_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTX210B = New FrmTX210B
  MyFrmTX210B.MdiParent = Me
  MyFrmTX210B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  If e.Button Is TBarPrint Then
    DoBtnPrint()
  End If
  If e.Button Is TBarMargins Then
    DoBtnMargins()
  End If
End Sub
Private Sub FrmTX210_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   ...
   MyFrmTX210B.RunReport()
   TBarPrint.Enabled = True
End Sub
Private Sub DoBtnMargins()
  MyFrmTX210B.Enabled = False
  MyFrmMargins = New FrmMargins
  MyFrmMargins.ShowDialog()
  MyFrmTX210B.Enabled = True
End Sub

...
'MK 7/24/25 Use TXINV RecordNotFound instead of IsEOF
'MK 8/ 1/25 Add logic for CC Audit
'MK 8/21/25 CC Audit: interest based on orig tax until C/C grace date
'MK 9/ 3/25 Check CCINT30 for a due date
'MK 9/ 8/25 Removed a few debug message lines that were not useful
'MK 9/11/15 Add Out_Adj1-4 properties
'MK 9/29/25 Add deferred expired (ICODE="E")
'Ken and mark 10/7/25 add code to fix kensington 219 overlay of data on delinquent
'MK 10/9/25 Kensington: don't charge min interest if already collected interest 
'MK  8/24/26 Add Out_IntCollect, Out_IntPaid
Imports System

...
#End Region
	...
	Private Sub FrmListCCReason_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
		MyFrmTXE18.SbpScreen.Text = "ListPenCd"
	End Sub
	...
	Private Sub FrmListCCReason_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		...
		MyFrmTXE18.TBarPrint.Enabled = False
		FormatGrid()
	End Sub
...
Private Sub C1DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
		...
		With MyFrmTXE18B
			If WrkField = "From" Then
				.TxtFromCode.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
				.TTp1.SetToolTip(.TxtFromCode, C1DataGrdList.Item(C1DataGrdList.Row, 1))
			Else
				.TxtToCode.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
				.TTp1.SetToolTip(.TxtToCode, C1DataGrdList.Item(C1DataGrdList.Row, 1))
			End If
		End With
...
Private Sub FrmListPenCd_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
	MyFrmTXE18.TBarPrint.Enabled = True
	MyFrmTXE18B.Show()
End Sub
End Class

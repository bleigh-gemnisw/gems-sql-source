...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTX808.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    .SetDataSource(wrkds)
    If Trim(MyFrmTX808B.TxtBankCd.Text) > "" Then
      .SetParameterValue("myreportTitle", "Bank List: " + MyFrmTX808B.TxtBankCd.Text)
    Else
      .SetParameterValue("myreportTitle", "Bank Service List")
    End If
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyPayment", "Pymt: " + Mypayment)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyPaid", MyFrmTX808B.ChkPaid.Checked)

...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTX313.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(Wrkds)
    .SetParameterValue("myreportTitle", "Multiple Status Code Update")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyPost", WrkPost)
    .SetParameterValue("MyCode", MyFrmTX313B.TxtStatusCD.Text)
   End With
   With Crv1
     .DisplayToolbar = True

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX313))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarRemove, Me.TBarSep1, Me.TBarPrint, Me.TBarSep2, Me.TBarPost, Me.TBarClear})
...
'TBarPost
'
Me.TBarPost.ImageIndex = 3
Me.TBarPost.Name = "TBarPost"
Me.TBarPost.Text = "Post Updates"
'
'ImageList1
'
...
Me.ImageList1.Images.SetKeyName(3, "export_png_194.png")
Me.ImageList1.Images.SetKeyName(4, "clear_24.png")
'
'SbMain
'
...
Me.Text = "Multiple Status Code Update"
...
#End Region
  ...
  Private Sub FrmTX313_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmTX313B = New FrmTX313B
    MyFrmTX313B.MdiParent = Me
    MyFrmTX313B.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
Private Sub FrmTX313_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnRemove()
  MyFrmTX313B.RemoveData()
End Sub
Private Sub DoBtnPrint()
  PrtReport(False)
End Sub
Private Sub DoBtnClear()
  Dim Answer As Integer

  Answer = MsgBox("Clear screen data?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "Confirm Clear")
  If Answer = MsgBoxResult.No Then Exit Sub

  myds.Clear()
End Sub
Private Sub DoBtnPost()
  Dim WrkDesc As String

  If myds.Tables(0).Rows.Count = 0 Then
    MsgBox("Nothing to do!", MsgBoxStyle.Exclamation, "No records to post")
    Exit Sub
  End If

  WrkDesc = GetTXStsDesc(MyFrmTX313B.TxtStatusCD.Text)
  If Mid(WrkDesc, 1, 3) = "***" Then
    MsgBox("Invalid or missing Status Code", MsgBoxStyle.Exclamation, "Posting aborted")
    Exit Sub
  End If

  TBarPost.Enabled = False
  MyFrmTX313B.PostUpdates()
  PrtReport(True)

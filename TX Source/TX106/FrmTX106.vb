...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX106))
...
Me.Text = "Suspense Reason Code Maintenance"
...
#End Region
Private Sub FrmTX106_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTX106B = New FrmTX106B
  MyFrmTX106B.MdiParent = Me
  MyFrmTX106B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTX106_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TX106B" Then
    MyFrmTX106.Close()
  Else
    MyFrmTX106C.Close()
    MyFrmTX106B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTX106C.DeleteData()
  MyFrmTX106C.Close()
End Sub
Private Sub DoBtnNew()
  MyFrmTX106C = New FrmTX106C
  MyFrmTX106C.MdiParent = MyFrmTX106B.ParentForm
  MyFrmTX106C.Wrksresn = ""
  MyFrmTX106C.Show()
  MyFrmTX106B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTX106B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTX106C.SaveData()
End Sub

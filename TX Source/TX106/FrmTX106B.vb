...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(384, 311)
...
#End Region
Private Sub FrmTX106B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myTXSRESN = New TXSRESN.mydata(MyDBConnect)
  Wrksresn = ""
  Call FormatGrid()
End Sub
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
  Wrksresn = TxtPos.Text
  FormatGrid()
  TxtPos.Text = ""
End Sub
...
Public Sub ShowGrid()
  ...
  DataGrdView.Refresh()
End Sub
Private Sub FrmTX106B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTX106.SbpScreen.Text = "TX106B"
  MyFrmTX106.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTX106C.MdiParent = Me.ParentForm
  MyFrmTX106C.Wrksresn = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTX106C.Wrksrdesc = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
  MyFrmTX106C.Show()
  Me.Hide()
End Sub
End Class

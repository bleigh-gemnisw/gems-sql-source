...
Module PrintReport
  ...
  Public Sub PrtReport()
    ...
    MyDblDays = myPKCNTL._DAYDBL
    GetDetail()

Done:
    MyCrViewer = New FrmCrViewer
    MyCrViewer.wrkds = ds
    MyCrViewer.WrkPayTo = Trim(myPKCNTL._PAYTO)
    MyCrViewer.WrkTitle = Trim(myPKCNTL._TITLE)
    MyCrViewer.WrkSigned = Trim(myPKCNTL._SIGNED)
    MyCrViewer.Show()
  ...
  Private Sub BuildDS()
    ...
    With myTable
      ...
      .Columns.Add("Viamt", Type.GetType("System.Decimal"))
  ...
  Private Sub GetDetail()
    ...
    WrkQry = WrkQry & WrkAnd & "STATUS<>'L'" & WrkAnd & "STATUS<>'P'" & WrkAnd & "STATUS<>'V'"
    If WrkOffcno <> "" Then
    ...
    End If
    WrkSort = ""
    If MyFrmPK230B.RbSortDate.Checked Then
      WrkSort = "VDATE, VTIME"
    End If
    If MyFrmPK230B.RbSortOffcno.Checked Then
      WrkSort = "OFFCNO, VDATE, VTIME"
    End If
    If MyFrmPK230B.RbSortRegNo.Checked Then
      WrkSort = "REGNO, REGST, VDATE, VTIME"
    End If
    If MyFrmPK230B.RbSortStreet.Checked Then
      WrkSort = "STREET, VDATE, VTIME"
    End If
    If MyFrmPK230B.RbSortTickNo.Checked Then
      WrkSort = "TICKNO"
    End If
    If MyFrmPK230B.RbSortViolNo.Checked Then

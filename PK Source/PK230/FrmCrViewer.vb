Public Class FrmCrViewer
  ...
  Friend WrkPayTo As String
  Friend WrkTitle As String
  Friend WrkSigned As String
...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtPK230.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyPayTo", WrkPayTo)
    .SetParameterValue("MyTitle", WrkTitle)
    .SetParameterValue("MySigned", WrkSigned)
   End With
   With Crv1
     .DisplayToolbar = True

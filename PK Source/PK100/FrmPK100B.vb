...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPK100B))
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(44, 93)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(479, 335)
...
#End Region
  ...
  Private Sub FrmPK100B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  Public Sub ShowGrid(ByVal Find As Boolean)
    ...
    If RbName.Checked Then
      ds = myPKTICKL1.GetViewbyName(WrkPos, 250)
    End If
    If RbRegno.Checked Then
      ds = myPKTICKL1.GetViewbyRegNo(WrkPos, 250)
    End If
  ...
  Private Sub DataGrdView_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles DataGrdView.CellFormatting
    ...
    End If
  End Sub
  Private Sub FrmPK100B_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    Application.Exit()
  End Sub
  ...
  Private Sub RbName_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RbName.Click
    FormatGrid(True)
  End Sub
  Private Sub FrmPK100B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmPK100.SbpScreen.Text = "PK100B"
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    MyFrmPK100C = New FrmPK100C

    MyFrmPK100C.AddMode = False
    MyFrmPK100C.WrkTickNo = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    MyFrmPK100C.MdiParent = Me.ParentForm
    MyFrmPK100C.Show()
    Me.Hide()
  End Sub

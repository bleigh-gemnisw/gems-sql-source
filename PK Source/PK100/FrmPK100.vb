...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPK100))
    ...
    Me.Text = "Maintain ParkingTickets"
...
Private Sub FrmPK100_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "PK100"
  TBarSave.Enabled = False
  TBarDelete.Enabled = False
  set_security() '#set
  MyFrmPK100B = New FrmPK100B
  MyFrmPK100B.MdiParent = Me
  MyFrmPK100B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmPK100_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  ...
  MyFrmPK100C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmPK100C.MdiParent = MyFrmPK100B.ParentForm
  MyFrmPK100C.WrkTickNo = 0
  MyFrmPK100C.AddMode = True
  MyFrmPK100C.Show()
  MyFrmPK100B.Hide()
End Sub

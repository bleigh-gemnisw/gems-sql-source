...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPK111))
...
#End Region
  ...
  Private Sub FrmPK111_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmPK111B = New FrmPK111B
    MyFrmPK111B.MdiParent = Me
    MyFrmPK111B.Show()
  End Sub
  ...
  Private Sub FrmPK111_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    If Me.SbpScreen.Text = "PK111B" Then
      MyFrmPK111.Close()
    Else
      MyFrmPK111C.Close()
      MyFrmPK111B.Show()
  ...
  Private Sub DoBtnDelete()
    MyFrmPK111C.DeleteData()
    MyFrmPK111C.Close()
    MyFrmPK111B.Show()
  End Sub
  Private Sub DoBtnNew()
    MyFrmPK111C = New FrmPK111C
    MyFrmPK111C.MdiParent = MyFrmPK111B.ParentForm
    MyFrmPK111C.WrkCode = ""
    MyFrmPK111C.WrkAddMode = True
    MyFrmPK111C.Show()
    MyFrmPK111B.Hide()
  End Sub
  Private Sub DoBtnPrint()
    ...
    MyCRViewer.Wrkds = MyFrmPK111B.ds
    MyCRViewer.Show()
  End Sub
  Private Sub DoBtnSave()
    MyFrmPK111C.SaveData()
  End Sub

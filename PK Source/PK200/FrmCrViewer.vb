...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtPK200.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    .SetParameterValue("MyFromDate", MyFrmPK200B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmPK200B.DtPckTo.Value)
   End With
   With Crv1
     .DisplayToolbar = True

...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPK110))
...
#End Region
  ...
  Private Sub FrmPK101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmPK101B = New FrmPK110B
    MyFrmPK101B.MdiParent = Me
    MyFrmPK101B.Show()
  End Sub
  ...
  Private Sub FrmPK101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    If Me.SbpScreen.Text = "PK101B" Then
      MyFrmPK101.Close()
    Else
      MyFrmPK101C.Close()
      MyFrmPK101B.Show()
  ...
  Private Sub DoBtnDelete()
    MyFrmPK101C.DeleteData()
    MyFrmPK101C.Close()
    MyFrmPK101B.Show()
  End Sub
  Private Sub DoBtnNew()
    MyFrmPK101C = New FrmPK110C
    MyFrmPK101C.MdiParent = MyFrmPK101B.ParentForm
    MyFrmPK101C.WrkCode = 0
    MyFrmPK101C.WrkAddMode = True
    MyFrmPK101C.Show()
    MyFrmPK101B.Hide()
  End Sub
  Private Sub DoBtnPrint()
    ...
    MyCRViewer.Wrkds = MyFrmPK101B.ds
    MyCRViewer.Show()
  End Sub
  Private Sub DoBtnSave()
    MyFrmPK101C.SaveData()
  End Sub

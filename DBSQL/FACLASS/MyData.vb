...
Public Class MyData
  ...
  Const cFileName As String = "FACLASS"
#Region "Constructors"
...
Public Sub GetOneRecordP(ByVal Code As String)
  ...
  StrSQL = "Select * from " & cFileName & " where CLCODE='" & Code & "'"
  Try
    Conn = MyDBConn.Open
...
Public Property _CLCODE As String
    Get
        Return mCLCODE
    End Get
    Set(ByVal value As String)
    ...
    End Set
End Property
Dim mCLDESC As String
Public Property _CLDESC As String
    Get
        Return mCLDESC
    End Get
    Set(ByVal value As String)

...
#Region "Methods: File Access Routines"
  Public Function GetViewbyScust(ByVal wrkcust As Integer, wrkchdate As Integer, ByVal NumRecs As Integer) As DataSet
    ...
    & " where scust = " & wrkcust & " AND chdate <= " & wrkchdate & " order by chdate desc"

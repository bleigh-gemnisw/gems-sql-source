...
#Region "Methods: File Access Routines"
  Public Function GetViewbyList(ByVal WrkYear As Integer, ByVal WrkList As Integer, ByVal WrkType As String,
   ByVal WrkDate As Integer, ByVal NumRecs As Integer) As DataSet
    ...
    & " order by year,list#,type,pdate desc,chdate desc, chtime desc, recid"
    Try
      Conn = MyDBConn.Open
  ...
  Public Function ReplaceDS(ByVal ds As DataSet) As DataSet
    ...
    With myTable
      ...
      .Columns.Add("wkpdate", Type.GetType("System.Int32"))
      .Columns.Add("pdate", Type.GetType("System.Int32"))
      .Columns.Add("wkcdate", Type.GetType("System.Int32"))
    ...
    For I = 0 To ds.Tables(0).Rows.Count - 1
      With ds.Tables(0).Rows(I)
        ...
        dr.Item("wkpdate") = GetDBDateInt(.Item("pdate"))
        dr.Item("pdate") = .Item("pdate")
        dr.Item("wkcdate") = GetDBDateInt(.Item("cdate"))
  ...
  Public Function GetDBDateInt(ByVal DateIn As Integer) As Integer
    ...
    Return WrkDate
  End Function
  Public Sub SetRange(ByVal WrkListNo As Integer, ByVal WrkYear As Integer, ByVal WrkType As String, ByVal WrkDate As Integer)
    Dim objCommand As SqlCommand

    RecordNotFound = False
    IsEOF = False
    StrSQL = "Select * from " & cFileName & " where list#=" & WrkListNo & " and year=" & WrkYear _
     & " and type='" & WrkType & "' and pdate<=" & WrkDate & " order by pdate desc, chdate desc, chtime desc"

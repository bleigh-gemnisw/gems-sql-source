...
#Region "Methods: File Access Routines"
  ...
  Public Sub GetOneRecordP(ByVal Wrkplistno As Integer, ByVal Wrktxyear As Integer)
    ...
    End Try
  End Sub
  'Public Function PosData(ByVal Wrkplistno As Integer, ByVal Wrktxyear As Integer) As DataSet
  '  Dim Conn As SqlConnection
  '  Dim objCommand As SqlCommand
  '  Dim ds As DataSet = New DataSet

  '  StrSQL = "Select * from " & cFileName & " where list# >= " & Wrkplistno & " And txyear = " & Wrktxyear & " Order by list#"
  '  Conn = MyDBConn.Open
  '  objCommand = New SqlCommand(StrSQL, Conn)
  ...
  '  ds = Nothing
  'End Sub
  'Public Sub DeleteQry()   '' LL not yet implemented 4/30/26
  '  Dim Conn As SqlConnection
  '  Dim objCommand As SqlCommand
  ...
  '  Try
  '    ' 2. Open connection and prepare command
  '    Conn = MyDBConn.Open
  '    objCommand = New SqlCommand(StrSQL, Conn)

  '    ' 3. Execute the command
  '    ' ExecuteNonQuery returns the number of rows deleted
  ...
  Public Sub ArchiveQry(ByVal WrkYear As Integer)
    ...
    Dim rowsAffected As Integer
    Dim StrSQL As String
    Dim targetColumns As String = "LIST#, TXYEAR, CAPGRS, CAPA1, CAPA2, CAPA3, CAPA4, CAPA5, CAPA6, CAPA7, CAPC1, CAPC2, CAPC3, CAPC4, CAPC5, CAPC6, CAPC7, ORIGRS, FULGRS, ADJGRS, ADJA1, ADJA2, ADJA3, ADJA4, ADJA5, ADJA6, ADJA7, ADJC1, ADJC2, ADJC3, ADJC4, ADJC5, ADJC6, ADJC7"
...
#Region "Properties: Get/Put"
  ...
  '  With ds.Tables(0).Rows(0)
  '    .Item("LIST#") = _LISTNo
  '    .Item("TXYEAR") = _TXYEAR   'LL new addition cloning from TXPHIN
  '    .Item("CAPGRS") = _CAPGRS
  '    .Item("CAPA1") = _CAPA1
  '    .Item("CAPA2") = _CAPA2
  '    .Item("CAPA3") = _CAPA3

...
#Region "Methods: File Access Routines"
  Public Function GetAllSS2(ByVal WrkSSNo As Integer, ByVal NumRecs As Integer, ByVal SetBlocking As Boolean) As DataSet
    ...
    StrSQL = "Select " & WrkTop & "ss2,name,list#,type,year,dob,mvflag,ccno,taxt,ccetax,payrec,newpay,bald,icode from " & cFileName _
    & " where ss2 =" & WrkSSNo & " and ss2 > 0 order by ss2"
    Try
      Conn = MyDBConn.Open
  ...
  Public Function ReplaceDS(ByVal ds As DataSet) As DataSet
    ...
    Return ds2
  End Function
  Public Function GetViewbySS2(ByVal WrkSSNo As Integer, WrkQrySelect As String, ByVal NumRecs As Integer, ByVal SetBlocking As Boolean) As DataSet
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    Dim ds2 As DataSet = New DataSet
    ...
    StrSQL = "Select " & WrkTop & "ss2,name,list#,type,year,ccno,taxt,ccetax,payrec,newpay,bald,icode from " & cFileName _
    & " where ss2 >=" & WrkSSNo & " and ss2 > 0 " & WrkWhere & " order by ss2"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
      'Fill the dataset with the data

...
Public Class MyData
  ...
  Const cFileName As String = "RQEBCH"
#Region "Constructors"
...
Public Function AutoGenKey(ByVal WrkLlocn As String, ByVal WrkBchno As Integer) As Integer
  ...
  StrSQL = "Select * from " & cFileName & " where llcon='" & WrkLlocn & "'" & _
   " and bchno=" & WrkBchno & " order by rqnbr desc"
  Try
    Conn = MyDBConn.Open
  ...
  Return NextKey
End Function
Public Sub GetOneRecordP(ByVal WrkLlocn As String, ByVal WrkBchno As Integer, ByVal WrkRqnbr As Integer)
  Dim Conn As SqlConnection
  Dim objCommand As SqlCommand
  Dim ds As DataSet = New DataSet
...
Public Property _FSCYR As Integer
    ...
    End Set
End Property
Dim mLNDSP As Decimal
Public Property _LNDSP As Decimal
    Get
        Return mLNDSP
    End Get
    Set(ByVal value As Decimal)
    ...
    End Set
End Property
Dim mLNDSD As Decimal
Public Property _LNDSD As Decimal
    Get
        Return mLNDSD
    End Get
    Set(ByVal value As Decimal)
...
Public Property _PRJ As Long
    ...
    End Set
End Property
Dim mRQPST As Integer
Public Property _RQPST As Integer
    Get
        Return mRQPST
    End Get
    Set(ByVal value As Integer)

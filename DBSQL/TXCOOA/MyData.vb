...
#Region "Methods: File Access Routines"
  ...
  End Sub
  Public Sub GetOneRecordP(ByVal Wrklistno As Integer, ByVal Wrkdevlt As String, ByVal WrkTxyear As Integer)
  ...
  Public Function GetIsPosted(ByVal WrkYear As Integer) As Integer
    ...
    End Try
  End Function
  Public Function PosData(ByVal Wrklistno As Integer, ByVal Wrkdevlt As String, ByVal WrkTxyear As Integer) As DataSet
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet

    StrSQL = "Select * from " & cFileName & " where list# = " & Wrklistno & " And devlt >= '" & Wrkdevlt &
      "' and txyear = " & WrkTxyear & " Or list# > " & Wrklistno & " and txyear = " & WrkTxyear & " Order by list#, devlt"
    Conn = MyDBConn.Open
    objCommand = New SqlCommand(StrSQL, Conn)

...
End Sub
  ...
  Public Function GetByList(ByVal Wrklistno As Integer, wrkyear As Integer) As DataSet
    ...
    End Try
  End Function
  Public Function GetFormType(ByVal Wrklistno As Integer, wrkyear As Integer) As String
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    ...
    StrSQL = "Select  * FROM " & cFileName _
    & " where list# = " & Wrklistno & " AND YEAR = " & wrkyear & " and code in (10,13,15,21,22) and value>0"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
      'Fill the dataset with the data

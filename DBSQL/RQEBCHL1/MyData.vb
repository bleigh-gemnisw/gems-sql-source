...
Public Function GetViewbyBatch(ByVal WrkLlocn As String, ByVal WrkBchno As Integer, _
 ByVal NumRecs As Integer) As DataSet
  ...
  If NumRecs > 0 Then
    WrkTop = "TOP " & NumRecs & " "
  End If
  StrSQL = "Select " & WrkTop & "rqnbr, vennm,amtnt from " & cFileName & _
    " where llocn='" & WrkLlocn & "' and bchno=" & WrkBchno & _
    " order by rqnbr"
  Try
    Conn = MyDBConn.Open

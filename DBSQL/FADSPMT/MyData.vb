...
Public Class MyData
  ...
  Const cFileName As String = "FADSPMT"
#Region "Constructors"
...
Public Sub GetOneRecordP(ByVal Code As String)
  ...
  StrSQL = "Select * from " & cFileName & " where DSCODE='" & Code & "'"
  Try
    Conn = MyDBConn.Open
...
Public Property ErrMsg() As String
    ...
    End Set
End Property
Dim mDSCODE As String
Public Property _DSCODE As String
    Get
        Return mDSCODE
    End Get
    Set(ByVal value As String)
    ...
    End Set
End Property
Dim mDSDESC As String
Public Property _DSDESC As String
    Get
        Return mDSDESC
    End Get
    Set(ByVal value As String)

...
#Region "Methods: File Access Routines"
  Public Function GetViewbyName(ByVal WrkGLYear As Integer, ByVal WrkName As String, ByVal WrkList As Integer,
    ...
    End Try
  End Function
  Public Function GetViewbyNamescan(ByVal Wrkyear As Integer, wrkname As String, NumRecs As Integer) As DataSet
    ...
    End If
    StrSQL = "Select " & WrkTop & "list#,name,loc#,loc,sname from " & cFileName _
    & " where txyear = " & Wrkyear & " AND name LIKE '%" & wrkname & "%' order by name,List#"

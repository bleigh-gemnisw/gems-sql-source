...
Public Class MyData
  ...
  Const cFileName As String = "FAAQUMT"
#Region "Constructors"
...
Public Sub GetOneRecordP(ByVal Code As String)
  ...
  StrSQL = "Select * from " & cFileName & " where aqcode='" & Code & "'"
  Try
    Conn = MyDBConn.Open
...
Public Property ErrMsg() As String
    ...
    End Set
End Property
Dim mAQCODE As String
Public Property _AQCODE As String
    Get
        Return mAQCODE
    End Get
    Set(ByVal value As String)
    ...
    End Set
End Property
Dim mAQDESC As String
Public Property _AQDESC As String
    Get
        Return mAQDESC
    End Get
    Set(ByVal value As String)

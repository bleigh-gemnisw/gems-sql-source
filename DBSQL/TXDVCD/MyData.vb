...
Public Class MyData
  ...
  Const cFileName As String = "TXDVCD"
#Region "Constructors"
...
End Sub
  Public Sub GetOneRecordP(ByVal Wrkyear As integer, ByVal Wrkcode As integer)
 ...
 ClearFields 
  ...
  End Try
End Sub
  Public Function PosData(ByVal Wrkyear As Integer, ByVal Wrkcode As Integer) As DataSet
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet

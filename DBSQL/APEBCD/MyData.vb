...
Public Function AutoGenKey(ByVal WrkBchno As Integer, ByVal WrkSeqno As Integer) As Integer
  ...
  StrSQL = "Select * from " & cFileName & " where bchno=" & WrkBchno & " and seqno=" & WrkSeqno & _
   " order by recno desc"
  Try
    Conn = MyDBConn.Open
  ...
  Return NextKey
End Function
Public Sub GetOneRecordP(ByVal WrkBchno As Integer, ByVal WrkSeqno As Integer, _
...
End Sub
  ...
  objCommand = Nothing
End Sub
  Public Sub DeleteSeqno(ByVal WrkBchno As Integer, ByVal WrkSeqno As Integer)
  Dim Conn As SqlConnection
  Dim objCommand As SqlCommand
  Dim Result As Integer
  ...
  RecordNotFound = False
  IsEOF = False
  StrSQL = "Delete from " & cFileName & " where bchno=" & WrkBchno & " and seqno=" & WrkSeqno
  Conn = MyDBConn.Open
  objCommand = New SqlCommand(StrSQL, Conn)
  Result = objCommand.ExecuteNonQuery()
  objCommand = Nothing

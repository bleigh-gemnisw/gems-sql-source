...
Public Class MyData
  ...
  Const cFileName As String = "FAUSER1"
#Region "Constructors"
...
Public Sub GetOneRecordP(ByVal Code As String)
  ...
  StrSQL = "Select * from " & cFileName & " where U1CODE='" & Code & "'"
  Try
    Conn = MyDBConn.Open
...
Public Property ErrMsg() As String
    ...
    End Set
End Property
Dim mU1CODE As String
Public Property _U1CODE As String
    Get
        Return mU1CODE
    End Get
    Set(ByVal value As String)
    ...
    End Set
End Property
Dim mU1DESC As String
Public Property _U1DESC As String
    Get
        Return mU1DESC
    End Get
    Set(ByVal value As String)

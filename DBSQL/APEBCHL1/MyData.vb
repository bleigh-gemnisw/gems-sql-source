...
Public Function GetViewbyInvno(ByVal WrkBchno As Integer, ByVal WrkVndnr As String, _
 ByVal WrkInvno As String, ByVal NumRecs As Integer) As DataSet
  ...
  If NumRecs > 0 Then
    WrkTop = "TOP " & NumRecs & " "
  End If
  StrSQL = "Select " & WrkTop & "seqno, invno, vndnr, vennm,amtgr,amtnt,ponbr from " & cFileName _
    & " where bchno=" & WrkBchno & " and vndnr='" & WrkVndnr _
    & "' and invno>='" & WrkInvno & "' or" _
    & " bchno=" & WrkBchno & " and vndnr>'" & WrkVndnr _
    & "' order by vndnr, invno"
  Try
    Conn = MyDBConn.Open
  ...
  End Try
End Function
Public Function GetInvno(ByVal WrkVndnr As String, _
 ByVal WrkInvno As String) As DataSet
  Dim Conn As SqlConnection
  Dim objCommand As SqlCommand
  Dim ds As DataSet = New DataSet
  Dim WrkTop As String

...
Public Class MyData
  ...
  Const cFileName As String = "FAUSER3"
#Region "Constructors"
...
Public Sub GetOneRecordP(ByVal Code As String)
  ...
  StrSQL = "Select * from " & cFileName & " where U3CODE='" & Code & "'"
  Try
    Conn = MyDBConn.Open
...
Public Property ErrMsg() As String
    ...
    End Set
End Property
Dim mU3CODE As String
Public Property _U3CODE As String
    Get
        Return mU3CODE
    End Get
    Set(ByVal value As String)
    ...
    End Set
End Property
Dim mU3DESC As String
Public Property _U3DESC As String
    Get
        Return mU3DESC
    End Get
    Set(ByVal value As String)

...
Public Class MyData
  ...
  Const cFileName As String = "FABLDG"
#Region "Constructors"
...
Public Sub GetOneRecordP(ByVal Code As String)
  ...
  StrSQL = "Select * from " & cFileName & " where blcode='" & Code & "'"
  Try
    Conn = MyDBConn.Open
...
Public Property ErrMsg() As String
    ...
    End Set
End Property
Dim mBLCODE As String
Public Property _BLCODE As String
    Get
        Return mBLCODE
    End Get
    Set(ByVal value As String)
    ...
    End Set
End Property
Dim mBLDESC As String
Public Property _BLDESC As String
    Get
        Return mBLDESC
    End Get
    Set(ByVal value As String)

...
#Region "Methods: File Access Routines"
  Public Function GetViewbyName(ByVal Wrkname As String, NumRecs As Integer, ByVal wrksetblocking As Boolean) As DataSet
    ...
    If NumRecs > 0 Then
      WrkTop = "TOP " & NumRecs & " "
    End If
    StrSQL = "Select " & WrkTop & "list#,name,regno,make,year,model,value from " & cFileName _
    & " where  name >= '" & Wrkname & "' order by name,add1,list#"
    ...
    End Try
  End Function
  Public Function GetViewbyNameScan(ByVal Wrkname As String, NumRecs As Integer, ByVal wrksetblocking As Boolean) As DataSet
    ...
    End If
    StrSQL = "Select " & WrkTop & "list#,name,regno,make,year,model,value from " & cFileName _
    & " where  name LIKE '%" & Wrkname & "%' order by name,add1,list#"
    ...
    End Try
  End Function
  Public Function GetViewDOB(ByVal Wrkdob As Integer, ByVal wrksetblocking As Boolean) As DataSet
    ...
    StrSQL = "Select list#,name,regno,make,year,model,value from " & cFileName _
    & " where  dob = " & Wrkdob & " order by name,add1,list#"
  ...
  Public Function GetViewgrid(ByVal Wrkname As String, NumRecs As Integer) As DataSet
    ...
    If NumRecs > 0 Then
      WrkTop = "TOP " & NumRecs & " "
    End If
    StrSQL = "Select " & WrkTop & " list#,name,make,year,model,sname,value from " & cFileName _

...
#Region "Methods: File Access Routines"
  Public Function GetViewbySName(ByVal WrkSName As String, ByVal WrkList As Integer,
 ByVal WrkYear As Integer, ByVal WrkType As String, WrkQrySelect As String, ByVal NumRecs As Integer, SetBlocking As Boolean) As DataSet
    ...
    StrSQL = "Select " & WrkTop & "sname,name,list#,type,year,ccno,taxt,ccetax,payrec,newpay,bald,icode from " & cFileName _
    & " where sname ='" & WrkSName & "' and list# =" & WrkList & " and year =" & WrkYear & " and type >'" & WrkType & "'" & WrkWhere _
    & " or sname ='" & WrkSName & "' and list# =" & WrkList & " and year >" & WrkYear & WrkWhere _
    & " or sname ='" & WrkSName & "' and list# >" & WrkList & WrkWhere _
    & " or sname >'" & WrkSName & "' " & WrkWhere & " order by sname,list#,year,type"
    Try
      Conn = MyDBConn.Open
  ...
  Public Function GetViewbySNameScan(ByVal WrkName As String, ByVal WrkList As Integer,
 ByVal WrkYear As Integer, ByVal WrkType As String, WrkQrySelect As String, ByVal NumRecs As Integer, SetBlocking As Boolean) As DataSet
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    ...
    StrSQL = "Select " & WrkTop & "sname,name,list#,type,year,ccno,taxt,ccetax,payrec,newpay,bald,icode from " & cFileName _
    & " where sname like '%" & WrkName & "%' and list# =" & WrkList & " and year =" & WrkYear & " and type >'" & WrkType & "' " & WrkWhere _
    & " or sname like '%" & WrkName & "%' and list# =" & WrkList & " and year >" & WrkYear & WrkWhere _
    & " or sname like '%" & WrkName & "%' and list# >" & WrkList & WrkWhere _
    & " order by sname,list#,year,type"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
      objCommand.CommandTimeout = 300

...
Public Class DBConnection
  ...
  Public Function Open() As SqlConnection
    ...
    End If
    If MyConnName = MyAppSettings.ConnName3 Then
      WrkPassword = GetPassword(MyAppSettings.Password3)
      ConnStr = "Data Source=" & MyAppSettings.ServerIP & ";Initial Catalog=" & MyAppSettings.DatabaseName3 &
      ";Integrated Security=false" & ";User ID=" & MyAppSettings.UserID3 & ";password=" & WrkPassword
    End If
    If MyConnName = MyAppSettings.ConnName4 Then
      WrkPassword = GetPassword(MyAppSettings.Password4)
      ConnStr = "Data Source=" & MyAppSettings.ServerIP & ";Initial Catalog=" & MyAppSettings.DatabaseName4 &
      ";Integrated Security=false" & ";User ID=" & MyAppSettings.UserID4 & ";password=" & WrkPassword
    End If
    Try

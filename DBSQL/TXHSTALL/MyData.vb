...
#End Region
  ...
  '' this is a new DLL for TXHST that retrieves all columns - Lou 2026-09-01

#Region "Methods: File Access Routines"
  Public Function GetAllRowsByCash(ByVal WrkList As String, ByVal WrkAsof As Integer, ByVal WrkCutoff As Integer) As DataSet
    ...
    & " where list# ='" & WrkList & "' and pdate<=" & WrkAsof & " and pdate>=" & WrkCutoff & " and cash>0" _
    & " order by pdate desc"
    Try
      Conn = MyDBConn.Open
  ...
  Public Function GetAllRowsByCheckRef(ByVal WrkRef As String, ByVal WrkAsof As Integer, ByVal WrkCutoff As Integer) As DataSet
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    Dim ds2 As DataSet = New DataSet
  ...
  Public Function ReplaceDS(ByVal ds As DataSet) As DataSet
    ...
    With myTable
      ...
      ' --- Columns --- existing in TXHST dlls
      ...
      ' --- added to this dll to retrieve all the columns , including  ones that are retrieved by other dlls  ---
      ...
      .Columns.Add("dist", Type.GetType("System.Decimal"))
      .Columns.Add("batchs", Type.GetType("System.Int32"))
      .Columns.Add("cdate", Type.GetType("System.Int32"))
      .Columns.Add("suscd", Type.GetType("System.String"))
      .Columns.Add("thajcd", Type.GetType("System.String"))
      .Columns.Add("thinpd", Type.GetType("System.String"))
      .Columns.Add("intor", Type.GetType("System.Decimal"))
      .Columns.Add("prf", Type.GetType("System.String"))
      .Columns.Add("chdate", Type.GetType("System.Int32"))
      .Columns.Add("chtime", Type.GetType("System.Int32"))
    End With
    ...
    For I = 0 To ds.Tables(0).Rows.Count - 1
      With ds.Tables(0).Rows(I)
        ...
        ' --- added to this dll to retrieve all the columns , including  ones that are retrieved by other dlls  ---
        dr.Item("recid") = .Item("recid")
        dr.Item("rcode") = .Item("rcode")
        dr.Item("cash") = .Item("cash")
        dr.Item("check") = .Item("check")
        dr.Item("credit") = .Item("credit")
        dr.Item("corc") = .Item("corc")
        dr.Item("dist") = .Item("dist")
        dr.Item("batchs") = .Item("batchs")
        dr.Item("cdate") = .Item("cdate")
        dr.Item("suscd") = .Item("suscd")
        dr.Item("thajcd") = .Item("thajcd")
        dr.Item("thinpd") = .Item("thinpd")
        dr.Item("intor") = .Item("intor")
        dr.Item("prf") = .Item("prf")
        dr.Item("chdate") = .Item("chdate")
        dr.Item("chtime") = .Item("chtime")

...
Public Class MyData
  ...
  Const cFileName As String = "FAEQUP"
#Region "Constructors"
...
Public Sub GetOneRecordP(ByVal Code As String)
  ...
  StrSQL = "Select * from " & cFileName & " where EQCODE='" & Code & "'"
  Try
    Conn = MyDBConn.Open
...
Public Property ErrMsg() As String
    ...
    End Set
End Property
Dim mEQCODE As String
Public Property _EQCODE As String
    Get
        Return mEQCODE
    End Get
    Set(ByVal value As String)
    ...
    End Set
End Property
Dim mEQDESC As String
Public Property _EQDESC As String
    Get
        Return mEQDESC
    End Get
    Set(ByVal value As String)

...
Public Function GetAllAcct(ByVal WrkFdnbr As String, ByVal WrkSfund As Integer, _
 ...
 ByVal WrkSubfn As Integer, ByVal WrkStrdt As Integer, WrkEnddt As Integer) As DataSet
  ...
  End Try
End Function
  Public Function GetInvoice(ByVal WrkPstdt As Integer, ByVal WrkInvno As String, ByVal WrkBatch As Integer, ByVal NumRecs As Integer) As DataSet
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    ...
    If NumRecs > 0 Then
      WrkTop = "TOP " & NumRecs & " "
    End If
    StrSQL = "Select " & WrkTop & "tdesc,bchno,refno,prf,fdnbr,sfund,dpnbr,obnbr,fnpgm,subfn," &
   "tramt,amtyp,fscyr,ponbr from " & cFileName &
   " where pstdt=" & WrkPstdt & " and invnr='" & WrkInvno & "' and bchno=" & WrkBatch & " and srcde=1"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
      'Fill the dataset with the data
    ...
    End Try
  End Function
  Public Function ReplaceDSInv(ByVal ds As DataSet) As DataSet
    Dim ds2 As DataSet = New DataSet
    Dim dr As DataRow
    ...
    With myTable
      ...
      .Columns.Add("batch", Type.GetType("System.Int16"))
      .Columns.Add("refno", Type.GetType("System.String"))
      ...
      .Columns.Add("po", Type.GetType("System.Int32"))
    End With
    ...
    For I = 0 To ds.Tables(0).Rows.Count - 1
      With ds.Tables(0).Rows(I)
        ...
        dr.Item(0) = .Item("tdesc")
        dr.Item(1) = .Item("bchno")
        dr.Item(2) = .Item("refno")
        dr.Item(3) = .Item("prf")
        dr.Item(4) = .Item("fdnbr")
        dr.Item(5) = .Item("sfund")
        dr.Item(6) = .Item("dpnbr")
        dr.Item(7) = .Item("obnbr")
        dr.Item(8) = .Item("fnpgm")
        dr.Item(9) = .Item("subfn")
        WrkAcct = BuildAcct(.Item("fdnbr"), .Item("sfund"), .Item("dpnbr"), .Item("obnbr"), .Item("fnpgm"), .Item("subfn"))
        dr.Item(10) = WrkAcct
        If .Item("amtyp") = "D" Then
          dr.Item(11) = .Item("tramt")
        Else
          dr.Item(12) = .Item("tramt")
        End If
        dr.Item(13) = .Item("tdesc")
        dr.Item(14) = .Item("fscyr")
        dr.Item(15) = .Item("ponbr")
        ds2.Tables(0).Rows.Add(dr)
      End With
    Next
    Return ds2
  End Function
  Public Function GetRef(ByVal WrkPstdt As Integer, ByVal WrkBchno As Integer, ByVal WrkTramt As Decimal,
 ByVal WrkTdesc As String, ByVal WrkRefno As Integer, ByVal WrkPrf As String, ByVal NumRecs As Integer) As DataSet
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    Dim ds2 As DataSet = New DataSet
    ...
    End If
    StrSQL = "Select " & WrkTop & "tdesc,bchno,refno,prf,fdnbr,sfund,dpnbr,obnbr,fnpgm,subfn," &
   "amtyp,tramt from " & cFileName &
   " where pstdt=" & WrkPstdt & " and bchno=" & WrkBchno & " and tramt=" & WrkTramt &
   " and prf='" & WrkPrf & "' and srcde=3"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
      'Fill the dataset with the data
    ...
    End Try
  End Function
  Public Function ReplaceDSRef(ByVal ds As DataSet) As DataSet
    Dim ds2 As DataSet = New DataSet
    Dim dr As DataRow
    Dim myTable As New DataTable
    Dim WrkAcct As String
 ...
 ByVal WrkTran As Integer, ByVal NumRecs As Integer) As DataSet
   ...
   " where pstdt=" & WrkPstdt & " and bchno=" & WrkBchno & " and trnbr=" & WrkTran & " and srcde=2"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
      'Fill the dataset with the data
    ...
    End Try
  End Function
  Public Function ReplaceDSTran(ByVal ds As DataSet) As DataSet
    Dim ds2 As DataSet = New DataSet
    Dim dr As DataRow
    Dim myTable As New DataTable
    Dim WrkAcct As String
    ...
    Return ds2
  End Function
  Public Function GetPO(ByVal WrkPstdt As Integer, ByVal WrkFscyr As Integer,
 ByVal WrkPOnbr As Integer, ByVal NumRecs As Integer) As DataSet
    ...
    StrSQL = "Select " & WrkTop & "tdesc,bchno,refno,prf,fdnbr,sfund,dpnbr,obnbr,fnpgm,subfn," &
   "tramt,amtyp,fscyr,ponbr from " & cFileName &
   " where pstdt=" & WrkPstdt & " and ponbr=" & WrkPOnbr & " and srcde=4"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
      'Fill the dataset with the data
    ...
    End Try
  End Function
  Public Function ReplaceDSPO(ByVal ds As DataSet) As DataSet
    Dim ds2 As DataSet = New DataSet
    Dim dr As DataRow
    Dim myTable As New DataTable
    Dim WrkAcct As String
    ...
    Return ds2
  End Function
  Public Function GetBchnoPR(ByVal WrkPstdt As Integer, ByVal WrkBchno As Integer,
 ByVal NumRecs As Integer) As DataSet
    ...
    StrSQL = "Select " & WrkTop & "fdnbr,sfund,dpnbr,obnbr,fnpgm,subfn,amtyp,tramt," &
   "tdesc,bchno,prf from " & cFileName &
   " where pstdt=" & WrkPstdt & " and bchno=" & WrkBchno & " and srcde=5"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
      'Fill the dataset with the data
    ...
    End Try
  End Function
  Public Function ReplaceDSPR(ByVal ds As DataSet) As DataSet
    Dim ds2 As DataSet = New DataSet
    Dim dr As DataRow
    Dim myTable As New DataTable
    Dim WrkAcct As String
    ...
    Return ds2
  End Function
  Public Function GetBchnoTX(ByVal WrkPstdt As Integer, ByVal WrkBchno As Integer,
 ByVal NumRecs As Integer) As DataSet
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    ...
    StrSQL = "Select " & WrkTop & "fdnbr,sfund,dpnbr,obnbr,fnpgm,subfn,amtyp,tramt," &
   "tdesc,bchno,prf from " & cFileName &
   " where pstdt=" & WrkPstdt & " and bchno=" & WrkBchno & " and srcde=6"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
      'Fill the dataset with the data
    ...
    End Try
  End Function
  Public Function ReplaceDSTX(ByVal ds As DataSet) As DataSet
    Dim ds2 As DataSet = New DataSet
    Dim dr As DataRow
    Dim myTable As New DataTable
    Dim WrkAcct As String

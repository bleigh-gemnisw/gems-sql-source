...
#Region "Methods: File Access Routines"
  Public Function GetViewbyYear(ByVal WrkYear As Integer, ByVal WrkCat As String, ByVal WrkName As String, ByVal Numrecs As Integer)
    ...
    StrSQL = "Select " & WrkTop & "mfcatg,mfnam,mfreg#,mfper#,mfyear,mfadd1,stampd,stampt from " & cFileName &
     " where mfyear=" & WrkYear & " and mfcatg='" & WrkCat & "' and mfnam>='" & WrkName &
     "' or mfyear=" & WrkYear & " and mfcatg>'" & WrkCat &
     "' order by mfcatg,mfnam,mfadd1,stampd,stampt"
    Conn = MyDBConn.Open
    ...
    Return ds
  End Function
  Public Function GetViewReg(ByVal WrkYear As Integer, ByVal WrkReg As String, ByVal Numrecs As Integer)
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    Dim WrkTop As String
    ...
    End If
    RecordNotFound = False
    StrSQL = "Select " & WrkTop & "mfyear,mfreg#,mfnam from " & cFileName & " where mfyear=" & WrkYear _
     & " and mfreg#='" & WrkReg & "' order by mfnam"
    Conn = MyDBConn.Open
    objCommand = New SqlCommand(StrSQL, Conn)

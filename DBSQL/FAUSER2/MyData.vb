...
Public Class MyData
  ...
  Const cFileName As String = "FAUSER2"
#Region "Constructors"
...
Public Sub GetOneRecordP(ByVal Code As String)
  ...
  StrSQL = "Select * from " & cFileName & " where U2CODE='" & Code & "'"
  Try
    Conn = MyDBConn.Open
...
Public Property ErrMsg() As String
    ...
    End Set
End Property
Dim mU2CODE As String
Public Property _U2CODE As String
    Get
        Return mU2CODE
    End Get
    Set(ByVal value As String)
    ...
    End Set
End Property
Dim mU2DESC As String
Public Property _U2DESC As String
    Get
        Return mU2DESC
    End Get
    Set(ByVal value As String)

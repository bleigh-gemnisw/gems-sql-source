...
#Region "Methods: File Access Routines"
  Public Function GetViewbyPcust(ByVal wrkcust As Integer, wrkchdate As Integer, ByVal NumRecs As Integer) As DataSet
    ...
    & " where pcust = " & wrkcust & " AND chdate <= " & wrkchdate & " order by chdate desc"
    Try
      Conn = MyDBConn.Open

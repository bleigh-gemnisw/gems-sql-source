...
End Sub
  ...
  RecordNotFound = False
    StrSQL = "Select * from " & cFileName & " where list# = " & Wrklistno & " and txyear = " & Wrkyear
    Try
    Conn = MyDBConn.Open
...
End Sub
  Public Function PosData(ByVal Wrklistno As Integer, ByVal Wrkyear As Integer) As DataSet
    ...
    StrSQL = "Select * from " & cFileName & " where list# >= " & Wrklistno & " And txyear = " & Wrkyear & " Order by list#"
    Conn = MyDBConn.Open
    objCommand = New SqlCommand(StrSQL, Conn)

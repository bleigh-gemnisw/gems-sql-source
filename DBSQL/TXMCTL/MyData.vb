...
Public Class MyData
  ...
  Const cFileName As String = "TXMCTL"
#Region "Constructors"
...
End Sub
 ...
 ClearFields 
  ...
  Public Sub AddOneRecordP()
    ...
    StrSQL = "Insert into " & cFileName & "(VALPER,VALMIN)" &
   " values('" & _VALPER & cnn & _VALMIN & "')"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
      da = New SqlDataAdapter
  ...
  Public Sub UpdateOneRecordP()
    ...
    StrSQL = "Update " & cFileName & " set valper=" & _VALPER & ",valmin=" & _VALMIN
...
Dim mVALPER as decimal
Public Property _VALPER as decimal
    Get
        Return mVALPER
    End Get
...
Dim mVALMIN  as integer 
Public Property _VALMIN  as integer   
    Get
        Return mVALMIN
    End Get

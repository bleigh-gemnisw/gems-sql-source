...
#Region "Methods: File Access Routines"
  Public Function GetViewbyDOB(ByVal WrkDOB As Integer, WrkQrySelect As String, ByVal NumRecs As Integer, SetBlocking As Boolean) As DataSet
    ...
    StrSQL = "Select " & WrkTop & "dob,name,list#,type,year,ccno,taxt,ccetax,payrec,newpay,bald,icode from " & cFileName _
    & " where dob >=" & WrkDOB & " and imvreg<>''" _
    & WrkWhere & " order by dob,name"
    Try
      Conn = MyDBConn.Open
    ...
    End Try
  End Function
  Public Function GetAllDOB(ByVal WrkDOB As Integer, ByVal NumRecs As Integer, SetBlocking As Boolean) As DataSet
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    Dim ds2 As DataSet = New DataSet
  ...
  Public Function ReplaceDS(ByVal ds As DataSet) As DataSet
    ...
    For I = 0 To ds.Tables(0).Rows.Count - 1
      With ds.Tables(0).Rows(I)
        ...
        dr.Item("wsel") = 0
        dr.Item("dob") = GetDBDate(.Item("dob"))
    ...
    Return ds2
  End Function
  Public Function GetDBDate(ByVal DateIn As Integer) As String
    ...
    If DateIn > 0 Then
      ...
      End Try
    End If
    WrkDate = Mid(WrkDate, 1, 2) & "/" & Mid(WrkDate, 3, 2) & "/" & Mid(WrkDate, 5, 4)
    If Mid(WrkDate, 1, 1) = "0" Then
      WrkDate = " " & Mid(WrkDate, 2, 9)
    End If
    Return WrkDate
  End Function
  Public Sub OpenFile()

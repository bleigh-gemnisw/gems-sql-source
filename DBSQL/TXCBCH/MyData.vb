...
Public Class MyData
  ...
  Const cFileName As String = "TXCBCH"
#Region "Constructors"
...
End Sub
 ...
 ClearFields 
  ...
  Public Sub AddOneRecordP()
    ...
    StrSQL = "Insert into " & cFileName & "(LCBCH#)" &
   " values('" & _LCBCHNo & "')"
    Try
      Conn = MyDBConn.Open
      objCommand = New SqlCommand(StrSQL, Conn)
  ...
  Public Sub UpdateOneRecordP()
    ...
    StrSQL = "Update " & cFileName & " set LCBCH#=" & _LCBCHNo
...
Dim mLCBCHNo  as integer 
Public Property _LCBCHNo  as integer   
    Get
        Return mLCBCHNo
    End Get

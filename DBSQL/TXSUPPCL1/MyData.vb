...
Public Class MyData
  ...
  Const cFileName As String = "TXSUPPC"
#Region "Constructors"
...
#Region "Methods: File Access Routines"
  ...
  Public Function GetViewbyRegNo(ByVal wrkclass As Integer, ByVal Wrkregno As String, NumRecs As Integer) As DataSet
    ...
    If NumRecs > 0 Then
      WrkTop = "TOP " & NumRecs & " "
    End If
    StrSQL = "Select " & WrkTop & "list#,name,class,regno,make,year,model,value from " & cFileName _
    & " where class = " & wrkclass & " AND regno = '" & Wrkregno & "' order by class,regno"

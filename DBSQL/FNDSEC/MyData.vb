...
Public Class MyData
  ...
  Const cFileName As String = "FNDSEC"
#Region "Constructors"
...
Public Sub GetOneRecordP(ByVal Usrprf As String, ByVal Fdnbr As Integer)
  Dim Conn As SqlConnection
  Dim objCommand As SqlCommand
  Dim ds As DataSet = New DataSet

  RecordNotFound = False
  StrSQL = "Select * from " & cFileName & " where USRPRF='" & Usrprf & "' and FDNBR=" & Fdnbr
  Try
    Conn = MyDBConn.Open
...
Public Function PosData(ByVal Usrprf As String) As DataSet
  ...
  StrSQL = "Select * from " & cFileName & " where USRPRF>='" & Usrprf & "' order by usrprf, fdnbr"
  Conn = MyDBConn.Open
  objCommand = New SqlCommand(StrSQL, Conn)

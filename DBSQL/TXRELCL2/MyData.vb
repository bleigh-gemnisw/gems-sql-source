...
#Region "Methods: File Access Routines"
  Public Function GetViewbyName(ByVal Wrkname As String, NumRecs As Integer, WrkBlocking As Boolean) As DataSet
    ...
    If NumRecs > 0 Then
      WrkTop = "TOP " & NumRecs & " "
    End If
    StrSQL = "Select " & WrkTop & "list#,name,loc#,loc,unit#,map from " & cFileName _
  ...
  Public Function GetViewgrid(ByVal Wrkname As String, NumRecs As Integer) As DataSet
    ...
    If NumRecs > 0 Then
      WrkTop = "TOP " & NumRecs & " "
    End If
    StrSQL = "Select " & WrkTop & "list#,name,loc#,loc,sname from " & cFileName _
    & " where name >= '" & Wrkname & "' order by name,list#"

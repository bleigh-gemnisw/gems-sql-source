...
#Region "Methods: File Access Routines"
  Public Function GetViewbyName(ByVal WrkGLYear As Integer, ByVal WrkName As String, ByVal WrkList As Integer,
    ...
    End Try
  End Function
  Public Function GetViewbyNameScan(ByVal WrkGLYear As Integer, ByVal Wrkname As String, NumRecs As Integer, ByVal wrksetblocking As Boolean) As DataSet
    ...
    End If
    StrSQL = "Select " & WrkTop & "list#,name,regno,make,year,model from " & cFileName _
    & " where txyear = " & WrkGLYear & " AND name LIKE '%" & Wrkname & "%' order by name,add1"
    ...
    End Try
  End Function
  Public Function GetViewDOB(ByVal WrkGLYear As Integer, ByVal Wrkdob As Integer) As DataSet
    ...
    & " where txyear = " & WrkGLYear & " AND dob = " & Wrkdob & " order by name,add1"

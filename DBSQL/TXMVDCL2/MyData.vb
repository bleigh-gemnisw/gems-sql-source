...
Public Class MyData
  ...
  Const cFileName As String = "TXMVDC"
#Region "Constructors"
...
#Region "Methods: File Access Routines"
  Public Sub GetOneRecordP(ByVal WrkClass As Integer, WrkRegNo As String)
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet

    RecordNotFound = False
    StrSQL = "Select * from " & cFileName & " where class = " & WrkClass & " and regno='" & WrkRegNo & "'"
    Try
      Conn = MyDBConn.Open
    ...
    End Try
  End Sub
  Public Function GetViewbyRegNo(ByVal wrkclass As Integer, ByVal Wrkregno As String, NumRecs As Integer) As DataSet
    ...
    If NumRecs > 0 Then
      WrkTop = "TOP " & NumRecs & " "
    End If
    StrSQL = "Select " & WrkTop & "list#,name,class,regno,make,year,model from " & cFileName _
    & " where class = " & wrkclass & " AND regno = '" & Wrkregno & "' order by regno"

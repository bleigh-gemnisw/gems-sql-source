...
Public Class MyData
  ...
  Const cFileName As String = "TXDCEX"
#Region "Constructors"
...
End Sub
  ...
  Public Function GetAllYear(ByVal Wrkyear As Integer) As DataSet
    ...
    StrSQL = "Select * from " & cFileName & " where year = " & Wrkyear & " Order By year,code"
    Conn = MyDBConn.Open
    objCommand = New SqlCommand(StrSQL, Conn)
...
Dim mEXVAL  as integer 
Public Property _EXVAL  as integer   
    Get
        Return mEXVAL
    End Get
    set(byval value as integer)

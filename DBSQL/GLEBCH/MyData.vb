...
Public Class MyData
  ...
  Const cFileName As String = "GLEBCH"
#Region "Constructors"
...
Public Function AutoGenTran(ByVal WrkBchno As Integer) As Integer
  ...
  Return NextKey
End Function
Public Function AutoGenSeq(ByVal WrkBchno As Integer, ByVal WrkTrnbr As Integer) As Integer
  Dim NextKey As Integer
  Dim Conn As SqlConnection
  Dim objCommand As SqlCommand
  Dim ds As DataSet = New DataSet
  ...
  StrSQL = "Select * from " & cFileName & " where bchno=" & WrkBchno & _
   " and trnbr=" & WrkTrnbr & " order by jrnseq desc"
  Try
    Conn = MyDBConn.Open
    objCommand = New SqlCommand(StrSQL, Conn)
    'Fill the dataset with the data
  ...
  Return NextKey
End Function
Public Sub GetOneRecordP(ByVal WrkBchno As Integer, ByVal WrkTrnbr As Integer, _
 ByVal WrkJrnseq As Integer)
  Dim Conn As SqlConnection
  Dim objCommand As SqlCommand
  Dim ds As DataSet = New DataSet
...
End Sub
  ...
  RecordNotFound = False
  IsEOF = False
  StrSQL = "Select * from " & cFileName & " where bchno=" & WrkBatch & " order by trnbr"
...
End Sub
  ...
  objCommand = Nothing
End Sub
  Public Sub DeleteTran(ByVal WrkBchno As Integer, ByVal WrkTrnbr As Integer)
  Dim Conn As SqlConnection
  Dim objCommand As SqlCommand
  Dim Result As Integer
  ...
  RecordNotFound = False
  IsEOF = False
  StrSQL = "Delete from " & cFileName & " where bchno=" & WrkBchno & " and trnbr=" & WrkTrnbr
  Conn = MyDBConn.Open
  objCommand = New SqlCommand(StrSQL, Conn)
  Result = objCommand.ExecuteNonQuery()
  objCommand = Nothing

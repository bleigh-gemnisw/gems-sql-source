...
#Region "Methods: File Access Routines"
  Public Function GetViewbyName(ByVal WrkName As String, NumRecs As Integer) As DataSet
    ...
    If NumRecs > 0 Then
      WrkTop = "TOP " & NumRecs & " "
    End If
    StrSQL = "Select " & WrkTop & "tickno, name, regno, regst, status from " & cFileName _
    ...
    End Try
  End Function
  Public Function GetViewbyRegNo(ByVal WrkRegNo As String, NumRecs As Integer) As DataSet
    Dim Conn As SqlConnection
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    Dim WrkTop As String
    ...
    If NumRecs > 0 Then
      WrkTop = "TOP " & NumRecs & " "
    End If
    StrSQL = "Select " & WrkTop & "tickno, regno, regst, name, status from " & cFileName _

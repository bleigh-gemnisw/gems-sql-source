Public Class FrmListmfpcat
  Inherits System.Windows.Forms.Form
  Dim myMFPCAT As MFPCAT.myData
  Dim ds As DataSet = New DataSet
  Friend Wrkmfpcat As String
...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(11, 50)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(379, 264)
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListmfpcat_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyfrmPS002.SbpScreen.Text = "LISTCategory"
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListmfpcat_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myMFPCAT = New MFPCAT.mydata(MyDBConnect)
    LblCurrent.Text = "(Category = " & Wrkmfpcat & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    Windows.Forms.Cursor.Current = Cursors.WaitCursor
      ...
      With MyfrmPS002C
        .Txtmfcatg.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.Txtmfcatg, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
        .Show()
      End With
...
Private Sub FrmListmfpcat_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  'Memory Cleanup
  myMFPCAT = Nothing
  MyFrmListmfpcat = Nothing
End Sub
End Class

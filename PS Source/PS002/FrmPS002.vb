...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPS002))
...
Me.TbMain.Size = New System.Drawing.Size(774, 50)
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 625)
...
Me.SbMain.Size = New System.Drawing.Size(774, 28)
...
Me.ClientSize = New System.Drawing.Size(774, 653)
...
#End Region
Private Sub FrmPS002_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyfrmPS002B = New FrmPS002B
  MyFrmPS002B.MdiParent = Me
  MyFrmPS002B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmPS002_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  ...
  MyFrmPS002C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmPS002C.MdiParent = MyFrmPS002B.ParentForm
  MyfrmPS002C.wrkmfyear = MyUtils.CnvSng(MyfrmPS002B.txtyear.Text)
...
Private Sub DoBtnPrint()
 ...
 ' MyCRViewer.Wrkds = MyFrmPS002B.ds
 ' MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmPS002C.SaveData()
End Sub

...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(637, 367)
...
#End Region
  Private Sub PS002B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  Public Sub ShowGrid()
    ...
    '   wrkmfcatg = ""
    '   wrkmfnam = ""
    '   ds = myMFPARK.GetViewbyYear(MyUtils.CnvSng(txtyear.Text), wrkmfcatg, wrkmfnam, 50)
    '   Else

    ds = myMFPARKL1.GetViewbyYear(MyUtils.CnvSng(txtyear.Text), TxtPosmfcatg.Text, txtposmfname.Text, 50)

    ' End If
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub PS002B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyfrmPS002.SbpScreen.Text = "PS002B"
    MyfrmPS002.TBarPrint.Enabled = True
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    MyfrmPS002C = New FrmPS002C
    MyfrmPS002C.MdiParent = Me.ParentForm
    MyfrmPS002C.wrkmfyear = MyUtils.CnvSng(txtyear.Text)
    MyfrmPS002C.wrkmfcatg = Trim(DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value)
    MyfrmPS002C.wrkmfnam = Trim(DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
    MyfrmPS002C.wrkmfadd1 = Trim(DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value)
    MyfrmPS002C.wrkstampd = MyUtils.CnvSng(DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
    MyfrmPS002C.wrkstampt = MyUtils.CnvSng(DataGrdView.Item(7, DataGrdView.CurrentRow.Index).Value)
    MyfrmPS002C.Show()
    Me.Hide()
  End Sub

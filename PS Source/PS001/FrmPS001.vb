...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPS001))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarPrint, Me.TBarPS})
Me.TbMain.DropDownArrows = True
Me.TbMain.ImageList = Me.ImageList1
Me.TbMain.Location = New System.Drawing.Point(0, 0)
Me.TbMain.Name = "TbMain"
Me.HelpProvider1.SetShowHelp(Me.TbMain, True)
...
Me.Text = "Parking Sticker Category"
...
#End Region
Private Sub FrmPS001_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  TBarPS.Enabled = True
  set_security() '#set
  MyFrmPS001B = New FrmPS001B
  MyFrmPS001B.MdiParent = Me
  MyFrmPS001B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmPS001_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "PS001B" Then
    MyFrmPS001.Close()
  Else
    MyFrmPS001C.Close()
    MyFrmPS001B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmPS001C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmPS001C.MdiParent = MyFrmPS001B.ParentForm
  'MyFrmPS001C.Wrkdecode = 0
  'MyFrmPS001C.WrkTxType = ""
  MyFrmPS001C.Show()
  MyFrmPS001B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmPS001B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnPS()
    MyUtils.PrtScreen(Form.ActiveForm)
...
'''pf.PrinterSettings.DefaultPageSettings.Margins.Top = 10
'''pf.PrinterSettings.DefaultPageSettings.Color = False
'''pf.Form.BackColor = Color.White
'''pf.Form.ForeColor = Color.Black
...
Private Sub pd_PrintPage(ByVal sender As Object, _
      ...
      e.Graphics.DrawImage(formImage, 1, 1)
   End Sub

...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtMR200.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      ...
      End If
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", "Misc.Receipts History")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyFromDate", MyFrmMR200B.DtPckFrom.Value)
      .SetParameterValue("MyToDate", MyFrmMR200B.DtPckTo.Value)
      .SetParameterValue("MySelCodes", MySelCodes)
      .SetParameterValue("MyBatch", MyUtils.CnvSng(MyFrmMR200B.TxtBatch.Text))
      .SetParameterValue("MyDetail", MyFrmMR200B.ChkDetail.Checked)
    End With
    With Crv1
      .DisplayToolbar = True

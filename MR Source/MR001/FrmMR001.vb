...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmMR001))
    ...
    Me.imageList1.Images.SetKeyName(5, "PostData.png")
    ...
    Me.Text = "Edit and Post Misc. Receipts"
...
#End Region
  ...
  Private Sub FrmMR001_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmMR001B = New FrmMR001B
    MyFrmMR001B.MdiParent = Me
    MyFrmMR001B.Show()
  ...
  Private Sub tbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    If e.Button Is TBarSave Then
      If SbpScreen.Text = "MR001D" Then
        MyFrmMR001D.SaveData()
        Exit Sub
      End If
    End If
    ...
    If MyFrmMR001B.DataGrdView.Rows.Count = 0 Then 'Buttons below require a batch
      Exit Sub
    End If
  ...
  Private Sub FrmMR001_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    Dim Cancel As Boolean

    If MyFrmMR001.SbpScreen.Text = "MR001C" Then
      If Cancel Then
        e.Cancel = True
      End If
      Exit Sub
  ...
  Private Sub DoBtnDelete()
    ...
    Select Case Me.SbpScreen.Text
      Case "MR001B"
        MyFrmMR001B.DeleteData(Cancel)
      Case "MR001D"
        MyFrmMR001D.DeleteData(Cancel)
  ...
  Private Sub DoBtnNew()
    Select Case Me.SbpScreen.Text
      Case "MR001B"
        MyFrmMR001B_New = New FrmMR001B_New
        MyFrmMR001B_New.MdiParent = MyFrmMR001B.ParentForm
        MyFrmMR001B_New.Create = True
        MyFrmMR001B_New.Show()
        MyFrmMR001B.Hide()
    End Select
  End Sub
  ...
  Private Function DoBtnPrtEdits(ByVal Post As Boolean) As Boolean
    ...
    WrkBatchNo = MyFrmMR001B.DataGrdView.Item(0, MyFrmMR001B.DataGrdView.CurrentRow.Index).Value
    WrkReceiptDate = MyUtils.GetDBDate(MyFrmMR001B.DataGrdView.Item(4, MyFrmMR001B.DataGrdView.CurrentRow.Index).Value)
    Errors = PrtEdits(WrkBatchNo, WrkReceiptDate, Post)

    Return Errors
  End Function

  Private Sub FrmMR001_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

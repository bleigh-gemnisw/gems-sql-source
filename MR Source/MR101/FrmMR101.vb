...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmMR101))
...
Me.TbMain.Size = New System.Drawing.Size(596, 50)
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 448)
...
Me.SbMain.Size = New System.Drawing.Size(596, 28)
...
Me.Text = "Maintain Misc Receipts Codes"
...
Private Sub FrmMR101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmMR101B = New FrmMR101B
  MyFrmMR101B.MdiParent = Me
  MyFrmMR101B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmMR101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "MR101B" Then
    MyFrmMR101.Close()
  Else
    MyFrmMR101C.Close()
    MyFrmMR101B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmMR101C.DeleteData(wrkcancel)
  If wrkcancel Then Exit Sub
  MyFrmMR101C.Close()
  MyFrmMR101B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmMR101C = New FrmMR101C
  MyFrmMR101C.MdiParent = MyFrmMR101B.ParentForm
  MyFrmMR101C.WrkCode = ""
  MyFrmMR101C.Show()
  MyFrmMR101B.Hide()
End Sub

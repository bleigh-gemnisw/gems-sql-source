...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmIA101))
...
#End Region
Private Sub FrmIA101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmIA101B = New FrmIA101B
  MyFrmIA101B.MdiParent = Me
  MyFrmIA101B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmIA101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "IA101B" Then
    MyFrmIA101.Close()
  Else
    MyFrmIA101C.Close()
    MyFrmIA101B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmIA101C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmIA101C.Close()
  MyFrmIA101B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmIA101C = New FrmIA101C
  MyFrmIA101C.MdiParent = MyFrmIA101B.ParentForm
  MyFrmIA101C.Show()
  MyFrmIA101B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmIA101B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmIA101C.SaveData()
End Sub

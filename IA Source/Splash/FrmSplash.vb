...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.GrpPrtScreen.Location = New System.Drawing.Point(80, 398)
    ...
    Me.GroupBox2.Location = New System.Drawing.Point(264, 10)
    Me.GroupBox2.Name = "GroupBox2"
    Me.GroupBox2.Size = New System.Drawing.Size(118, 56)
    ...
    Me.LblPrtScreen.Size = New System.Drawing.Size(250, 48)
    ...
    Me.BntShowPrtScreen.Location = New System.Drawing.Point(6, 83)
...
#End Region
  ...
  Public Sub GetAppConfig()
    ...
    WrkXMLPath = IO.Path.Combine(GetDataPath(), "Settings\" & WrkProgName & ".xml")
  ...
  Public Sub GetAppSettings()
    ...
    If MyAppConfig.WebName = GetComputerName() Then
      WrkXMLPath = IO.Path.Combine(GetDataPath(), "Settings\" & WrkProgName & " " & Environment.UserName & ".xml")
    Else
      WrkXMLPath = IO.Path.Combine(GetDataPath(), "Settings\" & WrkProgName & " " & GetComputerName() & ".xml")
    End If
    WrkFileExists = CheckFileExists(WrkXMLPath)
    If WrkFileExists Then
      sr = New IO.StreamReader(WrkXMLPath)

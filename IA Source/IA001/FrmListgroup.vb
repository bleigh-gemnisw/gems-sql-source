...
#Region " Windows Form Designer generated code "
    ...
    Me.LblCurrent.Location = New System.Drawing.Point(24, 36)
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(12, 62)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(409, 260)
    ...
    Me.Name = "FrmListgroup"
    Me.Text = "Select Group Code"
...
#End Region
    ...
    Public Sub ShowGrid()
        ...
        DataGrdView.Refresh()
    End Sub
    Private Sub FrmListGroup_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        MyFrmIA001.SbpScreen.Text = "ListGroup"
    ...
    Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        ...
        End If
    End Sub
  Private Sub FrmListgroup_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    If SaveDelete Then
      MyFrmIA001.TBarDelete.Enabled = True
    End If
    MyFrmIA001.TBarSave.Enabled = True
  End Sub
    Private Sub FrmListGroup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SaveDelete = MyFrmIA001.TBarDelete.Enabled
    ...
    Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
        ...
        With MyFrmIA001C
            .TxtGroup.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
            .Ttp1.SetToolTip(.TxtGroup, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
            .Show()
        End With

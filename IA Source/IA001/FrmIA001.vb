...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmIA001))
    ...
    Me.TbMain.Size = New System.Drawing.Size(570, 50)
    ...
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 467)
    ...
    Me.SbMain.Size = New System.Drawing.Size(570, 28)
    ...
    Me.ClientSize = New System.Drawing.Size(570, 495)
    ...
    Me.Text = "Gems Net User Security"
...
Private Sub FrmIA001_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  If Not MyPasswordMode Then
    MyFrmIA001B = New FrmIA001B
    MyFrmIA001B.MdiParent = Me
    MyFrmIA001B.Show()
  Else
    MyFrmIA001D = New FrmIA001D
    MyFrmIA001D.MdiParent = Me
    MyFrmIA001D.WrkGNETUSER = MyUserID
    MyFrmIA001D.Show()
  End If
End Sub
...
Private Sub DoBtnBack()
  ...
  Case "IA001D"
    MyFrmIA001D.Close()
  Case "ListGroup"
    MyfrmListgroup.Close()
  End Select
End Sub
Private Sub DoBtnDelete()
  Dim WrkCancel As Boolean
  MyFrmIA001C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmIA001C.MdiParent = MyFrmIA001B.ParentForm
  MyFrmIA001C.WrkGNETUSER = ""
  MyFrmIA001C.Show()
  MyFrmIA001B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmIA001B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  Select Case SbpScreen.Text
  Case Is = "IA001C"
    MyFrmIA001C.SaveData()
  Case Is = "IA001D"
    MyFrmIA001D.SaveData()
  End Select
End Sub

...
#End Region
  ...
  Private Sub FrmSignOn_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    End If
    If Trim(MyDBSettings.DatabaseName3) <> "" Then
      CboDatabase.Items.Add(MyDBSettings.DatabaseName3)
    End If
    If Trim(MyDBSettings.DatabaseName4) <> "" Then
      CboDatabase.Items.Add(MyDBSettings.DatabaseName4)
    End If

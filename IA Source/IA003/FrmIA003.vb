...
Friend WithEvents TBarFTP As System.Windows.Forms.ToolBarButton
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
Me.components = New System.ComponentModel.Container
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FRMIA003))
...
Me.TBarFTP = New System.Windows.Forms.ToolBarButton
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarPrint, Me.TBarSep2, Me.TBarFTP})
...
'TBarFTP
'
Me.TBarFTP.ImageIndex = 5
Me.TBarFTP.Name = "TBarFTP"
Me.TBarFTP.Text = "FTP"
'
'FRMIA003
'
...
Me.Text = "Gems Net Security Program Id Codes"
...
#End Region
  ...
  Private Sub FRMIA003_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      set_security() '#set
      MyFRMIA003B = New FrmIA003B
      MyFRMIA003B.MdiParent = Me
      MyFRMIA003B.Show()
  End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  If e.Button Is TBarSave Then
    DoBtnSave()
  End If
	If e.Button Is TBarFTP Then
		DoBtnFTP()
	End If
End Sub
Private Sub FrmIA003_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  ...
  MyFRMIA003C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFRMIA003C.Close()
  MyFRMIA003B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFRMIA003C = New FRMIA003C
  MyFRMIA003C.MdiParent = MyFRMIA003B.ParentForm
  MyFRMIA003C.WrkGNETPGM = ""
  MyFRMIA003C.Show()
  MyFRMIA003B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFRMIA003B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFRMIA003C.SaveData()
End Sub
Private Sub DoBtnFTP()
	MyFRMIA003D = New FrmIA003D
	MyFRMIA003D.MdiParent = MyFRMIA003B.ParentForm
	MyFRMIA003D.Show()
	MyFRMIA003B.Hide()
End Sub

...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(502, 350)
...
Private Sub FrmIA003B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub FormatGrid()
    ...
    With DataGrdView
      ...
      .RowHeadersWidth = 25
      .Columns(0).HeaderText = "Program Id"
      .Columns(0).Width = 65
      .Columns(1).HeaderText = "Description"
      .Columns(1).Width = 250
      .Columns(1).DefaultCellStyle.WrapMode = DataGridViewTriState.True
      .Columns(2).HeaderText = "App Id"
      .Columns(2).Width = 50
      .Columns(3).HeaderText = "Executable"
      .Columns(3).Width = 90
...
End Sub
Public Sub ShowGrid()
  ds = myGNETPGM.PosData(TxtPos.Text)
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
End Sub
Private Sub FrmIA003B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFRMIA003.SbpScreen.Text = "IA003B"
    MyFRMIA003.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    MyFRMIA003C.MdiParent = Me.ParentForm
    MyFRMIA003C.WrkGNETPGM = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    MyFRMIA003C.Show()
    Me.Hide()
End Sub
End Class

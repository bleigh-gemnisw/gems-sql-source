...
Public Class FrmIA002D
  ...
  Friend WrkWKGNETSEC As String
  Friend WrkGroup As String
  Friend WithEvents TxtPgmid As TextBox
...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.lblgname.Location = New System.Drawing.Point(500, 9)
    Me.lblgname.Name = "lblgname"
    Me.lblgname.Size = New System.Drawing.Size(336, 24)
    Me.lblgname.TabIndex = 20
    Me.lblgname.Text = "<lblgname>"
    Me.lblgname.TextAlign = System.Drawing.ContentAlignment.TopRight
    '
    'TxtPgmid
    '
    Me.TxtPgmid.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
    Me.TxtPgmid.Location = New System.Drawing.Point(74, 17)
    Me.TxtPgmid.Name = "TxtPgmid"
    Me.TxtPgmid.Size = New System.Drawing.Size(62, 20)
    Me.TxtPgmid.TabIndex = 21
    '
    'Label1
    '
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(142, 15)
...
#End Region
  ...
  Public Sub FormatGrid()
    ...
    With C1DataGrdList
      ...
      .Columns(9).ValueItems.Presentation = C1.Win.C1TrueDBGrid.PresentationEnum.CheckBox
      .Columns(9).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem(0, False)) ' checked
      .Columns(9).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem(1, True)) ' unchecked
      .Columns(9).ValueItems.Translate = True
      .Columns(9).Caption = "Post"
  ...
  Public Sub CreateGrid()
    ...
    For I = 0 To ds2.Tables(0).Rows.Count - 1
      ...
      myGNETSEC.GetOneRecordP(WrkGroup, Trim(ds2.Tables(0).Rows(I).Item("pgmid")))
  ...
  Public Sub SaveData()
    ...
    For I = 0 To (C1DataGrdList.Splits(0).Rows.Count - 1)
      ...
      If C1DataGrdList.Item(I, 8) = 1 Then
        sb.Append("E")
      End If
      If C1DataGrdList.Item(I, 9) = 1 Then
        sb.Append("P")
      End If
      ...
      If WrkRights <> String.Empty Then
        With myGNETSEC
          ._GRPID = WrkGroup
          ._PGMID = Trim(C1DataGrdList.Item(I, 1))
          ._PGMTYP = ""
          ._RIGHTS = WrkRights
          .AddOneRecordP()
        End With
  ...
  Private Sub BuildDS()
    ...
    With myTable
      .TableName = "mytable"
      .Columns.Add("grpid", Type.GetType("System.String"))
  ...
  Private Sub BtnFind_Click(sender As Object, e As EventArgs) Handles BtnFind.Click
    ...
    Windows.Forms.Cursor.Current = Cursors.WaitCursor()
    For I = 0 To (C1DataGrdList.Splits(0).Rows.Count - 1)
      If TxtPgmid.Text = Trim(C1DataGrdList.Item(I, 1)) Then
        C1DataGrdList.Row = I
        Exit For
      End If
    Next

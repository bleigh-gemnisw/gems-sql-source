...
Public Class TXINV
  ...
  'Const MyFileName As String = "TXINV"
  'Const MyFileName As String = "MUNINV"
  Const MyFileName As String = "NEWINV"
#Region "Constructors"
...
#Region "Methods: File Access Routines"
  Public Sub GetOneRecordP(ByVal Wrklistno As Integer, ByVal Wrkyear As Integer, ByVal Wrktype As String)
    ...
    StrSQL = "Select * from " & MyFileName & " where list# = " & Wrklistno & " and year = " & Wrkyear & " and type = " & "'" & Wrktype & "'"
    Try
  ...
  Public Sub AddOneRecordP()
    ...
    ds = Nothing
  End Sub
  Public Function AddBulk() As DataTable
    Dim CmdBldr As SqlCommandBuilder = New SqlCommandBuilder(da)
    Dim ds As DataSet = New DataSet
    Dim dr As DataRow
    Dim dt As DataTable
    ...
    Return dt
  End Function
  Public Sub AddBulkRecords(ByVal WrkTable As DataTable)
    Dim bulkinsert As New SqlBulkCopy(Conn)
    bulkinsert.DestinationTableName = MyFileName
    bulkinsert.WriteToServer(WrkTable)
  End Sub
  ...
  Public Sub InsertOneRecordP()
    ...
    StrSQL = "Insert into " & MyFileName & " values(" & ca &
...
#Region "Properties: Get/Put"
  Public Sub GetFields(ByVal ds As DataSet)
    ...
    End With
  End Sub
  Public Sub PutFields(ByRef ds As DataSet)
    With ds.Tables(0).Rows(0)
      .Item("ICODE") = _ICODE
      .Item("LIST#") = _LISTNo
      .Item("YEAR") = _YEAR

...
Public Class TXREAL
  ...
  Dim cFileName As String = "TXREALC"
  'Dim cFileName As String = "TXREAL"
#Region "Constructors"
...
#Region "Methods: File Access Routines"
  Public Sub GetOneRecordP(ByVal ListNo As Integer)
    ...
    End Try
  End Sub
  Public Sub GetOneRecordPLoc(ByVal WrkLoc As String, ByVal WrkLocno As String)
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet

    RecordNotFound = False
    StrSQL = "Select * from " & cFileName & " where loc = '" & WrkLoc & "' and loc#='" & WrkLocno & "'"
    Try
      objCommand = New SqlCommand(StrSQL, Conn)
      'Fill the dataset with the data
      da = New SqlDataAdapter

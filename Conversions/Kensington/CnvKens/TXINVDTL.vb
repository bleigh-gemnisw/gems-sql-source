...
#Region "Methods: File Access Routines"
  ...
  Public Sub GetYearTypePerCode(Wrkyear As Integer, ByVal Wrktype As String, ByVal Wrkperd As Integer, ByVal Wrkcode As String)
    ...
    End Try
  End Sub
  Public Function GetAllListYearTypeCode(ByVal WrkListNo As Integer, ByVal WrkYear As Integer, WrkType As String, ByVal WrkCode As String) As DataSet
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet
    ...
    Return ds
  End Function
  Public Function GetAllListYearType(ByVal WrkListNo As Integer, ByVal WrkYear As Integer, WrkType As String) As DataSet
    Dim objCommand As SqlCommand
    Dim ds As DataSet = New DataSet

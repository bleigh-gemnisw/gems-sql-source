...
Public Class DBConnection
  ...
  Public Function Open2() As SqlConnection
    ...
    Return Nothing
  End Function
  Public Function RunQuery(ByVal WrkFile As String, ByVal wrkWhere As String) As DataSet
  ...
  Public Sub DeleteRecords2(ByVal FileName As String, Optional ByVal wrkWhere As String = "")
    ...
    objCommand = Nothing
  End Sub
  Public Sub UpdateRecords2(ByVal FileName As String, ByVal wrkQry As String)
    Dim objCommand As SqlCommand
    Dim Result As Integer

    RecordNotFound = False
    StrSQL = "Update " & FileName & " " & wrkQry
    objCommand = New SqlCommand(StrSQL, MyConn2)
    objCommand.CommandTimeout = 300
    Result = objCommand.ExecuteNonQuery()
    objCommand = Nothing

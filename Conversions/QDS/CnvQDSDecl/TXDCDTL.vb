...
#Region "Methods: File Access Routines"
  ...
  Public Sub GetOneRecordP(ByVal Wrklistno As Integer, ByVal Wrkyear As Integer, ByVal Wrkcode As Integer, ByVal Wrkltr As String, ByVal Wrkdeyear As Integer)
    ...
    StrSQL = "Select * from " & MyFileName & " where list# = " & Wrklistno & " and year = " & Wrkyear & " and code = " & Wrkcode & " and ltr = " & "'" & Wrkltr & "'" & " and deyear = " & Wrkdeyear
    Try
  ...
  Public Function PosData(ByVal Wrklistno As Integer, ByVal Wrkyear As Integer, ByVal Wrkcode As Integer, ByVal Wrkltr As String, ByVal Wrkdeyear As Integer) As DataSet
    ...
    StrSQL = "Select * from " & MyFileName & " where list# = " & Wrklistno & " And year = " & Wrkyear & " And code = " & Wrkcode & " And ltr = " & "'" & Wrkltr & "'" & " And deyear >= " & Wrkdeyear & " Or list# = " & Wrklistno & " And year = " & Wrkyear & " And code = " & Wrkcode & " And ltr > " & "'" & Wrkltr & "'" & " Or list# = " & Wrklistno & " And year = " & Wrkyear & " And code > " & Wrkcode & " Or list# = " & Wrklistno & " And year > " & Wrkyear & " Or list# > " & Wrklistno & " Order by list#, year, code, ltr, deyear"
    objCommand = New SqlCommand(StrSQL, Conn)

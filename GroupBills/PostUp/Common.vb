...
Public Sub CrtTable(ByVal WrkTable As String)
  ...
  WrkSql = "CREATE TABLE " & WrkTable & " (" & _
    "RecID SMALLINT NOT NULL, Type varchar(1) default NULL," & _
    "Group1 varchar(50) default NULL, Group2 varchar(30) default NULL, IsCompany varchar(30) default null," & _
    ...
    "FirstName varchar(30) default NULL, LastName varchar(30) default NULL," & _
  ...
  '  sb.Append(", " & vbCrLf & SArray(I) & " varchar(35) default NULL")
  'Next

  'WrkSql = WrkSql & sb.ToString
  'WrkSql = WrkSql & ", " & vbCrLf & ")"
  WrkCmd = New SqlCommand(WrkSql, MyConn.MyConn)
  Try
...
Public Sub InsertRow(ByVal Counter As Integer, ByVal WrkTable As String, ByVal WrkType As String, ByVal RecArray() As String)
  ...
  WrkSql = "INSERT INTO " & WrkTable & " (RecID, Type, Group1, Group2, IsCompany, " & _
    "PostBarCode, PostEndorse, PostSort, GroupID, PostID," & _
  ...
  sb.Append("@PostBarCode, @PostEndorse, @PostSort, @GroupID, @PostID,")

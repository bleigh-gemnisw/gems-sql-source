...
Public Class AppSettings
  ...
  'LL 2026-03-04 ---start--- For QcCode.vb need this for the QrCode processing to add the QrCode to the end of the export records
  Private m_WebName As String
  Private m_WebPrefix As String
  Private m_WebScript As String
  Private m_WebSuffix As String
  'LL 2026-03-04 ---end--- For QcCode.vb need this for the QrCode processing to add the QrCode to the end of the export records
  ...
  Public Property WebSuffix As String
    Get
      Return m_WebSuffix
    End Get
    Set(value As String)

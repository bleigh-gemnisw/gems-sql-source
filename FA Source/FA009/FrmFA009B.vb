...
Private Sub FrmFA009B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
  Public Sub ShowGrid()
    ...
    myFAEQUP.CloseFile()
  End Sub
  Private Sub FrmFA009B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA009.SbpScreen.Text = "FA009B"
  MyFrmFA009.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmFA009C.MdiParent = Me.ParentForm
  MyFrmFA009C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmFA009C.Show()
  Me.Hide()
End Sub
End Class

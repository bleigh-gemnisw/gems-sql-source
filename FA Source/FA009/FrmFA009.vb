...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA009))
...
Me.Text = "Maintain Equipment Condition Codes"
...
Private Sub FrmFA009_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmFA009B = New FrmFA009B
  MyFrmFA009B.MdiParent = Me
  MyFrmFA009B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA009_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA009B" Then
    MyFrmFA009.Close()
  Else
    MyFrmFA009C.Close()
    MyFrmFA009B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmFA009C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmFA009C.Close()
  MyFrmFA009B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmFA009C = New FrmFA009C
  MyFrmFA009C.MdiParent = MyFrmFA009B.ParentForm
  MyFrmFA009C.WrkCode = ""
  MyFrmFA009C.Show()
  MyFrmFA009B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmFA009B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmFA009C.SaveData()
End Sub

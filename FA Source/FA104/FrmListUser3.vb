...
#Region " Windows Form Designer generated code "
    ...
    Me.Name = "FrmListUser3"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Select User 3"
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = myFAUSER3.PosData(TxtPos.Text)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListUser3_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA104.SbpScreen.Text = "ListUser3"
  End Sub
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListUser3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFAUSER3 = New FAUSER3.MyData()
    myFAUSER3.MyDBConn = myDBConnect
    LblCurrent.Text = "(" & WrkField & " User 3 =" & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmFA104B
      If WrkField = "From" Then
        .TxtUser3From.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtUser3From, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtUser3To.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtUser3To, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

...
#Region " Windows Form Designer generated code "
    ...
    Me.Text = "Select Equipment Condition"
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = myFAEQUP.PosData(TxtPos.Text)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListEqup_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA104.SbpScreen.Text = "ListEqup"
  End Sub
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListEqup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFAEQUP = New FAEQUP.MyData()
    myFAEQUP.MyDBConn = myDBConnect
    LblCurrent.Text = "(" & WrkField & " Equip Cond =" & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmFA104B
      If WrkField = "From" Then
        .TxtEqupFrom.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtEqupFrom, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtEqupTo.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtEqupTo, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

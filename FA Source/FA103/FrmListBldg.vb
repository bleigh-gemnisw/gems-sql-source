...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(11, 59)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(293, 255)
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = myFABLDG.PosData(TxtPos.Text)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListBldg_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA103.SbpScreen.Text = "ListBldg"
  End Sub
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListBldg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFABLDG = New FABLDG.MyData()
    myFABLDG.MyDBConn = myDBConnect
    LblCurrent.Text = "(" & WrkField & " Location =" & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmFA103B
      If WrkField = "From" Then
        .TxtBldgFrom.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtBldgFrom, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtBldgTo.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtBldgTo, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

...
Done:
  ...
  Private Sub GetDetail()
    ...
    End If
    If MyFrmFA103B.RbFundBusiness.Checked Then
      WrkQry = WrkQry & WrkAnd & "FAGOV<>'Y'"
    End If
    If MyFrmFA103B.RbFundGovernment.Checked Then
      WrkQry = WrkQry & WrkAnd & "FAGOV='Y'"
    End If
    If MyFrmFA103B.RbDeprYes.Checked Then
      WrkQry = WrkQry & WrkAnd & "FANDEP<>'Y'"
    End If
    If MyFrmFA103B.RbDeprNon.Checked Then
      WrkQry = WrkQry & WrkAnd & "FANDEP='Y'"
    End If
    If MyFrmFA103B.RbAssetsReport.Checked Then
      WrkQry = WrkQry & WrkAnd & "FANREP<>'Y'"
    End If
    If MyFrmFA103B.RbAssetsNon.Checked Then
      WrkQry = WrkQry & WrkAnd & "FANREP='Y'"
    End If

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA005))
...
Private Sub FrmFA005_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmFA005B = New FrmFA005B
  MyFrmFA005B.MdiParent = Me
  MyFrmFA005B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA005_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA005B" Then
    MyFrmFA005.Close()
  Else
    MyFrmFA005C.Close()
    MyFrmFA005B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmFA005C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmFA005C.Close()
  MyFrmFA005B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmFA005C = New FrmFA005C
  MyFrmFA005C.MdiParent = MyFrmFA005B.ParentForm
  MyFrmFA005C.WrkCode = ""
  MyFrmFA005C.Show()
  MyFrmFA005B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmFA005B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmFA005C.SaveData()
End Sub

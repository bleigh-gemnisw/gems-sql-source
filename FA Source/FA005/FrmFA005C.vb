...
#End Region
  ...
  Private Sub FrmFA005C_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFACLASS = New FACLASS.MyData()
    myFACLASS.MyDBConn = myDBConnect
    MyFrmFA005.TBarNew.Enabled = False
    MyFrmFA005.TBarSave.Enabled = True
    If WrkCode <> "" Then
      MyFrmFA005.TBarDelete.Enabled = True
      MyUtils.SetTxtReadOnly(TxtCode)
    End If
    MyFrmFA005.TBarPrint.Enabled = False
    myFACLASS.GetOneRecordP(WrkCode)
    TxtCode.Text = WrkCode
    If myFACLASS.RecordNotFound Then Exit Sub
    If s_chg = False And s_full = False Then    '#sec
      MyFrmFA005.TBarSave.Visible = False
    End If
    With myFACLASS
      TxtDesc.Text = Trim(._CLDESC)
    End With
  End Sub
  Private Sub FrmFA005C_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA005.SbpScreen.Text = "FA005C"
  MyUtils.CenterForm(Me.ParentForm, Me)
End Sub
Private Sub FrmFA005C_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  MyFrmFA005.TBarNew.Enabled = True
  MyFrmFA005.TBarDelete.Enabled = False
  MyFrmFA005.TBarSave.Enabled = False
  MyFrmFA005.TBarPrint.Enabled = False
  MyFrmFA005.TBarSave.Visible = True   '#sec
  MyFrmFA005B.FormatGrid()
  MyFrmFA005B.Show()
End Sub
Public Sub DeleteData(ByRef WrkCancel As Boolean)
  ...
  End If
  WrkCancel = False
	myFACLASS.DeleteOneRecordP()
  Me.Close()
End Sub
Public Sub SaveData()
	Dim ErrorField(25) As String
	Dim ErrorMsg(25) As String
	myFACLASS.GetOneRecordP(TxtCode.Text)
	If WrkCode = "" Then
	...
	If WrkCode <> "" Then
		...
		If IsNothing(ErrorMsg(0)) Then
			myFACLASS.UpdateOneRecordP()
		Else
			ShowError(ErrorField, ErrorMsg)
			Exit Sub
		End If
	Else
		myFACLASS._CLCODE = TxtCode.Text
		MovetoFile()
		EditChecks(ErrorField, ErrorMsg)
		If IsNothing(ErrorMsg(0)) Then
			myFACLASS.AddOneRecordP()
		Else
			ShowError(ErrorField, ErrorMsg)
			Exit Sub
		End If

...
Private Sub FrmFA005B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
  Public Sub ShowGrid()
    ...
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmFA005B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA005.SbpScreen.Text = "FA005B"
  MyFrmFA005.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmFA005C.MdiParent = Me.ParentForm
  MyFrmFA005C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmFA005C.Show()
  Me.Hide()
End Sub
End Class

...
#Region " Windows Form Designer generated code "
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(126, 5)
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(277, 344)
    Me.DataGrdView.TabIndex = 20
    '
    'FrmFA002B
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(304, 400)
    Me.ControlBox = False
...
#End Region
  ...
  Private Sub FrmFA002B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
  Public Sub ShowGrid()
    ...
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmFA002B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA002.SbpScreen.Text = "FA002B"
  MyFrmFA002.TBarPrint.Enabled = True
...
Private Sub DataGrdview_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmFA002C.MdiParent = Me.ParentForm
  MyFrmFA002C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmFA002C.Show()
  Me.Hide()
End Sub
End Class

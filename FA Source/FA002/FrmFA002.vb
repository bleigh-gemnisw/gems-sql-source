...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA002))
...
Me.Text = "Maintain Acquistion Codes"
...
Private Sub FrmFA002_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmFA002B = New FrmFA002B
   MyFrmFA002B.MdiParent = Me
   MyFrmFA002B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA002_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA002B" Then
    MyFrmFA002.Close()
  Else
    MyFrmFA002C.Close()
    MyFrmFA002B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmFA002C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmFA002C.Close()
  MyFrmFA002B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmFA002C = New FrmFA002C
  MyFrmFA002C.MdiParent = MyFrmFA002B.ParentForm
  MyFrmFA002C.WrkCode = ""
  MyFrmFA002C.Show()
  MyFrmFA002B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmFA002B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmFA002C.SaveData()
End Sub

...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.ClientSize = New System.Drawing.Size(286, 326)
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListUser1_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA001.SbpScreen.Text = "ListUser1"
  End Sub
  ...
  Private Sub FrmListUser1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    LblCurrent.Text = "(User 1 =" & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmFA001C
      .TxtUser1.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .Ttp1.SetToolTip(.TxtUser1, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With

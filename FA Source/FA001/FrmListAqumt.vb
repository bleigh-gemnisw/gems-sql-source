...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.ClientSize = New System.Drawing.Size(300, 326)
    ...
    Me.Name = "FrmListAqumt"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Select Acquisition Code"
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = MyFAAQUMT.PosData(TxtPos.Text)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListAqumt_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA001.SbpScreen.Text = "ListAqumt"
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListAqumt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    SaveDelete = MyFrmFA001.TBarDelete.Enabled
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  With MyFrmFA001C
    .TxtAqumt.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    .Ttp1.SetToolTip(.TxtAqumt, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
  End With
...
End Sub
Private Sub FrmListAqumt_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    MyFrmFA001.TBarDelete.Enabled = SaveDelete

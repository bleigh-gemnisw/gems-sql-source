...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(261, 260)
    ...
    Me.Name = "FrmListDspmt"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Select Disposal Code"
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = MyFADSPMT.PosData(TxtPos.Text)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListDspmt_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA001.SbpScreen.Text = "ListDspmt"
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListDspmt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  With MyFrmFA001C
    .TxtDspmt.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    .Ttp1.SetToolTip(.TxtDspmt, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
  End With
...
End Sub
Private Sub FrmListDspmt_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed

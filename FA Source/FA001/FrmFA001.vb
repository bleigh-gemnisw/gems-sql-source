...
Friend WithEvents TBarComments As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA001))
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarComments, Me.TBarSettings})
    ...
    Me.ImageList1.Images.SetKeyName(4, "comment_24.png")
    '
    'SbMain
    '
    ...
    Me.Text = "Maintain Fixed Asset Master"
...
Private Sub FrmFA001_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "FA001"
  TBarSave.Enabled = False
  TBarDelete.Enabled = False
  TBarComments.Enabled = False
  set_security() '#set
  MyFrmFA001B = New FrmFA001B
  MyFrmFA001B.MdiParent = Me
  MyFrmFA001B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA001_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  ...
  Case "Comments"
    ...
    MyFrmFA001C.Show()
  Case "ListAqumt"
    MyFrmListAqumt.Close()
    MyFrmFA001C.Show()
  Case "ListAsType"
    MyFrmListAstype.Close()
    MyFrmFA001C.Show()
  Case "ListBldg"
    MyFrmListBldg.Close()
    MyFrmFA001C.Show()
  Case "ListClass"
    MyFrmListClass.Close()
    MyFrmFA001C.Show()
  Case "ListDept"
    MyFrmListDept.Close()
    MyFrmFA001C.Show()
  Case "ListDspmt"
    MyFrmListDspmt.Close()
    MyFrmFA001C.Show()
  Case "ListEqup"
    MyFrmListEqup.Close()
    MyFrmFA001C.Show()
  Case "ListUser1"
    MyFrmListUser1.Close()
    MyFrmFA001C.Show()
  Case "ListUser2"
    MyFrmListUser2.Close()
    MyFrmFA001C.Show()
  Case "ListUser3"
    MyFrmListUser3.Close()
    MyFrmFA001C.Show()
  End Select
End Sub
Private Sub DoBtnDelete()
  Dim WrkCancel As Boolean
  MyFrmFA001C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmFA001C.MdiParent = MyFrmFA001B.ParentForm
  MyFrmFA001C.WrkTagNo = ""
  MyFrmFA001C.AddMode = True
  MyFrmFA001C.Show()
  MyFrmFA001B.Hide()
End Sub
Private Sub DoBtnComments()
    MyFrmComments = New FrmComments
    MyFrmComments.MdiParent = MyFrmFA001C.ParentForm
    MyFrmComments.WrkTagNo = MyFrmFA001C.TxtTagNo.Text
    MyFrmComments.Show()
    MyFrmFA001C.Hide()
End Sub

...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.LblCurrent.Location = New System.Drawing.Point(13, 35)
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(276, 260)
...
#End Region
  ...
  Private Sub FrmListAstype_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA001.SbpScreen.Text = "ListAsType"
  End Sub
  ...
  Private Sub FrmListAstype_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    LblCurrent.Text = "(Asset Type =" & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmFA001C
      .TxtAstype.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .Ttp1.SetToolTip(.TxtAstype, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With

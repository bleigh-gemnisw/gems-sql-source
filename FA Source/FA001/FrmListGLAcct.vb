...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(497, 260)
...
#End Region
  ...
  Private Sub FrmListGLAcct_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA001.SbpScreen.Text = "ListGLAcct"
  End Sub
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmFA001C
      If WrkField = "1" Then
        .TxtFnd.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TxtSfnd.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
        .TxtDpt.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
        ...
        .Ttp1.SetToolTip(.TxtFnd, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtFnd2.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TxtSfn2.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
        .TxtDpt2.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
        .TxtObj2.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
        .TxtFcn2.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
        .TxtSfc2.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtFnd2, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(282, 260)
...
#End Region
  ...
  Private Sub FrmListCCReason_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA001.SbpScreen.Text = "ListBldg"
  End Sub
  ...
  Private Sub FrmListCCReason_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    LblCurrent.Text = "(Location =" & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmFA001C
      .TxtBldg.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .Ttp1.SetToolTip(.TxtBldg, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With

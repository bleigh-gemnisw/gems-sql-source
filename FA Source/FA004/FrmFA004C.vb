...
Me.Name = "FrmFA004C"
Me.Text = "Maintain Building Code"
...
#End Region
  ...
  Private Sub FrmFA004C_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFABLDG = New FABLDG.MyData()
    myFABLDG.MyDBConn = myDBConnect
    MyFrmFA004.TBarNew.Enabled = False
    MyFrmFA004.TBarSave.Enabled = True
    If WrkCode <> "" Then
      MyFrmFA004.TBarDelete.Enabled = True
      MyUtils.SetTxtReadOnly(TxtCode)
    End If
    MyFrmFA004.TBarPrint.Enabled = False
    myFABLDG.GetOneRecordP(WrkCode)
    TxtCode.Text = WrkCode
    If myFABLDG.RecordNotFound Then Exit Sub
    If s_chg = False And s_full = False Then    '#sec
      MyFrmFA004.TBarSave.Visible = False
    End If
    With myFABLDG
      TxtDesc.Text = Trim(._BLDESC)
    End With
  End Sub
  Private Sub FrmFA004C_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA004.SbpScreen.Text = "FA004C"
  MyUtils.CenterForm(Me.ParentForm, Me)
End Sub
Private Sub FrmFA004C_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  MyFrmFA004.TBarNew.Enabled = True
  MyFrmFA004.TBarDelete.Enabled = False
  MyFrmFA004.TBarSave.Enabled = False
  MyFrmFA004.TBarPrint.Enabled = False
  MyFrmFA004.TBarSave.Visible = True   '#sec
  MyFrmFA004B.FormatGrid()
  MyFrmFA004B.Show()
End Sub
Public Sub DeleteData(ByRef WrkCancel As Boolean)
  ...
  End If
  WrkCancel = False
	myFABLDG.DeleteOneRecordP()
  Me.Close()
End Sub
Public Sub SaveData()
	Dim ErrorField(25) As String
	Dim ErrorMsg(25) As String
	myFABLDG.GetOneRecordP(TxtCode.Text)
	If WrkCode = "" Then
	...
	If WrkCode <> "" Then
		...
		If IsNothing(ErrorMsg(0)) Then
			myFABLDG.UpdateOneRecordP()
		Else
			ShowError(ErrorField, ErrorMsg)
			Exit Sub
		End If
	Else
		myFABLDG._BLCODE = TxtCode.Text
		MovetoFile()
		EditChecks(ErrorField, ErrorMsg)
		If IsNothing(ErrorMsg(0)) Then
			myFABLDG.AddOneRecordP()
		Else
			ShowError(ErrorField, ErrorMsg)
			Exit Sub
		End If

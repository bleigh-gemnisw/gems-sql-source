...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA004))
...
Me.Text = "Maintain Building Codes"
...
Private Sub FrmFA004_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmFA004B = New FrmFA004B
  MyFrmFA004B.MdiParent = Me
  MyFrmFA004B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA004_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA004B" Then
    MyFrmFA004.Close()
  Else
    MyFrmFA004C.Close()
    MyFrmFA004B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmFA004C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmFA004C.Close()
  MyFrmFA004B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmFA004C = New FrmFA004C
  MyFrmFA004C.MdiParent = MyFrmFA004B.ParentForm
  MyFrmFA004C.WrkCode = ""
  MyFrmFA004C.Show()
  MyFrmFA004B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmFA004B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmFA004C.SaveData()
End Sub

...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(10, 44)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(335, 344)
...
#End Region
  ...
  Private Sub FrmFA004B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
  Public Sub ShowGrid()
    ...
    myFABLDG.CloseFile()
  End Sub
  Private Sub FrmFA004B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA004.SbpScreen.Text = "FA004B"
  MyFrmFA004.TBarPrint.Enabled = True
...
Private Sub DataGrdview_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmFA004C.MdiParent = Me.ParentForm
  MyFrmFA004C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmFA004C.Show()
  Me.Hide()
End Sub
End Class

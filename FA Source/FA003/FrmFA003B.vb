...
#Region " Windows Form Designer generated code "
    ...
    Me.ClientSize = New System.Drawing.Size(424, 400)
    Me.ControlBox = False
...
Private Sub FrmFA003B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
  Public Sub FormatGrid()
    ...
    With DataGrdView
      ...
      .Columns(1).Width = 200
      .Columns(2).HeaderText = "Threshold"
      .Columns(2).Width = 60
      .Columns(2).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
      .Columns(3).HeaderText = "Years"
      .Columns(3).Width = 40
  ...
  Public Sub ShowGrid()
    ...
    DataGrdView.Refresh()
    myFAASTYPE.CloseFile()
  End Sub
  Private Sub FrmFA003B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA003.SbpScreen.Text = "FA003B"
  MyFrmFA003.TBarPrint.Enabled = True
...
Private Sub DataGrdview_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmFA003C = New FrmFA003C
  MyFrmFA003C.MdiParent = Me.ParentForm
  MyFrmFA003C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmFA003C.Show()
  Me.Hide()
End Sub
End Class

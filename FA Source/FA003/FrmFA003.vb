...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA003))
...
Private Sub FrmFA003_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmFA003B = New FrmFA003B
  MyFrmFA003B.MdiParent = Me
  MyFrmFA003B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA003_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA003B" Then
    MyFrmFA003.Close()
  Else
    MyFrmFA003C.Close()
    MyFrmFA003B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmFA003C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmFA003C.MdiParent = MyFrmFA003B.ParentForm
  MyFrmFA003C.WrkCode = ""
  MyFrmFA003C.Show()
  MyFrmFA003B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmFA003B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmFA003C.SaveData()
End Sub

...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents ChkInclDsp As System.Windows.Forms.CheckBox
...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA100B))
...
Me.ChkInclDsp = New System.Windows.Forms.CheckBox
...
Me.TpMain.Controls.Add(Me.ChkInclDsp)
...
'ChkInclDsp
'
Me.ChkInclDsp.AutoSize = True
Me.ChkInclDsp.Location = New System.Drawing.Point(347, 273)
Me.ChkInclDsp.Name = "ChkInclDsp"
Me.ChkInclDsp.Size = New System.Drawing.Size(141, 17)
Me.ChkInclDsp.TabIndex = 7
Me.ChkInclDsp.Text = "Include Disposed items?"
Me.ChkInclDsp.UseVisualStyleBackColor = True
'
'GroupBox1
'
...
Me.TbSelections.Size = New System.Drawing.Size(660, 356)
...
#End Region
  ...
  End Sub
Private Sub FrmFA100B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
Private Sub FrmFA100B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA100.SbpScreen.Text = "FA100B"
End Sub
Private Sub FrmFA100B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub

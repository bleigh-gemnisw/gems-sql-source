...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtFA100.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds1)
    .SetParameterValue("myreportTitle", "Fixed Assets List" & WrkSortby)
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtFA100L.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetDataSource(Wrkds1)
    .SetParameterValue("myreportTitle", "Fixed Assets List" & WrkSortby)
  ...
  Private Sub RunReport3()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtFA100Tot.rpt", myTOWN._TOWNBR)
   With myreport3
    .Load(ReportPath)
  ...
  Private Sub RunReport4()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtFA100Sel.rpt", myTOWN._TOWNBR)
   With myreport4
    .Load(ReportPath)
    .SetParameterValue("myreportTitle", "Fixed Assets List" & WrkSortby)
    .SetParameterValue("MyUserID", MyUserID)

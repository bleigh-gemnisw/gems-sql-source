Public Class FrmCrViewer
  ...
  Friend WrkExpirationDate As String
...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtFA102.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds1)
    .SetParameterValue("myreportTitle", "Fixed Assets Replacements" & WrkSortby)
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyExpirationDate", WrkExpirationDate)
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtFA102Sel.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetParameterValue("myreportTitle", "Fixed Assets Replacements" & WrkSortby)
    .SetParameterValue("MyUserID", MyUserID)

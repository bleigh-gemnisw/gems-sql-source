...
Private Sub FrmFA011B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
  Public Sub ShowGrid()
    ...
    myFAUSER2.CloseFile()
  End Sub
  Private Sub FrmFA011B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA011.SbpScreen.Text = "FA011B"
  MyFrmFA011.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmFA011C.MdiParent = Me.ParentForm
  MyFrmFA011C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmFA011C.Show()
  Me.Hide()
End Sub
End Class

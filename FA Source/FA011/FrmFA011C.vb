...
#End Region
  ...
  Private Sub FrmFA011C_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFAUSER2 = New FAUSER2.MyData()
    myFAUSER2.MyDBConn = myDBConnect
    MyFrmFA011.TBarNew.Enabled = False
    MyFrmFA011.TBarSave.Enabled = True
    If WrkCode <> "" Then
      MyFrmFA011.TBarDelete.Enabled = True
      MyUtils.SetTxtReadOnly(TxtCode)
    End If
    MyFrmFA011.TBarPrint.Enabled = False
    myFAUSER2.GetOneRecordP(WrkCode)
    TxtCode.Text = WrkCode
    If myFAUSER2.RecordNotFound Then Exit Sub
    If s_chg = False And s_full = False Then    '#sec
      MyFrmFA011.TBarSave.Visible = False
    End If
    With myFAUSER2
      TxtDesc.Text = Trim(._U2DESC)
    End With
  End Sub
  Private Sub FrmFA011C_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA011.SbpScreen.Text = "FA011C"
  MyUtils.CenterForm(Me.ParentForm, Me)
End Sub
Private Sub FrmFA011C_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  MyFrmFA011.TBarNew.Enabled = True
  MyFrmFA011.TBarDelete.Enabled = False
  MyFrmFA011.TBarSave.Enabled = False
  MyFrmFA011.TBarPrint.Enabled = False
  MyFrmFA011.TBarSave.Visible = True   '#sec
  MyFrmFA011B.FormatGrid()
  MyFrmFA011B.Show()
End Sub
Public Sub DeleteData(ByRef WrkCancel As Boolean)
  ...
  End If
  WrkCancel = False
	myFAUSER2.DeleteOneRecordP()
  Me.Close()
End Sub
Public Sub SaveData()
	Dim ErrorField(25) As String
	Dim ErrorMsg(25) As String
	myFAUSER2.GetOneRecordP(TxtCode.Text)
	If WrkCode = "" Then
	...
	If WrkCode <> "" Then
		...
		If IsNothing(ErrorMsg(0)) Then
			myFAUSER2.UpdateOneRecordP()
		Else
			ShowError(ErrorField, ErrorMsg)
			Exit Sub
		End If
	Else
		myFAUSER2._U2CODE = TxtCode.Text
		MovetoFile()
		EditChecks(ErrorField, ErrorMsg)
		If IsNothing(ErrorMsg(0)) Then
			myFAUSER2.AddOneRecordP()
		Else
			ShowError(ErrorField, ErrorMsg)
			Exit Sub
		End If

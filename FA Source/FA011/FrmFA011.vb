...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA011))
...
Private Sub FrmFA011_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmFA011B = New FrmFA011B
  MyFrmFA011B.MdiParent = Me
  MyFrmFA011B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA011_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA011B" Then
    MyFrmFA011.Close()
  Else
    MyFrmFA011C.Close()
    MyFrmFA011B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmFA011C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmFA011C.Close()
  MyFrmFA011B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmFA011C = New FrmFA011C
  MyFrmFA011C.MdiParent = MyFrmFA011B.ParentForm
  MyFrmFA011C.WrkCode = ""
  MyFrmFA011C.Show()
  MyFrmFA011B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmFA011B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmFA011C.SaveData()
End Sub

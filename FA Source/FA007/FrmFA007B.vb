...
#End Region
  ...
  Private Sub FrmFA007B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
  Public Sub ShowGrid()
    ...
    myFADEPT.CloseFile()
  End Sub
  Private Sub FrmFA007B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA007.SbpScreen.Text = "FA007B"
  MyFrmFA007.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmFA007C.MdiParent = Me.ParentForm
  MyFrmFA007C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmFA007C.Show()
  Me.Hide()
End Sub
End Class

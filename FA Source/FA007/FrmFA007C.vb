...
Me.Name = "FrmFA007C"
Me.Text = "Maintain Department Code"
...
#End Region
  ...
  Private Sub FrmFA007C_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFADEPT = New FADEPT.MyData()
    myFADEPT.MyDBConn = myDBConnect
    MyFrmFA007.TBarNew.Enabled = False
    MyFrmFA007.TBarSave.Enabled = True
    If WrkCode <> "" Then
      MyFrmFA007.TBarDelete.Enabled = True
      MyUtils.SetTxtReadOnly(TxtCode)
    End If
    MyFrmFA007.TBarPrint.Enabled = False
    myFADEPT.GetOneRecordP(WrkCode)
    TxtCode.Text = WrkCode
    If myFADEPT.RecordNotFound Then Exit Sub
    If s_chg = False And s_full = False Then    '#sec
      MyFrmFA007.TBarSave.Visible = False
    End If
    With myFADEPT
      TxtDesc.Text = Trim(._DEDESC)
    End With
  End Sub
  Private Sub FrmFA007C_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA007.SbpScreen.Text = "FA007C"
  MyUtils.CenterForm(Me.ParentForm, Me)
End Sub
Private Sub FrmFA007C_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  MyFrmFA007.TBarNew.Enabled = True
  MyFrmFA007.TBarDelete.Enabled = False
  MyFrmFA007.TBarSave.Enabled = False
  MyFrmFA007.TBarPrint.Enabled = False
  MyFrmFA007.TBarSave.Visible = True   '#sec
  MyFrmFA007B.FormatGrid()
  MyFrmFA007B.Show()
End Sub
Public Sub DeleteData(ByRef WrkCancel As Boolean)
  ...
  End If
  WrkCancel = False
	myFADEPT.DeleteOneRecordP()
  Me.Close()
End Sub
Public Sub SaveData()
	Dim ErrorField(25) As String
	Dim ErrorMsg(25) As String
	myFADEPT.GetOneRecordP(TxtCode.Text)
	If WrkCode = "" Then
	...
	If WrkCode <> "" Then
		...
		If IsNothing(ErrorMsg(0)) Then
			myFADEPT.UpdateOneRecordP()
		Else
			ShowError(ErrorField, ErrorMsg)
			Exit Sub
		End If
	Else
		myFADEPT._DECODE = TxtCode.Text
		MovetoFile()
		EditChecks(ErrorField, ErrorMsg)
		If IsNothing(ErrorMsg(0)) Then
			myFADEPT.AddOneRecordP()
		Else
			ShowError(ErrorField, ErrorMsg)
			Exit Sub
		End If

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA007))
...
Me.Text = "Maintain Department Codes"
...
Private Sub FrmFA007_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmFA007B = New FrmFA007B
  MyFrmFA007B.MdiParent = Me
  MyFrmFA007B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA007_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA007B" Then
    MyFrmFA007.Close()
  Else
    MyFrmFA007C.Close()
    MyFrmFA007B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmFA007C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmFA007C.Close()
  MyFrmFA007B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmFA007C = New FrmFA007C
  MyFrmFA007C.MdiParent = MyFrmFA007B.ParentForm
  MyFrmFA007C.WrkCode = ""
  MyFrmFA007C.Show()
  MyFrmFA007B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmFA007B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmFA007C.SaveData()
End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA008))
...
Me.Text = "Maintain Disposition Codes"
...
Private Sub FrmFA008_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmFA008B = New FrmFA008B
  MyFrmFA008B.MdiParent = Me
  MyFrmFA008B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA008_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA008B" Then
    MyFrmFA008.Close()
  Else
    MyFrmFA008C.Close()
    MyFrmFA008B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmFA008C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmFA008C.Close()
  MyFrmFA008B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmFA008C = New FrmFA008C
  MyFrmFA008C.MdiParent = MyFrmFA008B.ParentForm
  MyFrmFA008C.WrkCode = ""
  MyFrmFA008C.Show()
  MyFrmFA008B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmFA008B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmFA008C.SaveData()
End Sub

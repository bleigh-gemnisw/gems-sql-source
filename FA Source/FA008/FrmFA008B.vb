...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(333, 344)
...
#End Region
  ...
  Private Sub FrmFA008B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
  Public Sub ShowGrid()
    ...
    myFADSPMT.CloseFile()
  End Sub
  Private Sub FrmFA008B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA008.SbpScreen.Text = "FA008B"
  MyFrmFA008.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmFA008C.MdiParent = Me.ParentForm
  MyFrmFA008C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmFA008C.Show()
  Me.Hide()
End Sub
End Class

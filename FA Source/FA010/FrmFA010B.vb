...
#End Region
  ...
  Private Sub FrmFA010B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
  Public Sub ShowGrid()
    ...
    myFAUSER1.CloseFile()
  End Sub
  Private Sub FrmFA010B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA010.SbpScreen.Text = "FA010B"
  MyFrmFA010.TBarPrint.Enabled = True
...
Private Sub DataGrdview_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmFA010C.MdiParent = Me.ParentForm
  MyFrmFA010C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmFA010C.Show()
  Me.Hide()
End Sub
End Class

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA010))
...
Private Sub FrmFA010_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmFA010B = New FrmFA010B
  MyFrmFA010B.MdiParent = Me
  MyFrmFA010B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA010_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA010B" Then
    MyFrmFA010.Close()
  Else
    MyFrmFA010C.Close()
    MyFrmFA010B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmFA010C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmFA010C.Close()
  MyFrmFA010B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmFA010C = New FrmFA010C
  MyFrmFA010C.MdiParent = MyFrmFA010B.ParentForm
  MyFrmFA010C.WrkCode = ""
  MyFrmFA010C.Show()
  MyFrmFA010B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmFA010B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmFA010C.SaveData()
End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA006))
...
Me.TbMain.Size = New System.Drawing.Size(328, 50)
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 210)
...
Me.SbMain.Size = New System.Drawing.Size(328, 28)
...
Me.Text = "Fixed Assets Control File"
...
#End Region
  ...
  Private Sub FrmFA006_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmFA006B = New FrmFA006B
    MyFrmFA006B.MdiParent = Me
    MyFrmFA006B.Show()
  End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA006_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA006B" Then
    MyFrmFA006.Close()
  Else
    MyFrmFA006B.Show()
  End If

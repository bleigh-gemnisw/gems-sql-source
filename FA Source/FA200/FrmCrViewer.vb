Public Class FrmCrViewer
  ...
  Friend WrkFiscalYear As Integer
  Friend WrkFunded As String
  ...
  Friend WithEvents TabPgLegal As System.Windows.Forms.TabPage
  Friend WithEvents Crv2 As CrystalDecisions.Windows.Forms.CrystalReportViewer
  Dim WrkDepr As String
...
Me.TabCtl1.Controls.Add(Me.TabPgLegal)
...
'TabPgLegal
'
Me.TabPgLegal.Controls.Add(Me.Crv2)
Me.TabPgLegal.Location = New System.Drawing.Point(4, 22)
Me.TabPgLegal.Name = "TabPgLegal"
Me.TabPgLegal.Size = New System.Drawing.Size(648, 354)
Me.TabPgLegal.TabIndex = 3
Me.TabPgLegal.Text = "Detail - Legal Size"
Me.TabPgLegal.UseVisualStyleBackColor = True
'
'Crv2
'
...
Me.TabPgLegal.ResumeLayout(False)
...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtFA200.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds1)
    .SetParameterValue("myreportTitle", "Depreciation Report" & WrkSortby)
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyAsofDate", WrkAsofDate)
    .SetParameterValue("MyFiscalYear", WrkFiscalYear)
    .SetParameterValue("MyFunded", WrkFunded)
    .SetParameterValue("MyPost", WrkPost)
    .SetParameterValue("MyDepr", WrkDepr)
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtFA200L.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetDataSource(Wrkds1)
    .SetParameterValue("myreportTitle", "Depreciation Report" & WrkSortby)
  ...
  Private Sub RunReport3()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtFA200Tot.rpt", myTOWN._TOWNBR)
   With myreport3
    .Load(ReportPath)
  ...
  Private Sub RunReport4()
   ...
   With MyFrmFA200B
     ...
     If .DtPckAcqTo.Checked Then
       ...
       End If
     End If
     If .DtPckDspFrom.Checked Then
       WrkDspRange = "From: " & .DtPckDspFrom.Value & "  To: " & .DtPckDspTo.Value
     End If
     If .DtPckDspTo.Checked Then
       If WrkDspRange = "" Then
         WrkDspRange = "To: " & .DtPckDspTo.Value
       Else
         WrkDspRange = WrkDspRange & "  To: " & .DtPckDspTo.Value
       End If
     End If
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtFA200Sel.rpt", myTOWN._TOWNBR)
   With myreport4
    .Load(ReportPath)
    .SetParameterValue("myreportTitle", "Depreciation Report" & WrkSortby)
    .SetParameterValue("MyUserID", MyUserID)
    ...
    .SetParameterValue("MyDspRange", WrkDspRange)

...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(289, 260)
    ...
    Me.Name = "FrmListAsType"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Select Asset Type"
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = myFAASTYPE.PosData(TxtPos.Text)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListAstype_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA200.SbpScreen.Text = "ListAsType"
  End Sub
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListAstype_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFAASTYPE = New FAASTYPE.MyData()
    myFAASTYPE.MyDBConn = myDBConnect
    LblCurrent.Text = "(" & WrkField & " Asset Type =" & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmFA200B
      If WrkField = "From" Then
        .TxtAsTypeFrom.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtAsTypeFrom, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtAsTypeTo.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtAsTypeTo, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

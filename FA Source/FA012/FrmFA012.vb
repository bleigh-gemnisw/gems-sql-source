...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFA012))
...
Private Sub FrmFA012_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmFA012B = New FrmFA012B
  MyFrmFA012B.MdiParent = Me
  MyFrmFA012B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmFA012_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "FA012B" Then
    MyFrmFA012.Close()
  Else
    MyFrmFA012C.Close()
    MyFrmFA012B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmFA012C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmFA012C.Close()
  MyFrmFA012B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmFA012C = New FrmFA012C
  MyFrmFA012C.MdiParent = MyFrmFA012B.ParentForm
  MyFrmFA012C.WrkCode = ""
  MyFrmFA012C.Show()
  MyFrmFA012B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmFA012B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmFA012C.SaveData()
End Sub

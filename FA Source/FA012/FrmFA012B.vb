...
Private Sub FrmFA012B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
  Public Sub ShowGrid()
    ...
    myFAUSER3.CloseFile()
  End Sub
  Private Sub FrmFA012B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA012.SbpScreen.Text = "FA012B"
  MyFrmFA012.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmFA012C.MdiParent = Me.ParentForm
  MyFrmFA012C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmFA012C.Show()
  Me.Hide()
End Sub
End Class

...
#End Region
  ...
  Private Sub FrmFA012C_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFAUSER3 = New FAUSER3.MyData()
    myFAUSER3.MyDBConn = myDBConnect
    MyFrmFA012.TBarNew.Enabled = False
    MyFrmFA012.TBarSave.Enabled = True
    If WrkCode <> "" Then
      MyFrmFA012.TBarDelete.Enabled = True
      MyUtils.SetTxtReadOnly(TxtCode)
    End If
    MyFrmFA012.TBarPrint.Enabled = False
    myFAUSER3.GetOneRecordP(WrkCode)
    TxtCode.Text = WrkCode
    If myFAUSER3.RecordNotFound Then Exit Sub
    If s_chg = False And s_full = False Then    '#sec
      MyFrmFA012.TBarSave.Visible = False
    End If
    With myFAUSER3
      TxtDesc.Text = Trim(._U3DESC)
    End With
  End Sub
  Private Sub FrmFA012C_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmFA012.SbpScreen.Text = "FA012C"
  MyUtils.CenterForm(Me.ParentForm, Me)
End Sub
Private Sub FrmFA012C_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  MyFrmFA012.TBarNew.Enabled = True
  MyFrmFA012.TBarDelete.Enabled = False
  MyFrmFA012.TBarSave.Enabled = False
  MyFrmFA012.TBarPrint.Enabled = False
  MyFrmFA012.TBarSave.Visible = True   '#sec
  MyFrmFA012B.FormatGrid()
  MyFrmFA012B.Show()
End Sub
Public Sub DeleteData(ByRef WrkCancel As Boolean)
  ...
  End If
  WrkCancel = False
	myFAUSER3.DeleteOneRecordP()
  Me.Close()
End Sub
Public Sub SaveData()
	Dim ErrorField(25) As String
  Dim ErrorMsg(25) As String
	myFAUSER3.GetOneRecordP(TxtCode.Text)
  If WrkCode = "" Then
  ...
  If WrkCode <> "" Then
    ...
    If IsNothing(ErrorMsg(0)) Then
			myFAUSER3.UpdateOneRecordP()
    Else
			ShowError(ErrorField, ErrorMsg)
			Exit Sub
    End If
  Else
		myFAUSER3._U3CODE = TxtCode.Text
    MovetoFile()
		EditChecks(ErrorField, ErrorMsg)
		If IsNothing(ErrorMsg(0)) Then
			myFAUSER3.AddOneRecordP()
		Else
			ShowError(ErrorField, ErrorMsg)
			Exit Sub
		End If

...
#Region " Windows Form Designer generated code "
    ...
    Me.Name = "FrmListUser1"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Select User 1"
...
#End Region
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListUser1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFAUSER1 = New FAUSER1.MyData()
    myFAUSER1.MyDBConn = myDBConnect
    LblCurrent.Text = "(" & WrkField & " User 1 =" & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmFA101B
      If WrkField = "From" Then
        .TxtUser1From.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtUser1From, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtUser1To.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtUser1To, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

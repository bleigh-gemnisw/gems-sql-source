...
#Region " Windows Form Designer generated code "
    ...
    Me.Name = "FrmListUser2"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Select User 2"
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = myFAUSER2.PosData(TxtPos.Text)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListUser2_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmFA101.SbpScreen.Text = "ListUser2"
  End Sub
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListUser2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myFAUSER2 = New FAUSER2.MyData()
    myFAUSER2.MyDBConn = myDBConnect
    LblCurrent.Text = "(" & WrkField & " User 2 =" & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmFA101B
      If WrkField = "From" Then
        .TxtUser2From.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtUser2From, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtUser2To.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtUser2To, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

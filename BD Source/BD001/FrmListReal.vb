...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(7, 58)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(682, 276)
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    If RbView2.Checked Then
      ...
      Do While Len(WrkPosNo) < 7 'Left pad with blanks
        WrkPosNo = " " & WrkPosNo
      Loop
      ds = myTXREAL1.GetViewbyLoc(TxtPos.Text, WrkPosNo, 100, WrkBlocking)
    End If
  ...
  Private Sub FrmListRealC_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmBD001.SbpScreen.Text = "ListReal"
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    Select Case WrkFormID
      Case "CD"
        With MyFrmBD001CD
          If RbView1.Checked Then
            .TxtName.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
            .TxtLocNo.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
            .TxtLoc.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
            .TxtMap.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
          Else
            .TxtName.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
            .TxtLocNo.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
            .TxtLoc.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
            .TxtMap.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
          End If
          .LblListNo.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
          myTXREAL.GetOneRecordP(.LblListNo.Text)
  ...
  End Sub
  Private Sub FrmListReal_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed

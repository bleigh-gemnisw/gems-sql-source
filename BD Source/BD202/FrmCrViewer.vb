...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtBD202.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Permit Report")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmBD202B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmBD202B.DtPckTo.Value)
    .SetParameterValue("MyType", MyFrmBD202B.TxtType.Text)
   End With
   With Crv1
     .DisplayToolbar = True

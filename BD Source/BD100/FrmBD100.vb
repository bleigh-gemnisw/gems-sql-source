...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmBD100))
...
Private Sub FrmBD100_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmBD100B = New FrmBD100B
  MyFrmBD100B.MdiParent = Me
  MyFrmBD100B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmBD100_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "BD100B" Then
    MyFrmBD100.Close()
  Else
    MyFrmBD100C.Close()
    MyFrmBD100B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmBD100C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmBD100C.MdiParent = MyFrmBD100B.ParentForm
  MyFrmBD100C.WrkType = ""
  MyFrmBD100C.Show()
  MyFrmBD100B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmBD100B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmBD100C.SaveData()
End Sub

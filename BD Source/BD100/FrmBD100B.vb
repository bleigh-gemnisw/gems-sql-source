...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(613, 358)
...
Private Sub FrmBD100B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myBDRATE = New BDRATE.mydata(MyDBConnect)
  Wrkcresn = ""
  Call FormatGrid()
End Sub
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
  Wrkcresn = TxtPos.Text
  FormatGrid()
  TxtPos.Text = ""
End Sub
Public Sub FormatGrid()
  ...
  With DataGrdView
    ...
    .Columns(3).Width = 60
    .Columns(4).HeaderText = "Per"
    .Columns(4).Width = 50
    .Columns(5).HeaderText = "Cert"
    .Columns(5).Width = 60
    .Columns(6).Visible = False
  End With
End Sub
Public Sub ShowGrid()
  ds = myBDRATE.PosData(TxtPos.Text, 0)
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
End Sub
Private Sub FrmBD100B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmBD100.SbpScreen.Text = "BD100B"
  MyFrmBD100.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmBD100C = New FrmBD100C
  MyFrmBD100C.MdiParent = Me.ParentForm
  MyFrmBD100C.WrkType = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmBD100C.WrkTier = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
  MyFrmBD100C.Show()
  Me.Hide()
End Sub

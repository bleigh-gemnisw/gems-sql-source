...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmBD103))
...
#End Region
 ...
 Private Sub FrmBD103_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmBD103B = New FrmBD103B
  MyFrmBD103B.MdiParent = Me
  MyFrmBD103B.Show()
 End Sub
...
Private Sub FrmBD103_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "BD103B" Then
    MyFrmBD103.Close()
  Else
    MyFrmBD103C.Close()
    MyFrmBD103B.Show()
...
Private Sub DoBtnDelete()
  MyFrmBD103C.DeleteData()
  MyFrmBD103C.Close()
  MyFrmBD103B.Show()
End Sub
Private Sub DoBtnNew()
  MyFrmBD103C = New FrmBD103C
  MyFrmBD103C.MdiParent = MyFrmBD103B.ParentForm
  MyFrmBD103C.WrkRecID = 0
  MyFrmBD103C.WrkAddMode = True
  MyFrmBD103C.Show()
  MyFrmBD103B.Hide()
End Sub

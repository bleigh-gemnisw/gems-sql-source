...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtBD201.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Missing Inspections Report")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyTrDate", MyFrmBD201B.DtPckTr.Value)
    .SetParameterValue("MyType", MyFrmBD201B.TxtType.Text)
   End With
   With Crv1
     .DisplayToolbar = True

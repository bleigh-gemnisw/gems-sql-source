...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(31, 12)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(97, 302)
    Me.DataGrdView.TabIndex = 199
    '
    'FrmListTypes
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(161, 326)
...
#End Region
  ...
  Private Sub FrmListTypes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmBD201.SbpScreen.Text = "ListTypes"
  End Sub
...
End Sub
Private Sub FrmListTypes_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    With MyFrmBD201B
      .Show()
    End With
  'Memory Cleanup
  myBDRATE = Nothing
  MyFrmListTypes = Nothing
End Sub
End Class

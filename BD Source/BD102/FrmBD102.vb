...
Friend WithEvents HelpProvider1 As System.Windows.Forms.HelpProvider
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmBD102))
    ...
    Me.TbMain.Size = New System.Drawing.Size(484, 50)
    ...
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 300)
    ...
    Me.SbMain.Size = New System.Drawing.Size(484, 28)
    ...
    Me.Text = "Building Dept Billing Control File"
...
Private Sub FrmBD102_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmBD102B = New FrmBD102B
  MyFrmBD102B.MdiParent = Me
  MyFrmBD102B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmBD102_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "BD102B" Then
    MyFrmBD102.Close()
  Else
    MyFrmBD102B.Show()
  End If

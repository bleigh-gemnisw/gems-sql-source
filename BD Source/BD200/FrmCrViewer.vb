...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtBD200.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Permit Receipts Report")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmBD200B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmBD200B.DtPckTo.Value)
    .SetParameterValue("MyType", MyFrmBD200B.TxtType.Text)
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtBD200Tot.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
    ...
    .SetParameterValue("myreportTitle", "Permit Receipts Totals")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmBD200B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmBD200B.DtPckTo.Value)
    .SetParameterValue("MyType", MyFrmBD200B.TxtType.Text)
    .SetParameterValue("MyCash", WrkTCash)
    .SetParameterValue("MyCheck", WrkTCheck)
    .SetParameterValue("MyCredit", WrkTCredit)
    .SetParameterValue("MyState", WrkTState)
   End With
   With crv2
     .DisplayToolbar = True
     .ShowGroupTreeButton = False

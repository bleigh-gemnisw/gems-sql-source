...
Private Sub BD104B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myBDPAYCR = New BDPAYCR.mydata(MyDBConnect)

  MyFrmBD104.TBarNew.Visible = False
  MyFrmBD104.TBarSave.Visible = True
  MyFrmBD104.TBarPrint.Visible = False
  MyFrmBD104.TBarDelete.Visible = False
  myBDPAYCR.GetOneRecordP("PP")

  If s_chg = False And s_full = False Then    '#sec
    MyFrmBD104.TBarSave.Visible = False
  End If

  If myBDPAYCR.RecordNotFound Then Exit Sub
  ...
  End With
End Sub
Private Sub BD104B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmBD104.SbpScreen.Text = "BD104B"
...
Public Sub SaveData()
  ...
  MovetoFile()
  ' added this too
  If myBDPAYCR.RecordNotFound Then
    myBDPAYCR.AddOneRecordP()
  Else
    myBDPAYCR.UpdateOneRecordP()
  End If
  Me.Close()
  End Sub

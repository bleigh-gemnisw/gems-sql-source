...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmBD101))
...
#End Region
 ...
 Private Sub FrmBD101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  TBarSave.Enabled = False
   ...
   set_security() '#set
   MyFrmBD101B = New FrmBD101B
   MyFrmBD101B.MdiParent = Me
   MyFrmBD101B.Show()
 End Sub
...
Private Sub FrmBD101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "BD101B" Then
    MyFrmBD101.Close()
  Else
    MyFrmBD101C.Close()
    MyFrmBD101B.Show()
...
Private Sub DoBtnDelete()
  MyFrmBD101C.DeleteData()
  MyFrmBD101C.Close()
  MyFrmBD101B.Show()
End Sub
Private Sub DoBtnNew()
  MyFrmBD101C = New FrmBD101C
  MyFrmBD101C.MdiParent = MyFrmBD101B.ParentForm
  MyFrmBD101C.Wrktype = ""
  MyFrmBD101C.WrkAddMode = True
  MyFrmBD101C.Show()
  MyFrmBD101B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmBD101B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmBD101C.SaveData()
End Sub

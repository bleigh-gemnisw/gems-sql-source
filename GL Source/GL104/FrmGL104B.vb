...
#End Region
Private Sub FrmGL104B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
Public Sub ShowGrid()
  ds = myGLPROG.PosData(MyUtils.CnvSng(TxtPos.Text))
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
End Sub
Private Sub FrmGL104B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmGL104.SbpScreen.Text = "GL104B"
  MyFrmGL104.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmGL104C.MdiParent = Me.ParentForm
  MyFrmGL104C.WrkFNPGM = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
  MyFrmGL104C.Show()
  Me.Hide()
End Sub
End Class

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA31))
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 288)
...
Me.ClientSize = New System.Drawing.Size(654, 316)
...
Me.Text = "Maintain G/L Interface for Web Payments"
...
Private Sub FrmGLA31_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmGLA31B = New FrmGLA31B
  MyFrmGLA31B.MdiParent = Me
  MyFrmGLA31B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmGLA31_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "GLA31B" Then
    MyFrmGLA31.Close()
  Else
    MyFrmGLA31B.Show()
  End If

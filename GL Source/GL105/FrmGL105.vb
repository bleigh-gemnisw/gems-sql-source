...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL105))
...
#End Region
 ...
 Private Sub FrmGL105_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGL105B = New FrmGL105B
   MyFrmGL105B.MdiParent = Me
   MyFrmGL105B.Show()
 End Sub
...
Private Sub FrmGL105_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmGL105C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmGL105C = New FrmGL105C
  MyFrmGL105C.MdiParent = MyFrmGL105B.ParentForm
  MyFrmGL105C.Show()
  MyFrmGL105B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmGL105B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmGL105C.SaveData()
End Sub

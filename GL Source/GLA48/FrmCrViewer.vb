...
End Sub
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtGLA48.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      ...
      .SetParameterValue("MyFromDate", MyFrmGLA48B.DtPckFrom.Value)
      .SetParameterValue("MyToDate", MyFrmGLA48B.DtPckTo.Value)
      .SetParameterValue("MyBatch", MyUtils.CnvSng(MyFrmGLA48B.TxtBatch.Text))
      .SetParameterValue("MyGLYear", MyUtils.CnvSng(MyFrmGLA48B.TxtGLYear.Text))
      .SetParameterValue("MySuppSame", MyFrmGLA48B.ChkSuppSame.Checked)
    End With
    With Crv1
      .DisplayToolbar = True

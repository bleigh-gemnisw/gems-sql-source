...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGLA41.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Create Tax Bridge File")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyBatch", MyUtils.CnvSng(MyFrmGLA41B.TxtBatch.Text))
    .SetParameterValue("MyGLYear", MyUtils.CnvSng(MyFrmGLA41B.TxtGLYear.Text))
    .SetParameterValue("MySuppSame", MyFrmGLA41B.ChkSuppSame.Checked)
    .SetParameterValue("MyErrFees", WrkErrFees)
    .SetParameterValue("MyBatchDate", MyFrmGLA41B.DtPckBatch.Value)
    .SetParameterValue("MyPostDate", MyFrmGLA41B.DtPckPost.Value)
   End With
   With Crv1
     .DisplayToolbar = True

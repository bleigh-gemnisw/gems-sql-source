...
Friend WithEvents ChkSuppSame As System.Windows.Forms.CheckBox
    ...
    Me.DtPckPost.Location = New System.Drawing.Point(217, 78)
    ...
    Me.TxtFilePath.Location = New System.Drawing.Point(72, 109)
    ...
    Me.TxtBatch.Location = New System.Drawing.Point(94, 53)
...
Private Sub FrmGLA41B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmGLA41.SbpScreen.Text = "GLA41"
End Sub
Private Sub FrmGLA41B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
...
Private Sub FrmGLA41B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  TxtFilePath.Text = MyAppSettings.FilePath
  TxtGLYear.Text = MyAppSettings.GLYear
  DtPckBatch.Value = Date.Today

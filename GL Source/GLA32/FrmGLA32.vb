...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA32))
...
Me.Text = "Tax Interface To Admins"
...
#End Region
 ...
 Private Sub FrmGLA32_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGLA32B = New FrmGLA32B
   MyFrmGLA32B.MdiParent = Me
   MyFrmGLA32B.Show()
 End Sub
...
Private Sub FrmGLA32_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnCopy()
  MyFrmGLA32B.CopyData()
End Sub
Private Sub DoBtnDelete()
  MyFrmGLA32C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmGLA32C = New FrmGLA32C
  MyFrmGLA32C.MdiParent = MyFrmGLA32B.ParentForm
  MyFrmGLA32C.WrkType = String.Empty
  MyFrmGLA32C.WrkCopyMode = False
  MyFrmGLA32C.Show()
  MyFrmGLA32B.Hide()
End Sub
Private Sub DoBtnPrint()
  MyFrmGLA32B.PrintData()
End Sub
Private Sub DoBtnSave()
  MyFrmGLA32C.SaveData()
End Sub

...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGL205.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(ds)
    ...
    .SetParameterValue("MyFromDate", MyFrmGL205B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGL205B.DtPckTo.Value)
    .SetParameterValue("MyFromFund", MyUtils.CnvSng(MyFrmGL205B.TxtFundFrom.Text))
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtGL205Tot.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetDataSource(ds)
    ...
    .SetParameterValue("MyToDate", MyFrmGL205B.DtPckTo.Value)
    .SetParameterValue("MyFromFund", MyUtils.CnvSng(MyFrmGL205B.TxtFundFrom.Text))
    .SetParameterValue("MyPageDept", MyFrmGL205B.ChkPageDept.Checked)
   End With
   With Crv2
     .DisplayToolbar = True
     .ShowGroupTreeButton = False
  ...
  Private Sub RunReport3()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtGL205B.rpt", myTOWN._TOWNBR)
   With myreport3
    .Load(ReportPath)
    .SetDataSource(ds2)

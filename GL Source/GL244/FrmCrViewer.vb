...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtGL244.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      .SetDataSource(ds)
      .SetParameterValue("myreportTitle", "Activity Summary with MTD")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyFromDate", MyFrmGL244B.DtPckFrom.Value)
      .SetParameterValue("MyToDate", MyFrmGL244B.DtPckTo.Value)
      .SetParameterValue("MyFromFund", MyUtils.CnvSng(MyFrmGL244B.TxtFundFrom.Text))
      '    .SetParameterValue("MyPageDept", MyFrmGL244B.ChkPageDept.Checked)
    End With
    With Crv1
      .DisplayToolbar = True

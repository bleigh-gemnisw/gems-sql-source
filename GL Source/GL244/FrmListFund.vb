...
#End Region
  ...
  MyFrmGL244.SbpScreen.Text = "ListFund"
  End Sub
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  With MyFrmGL244B
    If WrkID = "From" Then
      .TxtFundFrom.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
    Else
      .TxtFundTo.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
    End If
  End With
  Me.Close()

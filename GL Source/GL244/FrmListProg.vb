...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = MyGLProg.PosData(MyUtils.CnvSng(TxtObj.Text))
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListProg_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListProg_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    MyFrmGL244B.Show()
  End Sub
  Private Sub FrmListProg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    MyGLProg = New GLPROG.MyData()
    MyGLProg.MyDBConn = myDBConnect
    If WrkProg > 0 Then
      TxtObj.Text = WrkProg
      LblCurrent.Text = "(Function =" & WrkProg & ")"
    End If
    FormatGrid()
  End Sub
  ...
  Windows.Forms.Cursor.Current = Cursors.WaitCursor
    ...
    With MyFrmGL244B
      If WrkID = "From" Then
        .TxtFuncFrom.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
      Else
        .TxtFuncTo.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
      End If
    End With
    Me.Close()

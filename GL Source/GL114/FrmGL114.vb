...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL114))
...
#End Region
 ...
 Private Sub FrmGL114_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGL114B = New FrmGL114B
   MyFrmGL114B.MdiParent = Me
   MyFrmGL114B.Show()
 End Sub
...
Private Sub FrmGL114_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmGL114C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmGL114C = New FrmGL114C
  MyFrmGL114C.MdiParent = MyFrmGL114B.ParentForm
  MyFrmGL114C.WrkUsrprf = ""
  MyFrmGL114C.Show()
  MyFrmGL114B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmGL114B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmGL114C.SaveData()
End Sub

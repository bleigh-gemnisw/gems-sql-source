...
#End Region
  ...
  MyFrmGL114.SbpScreen.Text = "ListFund"
  End Sub
 ...
 Private Sub FrmListFund_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
  MyFrmGL114.TBarSave.Enabled = WrkSave
  MyFrmGL114.TBarDelete.Enabled = WrkDelete
  MyFrmGL114C.Show()
 End Sub
  ...
  WrkSave = MyFrmGL114.TBarSave.Enabled
  WrkDelete = MyFrmGL114.TBarDelete.Enabled

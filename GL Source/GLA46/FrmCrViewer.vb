...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGLA46.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Create RWA G/L Interface File")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmGLA46B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGLA46B.DtPckTo.Value)
    .SetParameterValue("MyBatch", MyUtils.CnvSng(MyFrmGLA46B.TxtBatchFrom.Text))
   End With
   With Crv1
     .DisplayToolbar = True

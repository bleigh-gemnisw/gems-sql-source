...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL103))
...
#End Region
 ...
 Private Sub FrmGL103_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGL103B = New FrmGL103B
   MyFrmGL103B.MdiParent = Me
   MyFrmGL103B.Show()
 End Sub
...
Private Sub FrmGL103_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmGL103C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmGL103C = New FrmGL103C
  MyFrmGL103C.MdiParent = MyFrmGL103B.ParentForm
  MyFrmGL103C.Show()
  MyFrmGL103B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmGL103B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmGL103C.SaveData()
End Sub

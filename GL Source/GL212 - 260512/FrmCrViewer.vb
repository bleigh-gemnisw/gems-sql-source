...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtGL212.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      .SetDataSource(ds)
      ...
      .SetParameterValue("MyFromDate", MyFrmGL212B.DtPckFrom.Value)
      .SetParameterValue("MyToDate", MyFrmGL212B.DtPckTo.Value)
      .SetParameterValue("MyFromFund", MyUtils.CnvSng(MyFrmGL212B.TxtFundFrom.Text))
    End With
    With Crv1
      .DisplayToolbar = True
  ...
  Private Sub RunReport2()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtGL212Tot.rpt", myTOWN._TOWNBR)
    With myreport2
      .Load(ReportPath)
      .SetDataSource(ds)
      ...
      .SetParameterValue("MyToDate", MyFrmGL212B.DtPckTo.Value)
      .SetParameterValue("MyFromFund", MyUtils.CnvSng(MyFrmGL212B.TxtFundFrom.Text))
      .SetParameterValue("MyPageDept", MyFrmGL212B.ChkPageDept.Checked)
    End With
    With Crv2
      .DisplayToolbar = True
      .ShowGroupTreeButton = False
  ...
  Private Sub RunReport3()
    ...
    Me.Text = "Report Viewer"
    If MyFrmGL212B.RbExpVendName.Checked Then
      ReportPath = MyUtils.GetReportPath("PrtGL212B.rpt", myTOWN._TOWNBR)
    Else
      ReportPath = MyUtils.GetReportPath("PrtGL212C.rpt", myTOWN._TOWNBR)
    End If
    With myreport3
      .Load(ReportPath)
      .SetDataSource(ds2)

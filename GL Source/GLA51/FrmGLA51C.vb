...
#End Region
  ...
  Private Sub FrmGLA51C_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
  End Sub

  Private Sub FrmGLA51C_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    myPRGLMAP = New PRGLMAP.MyData(myDBConnect)
    myGLACCT = New GLACCT.MyData()
    myGLACCT.MyDBConn = myDBConnect

    MyFrmGLA51.TbarNew.Enabled = False
    MyFrmGLA51.TBarSave.Enabled = True
    ...
    If s_chg = False And s_full = False Then    '#sec
      MyFrmGLA51.TBarSave.Visible = False
    End If
    If s_del = False And s_full = False Then    '#sec
      MyFrmGLA51.TBarDelete.Visible = False
    End If
    ...
    If Not myPRGLMAP.RecordNotFound Then
      MyFrmGLA51.TBarDelete.Enabled = True
    End If
  ...
  Private Sub FrmGLA51C_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    MyFrmGLA51.TbarNew.Enabled = True
    MyFrmGLA51.TBarDelete.Enabled = False
  ...
  Private Sub ShowError(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
   ...
   ' ErrProv.SetError(TxtFndM, ErrorMsg(I))
    ...
    Next I
  End Sub
  Private Sub FrmGLA51C_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGLA51.SbpScreen.Text = "GLA51C"

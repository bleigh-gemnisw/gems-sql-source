...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA51))
...
#End Region
  ...
  Private Sub FrmGLA51_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmGLA51B = New FrmGLA51B
    MyFrmGLA51B.MdiParent = Me
    MyFrmGLA51B.Show()
  End Sub
  ...
  Private Sub FrmGLA51_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnDelete()
    ...
    MyFrmGLA51C.DeleteData(Cancel)
    If Cancel Then Exit Sub

  End Sub
  Private Sub DoBtnNew()
    MyFrmGLA51C = New FrmGLA51C
    MyFrmGLA51C.MdiParent = MyFrmGLA51B.ParentForm
    MyFrmGLA51C.WrkFdnbr = 0
    MyFrmGLA51C.WrkSfund = 0
    MyFrmGLA51C.WrkDpnbr = 0
    MyFrmGLA51C.WrkObnbr = 0
    MyFrmGLA51C.WrkFnpgm = 0
    MyFrmGLA51C.WrkSubfn = 0
    MyFrmGLA51C.Show()
    MyFrmGLA51B.Hide()
  End Sub

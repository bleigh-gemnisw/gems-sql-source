...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  If MyFrmGLA50B.RbDelete.Checked Then
    WrkMode = "Delete"
  Else
    WrkMode = "Change Date"
  End If
...
End Sub
   ...
   ReportPath = MyUtils.GetReportPath("PrtGLA50.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds)
    ...
    .SetParameterValue("MyBatchNo", MyUtils.CnvSng(MyFrmGLA50B.TxtBatch.Text))
    .SetParameterValue("MyBatchDate", MyFrmGLA50B.DtPckBatch.Value)
    .SetParameterValue("MyNewDate", Format(MyFrmGLA50B.DTPckNew.Value, "M/d/yy"))

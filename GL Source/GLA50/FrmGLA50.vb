...
Friend WithEvents TBarSep1 As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA50))
    ...
    Me.Text = "Delete Posted Batch or Change Batch Date"
...
Private Sub FrmGLA50_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmGLA50B = New FrmGLA50B
  MyFrmGLA50B.MdiParent = Me
  MyFrmGLA50B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmGLA50_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmGLA50.TBarPrint.Enabled = False
   MyFrmGLA50B.RunReport()
   MyFrmGLA50.TBarPrint.Enabled = True
End Sub

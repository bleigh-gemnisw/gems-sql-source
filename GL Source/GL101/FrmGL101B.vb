...
#End Region
Private Sub FrmGL101B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
End Sub
Public Sub ShowGrid()
  ds = myGLGRUP.PosData(MyUtils.CnvSng(TxtPos.Text))
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
End Sub
Private Sub FrmGL101B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmGL101.SbpScreen.Text = "GL101B"
  MyFrmGL101.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmGL101C = New FrmGL101C
  MyFrmGL101C.MdiParent = Me.ParentForm
  MyFrmGL101C.WrkGROUP = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmGL101C.Show()
  Me.Hide()
End Sub
End Class

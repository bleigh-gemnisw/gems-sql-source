...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL101))
...
#End Region
 ...
 Private Sub FrmGL101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGL101B = New FrmGL101B
   MyFrmGL101B.MdiParent = Me
   MyFrmGL101B.Show()
 End Sub
...
Private Sub FrmGL101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmGL101C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmGL101C = New FrmGL101C
  MyFrmGL101C.MdiParent = MyFrmGL101B.ParentForm
  MyFrmGL101C.Show()
  MyFrmGL101B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmGL101B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmGL101C.SaveData()
End Sub

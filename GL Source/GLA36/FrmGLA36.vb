...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA36))
...
#End Region
 ...
 Private Sub FrmGLA36_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGLA36B = New FrmGLA36B
   MyFrmGLA36B.MdiParent = Me
   MyFrmGLA36B.Show()
 End Sub
...
Private Sub FrmGLA36_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmGLA36C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmGLA36C = New FrmGLA36C
  MyFrmGLA36C.MdiParent = MyFrmGLA36B.ParentForm
  MyFrmGLA36C.WrkCode = String.Empty
  MyFrmGLA36C.Show()
  MyFrmGLA36B.Hide()
End Sub
Private Sub DoBtnPrint()
  MyFrmGLA36B.PrintData()
End Sub
Private Sub DoBtnSave()
  MyFrmGLA36C.SaveData()
End Sub

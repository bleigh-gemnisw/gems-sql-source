...
Me.RbCredit.Location = New System.Drawing.Point(49, 132)
...
Me.RbDebit.Location = New System.Drawing.Point(132, 132)
...
#End Region
  ...
  Private Sub FrmGLA36C_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myMUNLED = New MUNLED.MyData()
    myMUNLED.MyDBConn = myDBConnect
    LoadForm()
  End Sub
Private Sub LoadForm()
  MyFrmGLA36.TBarNew.Enabled = False
  MyFrmGLA36.TBarSave.Enabled = True
  MyFrmGLA36.TBarDelete.Enabled = True
  MyFrmGLA36.TBarPrint.Enabled = False

  myMUNLED.GetOneRecordP(WrkCode)
  If myMUNLED.RecordNotFound Then
    MyFrmGLA36.TBarDelete.Enabled = False
    Exit Sub
  End If
  ...
  End With
End Sub
Private Sub FrmGLA36C_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmGLA36.SbpScreen.Text = "GLA36C"
  MyUtils.CenterForm(Me.ParentForm, Me)
End Sub

Private Sub FrmGLA36C_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  MyFrmGLA36.TBarNew.Enabled = True
  MyFrmGLA36.TBarDelete.Enabled = False
  MyFrmGLA36.TBarSave.Enabled = False
  MyFrmGLA36.TBarNew.Enabled = True
  MyFrmGLA36.TBarPrint.Enabled = False
  MyFrmGLA36B.FormatGrid()
  MyFrmGLA36B.Show()
  'Memory Cleanup
  myMUNLED = Nothing
  MyFrmGLA36C = Nothing
...
Public Sub DeleteData()
  ...
  myMUNLED.GetOneRecordP(TxtCode.Text)
  myMUNLED.DeleteOneRecordP()
  Me.Close()
End Sub

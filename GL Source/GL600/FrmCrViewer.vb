...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGL600.rpt", myTOWN._TOWNBR)
   ...
   With myreport
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Purge Ledger History")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyAsofDate", WrkAsofDate)
    .SetParameterValue("MyPost", MyFrmGL600B.ChkUpdate.Checked)
   End With
   With Crv1
     .DisplayToolbar = True

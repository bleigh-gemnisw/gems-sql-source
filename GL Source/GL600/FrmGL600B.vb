...
#End Region
  ...
  End Sub
Private Sub FrmGL600B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    MyFrmGL600.SbpPgmID.Text = "GL600B"
    MyFrmGL600.SbpEnvironment.Text = myDBConnect.PgmDB
  End Sub
Private Sub FrmGL600B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmGL600.SbpScreen.Text = "GL600B"
End Sub
Private Sub FrmGL600B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
  ...
  End Sub
Private Sub FrmGL600B_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

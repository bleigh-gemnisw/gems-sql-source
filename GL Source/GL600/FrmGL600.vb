...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL600))
...
Private Sub FrmGL600_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "GL600"
  TBarProcess.Enabled = True
  set_security() '#set

  MyFrmGL600B = New FrmGL600B
  MyFrmGL600B.MdiParent = Me
  MyFrmGL600B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmGL600_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmGL600.TBarProcess.Enabled = False
   MyFrmGL600B.RunReport()
   MyFrmGL600.TBarProcess.Enabled = True
End Sub

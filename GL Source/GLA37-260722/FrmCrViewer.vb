...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGLA37.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    .SetParameterValue("MyFromDate", MyFrmGLA37B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGLA37B.DtPckTo.Value)
    .SetParameterValue("MyBatch", MyUtils.CnvSng(MyFrmGLA37B.TxtBatch.Text))
    .SetParameterValue("MyGLYear", MyUtils.CnvSng(MyFrmGLA37B.TxtGLYear.Text))
    .SetParameterValue("MySuppSame", MyFrmGLA37B.ChkSuppSame.Checked)

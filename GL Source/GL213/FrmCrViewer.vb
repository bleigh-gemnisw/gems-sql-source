...
Friend WithEvents TabPg2 As System.Windows.Forms.TabPage
    ...
    Me.TabCtl1.Controls.Add(Me.TabPage1)
    ...
    'TabPage1
    '
    Me.TabPage1.Controls.Add(Me.Crv3)
    Me.TabPage1.Location = New System.Drawing.Point(4, 22)
    Me.TabPage1.Name = "TabPage1"
    Me.TabPage1.Size = New System.Drawing.Size(648, 354)
    Me.TabPage1.TabIndex = 2
    Me.TabPage1.Text = "Expended Detail"
    ...
    Me.Crv3.Location = New System.Drawing.Point(0, 1)
    Me.Crv3.Name = "Crv3"
...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGL213.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(ds)
    .SetParameterValue("myreportTitle", "Detail Ledger by Acct")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmGL213B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGL213B.DtPckTo.Value)
    .SetParameterValue("MyFromFund", MyUtils.CnvSng(MyFrmGL213B.TxtFundFrom.Text))
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtGL213Tot.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetDataSource(ds)
    .SetParameterValue("myreportTitle", "Adjustment Register Totals")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmGL213B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGL213B.DtPckTo.Value)
    .SetParameterValue("MyFromFund", MyUtils.CnvSng(MyFrmGL213B.TxtFundFrom.Text))
    .SetParameterValue("MyPageDept", MyFrmGL213B.ChkPageDept.Checked)
   End With
   With Crv2
     .DisplayToolbar = True
     .ShowGroupTreeButton = False
  ...
  Private Sub RunReport3()
    ...
    Me.Text = "Report Viewer"
    If MyFrmGL213B.RbExpVendName.Checked Then
      ReportPath = MyUtils.GetReportPath("PrtGL213B.rpt", myTOWN._TOWNBR)
    Else
      ReportPath = MyUtils.GetReportPath("PrtGL213C.rpt", myTOWN._TOWNBR)
    End If
    With myreport3
      .Load(ReportPath)
      .SetDataSource(ds2)
      .SetParameterValue("myreportTitle", "Expended Detail by Acct")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyFromDate", MyFrmGL213B.DtPckFrom.Value)
      .SetParameterValue("MyToDate", MyFrmGL213B.DtPckTo.Value)

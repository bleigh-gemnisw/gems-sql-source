...
Module PrintReport
  ...
  Public Sub PrtReport()
    ...
    If WrkFile <> String.Empty Then
      sw = New StreamWriter(MyFrmGL213B.LblFilePath.Text)
    End If
    ...
    If MyFrmGL213B.RbFileCurr.Checked Then
      GetDetail()
    Else
      GetDetailHst()
    End If
...
Done:
  ...
  Private Sub BuildDS()
    ...
    With myTable
      ...
      .Columns.Add("Tdesc", Type.GetType("System.String")) 'Only 213/213B
      .Columns.Add("Vennm", Type.GetType("System.String")) 'Only 213C 
      .Columns.Add("Descr", Type.GetType("System.String")) 'Only 213C 
      .Columns.Add("Invnr", Type.GetType("System.String")) 'Only 213C 
    End With

...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(14, 51)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(570, 263)
    Me.DataGrdView.TabIndex = 205
    '
    'FrmListGLAcct
    '
...
#End Region
  ...
  Private Sub FrmListGLAcct_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGLA01.SbpScreen.Text = "ListGLAcct"
  End Sub
  Private Sub FrmListGLAcct_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    MyFrmGLA01.TBarSave.Enabled = WrkSave
    MyFrmGLA01.TBarDelete.Enabled = WrkDelete
    MyFrmGLA01C.Show()
  End Sub
  Private Sub FrmListGLAcct_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    WrkSave = MyFrmGLA01.TBarSave.Enabled
    WrkDelete = MyFrmGLA01.TBarDelete.Enabled
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmGLA01C
      Select Case WrkField
        ...
        Case "RD"
          .TxtFndRD.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
          .TxtSfndRD.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
          .TxtDptRD.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
          .TxtObjRD.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
          .TxtFcnRD.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
          .TxtSfcnRD.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
          .Ttp1.SetToolTip(.TxtFndRD, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
        Case "LC"
          .TxtFndLC.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
          .TxtSfndLC.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
          .TxtDptLC.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
          .TxtObjLC.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
          .TxtFcnLC.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
          .TxtSfcnLC.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
          .Ttp1.SetToolTip(.TxtFndLC, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
        Case "LD"
          .TxtFndLD.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
          .TxtSfndLD.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
          .TxtDptLD.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
          .TxtObjLD.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
          .TxtFcnLD.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
          .TxtSfcnLD.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
          .Ttp1.SetToolTip(.TxtFndLD, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      End Select
    End With
    Me.Close()

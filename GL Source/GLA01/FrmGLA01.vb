...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents TBarBack As ToolBarButton
  Friend WithEvents TBarNew As ToolBarButton
  Friend WithEvents TBarSave As ToolBarButton
  Friend WithEvents TBarDelete As ToolBarButton
  Friend WithEvents TBarCopy As ToolBarButton
  Friend WithEvents TBarMassCopy As ToolBarButton
  Friend WithEvents TBarMassRep As ToolBarButton
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA01))
    ...
    Me.TBarMassCopy = New System.Windows.Forms.ToolBarButton()
    Me.TBarMassRep = New System.Windows.Forms.ToolBarButton()
    ...
    Me.ImageList1.Images.SetKeyName(6, "update row_24.png")
    '
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarCopy, Me.TBarMassCopy, Me.TBarMassRep, Me.TBarSep1, Me.TBarPrint})
    ...
    'TBarMassCopy
    '
    Me.TBarMassCopy.ImageIndex = 5
    Me.TBarMassCopy.Name = "TBarMass"
    Me.TBarMassCopy.Text = "Mass Copy"
    '
    'TBarMassRep
    '
    Me.TBarMassRep.ImageKey = "update row_24.png"
    Me.TBarMassRep.Name = "TBarMassRep"
    Me.TBarMassRep.Text = "Mass Replace"
    '
    'TBarSep1
    '
    ...
    Me.Text = "Tax Interface G/L Accounts"
...
#End Region
  ...
  Private Sub FrmGLA01_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security()  '#set
    MyFrmGLA01B = New FrmGLA01B
    MyFrmGLA01B.MdiParent = Me
    MyFrmGLA01B.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    If e.Button Is TBarDelete Then
      DoBtnDelete()
    End If
    If e.Button Is TBarMassCopy Then
      DoBtnMassCopy()
    End If
    If e.Button Is TBarMassRep Then
      DoBtnMassRep()
    End If
  ...
  Private Sub FrmGLA01_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnCopy()
    MyFrmGLA01B.CopyData()
  End Sub
  Private Sub DoBtnMassCopy()
    MyFrmGLA01B.MassCopy()
  End Sub
  Private Sub DoBtnMassRep()
    MyFrmGLA01B.MassReplace()
  End Sub
  Private Sub DoBtnDelete()
    MyFrmGLA01C.DeleteData()
  End Sub
  Private Sub DoBtnNew()
    MyFrmGLA01C = New FrmGLA01C
    MyFrmGLA01C.MdiParent = MyFrmGLA01B.ParentForm
    MyFrmGLA01C.WrkType = String.Empty
    MyFrmGLA01C.WrkCopyMode = False
    MyFrmGLA01C.Show()
    MyFrmGLA01B.Hide()
  End Sub
  Private Sub DoBtnPrint()
    MyFrmGLA01B.PrintData()
  End Sub
  Private Sub DoBtnSave()
    MyFrmGLA01C.SaveData()
  End Sub

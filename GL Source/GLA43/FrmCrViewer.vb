...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGLA43.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    If MyFrmGLA43B.RbRevenue.Checked Then
      .SetParameterValue("myreportTitle", "Create Revenue Tax Bridge File")
    Else
      .SetParameterValue("myreportTitle", "Create A/R Tax Bridge File")
    End If
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmGLA43B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGLA43B.DtPckTo.Value)
    .SetParameterValue("MyBatch", MyUtils.CnvSng(MyFrmGLA43B.TxtBatch.Text))
    .SetParameterValue("MyGLYear", MyUtils.CnvSng(MyFrmGLA43B.TxtGLYear.Text))
    .SetParameterValue("MySuppSame", MyFrmGLA43B.ChkSuppSame.Checked)
   End With
   With Crv1
     .DisplayToolbar = True

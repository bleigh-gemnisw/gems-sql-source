Module PostBCHHDR
  ...
  Const cSrcde As Integer = 2
  Dim ds As DataSet = New DataSet
  Public Sub PstBCHHDR(ByVal BatchNo As Integer, ByVal BatchDate As Integer)
    ...
    Do While Not myGLRBCH.IsEOF
      ...
      If WrkRecovery And Not WrkRecoveryNormal Then
        If Not WrkPosted Then
          dsRec = myLEDGERL1.GetRecoveryTran(myGLRBCH._BCHNO, MyUtils.SetDBDate(MyUtils.GetDBDateMDY(BatchDate)))
...
Cleanup:
  ...
  End Sub
  Private Sub WriteLEDGER(ByVal BatchDate As Integer)
    Dim K As Integer

    With myLEDGER
      ._AMTYP = myGLRBCH._AMTTYP
      ._AUTOG = String.Empty
      ._BALFC = String.Empty
      ._BCHNO = myGLRBCH._BCHNO
      ._CBLCD = String.Empty
      ._CHKN = 0
      ._CNTRL = 0
      ._DATED = MyUtils.SetDBDateMDY(Date.Today)
      ._DPNBR = myGLRBCH._DPNBR
      ._FDNBR = myGLRBCH._FDNBR
      ._FIL10 = 0
      ._FNPGM = myGLRBCH._FNPGM
      ._FSCYR = 0
      ._GLPST = String.Empty
      ._GLTYP = myGLRBCH._GLTYP
      ._INVNR = String.Empty
      ._JRNSQ = myGLRBCH._JRNSEQ
      ._OBNBR = myGLRBCH._OBNBR
      ._ORIG = 0
      ._PONBR = 0
      ._PRF = Mid(MyUserID, 1, 10)
      ._PSTDT = MyUtils.SetDBDate(MyUtils.GetDBDateMDY(BatchDate))
      ._RECLS = String.Empty
      ._REFNO = myGLRBCH._REFNO
      ._ROCR = String.Empty
      ._SFUND = myGLRBCH._SFUND
      ._SRCDE = cSrcde
      ._SUBFN = myGLRBCH._SUBFN
      ._TDATE = MyUtils.SetDBDateMDY(Date.Today)
      ._TDESC = myGLRBCH._DESCR
      ._TRAMT = myGLRBCH._AMT
      ._TRFTO = String.Empty
      Select Case myGLRBCH._TRNTYP
        Case "T"
          ._TRTYP = "B"
          If myGLRBCH._AMTTYP = "D" Then
            ._TRFTO = "T"
          Else
            ._TRFTO = "F"
          End If
        Case "Z"
          ...
          ._ORIG = myGLRBCH._AMT
        Case Else
          ._TRTYP = myGLRBCH._TRNTYP
      End Select
      ._TRNBR = myGLRBCH._TRNBR
      .InsertOneRecordP()
      If .ErrMsg <> "" Then
    ...
    With myGLRBCH
      ...
      If ._GLTYP = "R" And ._TRNTYP = "X" Or ._GLTYP = "X" And ._TRNTYP = "X" Then
        K = LookupFundCtl(._FDNBR, ._GLTYP, ._JACT8)
        FundCtl(K) = ._FDNBR
        FundCtlType(K) = ._GLTYP
        FundCtlTrnbr(K) = ._TRNBR
        FundCtlDate(K) = MyUtils.SetDBDate(MyUtils.GetDBDateMDY(BatchDate))
  ...
  Private Sub UpdateGLEDOBJ()
    ...
    With myGLEDOBJ
      .GetOneRecordP(WrkYear, myGLRBCH._FDNBR, myGLRBCH._SFUND, myGLRBCH._DPNBR, myGLRBCH._OBNBR)
      Select Case Trim(myGLRBCH._TRNTYP)
        Case "B"

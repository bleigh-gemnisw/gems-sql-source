...
#End Region
  ...
  Private Sub FrmGL208B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGL208.SbpScreen.Text = "GL208"
  End Sub
  ...
  Private Sub LnkFuncTo_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LnkFuncTo.LinkClicked
    ...
    Me.Hide()
  End Sub
  Private Sub FrmGL208B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
    Me.Refresh()
  End Sub
  ...
  Private Sub FrmGL208B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    InitFiles()

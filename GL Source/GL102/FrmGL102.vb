...
Friend WithEvents HelpProvider1 As System.Windows.Forms.HelpProvider
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL102))
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarCopy, Me.TBarPrint})
...
#End Region
  ...
  Private Sub FrmGL102_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGL102B = New FrmGL102B
   MyFrmGL102B.MdiParent = Me
   MyFrmGL102B.Show()
 End Sub
Private Sub set_security()
  ...
  Private Sub FrmGL102_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmGL102C.DeleteData()
End Sub
  Private Sub DoBtnNew()
    MyFrmGL102C = New FrmGL102C
    MyFrmGL102C.MdiParent = MyFrmGL102B.ParentForm
    MyFrmGL102C.WrkMode = "Maintain"
    MyFrmGL102C.Show()
    MyFrmGL102B.Hide()
  End Sub
  Private Sub DoBtnCopy()
    MyFrmGL102C = New FrmGL102C
    MyFrmGL102C.MdiParent = MyFrmGL102B.ParentForm
    MyFrmGL102C.WrkFdnbr = MyFrmGL102B.DataGrdView.Item(0, MyFrmGL102B.DataGrdView.CurrentRow.Index).Value
    MyFrmGL102C.WrkSfund = MyFrmGL102B.DataGrdView.Item(1, MyFrmGL102B.DataGrdView.CurrentRow.Index).Value
    MyFrmGL102C.WrkMode = "Copy"
    MyFrmGL102C.Show()
    MyFrmGL102B.Hide()
  End Sub
  Private Sub DoBtnPrint()
    ...
    MyCRViewer.Wrkds = MyFrmGL102B.ds
    MyCRViewer.Show()
  End Sub
  Private Sub DoBtnSave()
  MyFrmGL102C.SaveData()
End Sub

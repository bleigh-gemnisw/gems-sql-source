...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(579, 278)
...
#End Region
 ...
 End Sub
  ...
  Private Sub FrmListGLAcct_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGL102.SbpScreen.Text = "ListGLAcct"
  End Sub
  ...
  Private Sub FrmListGLAcct_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    MyFrmGL102.TBarSave.Enabled = WrkSave
    MyFrmGL102.TBarDelete.Enabled = WrkDelete
    MyFrmGL102C.Show()
  End Sub
  Private Sub FrmListGLAcct_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    WrkSave = MyFrmGL102.TBarSave.Enabled
    WrkDelete = MyFrmGL102.TBarDelete.Enabled
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmGL102C
      ...
      Case "AP"
        .TxtFndAP.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TxtSfndAP.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
        .TxtDptAP.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
        .TxtObjAP.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
        .TxtFcnAP.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
        .TxtSfcnAP.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtFndAP, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      Case "CA"
        .TxtFndCA.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TxtSfndCA.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
        .TxtDptCA.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
        .TxtObjCA.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
        .TxtFcnCA.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
        .TxtSfcnCA.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtFndCA, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      Case "EC"
        .TxtFndEC.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TxtSfndEC.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
        .TxtDptEC.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
        .TxtObjEC.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
        .TxtFcnEC.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
        .TxtSfcnEC.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtFndEC, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      Case "EN"
        .TxtFndEN.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TxtSfndEN.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
        .TxtDptEN.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
        .TxtObjEN.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
        .TxtFcnEN.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
        .TxtSfcnEN.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtFndEN, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      Case "FB"
        .TxtFndFB.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TxtSfndFB.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
        .TxtDptFB.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
        .TxtObjFB.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
        .TxtFcnFB.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
        .TxtSfcnFB.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtFndFB, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      Case "RC"
        .TxtFndRC.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TxtSfndRC.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
        .TxtDptRC.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
        .TxtObjRC.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
        .TxtFcnRC.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
        .TxtSfcnRC.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtFndRC, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      Case "RE"
        .TxtFndRE.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TxtSfndRE.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
        .TxtDptRE.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
        .TxtObjRE.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
        .TxtFcnRE.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
        .TxtSfcnRE.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtFndRE, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      End Select
    End With
    Me.Close()

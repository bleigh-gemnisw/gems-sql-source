...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(112, 5)
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(319, 259)
    Me.DataGrdView.TabIndex = 206
    '
    'FrmListGroup
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(342, 326)
...
#End Region
  ...
  Private Sub FrmListCodes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGL102.SbpScreen.Text = "ListGroup"
  ...
  Private Sub FrmListGroup_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    LblCurrent.Text = "(Group = " & WrkGroup & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmGL102C
      ...
      .Ttp1.SetToolTip(.TxtGroup, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      .Show()
  End With

...
#End Region
Private Sub FrmGL661B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
  WrkDept = MyUtils.CnvSng(TxtPos.Text)
  FormatGrid()
  WrkDept = 0
  TxtPos.Text = ""
End Sub
...
End Sub
Public Sub ShowGrid()
  ds = myGLDEP.PosData(MyUtils.CnvSng(TxtPos.Text), 0)
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
  myGLDEP.CloseFile()
End Sub
Private Sub FrmGL661B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmGL661.SbpScreen.Text = "GL661B"
  MyFrmGL661.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmGL661C.MdiParent = Me.ParentForm
  MyFrmGL661C.WrkDept = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmGL661C.Show()
  Me.Hide()
End Sub
End Class

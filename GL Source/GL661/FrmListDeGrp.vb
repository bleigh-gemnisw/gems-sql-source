...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(17, 51)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(271, 263)
...
#End Region
  ...
  Private Sub FrmListCodes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGL661.SbpScreen.Text = "ListDeGrp"
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    Windows.Forms.Cursor.Current = Cursors.WaitCursor
      ...
      With MyFrmGL661C
        .TxtDeGrp.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtDeGrp, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
        .Show()
      End With
    Me.Close()
...
End Sub
Private Sub FrmListDeGrp_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  'Memory Cleanup
  myGLDEPGRP = Nothing
  MyFrmListDegrp = Nothing
End Sub
End Class

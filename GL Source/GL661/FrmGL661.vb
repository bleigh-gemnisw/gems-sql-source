...
Friend WithEvents TBarNarr As System.Windows.Forms.ToolBarButton
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    Me.components = New System.ComponentModel.Container()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL661))
    ...
    Me.TBarNarr = New System.Windows.Forms.ToolBarButton()
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarNarr, Me.TBarSep2, Me.TBarPrint})
    ...
    'TBarNarr
    '
    Me.TBarNarr.ImageIndex = 5
    Me.TBarNarr.Name = "TBarNarr"
    Me.TBarNarr.Text = "Narratives"
    '
    'TBarSep2
    '
    ...
    Me.Text = "Department Maintainence"
...
#End Region
 ...
 Private Sub FrmGL661_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGL661B = New FrmGL661B
   MyFrmGL661B.MdiParent = Me
   MyFrmGL661B.Show()
 End Sub
Private Sub set_security()
 ...
 If e.Button Is TBarSave Then
   DoBtnSave()
 End If
 If e.Button Is TBarNarr Then
   DoBtnNarr()
 End If
 End Sub

Private Sub FrmGL661_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmGL661C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmGL661C = New FrmGL661C
  MyFrmGL661C.MdiParent = MyFrmGL661B.ParentForm
  MyFrmGL661C.WrkDept = 0
  MyFrmGL661C.Show()
  MyFrmGL661B.Hide()
  End Sub
Private Sub DoBtnNarr()
  MyFrmDEPNARL = New FrmDEPNARL
  MyFrmDEPNARL.MdiParent = MyFrmGL661C.ParentForm
  MyFrmDEPNARL.WrkDept = MyUtils.CnvSng(MyFrmGL661C.TxtDept.Text)
  MyFrmDEPNARL.Show()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmGL661B.ds
  MyCRViewer.Show()
  TBarPrint.Enabled = True
End Sub
Private Sub DoBtnSave()
  Select Case Me.SbpScreen.Text
  Case "DEPNARL"
    MyFrmDEPNARL.SaveData()
  Case "GL661C"
    MyFrmGL661C.SaveData()
  End Select
End Sub

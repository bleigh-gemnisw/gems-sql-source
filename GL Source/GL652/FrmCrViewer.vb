...
End Sub
  ...
  Private Sub RunReport1()
   ...
   Dim WrkYear As Integer
    ...
    WrkYear = MyUtils.CnvSng(MyFrmGL652B.LblToYear.Text)
    Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtGL652.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Budget Worksheet")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFund", MyUtils.CnvSng(MyFrmGL652B.TxtFund.Text))
    .SetParameterValue("MyDept", MyUtils.CnvSng(MyFrmGL652B.TxtDept.Text))
    ...
    .SetParameterValue("MyNextYrs1", BuildYears(WrkYear, 1))
    .SetParameterValue("MyNextYrs2", BuildYears(WrkYear, 2))
    .SetParameterValue("MyNextYrs3", BuildYears(WrkYear, 3))
    .SetParameterValue("MyNextYrs4", BuildYears(WrkYear, 4))
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReportTot()
   ...
   Dim WrkYear As Integer
    ...
    WrkYear = MyUtils.CnvSng(MyFrmGL652B.LblToYear.Text)
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtGL652Tot.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetDataSource(wrkdsTot)
    .SetParameterValue("myreportTitle", "Budget Summary")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFund", MyUtils.CnvSng(MyFrmGL652B.TxtFund.Text))
    .SetParameterValue("MyDept", MyUtils.CnvSng(MyFrmGL652B.TxtDept.Text))

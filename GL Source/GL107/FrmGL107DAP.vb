Public Class FrmGL107DAP
  Inherits System.Windows.Forms.Form
  Dim myLEDGERAP As LEDGERAP.MyData
  Dim myLEDHSTL1 As LEDHSTL1.MyData

  Friend WrkDate As Date
  Friend WrkInvoice As String
...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.LblInvoice.Location = New System.Drawing.Point(72, 9)
    Me.LblInvoice.Name = "LblInvoice"
    Me.LblInvoice.Size = New System.Drawing.Size(54, 13)
    Me.LblInvoice.TabIndex = 342
    ...
    Me.LblDebit.Location = New System.Drawing.Point(547, 15)
    Me.LblDebit.Name = "LblDebit"
    Me.LblDebit.Size = New System.Drawing.Size(89, 16)
    Me.LblDebit.TabIndex = 360
    ...
    Me.Label30.Location = New System.Drawing.Point(507, 30)
    Me.Label30.Name = "Label30"
    Me.Label30.Size = New System.Drawing.Size(34, 13)
    Me.Label30.TabIndex = 358
    ...
    Me.Label29.Location = New System.Drawing.Point(507, 18)
    Me.Label29.Name = "Label29"
    Me.Label29.Size = New System.Drawing.Size(32, 13)
    Me.Label29.TabIndex = 357
...
#End Region
  ...
  Private Sub FrmGL107DAP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    Dim ds As DataSet = New DataSet
    Dim WrkDBDate As Integer

    If MyIsLedger Then
      myLEDGERAP = New LEDGERAP.MyData()
      myLEDGERAP.MyDBConn = myDBConnect
    Else
    ...
    If MyIsLedger Then
      ds = myLEDGERAP.GetInvoice(WrkDBDate, WrkInvoice, WrkBchno, 999)
    Else
      ds = myLEDHSTL1.GetInvoice(WrkDBDate, WrkInvoice, WrkBchno, 999)
    End If
  ...
  Public Sub FormatGrid(ByVal ds As DataSet)
    ...
    End With
  End Sub
  Private Sub FrmGL107DAP_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    MyFrmGL107C.Show()
  End Sub
  Private Sub FrmGL107DAP_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGL107.SbpScreen.Text = "GL107DAP"

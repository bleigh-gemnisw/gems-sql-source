Public Class FrmGL107DTX
  Inherits System.Windows.Forms.Form
  Dim myLEDGERTX As LEDGERTX.MyData
...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.LblDebit.Location = New System.Drawing.Point(552, 11)
    ...
    Me.LblCredit.Location = New System.Drawing.Point(552, 27)
    ...
    Me.Label30.Location = New System.Drawing.Point(512, 27)
    ...
    Me.Label29.Location = New System.Drawing.Point(512, 14)
...
#End Region
  ...
  Private Sub FrmGL107DTX_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    Dim ds As DataSet = New DataSet
    Dim WrkDBDate As Integer
    If MyIsLedger Then
      myLEDGERTX = New LEDGERTX.MyData()
      myLEDGERTX.MyDBConn = myDBConnect
    Else
    ...
    If MyIsLedger Then
      ds = myLEDGERTX.GetBchno(WrkDBDate, WrkBchno, 999)
    Else
      ds = myLEDHSTL1.GetBchnoTX(WrkDBDate, WrkBchno, 999)
    End If
  ...
  Public Sub FormatGrid(ByVal ds As DataSet)
    ...
    End With
  End Sub
  Private Sub FrmGL107DTX_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    MyFrmGL107C.Show()
  End Sub
  Private Sub FrmGL107DTX_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGL107.SbpScreen.Text = "GL107DTX"

...
Friend WithEvents SbpFiller As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL505))
    ...
    Me.TbMain.Size = New System.Drawing.Size(632, 50)
    ...
    Me.SbMain.Size = New System.Drawing.Size(632, 28)
    ...
    Me.Text = "Maintain Budget Headings"
...
Private Sub FrmGL505_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmGL505B = New FrmGL505B
  MyFrmGL505B.MdiParent = Me
  MyFrmGL505B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmGL505_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "GL505B" Then
    MyFrmGL505.Close()
  Else
    MyFrmGL505B.Show()
  End If

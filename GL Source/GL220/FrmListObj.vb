...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(315, 263)
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = myGLObj.PosData(MyUtils.CnvSng(TxtObj.Text))
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListObj_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGL220.SbpScreen.Text = "ListObj"
  End Sub
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListObj_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    MyFrmGL220B.Show()
  End Sub
  Private Sub FrmListObj_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myGLObj = New GLOBJT.MyData()
    myGLObj.MyDBConn = myDBConnect
    If WrkObj > 0 Then
      TxtObj.Text = WrkObj
      LblCurrent.Text = "(Object =" & WrkObj & ")"
    End If
    FormatGrid()
  End Sub
  ...
  Windows.Forms.Cursor.Current = Cursors.WaitCursor
    ...
    With MyFrmGL220B
      If WrkID = "From" Then
        .TxtObjFrom.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
      Else
        .TxtObjTo.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
      End If
    End With
    Me.Close()

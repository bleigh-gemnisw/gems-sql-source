...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGLA34.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    .SetParameterValue("MyFromDate", MyFrmGLA34B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGLA34B.DtPckTo.Value)
    .SetParameterValue("MyBatch", MyUtils.CnvSng(MyFrmGLA34B.TxtBatch.Text))
   End With
   With Crv1
     .DisplayToolbar = True

...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents Ttp1 As System.Windows.Forms.ToolTip
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA35D))
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(12, 52)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(562, 328)
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    For I = 0 To (DataGrdView.RowCount - 1)
  ...
  End Sub
  Private Sub FrmGLA35D_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGLA35.SbpScreen.Text = "GLA35D"
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    MyFrmGLA35E.MdiParent = Me.ParentForm
    MyFrmGLA35E.WrkBatchNo = WrkBatchNo
    MyFrmGLA35E.WrkTran = MyUtils.CnvSng(DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value)
    MyFrmGLA35E.WrkSeq = MyUtils.CnvSng(DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
    MyFrmGLA35E.Show()
    Me.Hide()
  End Sub
  Private Sub FrmGLA35D_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    With MyFrmGLA35
      .TBarNew.Text = "New"
  ...
  Private Sub ShowSeq()
    ...
    myMSCBCH.GetOneRecordP(WrkBatchNo, WrkBatchNo, MyUtils.CnvSng(TxtSeq.Text))
    If myMSCBCH.RecordNotFound Then

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA35))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSave, Me.TBarCreate, Me.TBarNew, Me.TBarSep1, Me.TBarDelete, Me.TBarSep2, Me.TBarPrtEdits, Me.TBarPost})
...
Me.Text = "Maintain Misc Journal Entries"
...
#End Region
    ...
    Private Sub FrmGLA35_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      MyFrmGLA35B = New FrmGLA35B
      MyFrmGLA35B.MdiParent = Me
      MyFrmGLA35B.Show()
...
End Sub
    ...
    Private Sub tbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
      ...
      If e.Button Is TBarSave Then
        If SbpScreen.Text = "GLA35E" Then
          MyFrmGLA35E.SaveData()
          Exit Sub
        End If
      End If
    ...
    If MyFrmGLA35B.DataGrdView.RowCount = 0 Then Exit Sub

    If e.Button Is TBarDelete Then
'        PassSecurity = GetFNDSEC(MyFrmGLA35B.C1DataGrdList.Item(MyFrmGLA35B.C1DataGrdList.Row, 4))
...
'        If Not PassSecurity Then Exit Sub
      ...
      WrkBatchNo = MyFrmGLA35B.DataGrdView.Item(0, MyFrmGLA35B.DataGrdView.CurrentRow.Index).Value
...
'        If Not PassSecurity Then Exit Sub
  ...
  Private Sub FrmGLA35_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    Dim Cancel As Boolean

    If MyFrmGLA35.SbpScreen.Text = "GLA35C" Then
      If Cancel Then
        e.Cancel = True
      End If
      Exit Sub
...
Private Sub DoBtnDelete()
  ...
  Select Case Me.SbpScreen.Text
  Case "GLA35B"
    MyFrmGLA35B.DeleteData(Cancel)
  Case "GLA35C"
'		MyFrmGLA35C.DeleteData(Cancel)
  Case "GLA35E"
    MyFrmGLA35E.DeleteData(Cancel)
...
Private Sub DoBtnCreate()
  MyFrmGLA35B_New = New FrmGLA35B_New
  MyFrmGLA35B_New.MdiParent = MyFrmGLA35B.ParentForm
  MyFrmGLA35B_New.Show()
  MyFrmGLA35B.Hide()
End Sub
Private Sub DoBtnNew()
 Select Case Me.SbpScreen.Text
 Case "GLA35D"
  MyFrmGLA35E = New FrmGLA35E
  MyFrmGLA35E.MdiParent = MyFrmGLA35B.ParentForm
  MyFrmGLA35E.WrkBatchNo = MyFrmGLA35D.WrkBatchNo
  MyFrmGLA35E.WrkTran = MyFrmGLA35D.WrkTran
  MyFrmGLA35E.WrkSeq = 0
  MyFrmGLA35E.Show()
  MyFrmGLA35D.Hide()
 End Select
End Sub
...
End Function
  ...
  Private Sub FrmGLA35_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

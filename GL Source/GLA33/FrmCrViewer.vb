...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGLA33.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Treasury Receipts Errors")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmGLA33B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGLA33B.DtPckTo.Value)
    .SetParameterValue("MyBatch", MyUtils.CnvSng(MyFrmGLA33B.TxtBatch.Text))
   End With
   With Crv1
     .DisplayToolbar = True

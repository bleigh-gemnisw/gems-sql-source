...
Module PrintReport
  ...
  Public Sub PrtReport()
    ...
    If MyFrmGL216B.RbFileCurr.Checked Then
      GetDetail()
    Else
      GetDetailHst()
    End If
...
NextRec:
  ...
  Private Sub GetBalance()
          ...
          Case "R"
            If .Item("pstdt") >= WrkDateFrom Then
              Select Case .Item("trtyp")
                ...
                Case Else
                  If WrkDtPost.Month = MyFrmGL216B.DtPckTo.Value.Month And WrkDtPost.Year = MyFrmGL216B.DtPckTo.Value.Year Then
    ...
    End If
    With myLEDGERQ
      If WrkBudget <> 0 Or WrkRemain <> 0 Or WrkExpend <> 0 Then

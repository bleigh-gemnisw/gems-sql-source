...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL660))
...
Me.Text = "Department Group Maintainence"
...
#End Region
 ...
 Private Sub FrmGL660_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGL660B = New FrmGL660B
   MyFrmGL660B.MdiParent = Me
   MyFrmGL660B.Show()
 End Sub
...
Private Sub FrmGL660_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "GL660B" Then
    MyFrmGL660.Close()
  Else
    MyFrmGL660C.Close()
    MyFrmGL660B.Show()
...
Private Sub DoBtnDelete()
  MyFrmGL660C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmGL660C = New FrmGL660C
  MyFrmGL660C.MdiParent = MyFrmGL660B.ParentForm
  MyFrmGL660C.WrkCode = 0
  MyFrmGL660C.Show()
  MyFrmGL660B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmGL660B.ds
  MyCRViewer.Show()
  TBarPrint.Enabled = True
End Sub
Private Sub DoBtnSave()
  MyFrmGL660C.SaveData()
End Sub

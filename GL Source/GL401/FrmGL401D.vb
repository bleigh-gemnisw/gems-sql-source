Public Class FrmGL401D
  ...
  Friend WithEvents DtPckEnter As System.Windows.Forms.DateTimePicker
...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL401D))
    ...
    Me.DtPckEnter = New System.Windows.Forms.DateTimePicker()
    ...
    Me.C1DataGrdList.Size = New System.Drawing.Size(613, 169)
    ...
    Me.LblDebit.Location = New System.Drawing.Point(547, 12)
    ...
    'Label6
    '
    Me.Label6.Location = New System.Drawing.Point(471, 12)
    ...
    Me.LblCredit.Location = New System.Drawing.Point(547, 30)
    ...
    'Label3
    '
    Me.Label3.Location = New System.Drawing.Point(471, 30)
    ...
    Me.GrpType.Location = New System.Drawing.Point(469, 244)
    ...
    Me.TxtDescr.Location = New System.Drawing.Point(234, 274)
    Me.TxtDescr.MaxLength = 30
    Me.TxtDescr.Name = "TxtDescr"
    Me.TxtDescr.Size = New System.Drawing.Size(229, 20)
    Me.TxtDescr.TabIndex = 248
    '
    'Label7
    '
    Me.Label7.AutoSize = True
    Me.Label7.Location = New System.Drawing.Point(167, 275)
    ...
    Me.TxtAmount.Location = New System.Drawing.Point(69, 275)
    ...
    'DtPckEnter
    '
    Me.DtPckEnter.Format = System.Windows.Forms.DateTimePickerFormat.[Short]
    Me.DtPckEnter.Location = New System.Drawing.Point(330, 301)
    Me.DtPckEnter.Name = "DtPckEnter"
    Me.DtPckEnter.Size = New System.Drawing.Size(84, 20)
    Me.DtPckEnter.TabIndex = 456
    '
    'FrmGL401D
    '
...
#End Region
  ...
  Public Sub FormatGrid()
    ...
    With C1DataGrdList
      ...
      .Columns(12).Caption = "Acct Description"
  ...
  Public Sub ShowGrid()
    ...
    Dim I As Integer
    ds = myGLEBCHL1.GetViewbyBatch(WrkBatchNo, WrkTran, 9999)
  ...
  Private Sub RefreshDs(ByRef ds As DataSet)
    ...
    Next
  End Sub
  Private Sub FrmGL401D_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGL401.SbpScreen.Text = "GL401D"
    ...
    If C1DataGrdList.Item(C1DataGrdList.Row, 1) > 0 Then
      ...
      With myGLEBCH
        ...
        If ._REFNO > 0 Then
          TxtRef.Text = ._REFNO
        End If
        DtPckEnter.Value = MyUtils.GetDBDate(._JENT8)
      End With
      BtnAddDtl.Text = "Update Item"
      BtnRemDtl.Enabled = True
    End If
  End Sub
  Private Sub FrmGL401D_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    With MyFrmGL401
      .TBarNew.Text = "New"
  ...
  Public Sub SaveDtl()
    ...
    If WrkTran = 0 Then
      WrkTran = myGLEBCH.AutoGenTran(WrkBatchNo)
    End If
    WrkSeq = MyUtils.CnvSng(LblSeq.Text)
    If WrkSeq = 0 Then
      WrkSeq = myGLEBCH.AutoGenSeq(WrkBatchNo, WrkTran)
    End If
    myGLEBCH.GetOneRecordP(WrkBatchNo, WrkTran, WrkSeq)
    ...
    If Not myGLEBCH.RecordNotFound Then
      MovetoFile()
      EditChecks(ErrorField, ErrorMsg)
      If IsNothing(ErrorMsg(0)) Then
        myGLEBCH.UpdateOneRecordP()
      Else
  ...
  Private Sub MovetoFile()
    With myGLEBCH
      ...
      If GrpType.Visible Then
        ...
        ._JACT8 = MyUtils.SetDBDate(DtPckEnter.Value)
        ._JENT8 = MyUtils.SetDBDate(DtPckEnter.Value)
      Else
        ._TRNTYP = C1DataGrdList.Item(0, 9)
        ._JACT8 = MyUtils.SetDBDate(MyUtils.GetDBDateMDY(C1DataGrdList.Item(0, 11)))
        ._JENT8 = MyUtils.SetDBDate(MyUtils.GetDBDateMDY(C1DataGrdList.Item(0, 11)))
      End If
  ...
  Private Sub EditChecks(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
    ...
    If MyUtils.CnvSng(TxtAmount.Text) = 0 Then
      ErrorField(I) = "amt"
      ErrorMsg(I) = "Amount cannot be zero"
      I = I + 1
    End If
    ...
    If Trim(myBCHHDR._FREEA) <> "PR" Then 'Payroll can be any fund
      If C1DataGrdList.VisibleRows > 0 And C1DataGrdList.Item(0, 9) = "X" Then
        If MyUtils.CnvSng(TxtFund.Text) <> C1DataGrdList.Item(0, 2) Then
          ErrorField(I) = "fund"
          ErrorMsg(I) = "Cannot mix Funds"
          I = I + 1
        End If
      End If
    End If

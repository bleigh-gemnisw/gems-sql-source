...
Friend WithEvents TBarImport As System.Windows.Forms.ToolBarButton
  Friend WithEvents TBarLayout As ToolBarButton
  Friend WithEvents HelpProvider1 As System.Windows.Forms.HelpProvider
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    Me.components = New System.ComponentModel.Container()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL401))
    ...
    Me.TBarPrinters = New System.Windows.Forms.ToolBarButton()
        ...
        Me.imageList1.Images.SetKeyName(6, "update all_24.png")
        Me.imageList1.Images.SetKeyName(7, "Printer Setup.png")
        Me.imageList1.Images.SetKeyName(8, "scroll.ico")
        '
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSave, Me.TBarCreate, Me.TBarImport, Me.TBarNew, Me.TBarSep1, Me.TBarDelete, Me.TBarSep2, Me.TBarPrtEdits, Me.TBarPost, Me.TBarPrinters, Me.TBarLayout})
        ...
        Me.TBarImport.Text = "Import File"
        '
        'TBarNew
        '
        ...
        Me.Text = "Maintain Journal Entries"
...
#End Region
    ...
    Private Sub FrmGL401_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      MyFrmGL401B = New FrmGL401B
      MyFrmGL401B.MdiParent = Me
      MyFrmGL401B.Show()
...
End Sub
    ...
    Private Sub tbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
     ...
     End If
      ...
      If MyFrmGL401B.C1DataGrdList.VisibleRows = 0 Then Exit Sub

      If e.Button Is TBarDelete Then
'        PassSecurity = GetFNDSEC(MyFrmGL401B.C1DataGrdList.Item(MyFrmGL401B.C1DataGrdList.Row, 4))
...
'        If Not PassSecurity Then Exit Sub
        ...
        WrkBatchNo = MyFrmGL401B.C1DataGrdList.Item(MyFrmGL401B.C1DataGrdList.Row, 0)
...
'        If Not PassSecurity Then Exit Sub
  ...
  Private Sub FrmGL401_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    Dim Cancel As Boolean

    If MyFrmGL401.SbpScreen.Text = "GL401C" Then
      If Cancel Then
        e.Cancel = True
      End If
      Exit Sub
...
Private Sub DoBtnBack()
  ...
  Case "GL401B"
    MyFrmGL401B.Close()
  Case "GL401B_New"
    MyFrmGL401B_New.Close()
    MyFrmGL401B.Show()
  Case "GL401B_Import"
    MyFrmGL401B_Import.Close()
    MyFrmGL401B.Show()
  Case "GL401C"
    MyFrmGL401C.Close()
  Case "GL401D"
...
Private Sub DoBtnDelete()
  ...
  Select Case Me.SbpScreen.Text
  Case "GL401B"
    MyFrmGL401B.DeleteData(Cancel)
  Case "GL401C"
    MyFrmGL401C.DeleteData(Cancel)
  End Select

End Sub
Private Sub DoBtnCreate()
  MyFrmGL401B_New = New FrmGL401B_New
  MyFrmGL401B_New.MdiParent = MyFrmGL401B.ParentForm
  MyFrmGL401B_New.Show()
  MyFrmGL401B.Hide()
End Sub
Private Sub DoBtnImport()
  MyFrmGL401B_Import = New FrmGL401B_Import
  MyFrmGL401B_Import.MdiParent = MyFrmGL401B.ParentForm
  MyFrmGL401B_Import.Show()
  MyFrmGL401B.Hide()
End Sub
  ...
  Private Sub DoBtnNew()
    Select Case Me.SbpScreen.Text
      Case "GL401C"
        ...
        MyFrmGL401D.MdiParent = MyFrmGL401C.ParentForm
        MyFrmGL401D.WrkBatchNo = MyFrmGL401C.WrkBatchNo
        MyFrmGL401D.WrkTran = 0
        MyFrmGL401D.Show()
        FrmGL401C.Hide()
    End Select
  End Sub
  ...
  WrkBatchNo = MyFrmGL401B.C1DataGrdList.Item(MyFrmGL401B.C1DataGrdList.Row, 0)
  Errors = PrtEdits(WrkBatchNo, Post)

  Return Errors
End Function

  Private Sub FrmGL401_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

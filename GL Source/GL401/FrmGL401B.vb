...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL401B))
...
#End Region
  ...
  Private Sub FrmGL401B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGL401.SbpScreen.Text = "GL401B"
    With MyFrmGL401
  ...
  Private Sub C1DataGrdList_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
    ...
    OpenBatch()
    MyFrmGL401.TBarNew.Enabled = False
    MyFrmGL401.TBarDelete.Enabled = False
    MyFrmGL401C = New FrmGL401C
    MyFrmGL401C.MdiParent = Me.ParentForm
    MyFrmGL401C.WrkBatchNo = WrkBatchNo
    MyFrmGL401C.Show()
    Me.Hide()
  ...
  Public Sub DeleteData(ByRef Cancel As Boolean)
    ...
    MyFrmDltBch.MdiParent = MyFrmGL401B.ParentForm
  ...
  Private Sub C1DataGrdList_FetchRowStyle(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.FetchRowStyleEventArgs) Handles C1DataGrdList.FetchRowStyle
    ...
    End If
  End Sub
  Private Sub FrmGL401B_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    'Memory Cleanup
    myBCHHDR = Nothing
    MyFrmGL401B = Nothing
  End Sub

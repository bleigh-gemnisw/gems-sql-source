Module PrintEdits
  ...
  Public Function PrtEdits(ByVal BatchNo As Integer, ByVal Post As Boolean) As Boolean
    ...
    myGLEBCH.GetOneRecordP(BatchNo, 0, 0)
    ...
    Do While Not myGLEBCH.IsEOF
      ...
      With myGLEBCH
        ...
        If ._JRNSEQ > 0 Then
          ...
          dr("acct") = WrkAcct
          dr("acctdesc") = WrkAcct & " " & myGLACCT._GLDSC
          If myGLACCT.RecordNotFound Then
            dr("acctdesc") = WrkAcct & " " & "*** Invalid Account ***"
            dr("errmsg") = "*** Invalid Account ***"
            WrkError = True
          Else
            If myGLACCT._ACREC = "I" Then
              dr("acctdesc") = WrkAcct & " " & "*** Inactive Account ***"
              dr("errmsg") = "*** Inactive Account ***"
              WrkError = True
            End If
            If myGLACCT._GLTYP = "H" Then
              dr("acctdesc") = WrkAcct & " " & "*** Header Account ***"

Public Class FrmCr_PrtEdits
  ...
  Friend WithEvents TpAcct As TabPage
...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents TpAcctSum As System.Windows.Forms.TabPage
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.TpAcctSum = New System.Windows.Forms.TabPage()
    ...
    Me.TabCtl1.Controls.Add(Me.TpAcctSum)
    ...
    'TpAcctSum
    '
    Me.TpAcctSum.Controls.Add(Me.Crv3)
    Me.TpAcctSum.Location = New System.Drawing.Point(4, 22)
    Me.TpAcctSum.Name = "TpAcctSum"
    Me.TpAcctSum.Size = New System.Drawing.Size(632, 318)
    Me.TpAcctSum.TabIndex = 2
    Me.TpAcctSum.Text = "Acct Summary"
    Me.TpAcctSum.UseVisualStyleBackColor = True
    '
    'Crv3
    '
    ...
    Me.TpAcct.TabIndex = 3
    Me.TpAcct.Text = "Acct Detail"
    ...
    Me.TpAcctSum.ResumeLayout(False)
...
#End Region
  ...
  Private Sub RptEditBySeqNo()
    ...
    ReportPath = MyUtils.GetReportPath("PrtGL401.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      If MyAppSettings.Printer <> "" Then
  ...
  Private Sub RptEditByAcct()
    ...
    ReportPath = MyUtils.GetReportPath("PrtGL401C.rpt", myTOWN._TOWNBR)
    With myreport2
      .Load(ReportPath)
      If MyAppSettings.Printer <> "" Then
        .PrintOptions.PrinterName = MyAppSettings.Printer
      ...
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      If WrkPost Then
        .SetParameterValue("MyReportTitle", "Detail of Entries Posted To LEDGER")
      Else
        .SetParameterValue("MyReportTitle", "Detail of Entries To Be Posted To LEDGER")
      End If
      .SetParameterValue("MyPost", WrkPost)
      .SetParameterValue("MyError", WrkError)
      If MyAppSettings.Printer <> "" Then
  ...
  End Sub
  Private Sub RptEditByAcctSum()
    Dim ReportPath As String

    ReportPath = MyUtils.GetReportPath("PrtGL401B.rpt", myTOWN._TOWNBR)
    With myreport3
      .Load(ReportPath)
      If MyAppSettings.Printer <> "" Then
        .PrintOptions.PrinterName = MyAppSettings.Printer

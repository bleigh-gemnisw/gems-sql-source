...
Friend WithEvents TTp1 As System.Windows.Forms.ToolTip
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    'Label4
    '
    Me.Label4.Location = New System.Drawing.Point(243, 65)
    ...
    Me.TxtDept.Location = New System.Drawing.Point(195, 61)
    ...
    Me.LblToYear.Location = New System.Drawing.Point(256, 89)
    ...
    Me.Label7.Location = New System.Drawing.Point(243, 93)
    ...
    Me.TxtFromYear.Location = New System.Drawing.Point(195, 89)
    ...
    Me.Label3.Location = New System.Drawing.Point(85, 93)
...
#End Region
  ...
  End Sub
  Private Sub FrmGL651B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  End Sub
  Private Sub FrmGL651B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmGL651.SbpScreen.Text = "GL651B"
  End Sub
  Private Sub FrmGL651B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
    Me.Refresh()
  End Sub
  ...
  Private Sub TxtDept_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtDept.KeyPress
    e.Handled = MyUtils.FilterNumbers(e.KeyChar, False, False)
  End Sub
  Private Sub TxtFromYear_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtFromYear.KeyPress
    e.Handled = MyUtils.FilterNumbers(e.KeyChar, False, False)
  End Sub

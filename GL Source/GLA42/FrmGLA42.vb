...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA42))
...
#End Region
 ...
 Private Sub FrmGLA42_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGLA42B = New FrmGLA42B
   MyFrmGLA42B.MdiParent = Me
   MyFrmGLA42B.Show()
 End Sub
...
Private Sub FrmGLA42_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmGLA42C.DeleteData()
End Sub
Private Sub DoBtnMass()
  MyFrmGLA42B.MassCopy()
End Sub
Private Sub DoBtnNew()
  MyFrmGLA42C = New FrmGLA42C
  MyFrmGLA42C.MdiParent = MyFrmGLA42B.ParentForm
  MyFrmGLA42C.WrkCode = String.Empty
  MyFrmGLA42C.Show()
  MyFrmGLA42B.Hide()
End Sub
Private Sub DoBtnPrint()
  MyFrmGLA42B.PrintData()
End Sub
Private Sub DoBtnSave()
  MyFrmGLA42C.SaveData()
End Sub

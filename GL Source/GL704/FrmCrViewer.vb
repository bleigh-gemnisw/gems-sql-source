...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGL704.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(ds)
    ...
    .SetParameterValue("MyFromDate", MyFrmGL704B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGL704B.DtPckTo.Value)
    .SetParameterValue("MyFromFund", MyUtils.CnvSng(MyFrmGL704B.TxtFundFrom.Text))
    '.SetParameterValue("MyToFund", MyUtils.CnvSng(MyFrmGL704B.TxtToFund.Text))
   End With
   With Crv1
     .DisplayToolbar = True

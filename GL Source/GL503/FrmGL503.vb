...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL503))
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarSave, Me.TBarPrint})
    ...
    Me.ImageList1.Images.SetKeyName(3, "checked_24.png")
    '
    'SbMain
    '
...
#End Region
  ...
  Private Sub FrmGL503_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    If MyFrmGL503B.RbBamt1.Checked Then MyAppSettings.Selection = 1
    If MyFrmGL503B.RbBamt2.Checked Then MyAppSettings.Selection = 2
    If MyFrmGL503B.RbBamt3.Checked Then MyAppSettings.Selection = 3
    If MyFrmGL503B.RbBamt4.Checked Then MyAppSettings.Selection = 4
    If MyFrmGL503B.RbNarr.Checked Then MyAppSettings.Selection = 5
    SaveAppSettings()
  End Sub

Private Sub FrmGL503_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmGL503B = New FrmGL503B
  MyFrmGL503B.MdiParent = MyFrmGL503
  MyFrmGL503B.Show()
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmGL503_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmGL503B.PrintData()
End Sub
Private Sub DoBtnSave()
  MyFrmGL503B.SaveData()
End Sub

...
Partial Public Class GL530
    ...
    Partial Public Class mytableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddmytableRow(ByVal ACCT As String, ByVal DESC As String, ByVal AMOUNT As Decimal, ByVal ERRORMSG As String) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {ACCT, DESC, AMOUNT, ERRORMSG}

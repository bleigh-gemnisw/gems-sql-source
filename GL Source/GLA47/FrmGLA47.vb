...
Friend WithEvents TBarMass As System.Windows.Forms.ToolBarButton
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    Me.components = New System.ComponentModel.Container()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA47))
    ...
    Me.TBarMass = New System.Windows.Forms.ToolBarButton()
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarMass, Me.TBarPrint})
    Me.TbMain.DropDownArrows = True
    Me.TbMain.ImageList = Me.ImageList1
    Me.TbMain.Location = New System.Drawing.Point(0, 0)
    Me.TbMain.Name = "TbMain"
    Me.TbMain.ShowToolTips = True
    Me.TbMain.Size = New System.Drawing.Size(613, 50)
    ...
    'TBarMass
    '
    Me.TBarMass.ImageIndex = 5
    Me.TBarMass.Name = "TBarMass"
    Me.TBarMass.Text = "Mass Copy"
    '
    'TBarPrint
    '
    ...
    Me.SbMain.Size = New System.Drawing.Size(613, 28)
    ...
    Me.ClientSize = New System.Drawing.Size(613, 614)
...
#End Region
 ...
 Private Sub FrmGLA47_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGLA47B = New FrmGLA47B
   MyFrmGLA47B.MdiParent = Me
   MyFrmGLA47B.Show()
 End Sub
...
Private Sub FrmGLA47_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmGLA47C.DeleteData()
End Sub
Private Sub DoBtnMass()
  MyFrmGLA47B.MassCopy()
End Sub
Private Sub DoBtnNew()
  MyFrmGLA47C = New FrmGLA47C
  MyFrmGLA47C.MdiParent = MyFrmGLA47B.ParentForm
  MyFrmGLA47C.WrkCode = String.Empty
  MyFrmGLA47C.Show()
  MyFrmGLA47B.Hide()
End Sub
Private Sub DoBtnPrint()
  MyFrmGLA47B.PrintData()
End Sub
Private Sub DoBtnSave()
  MyFrmGLA47C.SaveData()
End Sub

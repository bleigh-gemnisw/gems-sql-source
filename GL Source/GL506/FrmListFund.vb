...
#End Region
  ...
  MyFrmGL506.SbpScreen.Text = "ListFund"
  End Sub
 ...
 Private Sub FrmListFund_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
  MyFrmGL506.TBarSave.Enabled = WrkSave
  MyFrmGL506.TBarDelete.Enabled = WrkDelete
  MyFrmGL506C.Show()
 End Sub
  ...
  WrkSave = MyFrmGL506.TBarSave.Enabled
  WrkDelete = MyFrmGL506.TBarDelete.Enabled

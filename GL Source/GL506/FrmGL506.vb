...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL506))
...
#End Region
  ...
  Private Sub FrmGL506_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmGL506B = New FrmGL506B
    MyFrmGL506B.MdiParent = Me
    MyFrmGL506B.Show()
  End Sub
  ...
  Private Sub FrmGL506_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnDelete()
    MyFrmGL506C.DeleteData()
  End Sub
  Private Sub DoBtnNew()
    MyFrmGL506C = New FrmGL506C
    MyFrmGL506C.MdiParent = MyFrmGL506B.ParentForm
    MyFrmGL506C.WrkUsrprf = ""
    MyFrmGL506C.Show()
    MyFrmGL506B.Hide()
  End Sub
  Private Sub DoBtnPrint()
    ...
    MyCRViewer.Wrkds = MyFrmGL506B.ds
    MyCRViewer.Show()
  End Sub
  Private Sub DoBtnSave()
    MyFrmGL506C.SaveData()
  End Sub

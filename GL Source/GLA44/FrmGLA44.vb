...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA44))
...
Me.Text = "Tax Interface To Munis"
...
#End Region
 ...
 Private Sub FrmGLA44_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGLA44B = New FrmGLA44B
   MyFrmGLA44B.MdiParent = Me
   MyFrmGLA44B.Show()
 End Sub
...
Private Sub FrmGLA44_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  If MyFrmGLA44B.RbAccts.Checked Then
    MyFrmGLA44C.DeleteData()
  Else
    MyFrmGLA44D.DeleteData()
  End If
End Sub
Private Sub DoBtnNew()
  If MyFrmGLA44B.RbAccts.Checked Then
    MyFrmGLA44C = New FrmGLA44C
    MyFrmGLA44C.MdiParent = MyFrmGLA44B.ParentForm
    MyFrmGLA44C.WrkCode = String.Empty
    MyFrmGLA44C.Show()
  Else
    MyFrmGLA44D = New FrmGLA44D
    MyFrmGLA44D.MdiParent = MyFrmGLA44B.ParentForm
    MyFrmGLA44D.WrkYear = 0
    MyFrmGLA44D.Show()
  End If
  MyFrmGLA44B.Hide()
End Sub
Private Sub DoBtnPrint()
  MyFrmGLA44B.PrintData()
End Sub
Private Sub DoBtnSave()
  If MyFrmGLA44B.RbAccts.Checked Then
    MyFrmGLA44C.SaveData()
  Else
    MyFrmGLA44D.SaveData()
  End If
End Sub

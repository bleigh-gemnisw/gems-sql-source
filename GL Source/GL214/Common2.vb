Module Common2
  ...
  Public Function GetAcctDesc(ByVal Fund As Integer, ByVal Dept As Integer, ByVal Obj As Integer, _
    ByVal Func As Integer, Sfunc As Integer) As String
     ...
     Return GetAcctDesc
  End Function
  Public Function GetAcctRoll(ByVal Fund As Integer, Sfund As Integer, Dept As Integer, Obj As Integer, _
    Func As Integer, Sfunc As Integer) As Integer
     myGLACCT.GetOneRecordP(Fund, Sfund, Dept, Obj, func, sfunc)
     If Not myGLACCT.RecordNotFound Then
       GetAcctRoll = myGLACCT._RLNBR
     Else
       GetAcctRoll = 0
     End If
     Return GetAcctRoll

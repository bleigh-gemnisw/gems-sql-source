...
End Sub
  Private Sub RunReport1()
   ...
   With myreport1
    ...
    .SetParameterValue("MyFromDate", MyFrmGL701B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGL701B.DtPckTo.Value)
    .SetParameterValue("MyFromFund", MyUtils.CnvSng(MyFrmGL701B.TxtFundFrom.Text))
    '.SetParameterValue("MyToFund", MyUtils.CnvSng(MyFrmGL701B.TxtToFund.Text))
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtGL701Tot.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetDataSource(ds)

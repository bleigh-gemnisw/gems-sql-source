...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  Else
   RunReportErr()
   TabControl1.TabPages.Remove(TpTotals)
  End If
 End Sub
...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGLA02Bch.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "J/E Batch from GEMS.NET batches")
 ...
 Private Sub RunReportErr()
  ...
  Me.Text = "Report Viewer"
  ReportPath = MyUtils.GetReportPath("PrtGLA02Err.rpt", myTOWN._TOWNBR)
  With myreport2
  .Load(ReportPath)
  If MyReportLandscape Then
    .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
  ...
  .SetParameterValue("myreportTitle", "J/E Batch from GEMS.NET errors")
  .SetParameterValue("MyUserID", MyUserID)
  .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
  End With
  With Crv2

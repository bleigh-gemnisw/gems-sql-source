...
#End Region
	...
	Private Sub FrmGLA02E_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  myGLACCT.MyDBConn = myDBConnect
	...
	MyFrmGLA02.TBarSave.Enabled = True
	LblBatch.Text = WrkBatchNo

	If WrkSeq > 0 Then
		MyFrmGLA02.TBarDelete.Enabled = True
	Else
		AddMode = True
		WrkSeq = myTAXBCH.AutoGenKey(WrkBatchNo)
		myBCHHDR.GetOneRecordP(MyBatch, WrkBatchNo)
		myTAXBCH.GetOneRecordP(WrkBatchNo, WrkTran, 0)
		With myTAXBCH
	...
	myTAXBCH.GetOneRecordP(WrkBatchNo, WrkTran, WrkSeq)
	If myTAXBCH.RecordNotFound Then Exit Sub
...
Private Sub FrmGLA02E_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
	MyFrmGLA02.SbpScreen.Text = "GLA02E"
  MyUtils.CenterForm(Me.ParentForm, Me)
End Sub

Private Sub FrmGLA02E_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
	MyFrmGLA02.TBarNew.Enabled = True
	MyFrmGLA02.TBarDelete.Enabled = False
	MyFrmGLA02.TBarSave.Enabled = False
	MyFrmGLA02D.FormatGrid()
	MyFrmGLA02D.Show()
	'Memory Cleanup
	myTAXBCH = Nothing
	MyFrmGLA02E = Nothing

...
Friend WithEvents HelpProvider1 As System.Windows.Forms.HelpProvider
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA02))
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSave, Me.TBarCreate, Me.TBarImport, Me.TBarNew, Me.TBarSep1, Me.TBarDelete, Me.TBarSep2, Me.TBarPrtEdits, Me.TBarPost})
    ...
    Me.TBarCreate.Text = "Create Batches"
    '
    'TBarNew
    '
    ...
    Me.Text = "Maintain Tax Receipt Journal Entries"
...
#End Region
		...
		Private Sub FrmGLA02_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      MyFrmGLA02B = New FrmGLA02B
			MyFrmGLA02B.MdiParent = Me
			MyFrmGLA02B.Show()
...
End Sub
      ...
      Dim PassSecurity As Boolean
			...
			If e.Button Is TBarSave Then
				If SbpScreen.Text = "GLA02E" Then
					MyFrmGLA02E.SaveData()
					Exit Sub
				End If
			End If
     ...
     End If
      ...
      PassSecurity = GetFNDSEC(MyFrmGLA02B.DataGrdView.Item(5, MyFrmGLA02B.DataGrdView.CurrentRow.Index).Value)
      ...
      WrkBatchNo = MyFrmGLA02B.DataGrdView.Item(0, MyFrmGLA02B.DataGrdView.CurrentRow.Index).Value
	...
	Private Sub FrmGLA02_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
		Dim Cancel As Boolean

		If MyFrmGLA02.SbpScreen.Text = "GLA02C" Then
			If Cancel Then
				e.Cancel = True
			End If
			Exit Sub
...
Private Sub DoBtnBack()
	...
	Case "GLA02B"
		MyFrmGLA02B.Close()
  Case "GLA02B_Import"
    MyFrmGLA02B_Import.Close()
    MyFrmGLA02B.Show()
  Case "GLA02B_New"
    MyFrmGLA02B_New.Close()
    MyFrmGLA02B.Show()
	Case "GLA02C"
		MyFrmGLA02C.Close()
	Case "GLA02D"
...
Private Sub DoBtnDelete()
	...
	Select Case Me.SbpScreen.Text
	Case "GLA02B"
		MyFrmGLA02B.DeleteData(Cancel)
  Case "GLA02E"
    MyFrmGLA02E.DeleteData(Cancel)
...
Private Sub DoBtnImport()
  MyFrmGLA02B_Import = New FrmGLA02B_Import
  MyFrmGLA02B_Import.MdiParent = MyFrmGLA02B.ParentForm
  MyFrmGLA02B_Import.Show()
  MyFrmGLA02B.Hide()
End Sub
Private Sub DoBtnNew()
 Select Case Me.SbpScreen.Text
 Case "GLA02B"
  MyFrmGLA02B_New = New FrmGLA02B_New
  MyFrmGLA02B_New.MdiParent = MyFrmGLA02B.ParentForm
  MyFrmGLA02B_New.Show()
  MyFrmGLA02B.Hide()
 Case "GLA02D"
  MyFrmGLA02E = New FrmGLA02E
  MyFrmGLA02E.MdiParent = MyFrmGLA02B.ParentForm
  MyFrmGLA02E.WrkBatchNo = MyFrmGLA02D.WrkBatchNo
  MyFrmGLA02E.WrkTran = MyFrmGLA02D.WrkTran
  MyFrmGLA02E.WrkSeq = 0
  MyFrmGLA02E.Show()
  MyFrmGLA02D.Hide()
 End Select
End Sub
...
End Function
	...
	Private Sub FrmGLA02_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

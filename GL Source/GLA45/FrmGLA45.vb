...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA45))
...
Me.Text = "Create Munis Journal Entries"
...
Private Sub FrmGLA45_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmGLA45B = New FrmGLA45B
  MyFrmGLA45B.MdiParent = Me
  MyFrmGLA45B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmGLA45_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnSettings()
    ...
    With MyFrmGLA45B
      ...
      MyAppSettings.GLYear = .TxtGLYear.text
      MyAppSettings.SuppSame = .ChkSuppSame.Checked
    End With

...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtGLA45.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Create Munis Journal Entries")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmGLA45B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmGLA45B.DtPckTo.Value)
    .SetParameterValue("MyBatch", MyUtils.CnvSng(MyFrmGLA45B.TxtBatch.Text))
    .SetParameterValue("MyGLYear", MyUtils.CnvSng(MyFrmGLA45B.TxtGLYear.Text))
    .SetParameterValue("MySuppSame", MyFrmGLA45B.ChkSuppSame.Checked)

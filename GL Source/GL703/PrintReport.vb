...
Module PrintReport
  ...
  Public Sub PrtReport()
    ...
    If WrkFile <> String.Empty Then
      sw = New StreamWriter(MyFrmGL703B.LblFilePath.Text)
    End If
    ...
    If Not myLEDGERQ.IsEOF Then
      With myLEDGERQ
          ...
          If ._FDNBR <> SaveFund Or ._DPNBR <> SaveDept Or ._OBNBR <> SaveObj Or ._FNPGM <> SaveFunc Or ._SUBFN <> SaveSfunc Then
            ...
            If WrkDebit - WrkCredit <> 0 And WrkFundDesc <> "" Or WrkNoActivity And WrkFundDesc <> "" Then
             ...
             "-" & Format(SaveFunc, "0000") & "-" & Format(SaveSfunc, "0000")
              ...
              dr.Item("debit") = WrkDebit
              dr.Item("credit") = WrkCredit
              dr.Item("endbal") = WrkBegBal + WrkDebit - WrkCredit
              ...
              If WrkFile <> String.Empty Then
                ...
                sb.Append(WrkCredit)
                sb.Append(",")
                sb.Append(WrkBegBal + WrkDebit - WrkCredit)
                sw.WriteLine(sb.ToString)
                sb = Nothing
              End If
            End If
        ...
        If SaveGltyp = "Q" Then
          ...
          End If
        End If
        If ._PSTDT < WrkDateFrom Then
          If ._AMTYP = "D" Then
            WrkBegBal = WrkBegBal + ._TRAMT
          Else
            WrkBegBal = WrkBegBal - ._TRAMT
          End If
          GoTo NextRec

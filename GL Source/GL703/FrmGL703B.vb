...
Friend WithEvents ChkAcct As System.Windows.Forms.CheckBox
    ...
    Me.TTp1 = New System.Windows.Forms.ToolTip()
    ...
    Me.ChkAcct.Location = New System.Drawing.Point(20, 252)
    ...
    Me.ChkNoActivity.Location = New System.Drawing.Point(20, 275)
    ...
    Me.GrpDownload.Location = New System.Drawing.Point(12, 325)
...
Private Sub FrmGL703B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmGL703.SbpScreen.Text = "GL703"
End Sub
...
Private Sub LnkFundTo_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LnkFundTo.LinkClicked
  ...
  Me.Hide()
End Sub
Private Sub FrmGL703B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
...
Private Sub FrmGL703B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  InitFiles()

...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGLA40))
...
#End Region
 ...
 Private Sub FrmGLA40_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmGLA40B = New FrmGLA40B
   MyFrmGLA40B.MdiParent = Me
   MyFrmGLA40B.Show()
 End Sub
...
Private Sub FrmGLA40_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmGLA40C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmGLA40C = New FrmGLA40C
  MyFrmGLA40C.MdiParent = MyFrmGLA40B.ParentForm
  MyFrmGLA40C.WrkCode = String.Empty
  MyFrmGLA40C.Show()
  MyFrmGLA40B.Hide()
End Sub
Private Sub DoBtnPrint()
  MyFrmGLA40B.PrintData()
End Sub
Private Sub DoBtnSave()
  MyFrmGLA40C.SaveData()
End Sub

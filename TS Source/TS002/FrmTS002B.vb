...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents TxtPos As System.Windows.Forms.TextBox
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(340, 313)
...
#End Region
Private Sub FrmTS002B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub ShowGrid()
 If TxtPos.Text = Trim("") Then
    ...
    Else
    ds = myMFTTYPE.PosData(TxtPos.Text)
 End If
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
End Sub
Private Sub FrmTS002B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTS002.SbpScreen.Text = "TS002B"
  MyFrmTS002.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTS002C.MdiParent = Me.ParentForm
  MyFrmTS002C.wrkmfttyp = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTS002C.Show()
  Me.Hide()
End Sub
End Class

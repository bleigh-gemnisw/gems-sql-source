...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTS002))
...
Me.Text = "Transfer Station Types"
...
#End Region
Private Sub FrmTS002_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTS002B = New FrmTS002B
  MyFrmTS002B.MdiParent = Me
  MyFrmTS002B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTS002_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TS002B" Then
    MyFrmTS002.Close()
  Else
    MyFrmTS002C.Close()
    MyFrmTS002B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTS002C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmTS002C.Close()
  MyFrmTS002B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTS002C = New FrmTS002C
  MyFrmTS002C.MdiParent = MyFrmTS002B.ParentForm
  'MyFrmTS002C.Wrkdecode = 0
  'MyFrmTS002C.WrkTxType = ""
  MyFrmTS002C.Show()
  MyFrmTS002B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTS002B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTS002C.SaveData()
End Sub

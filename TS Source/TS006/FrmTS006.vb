...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTS006))
...
Me.Text = "Print Transfer Station List"
...
Private Sub FrmTS006_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTS006B = New FrmTS006B
  MyFrmTS006B.MdiParent = Me
  MyFrmTS006B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTS006_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTS006.TBarPrint.Enabled = False
   MyFrmTS006B.RunReport()
   MyFrmTS006.TBarPrint.Enabled = True
End Sub

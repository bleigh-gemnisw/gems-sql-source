...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTS001))
    ...
    Me.TbMain.Size = New System.Drawing.Size(651, 50)
    ...
    Me.SbMain.Size = New System.Drawing.Size(651, 28)
    ...
    Me.ClientSize = New System.Drawing.Size(651, 614)
    ...
    Me.Text = "Transfer Station Classification"
...
#End Region
Private Sub FrmTS001_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTS001B = New FrmTS001B
  MyFrmTS001B.MdiParent = Me
  MyFrmTS001B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTS001_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TS001B" Then
    MyFrmTS001.Close()
  Else
    MyFrmTS001C.Close()
    MyFrmTS001B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTS001C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmTS001C.Close()
  MyFrmTS001B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTS001C = New FrmTS001C
  MyFrmTS001C.MdiParent = MyFrmTS001B.ParentForm
  'MyFrmTS001C.Wrkdecode = 0
  'MyFrmTS001C.WrkTxType = ""
  MyFrmTS001C.Show()
  MyFrmTS001B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTS001B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTS001C.SaveData()
End Sub

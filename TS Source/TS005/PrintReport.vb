...
Dim myMFTRNHQ As MFTRNHQ.myData
...
Public Sub PrtReport()
  ...
  myMFTRNHQ = New MFTRNHQ.mydata(MyDBConnect)
...
'mftdat/mfttim/mfyear/mfcatg/mfnam.mfadd1/mfperno/mflfee
      ...
      .Columns.Add("Mfttim", Type.GetType("System.Int32"))
...
myMFTRNHQ.OpenQry(WrkSort, WrkQry)

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTS005))
...
Me.Text = "Print Transfer Station Collection Report"
...
Private Sub FrmTS005_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTS005B = New FrmTS005B
  MyFrmTS005B.MdiParent = Me
  MyFrmTS005B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTS005_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTS005.TBarPrint.Enabled = False
   MyFrmTS005B.RunReport()
   MyFrmTS005.TBarPrint.Enabled = True
End Sub

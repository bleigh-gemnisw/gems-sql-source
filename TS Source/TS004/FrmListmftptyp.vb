Public Class FrmListmftptyp
  Inherits System.Windows.Forms.Form
  Dim myMFTPTYP As MFTPTYP.myData
  Dim ds As DataSet = New DataSet
  Friend Wrkmfrtyp As String
...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(432, 260)
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    ds = myMFTPTYP.GetAllData
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListmftptyp_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyfrmTS004.SbpScreen.Text = "LISTPAYTYPE"
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListmftptyp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myMFTPTYP = New MFTPTYP.mydata(MyDBConnect)
    LblCurrent.Text = "(Catagory = " & Wrkmfrtyp & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyfrmTS004C
      .txtmfptyp.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .Ttp1.SetToolTip(.txtmfptyp, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With
    Me.Close()
...
Private Sub FrmListmftptyp_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  'Memory Cleanup
  myMFTPTYP = Nothing
  MyfrmListmftptyp = Nothing
End Sub
End Class

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTS004))
...
Me.Text = "Transfer Station Entry"
...
#End Region
Private Sub FrmTS004_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyfrmTS004B = New FrmTS004B
  MyFrmTS004B.MdiParent = Me
  MyFrmTS004B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTS004_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  ...
  MyFrmTS004C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmTS004C.MdiParent = MyFrmTS004B.ParentForm
  MyfrmTS004C.wrkmfyear = MyUtils.CnvSng(MyfrmTS004B.txtyear.Text)
...
Private Sub DoBtnPrint()
 ...
 ' MyCRViewer.Wrkds = MyFrmTS004B.ds
 ' MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTS004C.SaveData()
End Sub

...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(431, 260)
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = myMFTTYPE.GetAllData
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListmfttype_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyfrmTS004.SbpScreen.Text = "LISTTYPES"
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListmfttype_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myMFTTYPE = New MFTTYPE.mydata(MyDBConnect)
    LblCurrent.Text = "(Catagory = " & Wrkmfttyp & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyfrmTS004C
      .txtmftyp.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .Ttp1.SetToolTip(.txtmftyp, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With
...
Private Sub FrmListmfttype_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  'Memory Cleanup
  myMFTTYPE = Nothing
  MyfrmListmfttype = Nothing
End Sub
End Class

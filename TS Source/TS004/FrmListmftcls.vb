...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(540, 260)
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    ds = myMFTCLS.GetAllData
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListmftcls_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyfrmTS004.SbpScreen.Text = "LISTMFTCLS"
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListmftcls_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myMFTCLS = New MFTCLS.mydata(MyDBConnect)
    LblCurrent.Text = "(Class = " & Wrkmftcod & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  Dim WRKFEE As Double


  With MyfrmTS004C
    .Txtmfcls.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    .Ttp1.SetToolTip(.Txtmfcls, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
    .lblclassd.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
    WRKFEE = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
    .txtmftfee.Text = WRKFEE
    .lblclassfee.Text = "Class Fee: " + Format(WRKFEE, "###.00")
    .Show()
  End With
...
Private Sub FrmListmftcls_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  'Memory Cleanup
  myMFTCLS = Nothing
  MyfrmListmftcls = Nothing
End Sub
End Class

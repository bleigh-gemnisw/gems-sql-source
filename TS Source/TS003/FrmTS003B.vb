...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents TxtPos As System.Windows.Forms.TextBox
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(395, 350)
...
#End Region
Private Sub FrmTS003B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub ShowGrid()
 If TxtPos.Text = Trim("") Then
    ...
    Else
    ds = myMFTPTYP.PosData(TxtPos.Text)
 End If
 DataGrdView.DataSource = ds.Tables(0)
 DataGrdView.Refresh()
End Sub
Private Sub FrmTS003B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTS003.SbpScreen.Text = "TS003B"
  MyFrmTS003.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTS003C.MdiParent = Me.ParentForm
  MyFrmTS003C.wrkfrtyp = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTS003C.Show()
  Me.Hide()
End Sub
End Class

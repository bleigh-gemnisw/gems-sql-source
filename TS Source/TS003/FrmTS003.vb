...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTS003))
...
Me.Text = "Transfer Station Pay Type"
...
#End Region
Private Sub FrmTS003_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTS003B = New FrmTS003B
  MyFrmTS003B.MdiParent = Me
  MyFrmTS003B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTS003_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TS003B" Then
    MyFrmTS003.Close()
  Else
    MyFrmTS003C.Close()
    MyFrmTS003B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTS003C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmTS003C.Close()
  MyFrmTS003B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTS003C = New FrmTS003C
  MyFrmTS003C.MdiParent = MyFrmTS003B.ParentForm
  'MyFrmTS003C.Wrkdecode = 0
  'MyFrmTS003C.WrkTxType = ""
  MyFrmTS003C.Show()
  MyFrmTS003B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTS003B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTS003C.SaveData()
End Sub

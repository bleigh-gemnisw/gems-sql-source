...
'MK  8/11/25 Copy new year TXDCDTL recalculates decost based on yearno for year 2025
'            Remove hard coded year...use Declaration Year
'MK 8/18/25 Add line for missing decl year
Imports System

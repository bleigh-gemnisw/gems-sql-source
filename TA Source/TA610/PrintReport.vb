...
NextRec:
  ...
  Private Sub GetDetail()
    ...
    If WrkPost Then
      myTXPHIN.WriteNewYear(WrkFromYear, WrkGLYear) 'Write All GL Year records
    End If
    ...
    If Not myTXREALQ.IsEOF Then
      With myTXREALQ
        ...
        If myTXREALC._CCNO > 0 Then
          WrkOGross = myTXREALC._CCGRS
        Else
          WrkOGross = ._GROSS
        End If
        WrkGross = 0
        With myTXPHIN
          .GetOneRecordP(myTXREALQ._LISTNO, WrkFromYear)
          If Not .RecordNotFound And ._FULGRS > 0 Then
            WrkGross = WrkOGross + ._CAPGRS + ._ADJGRS
          Else
            dr = ds3.Tables(0).NewRow
            dr.Item("listno") = myTXREALQ._LISTNO
            dr.Item("name") = myTXREALQ._NAME
            dr.Item("proploc") = Trim(myTXREALQ._LOCNO) & " " & myTXREALQ._LOC
            dr.Item("ogross") = WrkOGross
            dr.Item("gross") = WrkOGross
            dr.Item("phasein") = 0
            ds3.Tables(0).Rows.Add(dr)
            GoTo NextRec
          End If
...
ReadNext:
    ...
    If Not myTXREALCQ.IsEOF Then
      With myTXREALCQ
        ...
        myTXPHIN.GetOneRecordP(._LISTNO, WrkGLYear)
        WrkBTR = ._BTR * 5
  ...
  Private Sub AdjustTXREAL(ByVal WrkList As Integer)
    ...
    If Not myTXREAL.RecordNotFound Then
      With myTXREAL
        myTXPHIN.GetOneRecordP(WrkList, WrkGLYear)
        If myTXPHIN.RecordNotFound Then Exit Sub
        myTXREALC.GetOneRecordP(WrkList)
        If myTXREALC._CCNO > 0 Then
          WrkAss(0) = myTXREALC._CASS1
          WrkAss(1) = myTXREALC._CASS2
          WrkAss(2) = myTXREALC._CASS3
          WrkAss(3) = myTXREALC._CASS4
          WrkAss(4) = myTXREALC._CASS5
          WrkAss(5) = myTXREALC._CASS6
          WrkAss(6) = myTXREALC._CASS7
        Else
          WrkAss(0) = ._ASS1
          WrkAss(1) = ._ASS2
          WrkAss(2) = ._ASS3
          ...
          WrkAss(6) = ._ASS7
        End If
        WrkCapa(0) = myTXPHIN._CAPA1
        WrkCapa(1) = myTXPHIN._CAPA2
        WrkCapa(2) = myTXPHIN._CAPA3
        WrkCapa(3) = myTXPHIN._CAPA4
        WrkCapa(4) = myTXPHIN._CAPA5
        WrkCapa(5) = myTXPHIN._CAPA6
        WrkCapa(6) = myTXPHIN._CAPA7

        'Calculate ASS values
        For I = 0 To 6
          WrkAss(I) = WrkAss(I) + WrkCapa(I)
          Total += WrkAss(I)
        Next
        ...
        ._ASS6 = WrkAss(5)
        ._ASS7 = WrkAss(6)
        ._CODE1 = Trim(myTXPHIN._CAPC1)
        ._CODE2 = Trim(myTXPHIN._CAPC2)
        ._CODE3 = Trim(myTXPHIN._CAPC3)
        ._CODE4 = Trim(myTXPHIN._CAPC4)
        ._CODE5 = Trim(myTXPHIN._CAPC5)
        ._CODE6 = Trim(myTXPHIN._CAPC6)
        ._CODE7 = Trim(myTXPHIN._CAPC7)
        ._GROSS = Total
        ._NET = ._GROSS - ._EXAM1 - ._EXAM2 - ._EXAM3 - ._EXAM4 - ._EXAM5 - ._EXAM6 - ._EXAM7
        .UpdateOneRecordP()
      End With

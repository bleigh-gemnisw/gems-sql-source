...
End Sub
  Private Sub RunReportTot()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTAP22.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(Wrkds)
    .SetParameterValue("myreportTitle", "PP Declarations Summary vs Detail")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyYear", MyFrmTAP22B.TxtGLYear.Text)
   End With
   With Crv1
     .DisplayToolbar = True

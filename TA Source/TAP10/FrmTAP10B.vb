...
#Region " Windows Form Designer generated code "
    ...
    Me.LblYear.Location = New System.Drawing.Point(63, 8)
    ...
    'Label29
    '
    Me.Label29.Location = New System.Drawing.Point(22, 9)
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(400, 366)
    Me.DataGrdView.TabIndex = 215
    '
    'FrmTAP10B
    '
...
#End Region
Private Sub FrmTAP10B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub FormatGrid()
  ...
  With DataGrdView
    ...
    .Columns(3).Width = 200
    .Columns(4).HeaderText = "Dep Code"
    .Columns(4).Width = 35
    .Columns(5).HeaderText = "Asm Code"
    .Columns(5).Width = 35
    .Columns(6).HeaderText = "Asm %"
    .Columns(6).Visible = False
  End With
End Sub
Public Sub ShowGrid()
  If WrkCode = "" Then
    ds = myTXDCCD.GetAllYear(WrkYear)
  Else
    ds = myTXDCCD.PosData(WrkYear, MyUtils.CnvSng(TxtPos.Text), WrkTxltr)
  End If
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
End Sub
Private Sub FrmTAP10B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTAP10.SbpScreen.Text = "TAP10B"
  MyFrmTAP10.TBarPrint.Enabled = True
...
Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtPos.KeyPress
  ...
  If e.KeyChar = MyUtils.VbKeyEnter Then
    ds = myTXDCCD.PosData(WrkYear, Val(TxtPos.Text), WrkTxltr)
    WrkFind = True
    FormatGrid()
    WrkFind = False
    TxtPos.Text() = ""
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmTAP10C = New FrmTAP10C
  MyFrmTAP10C.MdiParent = Me.ParentForm
  MyFrmTAP10C.WrkYear = WrkYear
  MyFrmTAP10C.Wrktxdccd = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
  MyFrmTAP10C.WrktxLtr = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
  MyFrmTAP10C.Show()
  Me.Hide()
End Sub
End Class

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP10))
...
Me.Text = "PP Declaration Property Codes"
...
#End Region
Private Sub FrmTAP10_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTAP10B = New FrmTAP10B
  MyFrmTAP10B.MdiParent = Me
  MyFrmTAP10B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTAP10_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TAP10B" Then
    MyFrmTAP10.Close()
  Else
    MyFrmTAP10C.Close()
    MyFrmTAP10B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTAP10C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmTAP10C.MdiParent = MyFrmTAP10B.ParentForm
  MyFrmTAP10C.WrkYear = MyUtils.CnvSng(MyFrmTAP10B.LblYear.Text)
	'MyFrmTAP10C.Wrktxdccd = 0
  'MyFrmTAP10C.WrkTxType = ""
  MyFrmTAP10C.Show()
  MyFrmTAP10B.Hide()
End Sub
Private Sub DoBtnPrint()
  Dim MyCRViewer As FrmCrViewer
	...
	MyCRViewer.Wrkds = MyFrmTAP10B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTAP10C.SaveData()
End Sub

...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("TA513"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class TA513
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As TA513 = CType(MyBase.Clone,TA513)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "TA513"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/TA513.xsd"
    ...
    Partial Public Class mytableDataTable
        ...
        Public Overloads Function AddmytableRow( _
                    ...
                    ByVal PCLR As String) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {LISTNO, ADDR1, ADDR2, ADDR3, ADDR4, ADDR5, VALUE, _CLASS, MAKE, YEAR, VINNO, MODEL, BODY, LWT, GWT, REGNO, SEAT, PCLR}

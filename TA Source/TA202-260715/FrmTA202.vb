...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA202))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarDelete, Me.TBarSave, Me.TBarSep1, Me.TBarPS})
...
Me.Text = "Maintain Elderly/Local Benefits"
...
#End Region
  ...
  Private Sub FrmTA202_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmTA202B = New FrmTA202B
    MyFrmTA202B.MdiParent = Me
    MyFrmTA202B.Show()
  End Sub
...
Private Sub FrmTA202_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnSave()
  Select Case Me.SbpScreen.Text
  Case "TA202C"
    MyFrmTA202C.SaveData()
  Case "TA202E"
    MyFrmTA202E.SaveData()
  End Select
End Sub
Private Sub DoBtnPS()

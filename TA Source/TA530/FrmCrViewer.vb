...
#End Region
  ...
  Private Sub CrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA530.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(Wrkds)
    .SetParameterValue("MyReportTitle", "NADA Error List (Suppl)")
    ...
    .SetParameterValue("MyNADA", WrkNADA)
   End With
   With Crv1
     .DisplayToolbar = True

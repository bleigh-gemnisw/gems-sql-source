...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA902))
...
Me.Text = "Extract Personal Property Grand List Information "
...
#End Region
  ...
  Private Sub FrmTA902_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmTA902B = New FrmTA902B
    MyFrmTA902B.MdiParent = Me
    MyFrmTA902B.Show()
  End Sub

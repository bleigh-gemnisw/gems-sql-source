...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA601))
...
#End Region
  ...
  Private Sub FrmTA601_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmTA601B = New FrmTA601B
    MyFrmTA601B.MdiParent = Me
    MyFrmTA601B.Show()
  End Sub
  ...
  End Sub
  Private Sub FrmTA601_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    Select Case SbpScreen.Text
      ...
      Case "TA601B"
        MyFrmTA601B.Close()
        MyFrmTA601.TBarProcess.Enabled = False
        MyFrmTA601B.Show()
    End Select
  End Sub
  Private Sub DoBtnProcess()
    MyFrmTA601B.RunImport()
  End Sub

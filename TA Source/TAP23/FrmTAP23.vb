...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP23))
    ...
    Me.Text = "Create Declarations Mail Merge File"
...
Private Sub FrmTAP23_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "TAP23"
  TBarProcess.Enabled = True
  set_security() '#set

  MyFrmTAP23B = New FrmTAP23B
  MyFrmTAP23B.MdiParent = Me
  MyFrmTAP23B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTAP23_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTAP23.TBarProcess.Enabled = False
   MyFrmTAP23B.RunReport()
   MyFrmTAP23.TBarProcess.Enabled = True
End Sub

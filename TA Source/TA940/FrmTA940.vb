...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA940))
...
Me.Text = "Create  VIN Decoder File"
...
Private Sub FrmTA940_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "TA940"
  TBarProcess.Enabled = True
  set_security() '#set

  MyFrmTA940B = New FrmTA940B
  MyFrmTA940B.MdiParent = Me
  MyFrmTA940B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA940_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTA940.TBarProcess.Enabled = False
   MyFrmTA940B.RunReport()
   MyFrmTA940.TBarProcess.Enabled = True
End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA107))
...
Private Sub FrmTA107_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA107B = New FrmTA107B
  MyFrmTA107B.MdiParent = Me
  MyFrmTA107B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA107_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA107B" Then
    MyFrmTA107.Close()
  Else
    MyFrmTA107C.Close()
    MyFrmTA107B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTA107C.DeleteData(wrkcancel)
  If wrkcancel Then Exit Sub
  MyFrmTA107C.Close()
  MyFrmTA107B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTA107C = New FrmTA107C
  MyFrmTA107C.MdiParent = MyFrmTA107B.ParentForm
  MyFrmTA107C.Wrkbtcode = ""
  MyFrmTA107C.Show()
  MyFrmTA107B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTA107B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTA107C.SaveData()
End Sub
Private Sub SbMain_PanelClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.StatusBarPanelClickEventArgs)

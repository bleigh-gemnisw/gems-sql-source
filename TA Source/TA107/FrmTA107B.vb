...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(21, 40)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(403, 228)
...
Private Sub FrmTA107B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myTXBUSTY = New TXBUSTY.mydata(MyDBConnect)
  Wrkbtcode = ""
  Call FormatGrid()
End Sub
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
  Wrkbtcode = TxtPos.Text
  FormatGrid()
  TxtPos.Text() = ""
End Sub
...
Public Sub ShowGrid()
  ...
  myTXBUSTY.CloseFile()
End Sub
Private Sub FrmTA107B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTA107.SbpScreen.Text = "TA107B"
  MyFrmTA107.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTA107C.MdiParent = Me.ParentForm
  MyFrmTA107C.Wrkbtcode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTA107C.Show()
  Me.Hide()
End Sub
End Class

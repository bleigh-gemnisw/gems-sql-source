...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTA432.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      ...
      End If
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", "Price Unpriced MV using MSRP Complete")
  ...
  Private Sub RunReport2()
    ...
    With myreport2
      ...
      .SetParameterValue("myreportTitle", "Price Unpriced MV using MSRP Incomplete")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    End With
    With crv2
  ...
  Private Sub RunReport3()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtTA432Tot.rpt", myTOWN._TOWNBR)
    With myreport3
      .Load(ReportPath)
      If MyReportLandscape Then
        .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
      ...
      .SetParameterValue("myreportTitle", "Price Unpriced MV using MSRP Totals")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    End With
    With crv3

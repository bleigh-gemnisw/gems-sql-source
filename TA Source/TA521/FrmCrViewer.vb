...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA521.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds)
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("myreportTitle", "Supplement MV with C/C Number List")
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTA521B.TxtGLYear.Text))
   End With
   With Crv1
     .DisplayToolbar = True

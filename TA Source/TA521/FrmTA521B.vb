...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA521B))
...
'LnkDist
'
Me.LnkDist.Location = New System.Drawing.Point(29, 57)
...
#End Region
  ...
  End Sub
Private Sub FrmTA521B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTA521.SbpScreen.Text = "TA521B"
End Sub
Private Sub FrmTA521B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
...
Private Sub FrmTA521B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

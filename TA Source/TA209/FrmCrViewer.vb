...
End Sub
  ...
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA209.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", "Purchase / Exemption Report   " & MyFrmTA209B.DtPckFrom.Value.ToString("MM/dd/yyyy") & " thru " & MyFrmTA209B.DtPckTo.Value.ToString("MM/dd/yyyy"))
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyExempt", myexempt)
    End With
   With Crv1
     .DisplayToolbar = True

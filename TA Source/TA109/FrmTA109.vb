...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA109))
...
Me.Text = "Elderly Prorate Percentages"
...
#End Region
Private Sub FrmTA109_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA109B = New FrmTA109B
  MyFrmTA109B.MdiParent = Me
  MyFrmTA109B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
	...
	End If
End Sub
Private Sub FrmTA109_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA109B" Then
    MyFrmTA109.Close()
  Else
    MyFrmTA109C.Close()
    MyFrmTA109B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTA109C.DeleteData()
End Sub
Private Sub DoBtnSave()
	MyFrmTA109C.SaveData()
End Sub
Private Sub DoBtnNew()
  MyFrmTA109C = New FrmTA109C
  MyFrmTA109C.MdiParent = MyFrmTA109B.ParentForm
	MyFrmTA109C.Wrkprmo = 0
  MyFrmTA109C.Show()
  MyFrmTA109B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTA109B.ds
  MyCRViewer.Show()
End Sub

...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(169, 179)
    Me.DataGrdView.TabIndex = 20
    '
    'FrmTA109B
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(193, 229)
    Me.ControlBox = False
...
Private Sub FrmTA109B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub FormatGrid()
  ...
  With DataGrdView
    ...
    .RowHeadersWidth = 25
    .Columns(0).HeaderText = "Month"
    .Columns(0).Width = 40
    .Columns(1).HeaderText = "Percentage"
    .Columns(1).Width = 65
   End With
End Sub
  Public Sub ShowGrid()
    ds = myTXPROETB.PosData(MyUtils.CnvSng(TxtPos.Text))
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
    myTXPROETB.CloseFile()
  End Sub
  Private Sub FrmTA109B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTA109.SbpScreen.Text = "TA109B"
  MyFrmTA109.TBarNew.Enabled = True
  MyFrmTA109.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTA109C.MdiParent = Me.ParentForm
  MyFrmTA109C.Wrkprmo = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTA109C.Show()
  Me.Hide()
End Sub
End Class

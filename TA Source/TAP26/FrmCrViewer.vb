...
End Sub
  Private Sub RunReportTot()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTAP26.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      ...
      End If
      .SetDataSource(Wrkds)
      .SetParameterValue("myreportTitle", "PP Declarations Year to Year Detail")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyYear", MyFrmTAP26B.TxtGLYear.Text)
      .SetParameterValue("MyYear2", MyFrmTAP26B.TxtGLYear2.Text)
      .SetParameterValue("MyCode", MyUtils.CnvSng(MyFrmTAP26B.TxtCode.Text))
    End With
    With Crv1
      .DisplayToolbar = True

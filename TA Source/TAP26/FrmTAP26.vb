...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP26))
    ...
    Me.Text = "Print Year to Year Codes"
...
Private Sub FrmTAP26_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTAP26B = New FrmTAP26B
  MyFrmTAP26B.MdiParent = Me
  MyFrmTAP26B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTAP26_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTAP26.TBarPrint.Enabled = False
   MyFrmTAP26B.RunReport()
   MyFrmTAP26.TBarPrint.Enabled = True
End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA212))
...
Private Sub FrmTA212_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTA212B = New FrmTA212B
  MyFrmTA212B.MdiParent = Me
  MyFrmTA212B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA212_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTA212.TBarPrint.Enabled = False
   MyFrmTA212B.RunReport()
   MyFrmTA212.TBarPrint.Enabled = True
End Sub
Private Sub DoBtnMargins()
  MyFrmTA212B.Enabled = False
  MyFrmMargins = New FrmMargins
  MyFrmMargins.ShowDialog()
  MyFrmTA212B.Enabled = True
End Sub

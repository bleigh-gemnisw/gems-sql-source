...
#End Region
  ...
  Private Sub FrmComments_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    If s_full = True Or s_add = True Or s_chg = True Then
      MyFrmTA811.TBarSave.Enabled = True
      MyFrmTA811.TBarSave.Visible = True
    End If
    ...
    Select Case WrkType
      Case "M"
        LblName.Text = MyFrmTA8114R.TxtName.Text
      Case "P"
        LblName.Text = MyFrmTA8113R.TxtName.Text
      Case "R"
        LblName.Text = MyFrmTA8112R.TxtName.Text
      Case "S"
        LblName.Text = MyFrmTA8115R.TxtName.Text
    End Select
  ...
  Private Sub FrmComments_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    MyFrmTA811.SbpScreen.Text = WrkPrevScreen
    MyFrmTA811.TBarComments.Enabled = True
    MyFrmTA811.TBarSave.Enabled = True
    If SaveDelete Then
      MyFrmTA811.TBarDelete.Enabled = True
      MyFrmTA811.TBarComments.Enabled = True
    End If
    MyFrmTA811.TBarPrint.Enabled = True
    MyFrmTA811.TBarAttach.Enabled = True
  ...
  Private Sub FrmComments_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTA811.SbpScreen.Text = "Comments"
  ...
  Public Sub SaveData()
    ...
    MyFrmTA811.TBarComments.ImageKey = ""
    If WrkRecs > 0 Then
      MyFrmTA811.TBarComments.ImageKey = "comment_24.png"
    End If
    Me.Close()
  End Sub
End Class

...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA237.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(Wrkds)
    .SetParameterValue("myreportTitle", "Local Elderly List by Name")
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTA237B.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
    ...
    End If
    .SetDataSource(Wrkds)
    .SetParameterValue("myreportTitle", "Local Elderly List by Code")
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyUserID", MyUserID)
   End With
   With Crv2
  ...
  End Sub
	Private Sub RunReportTot()
	 ...
	 Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTA237Tot.rpt", myTOWN._TOWNBR)
	 With myreportTot
		.Load(ReportPath)
		If MyReportLandscape Then
			.PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
      ...
      .PrintOptions.ApplyPageMargins(WrkMargin)
		End If
		.SetDataSource(Wrkds)
    .SetParameterValue("myreportTitle", "Local Elderly Totals")
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyUserID", MyUserID)
   End With
	 With Crv3

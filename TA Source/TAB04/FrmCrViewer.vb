...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTAB04.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      ...
      End If
      .SetDataSource(Wrkds)
      .SetParameterValue("MyReportName", "Compare Exemptions (Missing)")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyExempt1", MyFrmTAB04B.TxtExempt1.Text)
      .SetParameterValue("MyExempt2", MyFrmTAB04B.TxtExempt2.Text)
      .SetParameterValue("MyExempt3", MyFrmTAB04B.TxtExempt3.Text)
      .SetParameterValue("MyExempt4", MyFrmTAB04B.TxtExempt4.Text)
      .SetParameterValue("MyExempt5", MyFrmTAB04B.TxtExempt5.Text)
      .SetParameterValue("MyExempt6", MyFrmTAB04B.TxtExempt6.Text)
      .SetParameterValue("MyExempt7", MyFrmTAB04B.TxtExempt7.Text)
    End With
    With Crv1
     .DisplayToolbar = True

...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAD03))
    ...
    Me.Text = "Update Freeze with BAA"
...
Private Sub FrmTAD03_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTAD03B = New FrmTAD03B
  MyFrmTAD03B.MdiParent = Me
  MyFrmTAD03B.Show()
End Sub
...
End Sub
Private Sub FrmTAD03_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnProcess()
  MyFrmTAD03.TBarProcess.Enabled = False
  MyFrmTAD03B.RunProcess()
  MyFrmTAD03.TBarProcess.Enabled = False
End Sub

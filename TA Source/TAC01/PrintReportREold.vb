...
Cleanup:
  ...
  Public Sub ReadVision(ByVal WrkLen As Integer)
    ...
    For J = 0 To 11
      ReadVisionAssmnt(J)
      If Trim(WrkCode(J)) = "" Then Exit For
      If MyPhaseIn Then
        myTXPHIN.GetOneRecordP(WrkListNo, WrkGLYear)
        If Not myTXPHIN.RecordNotFound Then
          WrkFullAssmnt(J) = WrkAssmnt(J)
          WrkAssmnt(J) = (WrkAssmnt(J) - myTXPHIN._ORIA1) * (WrkCurrYear / WrkTotalYears)
        End If
      End If
    ...
    '  If Trim(WrkCode(0)) = "11" Or Trim(WrkCode(0)) = "12" Or Trim(WrkCode(0)) = "13" Or _
    '   Trim(WrkCode(0)) = "14" Or Trim(WrkCode(0)) = "21" Or Trim(WrkCode(0)) = "22" Or _
    '   Trim(WrkCode(0)) = "25" Then
    '    WrkCat = "3"
    '  End If
    'End If
  ...
  Private Sub ReadVisionAssmnt(ByVal I As Integer)
    ...
    If Trim(WrkCode(I)) & "" = "" Then
      If strBuffer.Substring(Pos + 3, 1) = "E" Then
        WrkCode(I) = strBuffer.Substring(Pos, 3)
      Else
        WrkCode(I) = strBuffer.Substring(Pos, 4)
      End If
    End If
    WrkCode(I) = Replace(WrkCode(I), "-", "")
  ...
  Private Sub ReadProValAssmnt(ByVal I As Integer)
    ...
    WrkCode(I) = strBuffer.Substring(PosCode)
...
CloseFiles:
  ...
  Private Sub UpdateTXPHIN(ByVal WrkList As Integer, ByVal WrkBTR As Integer)
    ...
    With myTXPHIN
      ...
      WrkTotass = WrkAssmnt(0) + WrkAssmnt(1) + WrkAssmnt(2) + WrkAssmnt(3) + WrkAssmnt(4) + WrkAssmnt(5) + WrkAssmnt(6)
      WrkFullass = WrkFullAssmnt(0) + WrkFullAssmnt(1) + WrkFullAssmnt(2) + WrkFullAssmnt(3) + WrkFullAssmnt(4) + WrkFullAssmnt(5) + WrkFullAssmnt(6)
      ._FULGRS = WrkFullass - ._ORIGRS
      ._FULA1 = WrkFullAssmnt(0)
      ._FULA2 = WrkFullAssmnt(1)
      ._FULA3 = WrkFullAssmnt(2)
      ._FULA4 = WrkFullAssmnt(3)
      ._FULA5 = WrkFullAssmnt(4)
      ._FULA6 = WrkFullAssmnt(5)
      ...
      ._FULC7 = WrkCode(6)
      For I = 0 To 6
        WrkNass(I) = (WrkFullAssmnt(I) - WrkAssmnt(I)) / WrkYearsLeft
      Next

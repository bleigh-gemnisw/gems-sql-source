...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA139))
    ...
    Me.Text = "Maintain Defer Max Tax and TRF Adjust"
...
#End Region
  ...
  Private Sub FrmTA139_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmTA139B = New FrmTA139B
    MyFrmTA139B.MdiParent = Me
    MyFrmTA139B.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
  Private Sub FrmTA139_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    If Me.SbpScreen.Text = "TA139B" Then
      If MyUtils.CnvSng(MyFrmTA139B.TxtYear.Text) > 0 Then
        MyFrmTA139B.GrpData.Enabled = False
        MyFrmTA139B.TxtYear.Enabled = True
        MyFrmTA139B.TxtYear.Text = ""
      Else
        MyFrmTA139.Close()
      End If
    Else
  ...
  Private Sub DoBtnSave()
    ...
    WrkError = MyFrmTA139B.CheckErrors
    If WrkError Then Exit Sub

    WrkYear = MyUtils.CnvSng(MyFrmTA139B.TxtYear.Text)
    With MyFrmTA139B
      .SaveData(WrkYear)

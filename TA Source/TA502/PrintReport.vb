...
Done:
  ...
  Private Sub GetDetail()
    ...
    Try
      WrkStream = New FileStream(MyFrmTA502B.LblFilePath.Text, FileMode.Open, FileAccess.Read, FileShare.Read)
...
NextLine:
   ...
   MyUtils.SetDBDate(SArray(31)) < MyUtils.CnvSng(Date.Now.Year & "1002") Then
    ...
    End If
    'MK 10/6/25 Begin
    WrkMonths = DateDiff(DateInterval.Month, Date.Parse(SArray(30)), Date.Parse(SArray(0)))
    If WrkMonths > 1 Or WrkMonths < 0 Then
      WrkIsOutdated = True
    End If
    'MK 10/6/25 End

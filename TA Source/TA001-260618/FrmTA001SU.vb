...
Public Class FrmTA001SU
  ...
  Friend WithEvents LblOListNo As Label
...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.TxtORegNo.Location = New System.Drawing.Point(514, 362)
    ...
    Me.TxtOVIN.Location = New System.Drawing.Point(363, 362)
    ...
    Me.TxtOClass.Location = New System.Drawing.Point(334, 362)
    ...
    Me.TxtOYear.Location = New System.Drawing.Point(288, 362)
    ...
    Me.TxtOModel.Location = New System.Drawing.Point(163, 362)
    ...
    Me.TxtOMake.Location = New System.Drawing.Point(107, 362)
    ...
    Me.TxtOAss.Location = New System.Drawing.Point(588, 362)
    ...
    'LblOPct
    '
    Me.LblOPct.Location = New System.Drawing.Point(810, 368)
    ...
    'LnkOAsmt
    '
    Me.LnkOAsmt.Location = New System.Drawing.Point(580, 344)
    ...
    'LnkOClass
    '
    Me.LnkOClass.Location = New System.Drawing.Point(335, 344)
    ...
    Me.TxtOVMSRPcr.Location = New System.Drawing.Point(612, 362)
    ...
    Me.TxtSourceCr.Location = New System.Drawing.Point(701, 362)
    ...
    Me.ChkCompleteCR.Location = New System.Drawing.Point(723, 367)
    ...
    Me.LnkSourceCr.Location = New System.Drawing.Point(692, 344)
    ...
    'LblOListNo
    '
    Me.LblOListNo.Location = New System.Drawing.Point(59, 364)
...
#End Region
  ...
  Private Sub FrmTA001SU_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Do
      WrkFound = myTXSUPA.GetIsPosted(WrkChkYear)
  ...
  Public Sub SaveData()
    ...
    'Save to MSRP File
    If Trim(TxtOVMSRP.Text) <> "" Then
      With myTXMSRP
        .GetOneRecordP(Trim(TxtVIN.Text))
    ...
    'Save Credit Vehicle to MSRP File
    If Trim(TxtOVMSRPcr.Text) <> "" Then
      With myTXMSRP
        .GetOneRecordP(Trim(TxtOVIN.Text))
        ._OVMSRP = MyUtils.CnvSng(TxtOVMSRPcr.Text)
        ._OVSOURCE = TxtSourceCr.Text
        If ChkCompleteCR.Checked Then
          ._COMPLETE = "Y"
        Else
          ._COMPLETE = ""
        End If
...
CheckFile:
  ...
  Private Function GetCreditMSRPData(WrkVin As String, WrkList As Integer) As CreditVehicleInfo
    ...
    'Try MVD first and check for same VIN else use SUPP 
    myTXMVD.GetOneRecordP(WrkList)
    If Not myTXMVD.RecordNotFound And Trim(myTXMVD._VINNO) = Trim(TxtOVIN.Text) Then
      info.mycrMSRP = myTXMVD._MSRP
      info.mycrValue = myTXMVD._VALUE
    Else
      myTXSUPPlook.GetOneRecordP(WrkList)
  ...
  Public Sub CalcAssmt()
    'Recalculate Gross, Credit, Exemptions and Net  
    ...
    'Credit can't be higher than Gross
    If WrkCredit > WrkGross Then
      WrkCredit = WrkGross
    End If
  ...
  Private Sub BtnCredit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCredit.Click
    ...
    If Trim(LblOListNo.Text) <> "" Then
      TxtOVMSRPcr.ReadOnly = False
      TxtSourceCr.ReadOnly = False
      ChkCompleteCR.Enabled = True
    End If
    If MyManual Then
      TxtOMake.ReadOnly = False
      TxtOModel.ReadOnly = False
      TxtOYear.ReadOnly = False
      TxtOClass.ReadOnly = False
      TxtOVIN.ReadOnly = False
      TxtORegNo.ReadOnly = False
      Exit Sub
    End If
    ...
    If Trim(TxtOVIN.Text) > "" Then
      ...
      ChkCompleteCR.Checked = creditInfo.mycrIsComplete
      'MK 10/27/25 Begin
      CalcValueCR(MyUtils.CnvSng(LblMSRPcr.Text), MyUtils.CnvSng(TxtOVMSRPcr.Text), MyUtils.CnvSng(TxtOYear.Text)) 'populate LblMSRPCalcCR
      'MK 10/27/25 End
    End If
  End Sub
  ...
  Private Sub TxtOVIN_Leave(sender As Object, e As EventArgs) Handles TxtOVIN.Leave
    myTXMSRP.GetOneRecordP(Trim(TxtOVIN.Text))
    If Not myTXMSRP.RecordNotFound Then
      If Trim(myTXMSRP._OVSOURCE) <> "" Then
        TxtOVMSRPcr.Text = myTXMSRP._OVMSRP
        TxtSourceCr.Text = Trim(myTXMSRP._OVSOURCE)
      End If
      If myTXMSRP._COMPLETE = "Y" Then
        ChkCompleteCR.Checked = True
      End If
    End If
  End Sub
End Class

...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(333, 438)
    Me.DataGrdView.TabIndex = 20
    '
    'FrmTA106B
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(359, 488)
    Me.ControlBox = False
...
#End Region
Private Sub FrmTA106B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub ShowGrid()
  ...
  myTXCRESN.CloseFile()
End Sub
Private Sub FrmTA106B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTA106.SbpScreen.Text = "TA106B"
  MyFrmTA106.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTA106C.MdiParent = Me.ParentForm
  MyFrmTA106C.Wrkcresn = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTA106C.Show()
  Me.Hide()
End Sub
End Class

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA106))
...
#End Region
Private Sub FrmTA106_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA106B = New FrmTA106B
  MyFrmTA106B.MdiParent = Me
  MyFrmTA106B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA106_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA106B" Then
    MyFrmTA106.Close()
  Else
    MyFrmTA106C.Close()
    MyFrmTA106B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTA106C.DeleteData(wrkcancel)
  If wrkcancel Then Exit Sub
  MyFrmTA106C.Close()
  MyFrmTA106B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTA106C = New FrmTA106C
  MyFrmTA106C.MdiParent = MyFrmTA106B.ParentForm
  MyFrmTA106C.Wrkcresn = ""
  MyFrmTA106C.Show()
  MyFrmTA106B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTA106B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTA106C.SaveData()
End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA105))
...
Me.Text = "Homeowner's Percentages"
...
Private Sub FrmTA105_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA105B = New FrmTA105B
  MyFrmTA105B.MdiParent = Me
  MyFrmTA105B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA105_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA105B" Then
    MyFrmTA105.Close()
  Else
    MyFrmTA105C.Close()
    MyFrmTA105B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTA105C.DeleteData(Wrkcancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmTA105C.MdiParent = MyFrmTA105B.ParentForm
  'MyFrmTA105C.Wrkcrperc = 0
  MyFrmTA105C.Show()
  MyFrmTA105B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTA105B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTA105C.SaveData()
End Sub

...
Me.Crv1.Location = New System.Drawing.Point(-3, -2)
Me.Crv1.Name = "Crv1"
Me.Crv1.SelectionFormula = ""
Me.Crv1.Size = New System.Drawing.Size(668, 389)
Me.Crv1.TabIndex = 2
...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA531.rpt", myTOWN._TOWNBR)
	 With myreport
		.Load(ReportPath)
      ...
      .PrintOptions.DissociatePageSizeAndPrinterPaperSize = False
		...
		End If
		.SetDataSource(wrkds)
		.SetParameterValue("myreportTitle", "Round Values (Suppl. MV)")

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA108))
...
Private Sub FrmTA108_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA108B = New FrmTA108B
  MyFrmTA108B.MdiParent = Me
  MyFrmTA108B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA108_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA108B" Then
    MyFrmTA108.Close()
  Else
    MyFrmTA108C.Close()
    MyFrmTA108B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTA108C.DeleteData(wrkcancel)
  If wrkcancel Then Exit Sub
  MyFrmTA108C.Close()
  MyFrmTA108B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTA108C = New FrmTA108C
  MyFrmTA108C.MdiParent = MyFrmTA108B.ParentForm
  MyFrmTA108C.Wrktycode = ""
  MyFrmTA108C.Show()
  MyFrmTA108B.Hide()
End Sub

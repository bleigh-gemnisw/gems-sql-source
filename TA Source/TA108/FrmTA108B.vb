...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(280, 314)
...
Private Sub FrmTA108B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myTXTYPE = New TXTYPE.mydata(MyDBConnect)
  Wrktycode = ""
  Call FormatGrid()
End Sub
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
  Wrktycode = TxtPos.Text
  FormatGrid()
  TxtPos.Text() = ""
End Sub
Public Sub FormatGrid()
  ...
  With DataGrdView
    ...
    .Columns(0).Width = 40
    .Columns(1).HeaderText = "Property Description"
    .Columns(1).Width = 150
...
Public Sub ShowGrid()
  ...
  End If
    ...
    myTXTYPE.CloseFile()
End Sub
Private Sub FrmTA108B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTA108.SbpScreen.Text = "TA108B"
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTA108C.MdiParent = Me.ParentForm
  MyFrmTA108C.Wrktycode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTA108C.Show()
  Me.Hide()
End Sub
End Class

Public Class FrmCrViewer
  ...
  Friend WrkSkipped As Integer
  Friend WrkOutDated As Integer
  Friend WithEvents TabControl1 As System.Windows.Forms.TabControl
  Friend WithEvents TpTotals As System.Windows.Forms.TabPage
  Friend WithEvents Crv1 As CrystalDecisions.Windows.Forms.CrystalReportViewer
  Friend WithEvents TpSkipped As System.Windows.Forms.TabPage
  Friend WithEvents Crv2 As CrystalDecisions.Windows.Forms.CrystalReportViewer
  Friend WithEvents TbOutdated As System.Windows.Forms.TabPage
...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents Cr1 As CrystalDecisions.Windows.Forms.CrystalReportViewer
    ...
    Me.TabControl1.Controls.Add(Me.TbOutdated)
    ...
    'TpSkipped
    '
    Me.TpSkipped.Controls.Add(Me.Crv2)
    ...
    'TbOutdated
    '
    Me.TbOutdated.Controls.Add(Me.Crv3)
    Me.TbOutdated.Location = New System.Drawing.Point(4, 22)
    Me.TbOutdated.Name = "TbOutdated"
    Me.TbOutdated.Size = New System.Drawing.Size(636, 350)
    Me.TbOutdated.TabIndex = 2
    Me.TbOutdated.Text = "Outdated"
    Me.TbOutdated.UseVisualStyleBackColor = True
    '
    'Crv3
    '
    ...
    Me.TbOutdated.ResumeLayout(False)
...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA502.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    .SetDataSource(Wrkds)
    .SetParameterValue("myreportTitle", MyFrmTA502.Text)
  ...
  End Sub
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTA502B.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetDataSource(Wrkds2)
    .SetParameterValue("myreportTitle", "Suppl Skipped records")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyCount", WrkSkipped)
    .SetParameterValue("MyMinValue", WrkMinValue)
   End With
   With Crv2
     .DisplayToolbar = True
 ...
 Private Sub RunReport3()
   ...
   With myreport3
    ...
    .SetParameterValue("myreportTitle", "Suppl records outside date range")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))

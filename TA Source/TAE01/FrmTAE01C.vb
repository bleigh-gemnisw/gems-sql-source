Public Class FrmTAE01C
  ...
  Friend WithEvents ChkFrozen As CheckBox
...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    'TxtDevlt
    '
    Me.TxtDevlt.Location = New System.Drawing.Point(264, 16)
    ...
    'Label13
    '
    Me.Label13.Location = New System.Drawing.Point(178, 20)
    ...
    'LnkListNo
    '
    Me.LnkListNo.Location = New System.Drawing.Point(16, 20)
    Me.LnkListNo.Name = "LnkListNo"
    Me.LnkListNo.Size = New System.Drawing.Size(64, 16)
    Me.LnkListNo.TabIndex = 50
    Me.LnkListNo.TabStop = True
    Me.LnkListNo.Text = "List No"
    '
    'LnkREListNo
    '
    Me.LnkREListNo.Location = New System.Drawing.Point(320, 16)
    Me.LnkREListNo.Name = "LnkREListNo"
    Me.LnkREListNo.Size = New System.Drawing.Size(64, 16)
    Me.LnkREListNo.TabIndex = 51
    ...
    'BtnCalc
    '
    Me.BtnCalc.Location = New System.Drawing.Point(302, 300)
    Me.BtnCalc.Name = "BtnCalc"
    Me.BtnCalc.Size = New System.Drawing.Size(38, 26)
    Me.BtnCalc.TabIndex = 72
    ...
    Me.ChkFrozen.Location = New System.Drawing.Point(548, 14)
    Me.ChkFrozen.Name = "ChkFrozen"
    Me.ChkFrozen.Size = New System.Drawing.Size(147, 17)
    Me.ChkFrozen.TabIndex = 71
    Me.ChkFrozen.TabStop = False
    Me.ChkFrozen.Text = "Lookups use Frozen File?"
...
#End Region
  ...
  Private Sub FrmTAE01C_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    LoadScrn = True
    MyFrmTAE01.TBarNew.Enabled = False
    MyFrmTAE01.TBarSave.Enabled = True
    ...
    If WrkListNo > 0 Then
      ...
      MyFrmTAE01.TBarDelete.Enabled = True
      MyFrmTAE01.TBarPrint.Enabled = True
      TxtListNo.Text = WrkListNo
      LnkListNo.Enabled = False
      TxtListNo.ReadOnly = True
      TxtDevlt.ReadOnly = True
      myTXCOO.GetOneRecordP(WrkListNo, WrkDevlt)
      If myTXCOO.RecordNotFound Then
        MyFrmTAE01.TBarNew.Enabled = False
        MyFrmTAE01.TBarSave.Enabled = False
        MyFrmTAE01.TBarDelete.Enabled = False
    ...
    Else
      ...
      If RbTaxable.Checked Then
        ...
        If myTXREALC._CCNO > 0 Then
          TotAmount = myTXREALC._CCGRS
        Else
          TotAmount = myTXREALC._GROSS + myTXREALC._BTR
        End If
  ...
  Private Sub FrmTAE01C_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    MyFrmTAE01.TBarNew.Enabled = True
    MyFrmTAE01.TBarSave.Enabled = False
    MyFrmTAE01.TBarDelete.Enabled = False
    MyFrmTAE01.TBarPrint.Enabled = False
    MyFrmTAE01B.FormatGrid()
    MyFrmTAE01B.Show()
  ...
  Private Sub MoveToFile()
    With myTXCOO
      ...
      ._CONAM = TxtName.Text
      ._CONAM2 = TxtSname.Text
      ._COADD1 = TxtAdd1.Text
      ._COADD2 = TxtAdd2.Text
      ._COCITY = TxtCity.Text
      ._COSTE = TxtState.Text
      ._COZIP5 = MyUtils.CnvSng(TxtZip5.Text)
      ._COZIP4 = MyUtils.CnvSng(TxtZip4.Text)
      ._PCOBEF = MyUtils.CnvSng(TxtBeforePct.Text)
      ._PCOAFT = MyUtils.CnvSng(TxtAfterPct.Text)
      If RbEld.Checked Then
        ._AMT = MyUtils.CnvSng(LblIncr.Text)
        ._BENAMT = MyUtils.CnvSng(LblProrate.Text)
        ._PINC = MyUtils.CnvSng(LblGrantor.Text)
      End If
      If RbNew.Checked Or RbVet.Checked Then
        ._AMT = MyUtils.CnvSng(TxtAmount.Text)
        ._BENAMT = 0
        ._PINC = MyUtils.CnvSng(LblProrate.Text)
      End If
      If RbTaxable.Checked Then
        ._AMT = MyUtils.CnvSng(LblIncr.Text)
        ._BENAMT = 0
      ...
      If RbEld.Checked = True Then
        ._PCD = "E"
      End If
      If RbNew.Checked = True Then
        ._PCD = "N"
      End If
      If RbTaxable.Checked = True Then
        ._PCD = "T"
      End If
      If RbVet.Checked = True Then
        ._PCD = "V"
      End If
      ._DATE = MyUtils.SetDBDate(DtPckProrate.Value)
      ._DAYS = MyUtils.CnvSng(LblDays.Text)
      ._PCT = MyUtils.CnvSng(LblPct.Text)
  ...
  Private Sub EditChecks(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
    ...
    If MyUtils.CnvSng(TxtAmount.Text) = 0 And TxtAmount.Visible Then
      ErrorField(I) = "amount"
  ...
  Private Sub ShowError(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
    ...
    Next I
  End Sub
  Private Sub FrmTAE01C_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTAE01.SbpScreen.Text = "TAE01C"
  ...
  Private Sub LnkListNo_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LnkListNo.LinkClicked
    ...
    MyFrmListReal.WrkFrozen = ChkFrozen.Checked
    MyFrmListReal.Show()
  End Sub
  ...
  Private Sub TxtListNo_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtListNo.Leave
    ...
    LoadAddrs()
  End Sub
  Private Sub TxtREListNo_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtReListNo.Leave
    Dim WrkREListNo As Integer
    Dim WrkFrozen As Boolean

    If Not AddMode Then Exit Sub
    If Not TxtReListNo.Modified Then Exit Sub

    WrkFrozen = ChkFrozen.Checked
    WrkREListNo = MyUtils.CnvSng(TxtReListNo.Text)
    Call GetREAddr(WrkREListNo, WrkFrozen)
  End Sub

  Private Sub RbEld_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RbEld.CheckedChanged
    If LoadScrn Then Exit Sub

    Call CalcProrate(True)
  End Sub
  ...
  Private Sub RbVet_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RbVet.CheckedChanged
    If LoadScrn Then Exit Sub

    Call CalcProrate(True)
  End Sub
  Private Sub RbAssmnt_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RbTaxable.CheckedChanged
    If LoadScrn Then Exit Sub

    Call CalcProrate(True)
  End Sub
  Private Sub DtPckProrate_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DtPckProrate.ValueChanged
    If LoadScrn Then Exit Sub

    Call CalcProrate(False)
  End Sub
  ...
  Public Sub LoadAddrs()
    ...
    WrkFrozen = ChkFrozen.Checked
    WrkListNo = MyUtils.CnvSng(TxtListNo.Text)
    Call GetAddr(WrkListNo, WrkFrozen)
    WrkREListNo = MyUtils.CnvSng(TxtReListNo.Text)
    If WrkREListNo > 0 Then
      TxtReListNo.Text = WrkListNo
      Call GetREAddr(WrkListNo, WrkFrozen)
    End If
  End Sub
  Private Sub BtnCalc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCalc.Click
    MyFrmCalcIncr = New FrmCalcIncr
    If MyUtils.CnvSng(TxtReListNo.Text) > 0 Then
      MyFrmCalcIncr.WrkListNo = MyUtils.CnvSng(TxtReListNo.Text)
    Else
      MyFrmCalcIncr.WrkListNo = MyUtils.CnvSng(TxtListNo.Text)
    End If
    MyFrmCalcIncr.ShowDialog()
  End Sub

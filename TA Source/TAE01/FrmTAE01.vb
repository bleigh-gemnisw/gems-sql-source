...
Friend WithEvents TBarSetup As System.Windows.Forms.ToolBarButton
...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAE01))
Me.ImageList1 = New System.Windows.Forms.ImageList(Me.components)
Me.HelpProvider1 = New System.Windows.Forms.HelpProvider
Me.TBarSetup = New System.Windows.Forms.ToolBarButton
...
'TBarSetup
'
Me.TBarSetup.Name = "TBarSetup"
Me.TBarSetup.Text = "Set Dates"
Me.TBarSetup.Visible = False
'
'TBarSep2
'
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarPrint, Me.TBarSep2, Me.TBarSetup})
...
#End Region
  ...
  Private Sub FrmTAE01_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmTAE01B = New FrmTAE01B
    MyFrmTAE01B.MdiParent = Me
    MyFrmTAE01B.Show()
  End Sub
...
Private Sub FrmTAE01_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnNew()
  MyFrmTAE01C = New FrmTAE01C
  MyFrmTAE01C.MdiParent = MyFrmTAE01B.ParentForm
  MyFrmTAE01C.WrkListNo = 0
  MyFrmTAE01C.Show()
  MyFrmTAE01B.Hide()

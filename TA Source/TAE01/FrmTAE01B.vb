Imports System.Data
Public Class FrmTAE01B
  Inherits System.Windows.Forms.Form
  Dim myTXCOOL1 As TXCOOL1.MyData
...
#End Region
  ...
  Private Sub FrmTAE01B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myTXCOOL1 = New TXCOOL1.MyData(myDBConnect)
    CboSort.Items.Clear()
  ...
  Public Sub ShowGrid()
    ...
    Select Case CboSort.SelectedItem.ToString
      Case "Owner's Name"
        ds = myTXCOOL1.GetViewbyName(WrkPos, cMaxRecs)
      Case "Second Name"
        ds = myTXCOOL1.GetViewbySName(WrkPos, cMaxRecs)
    End Select
    DataGrdView.DataSource = Nothing
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmTAE01B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTAE01.SbpScreen.Text = "TAE01B"
  ...
  Private Sub BtnFast_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFast.Click
    ...
    MyFrmTAE01C.MdiParent = Me.ParentForm
    MyFrmTAE01C.WrkListNo = TxtListNo.Text
    MyFrmTAE01C.WrkDevlt = TxtDevlt.Text
    MyFrmTAE01C.Show()
    TxtListNo.Text = ""
    Me.Hide()
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    MyFrmTAE01C = New FrmTAE01C
    MyFrmTAE01C.MdiParent = Me.ParentForm
    MyFrmTAE01C.WrkListNo = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    MyFrmTAE01C.WrkDevlt = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
    MyFrmTAE01C.Show()
    Me.Hide()

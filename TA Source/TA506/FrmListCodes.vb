...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(108, 6)
    ...
    Me.TxtPos.Size = New System.Drawing.Size(30, 20)
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    Else
      ds = myTXCode.PosData(MyUtils.CnvSng(TxtPos.Text), WrkType)
    End If
  ...
  Private Sub FrmListCodes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTA506.SbpScreen.Text = "ListCodes"
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTA506B
      .TxtFindClass.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .Ttp1.SetToolTip(.TxtFindClass, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With

...
Me.Text = "Select Assessment Codes"
...
Private Sub RefreshDS()
  ...
  Dim Pos As Integer
    ...
    For I = 0 To ds.Tables(0).Rows.Count - 1
      ...
      If WrkType = "M" Or WrkType = "S" Then
        Pos = InStr(MySelCodes, Format(MyUtils.CnvSng(ds.Tables(0).Rows(I).Item("tccode")), " 00"))
      Else
        Pos = InStr(MySelCodes, Format(MyUtils.CnvSng(ds.Tables(0).Rows(I).Item("tccode")), " ###"))
      End If
      ...
      Else
        myDr("select") = False
      End If
      myDr("code") = ds.Tables(0).Rows(I).Item("tccode")
      myDr("description") = ds.Tables(0).Rows(I).Item("tcdesc")
...
End Sub
  ...
  For I = 0 To (C1DataGrdList.Splits(0).Rows.Count - 1)
    If C1DataGrdList.Item(I, 0) Then
      If WrkType = "M" Or WrkType = "S" Then
        MySelCodes = MySelCodes + Format(MyUtils.CnvSng(C1DataGrdList.Item(I, 1)), " 00")
      Else
        MySelCodes = MySelCodes + Format(MyUtils.CnvSng(C1DataGrdList.Item(I, 1)), " ###")
      End If
    Else
      WrkAllCodes = False
    End If
...
Private Sub FrmSelTypes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
     MyFrmTAB03.SbpScreen.Text = "SelCodes"
  End Sub

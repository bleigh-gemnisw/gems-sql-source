...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTAB03.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds)
   End With
   WrkSection = GetReportSection("Section2")
   WrkSection.Height = MyUtils.CnvSng(MyFrmTAB03B.TxtVAdjust1.Text)
   WrkSection = GetReportSection("DetailSection3")
   WrkSection.Height = MyUtils.CnvSng(MyFrmTAB03B.TxtVAdjust2.Text)
   With Crv1
     .DisplayToolbar = True

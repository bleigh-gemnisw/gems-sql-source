...
Friend WithEvents ToolStripLabel1 As System.Windows.Forms.ToolStripLabel
    Friend WithEvents TBarProcess As ToolBarButton
    Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA540))
        ...
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarPrint, Me.TBarProcess})
        Me.TbMain.DropDownArrows = True
        Me.TbMain.ImageList = Me.ImageList1
        Me.TbMain.Location = New System.Drawing.Point(0, 0)
        Me.TbMain.Name = "TbMain"
        Me.TbMain.ShowToolTips = True
        Me.TbMain.Size = New System.Drawing.Size(931, 50)
        ...
        'TBarProcess
        '
        Me.TBarProcess.ImageIndex = 2
        Me.TBarProcess.Name = "TBarProcess"
        Me.TBarProcess.Text = "P&rocess"
        '
        'ImageList1
        '
        ...
        Me.ImageList1.Images.SetKeyName(2, "update all_24.png")
        '
        'SbMain
        '
        ...
        Me.SbMain.Size = New System.Drawing.Size(931, 28)
        ...
        Me.Text = "Make And Class Update For Non Tax"
...
#End Region
    ...
    Private Sub FrmTA540_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTA540B = New FrmTA540B
  MyFrmTA540B.MdiParent = Me
  MyFrmTA540B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
    ...
    End If
  End Sub
Private Sub FrmTA540_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  ...
  Case "TA540B"
        MyFrmTA540.Close()
      Case "TA540C"
        Dim result As DialogResult = MessageBox.Show("Are you sure you want to go back? All changes will be removed.", "Confirm Action",
        ...
        If result = DialogResult.Yes Then
          MyFrmTA540.SbpScreen.Text = "TA540C"
          MyFrmTA540C.Close()
          MessageBox.Show("Changes were discarded.", "Action Confirmed", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Else
...
End Sub
  Private Sub DoBtnPrint()
    MyFrmTA540C.RunReport()
  End Sub
  Private Sub DoBtnProcess()
    MyFrmTA540B.ProcessMe()
  End Sub

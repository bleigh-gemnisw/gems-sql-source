...
#End Region
  ...
  Public Sub ProcessMe()
    ...
    MyFrmTA540.TBarProcess.Enabled = False
    MyFrmTA540.TBarPrint.Enabled = True
    MyFrmTA540.SbpScreen.Text = "TA540C"
    MyFrmTA540C = New FrmTA540C
    MyFrmTA540C.MdiParent = Me.ParentForm
    MyFrmTA540C.wrkclassdesc = WrkClassDesc
    MyFrmTA540C.Show()
    Me.Hide()

  End Sub
  Private Sub FrmTA540B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    TxtClass.Focus()
  End Sub
  Private Sub FrmTA540B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated

    TxtClass.Focus()
    Me.Refresh()
    MyFrmTA540.SbpScreen.Text = "TA540B"

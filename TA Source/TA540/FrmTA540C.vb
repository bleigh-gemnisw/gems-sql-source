...
Public Class FrmTA540C
  Dim ds As DataSet = New DataSet
  Dim myTXSUPPq As New TXSUPPQ.MyData(myDBConnect)
  Friend wrkclassdesc As String

  Private Sub FrmTA540C_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    TxTSearch.Focus()

    Call FormatGrid()
  End Sub
  Private Sub FrmTA540C_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTA540.SbpScreen.Text = "TA540C"
    MyUtils.CenterForm(Me.ParentForm, Me)
    TxTSearch.Focus()
  End Sub
  Private Sub FrmTA540C_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    MyFrmTA540.TBarProcess.Enabled = True
    MyFrmTA540.TBarPrint.Enabled = False
    MyFrmTA540B.TxtClass.Focus()
    MyFrmTA540B.Show()
  End Sub
  ...
  Public Sub ShowGrid()
    ...
    Windows.Forms.Cursor.Current = Cursors.WaitCursor
    wrkclass = MyUtils.CnvSng(MyFrmTA540B.TxtClass.Text)
    wrkgross = MyUtils.CnvSng(MyFrmTA540B.TxtGross.Text)
    wrkmake = UCase(MyFrmTA540B.TxtMake.Text)
    ...
    End If
    If MyFrmTA540B.ChkZero.Checked Then
      wrkqry = wrkqry & " AND value=0"
    End If
    myTXSUPPq.OpenQry(wrksortfield, wrkqry)
    dt = BuildDT()
    ds.Tables.Add(dt)

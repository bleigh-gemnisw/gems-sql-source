...
#End Region
    ...
    Dim WrkBass8 As Integer
    Dim WrkBass9 As Integer
    Dim WrkBass10 As Integer
    ...
    If Not MyTXINV.RecordNotFound Then
      With MyTXINV
        ...
        If CoeCCNo = 0 Then
          ...
          LblOrigAssmt8.Text = ._OAS8 + WrkBass8
          LblOrigAssmt9.Text = ._OAS9 + WrkBass9
          LblOrigAssmt10.Text = ._OAS10 + WrkBass10

...
#End Region
  ...
  Private Sub FrmListMvpct_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTA811.SbpScreen.Text = "ListMvpct"
  ...
  Private Sub FrmListMvpct_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Select Case WrkType
      ...
      Case "C"
        Me.Text = "Select Credit Sale Month"
    End Select
  End Sub
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    Else
      With MyFrmTA8115R
        Select Case WrkType
          Case "P"
            .TxtPurchMonth.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
            .CalcPurch()
          Case "S"
            .TxtSaleMonth.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
            .CalcSale()
          Case "C"
            .TxtCRSaleMonth.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
            .CalcSaleCR()
        End Select
        .Show()
      End With
  ...
  Private Sub DataGrdView_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles DataGrdView.CellFormatting
    ...
    '    DataGrdView.Rows(e.RowIndex).DefaultCellStyle.BackColor = Color.Aqua
    '   End If
  End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA330))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarPS})
...
Me.Text = "View Change Logs - RE, PP, MV, SU"
...
#End Region
  ...
  Private Sub FrmTA330_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security()   '#sec
    MyFrmTA330B = New FrmTA330B
    MyFrmTA330B.MdiParent = Me
    MyFrmTA330B.Show()
  End Sub
  ...
  Private Sub FrmTA330_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnLog()
    If MyFrmTA330B.RbRE.Checked Then
       MyFrmLOG.WrkType = "R"
    End If
    If MyFrmTA330B.RbPP.Checked Then
       MyFrmLOG.WrkType = "P"
    End If
    If MyFrmTA330B.RbMV.Checked Then
       MyFrmLOG.WrkType = "M"
    End If
    If MyFrmTA330B.RbSU.Checked Then
       MyFrmLOG.WrkType = "S"
    End If

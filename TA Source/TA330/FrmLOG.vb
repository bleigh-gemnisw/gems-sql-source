...
Public Sub FormatGridSU()
  ...
  With C1DataGrdList
      ...
      ' added 5/16/25 ken
      .Columns(94).Caption = "Domicile Address"
      .Columns(95).Caption = "Domicile Address 2"
      .Columns(96).Caption = "Domicile City"
      .Columns(97).Caption = "Domicile State"
      .Columns(98).Caption = "Domicile Zip"
      .Columns(99).Caption = "Domicile Zip4"
      '  .Columns(100).Caption = "BTR Date"
      '  .Columns(101).Caption = "BTR DN"
      .Columns(102).Caption = "Loc#"
      .Columns(103).Caption = "Location"
      '
      .Splits(0).DisplayColumns(0).Width = 55
			.Columns(0).ValueItems.Values.Clear()
			.Columns(0).ValueItems.Values.Add(New C1.Win.C1TrueDBGrid.ValueItem("1", "Taxable"))
...
'
      ...
      ' 5/16/25 added   ken
      .Splits(0).DisplayColumns(100).Visible = False    'btr stuff
      .Splits(0).DisplayColumns(101).Visible = False
      .Splits(0).DisplayColumns(94).Width = 250
      .Splits(0).DisplayColumns(95).Width = 250
      .Splits(0).DisplayColumns(96).Width = 250
      .Splits(0).DisplayColumns(97).Width = 80
      .Splits(0).DisplayColumns(98).Width = 80
      .Splits(0).DisplayColumns(99).Width = 80
      .Splits(0).DisplayColumns(102).Width = 80
      .Splits(0).DisplayColumns(103).Width = 250

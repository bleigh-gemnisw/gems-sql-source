...
Me.Crv1.Size = New System.Drawing.Size(664, 387)
Me.Crv1.TabIndex = 2
...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA5077.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Supplement Motor Vehicle List with No Value")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyDouble", MyFrmTA5077B.ChkDouble.Checked)
	 End With
   With Crv1
     .DisplayToolbar = True

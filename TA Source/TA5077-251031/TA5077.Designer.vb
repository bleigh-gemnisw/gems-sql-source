...
Partial Public Class TA5077
    ...
    Partial Public Class mytableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddmytableRow(ByVal LISTNO As Long, ByVal NAME As String, ByVal SNAME As String, ByVal ADDR As String, ByVal CITY As String, ByVal STATE As String) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {LISTNO, NAME, SNAME, ADDR, CITY, STATE}

...
Me.TabGL.Name = "TabGL"
Me.TabGL.Size = New System.Drawing.Size(648, 354)
Me.TabGL.TabIndex = 0
Me.TabGL.Text = "Letter Totals"
...
End Sub
  Private Sub RunReportTot()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA213.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    ...
    .SetParameterValue("myreportTitle", "Letter Totals")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyYear", MyFrmTA213B.TxtGLYear.Text)
    .SetParameterValue("MyTypeDesc", GetTXTypeDesc(WrkType))
    .SetParameterValue("MyBTR", WrkBTR)
    .SetParameterValue("MyType", WrkType)
    .SetParameterValue("MyFrozen", MyFrmTA213B.ChkFrozenFile.Checked)
		.SetParameterValue("MyNonExempt", MyFrmTA213B.ChkNonExempt.Checked)
	 End With
   With Crv1
     .DisplayToolbar = True

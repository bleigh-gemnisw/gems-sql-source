...
Public Class FrmTAD05SU
  ...
  Friend WithEvents LnkOAsmt As LinkLabel
  Friend WithEvents LnkAsmt As LinkLabel
  Friend WithEvents LblOPct As Label
  Friend WithEvents TxtOAss As TextBox
  Friend WithEvents Label25 As Label
  Friend WithEvents LblPct As Label
  Friend WithEvents TxtAss As TextBox
...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.LblMSRPcr.Location = New System.Drawing.Point(596, 228)
    Me.LblMSRPcr.Name = "LblMSRPcr"
    Me.LblMSRPcr.Size = New System.Drawing.Size(64, 16)
    Me.LblMSRPcr.TabIndex = 327
    ...
    Me.LblValuecr.Location = New System.Drawing.Point(669, 229)
    Me.LblValuecr.Name = "LblValuecr"
    Me.LblValuecr.Size = New System.Drawing.Size(64, 16)
    Me.LblValuecr.TabIndex = 326
    ...
    Me.LblMSRPCalc.Location = New System.Drawing.Point(592, 160)
    Me.LblMSRPCalc.Name = "LblMSRPCalc"
    Me.LblMSRPCalc.Size = New System.Drawing.Size(74, 13)
    Me.LblMSRPCalc.TabIndex = 325
    ...
    Me.LblValue.Location = New System.Drawing.Point(667, 191)
    Me.LblValue.Name = "LblValue"
    Me.LblValue.Size = New System.Drawing.Size(64, 16)
    Me.LblValue.TabIndex = 322
    Me.LblValue.TextAlign = System.Drawing.ContentAlignment.MiddleRight
    '
    'Label26
    '
    Me.Label26.AutoSize = True
    Me.Label26.Location = New System.Drawing.Point(679, 178)
    ...
    Me.LnkSourceCr.Location = New System.Drawing.Point(670, 300)
    Me.LnkSourceCr.Name = "LnkSourceCr"
    Me.LnkSourceCr.Size = New System.Drawing.Size(41, 13)
    Me.LnkSourceCr.TabIndex = 345
    ...
    Me.Label34.Location = New System.Drawing.Point(588, 262)
    ...
    Me.TxtOAss.Location = New System.Drawing.Point(566, 314)
    Me.TxtOAss.MaxLength = 1
    Me.TxtOAss.Name = "TxtOAss"
    Me.TxtOAss.Size = New System.Drawing.Size(18, 22)
    Me.TxtOAss.TabIndex = 332
    '
    'Label25
    '
    Me.Label25.Location = New System.Drawing.Point(739, 263)
    ...
    'LblPct
    '
    Me.LblPct.Location = New System.Drawing.Point(723, 285)
    Me.LblPct.Name = "LblPct"
    Me.LblPct.Size = New System.Drawing.Size(56, 16)
    Me.LblPct.TabIndex = 331
    '
    'TxtAss
    '
...
#End Region
  ...
  Public Sub LoadForm()
    ...
    With myTXSUPA
      ...
      If Trim(._OVIN) > "" Then
        Dim creditInfo As CreditVehicleInfo = Me.GetCreditMSRPData(._OVIN, ._OLIST)
        ...
        CalcValueCR(MyUtils.CnvSng(LblMSRPcr.Text), MyUtils.CnvSng(TxtOVMSRPcr.Text), ._OYEAR) 'populate LblMSRPCalcCR
      End If 'ovin > ""
    End With
    ...
    With myTXSUPA
      ...
      SetSupCdTip()
      SetOSupCdTip()
      WrkProRate = CalcProRate(MyUtils.CnvSng(LblValue.Text), MyUtils.CnvSng(LblPct.Text))
      LblPRGross.Text = Format(WrkProRate, "#######0")
      WrkProRateCR = CalcProRate(MyUtils.CnvSng(LblValuecr.Text), MyUtils.CnvSng(LblOPct.Text))
  ...
  Public Sub CalcAssmt()
    ...
    If WrkNet < 0 Then
      If WrkOValue > 0 And WrkExam = 0 Then
        LblValuecr.Text = MyUtils.Round(WrkOValue - (Math.Abs(WrkNet) / MyUtils.CnvSng(LblOPct.Text)), 0)
        WrkCredit = CalcProRate(MyUtils.CnvSng(LblValuecr.Text), MyUtils.CnvSng(LblOPct.Text))
        MsgBox("Credit changed from " & WrkOValue & " to " & LblValuecr.Text, MsgBoxStyle.Information, "Net would be negative")
        WrkNet = WrkGross - WrkCredit - WrkExam
      End If
    End If
  ...
  Private Function CalcValue(ByVal WrkMSRP As Integer, ByVal WrkOvMSRP As Integer, ByVal WrkMVYear As Integer) As Integer
    ...
    WrkValue = 0
    WrkChkYear = WrkYear
    WrkDeYear = WrkChkYear - WrkMVYear + 1
    If WrkDeYear < 1 Then
      WrkDeYear = 1
    End If
    ...
    Return WrkValue
  End Function
  Private Function CalcValueCR(ByVal WrkMSRP As Integer, ByVal WrkOvMSRP As Integer, ByVal WrkMVYear As Integer) As Integer
    Dim WrkChkYear As Integer
    Dim WrkDeYear As Integer
    Dim WrkValue As Integer
    Dim WrkDepr As Decimal
    ...
    Return WrkValue
  End Function
  Private Function GetCreditMSRPData(WrkVin As String, WrkList As Integer) As CreditVehicleInfo
    Dim info As New CreditVehicleInfo

    Dim myTXMVA As New TXMVA.MyData(myDBConnect)
    Dim myTXSUPPlook As New TXSUPA.MyData(myDBConnect)

    'Try MVDA first and check for same VIN else use SUPP 
    myTXMVA.GetOneRecordP(WrkList, WrkYear)
    If Not myTXMVA.RecordNotFound And Trim(myTXMVA._VINNO) = Trim(TxtOVIN.Text) Then
      info.mycrMSRP = myTXMVA._MSRP
      info.mycrValue = myTXMVA._VALUE
    Else
      myTXSUPPlook.GetOneRecordP(WrkList, WrkYear)
    ...
    myTXMSRP.GetOneRecordP(Trim(WrkVin))
  ...
  Private Sub TxtValue_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    CalcAssmt()
  End Sub
  Private Sub LnkAsmt_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs)
  ...
  End Sub
  Private Sub TxtAss_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    SetSupCdTip()
    CalcAssmt()
  End Sub
  Private Sub TxtOAss_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    SetOSupCdTip()
    CalcAssmt()
  End Sub
  ...
  Private Sub TxtOClass_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtOClass.KeyPress
    e.Handled = MyUtils.FilterNumbers(e.KeyChar, False, False)
  End Sub
  Private Sub TxtOValue_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    e.Handled = MyUtils.FilterNumbers(e.KeyChar, False, False)
  End Sub

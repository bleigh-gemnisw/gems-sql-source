...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA231))
    ...
    Me.Text = "Remove Elderly Benefit Amount"
...
Private Sub FrmTA231_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTA231B = New FrmTA231B
  MyFrmTA231B.MdiParent = Me
  MyFrmTA231B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA231_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnProcess()
   MyFrmTA231.TBarProcess.Enabled = False
   MyFrmTA231B.RunReport()
   MyFrmTA231.TBarProcess.Enabled = True
End Sub

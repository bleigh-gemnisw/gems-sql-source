...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA101))
    ...
    Me.Text = "Exempt Real Property Codes"
...
#End Region
  ...
  Private Sub FrmTA101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmTA101B = New FrmTA101B
    MyFrmTA101B.MdiParent = Me
    MyFrmTA101B.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
  Private Sub FrmTA101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    If Me.SbpScreen.Text = "TA101B" Then
      MyFrmTA101.Close()
    Else
      MyFrmTA101C.Close()
      MyFrmTA101B.Show()
  ...
  Private Sub DoBtnDelete()
    ...
    MyFrmTA101C.DeleteData(WrkCancel)
  ...
  Private Sub DoBtnNew()
    ...
    MyFrmTA101C.MdiParent = MyFrmTA101B.ParentForm
    MyFrmTA101C.Wrkprexem = ""
    MyFrmTA101C.Show()
    MyFrmTA101B.Hide()
  End Sub
  Private Sub DoBtnPrint()
    ...
    MyCRViewer.Wrkds = MyFrmTA101B.ds
    MyCRViewer.Show()
  End Sub
  Private Sub DoBtnSave()
    MyFrmTA101C.SaveData()
  End Sub

...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA235.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds)
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTA235B.TxtGLYear.Text))
    .SetParameterValue("MyBTR", WrkBTR)
    .SetParameterValue("MyDate", Date.Now)
    .SetParameterValue("MyFrozen", MyFrmTA235B.ChkFrozenFile.Checked)
   End With
   With Crv1
     .DisplayToolbar = True

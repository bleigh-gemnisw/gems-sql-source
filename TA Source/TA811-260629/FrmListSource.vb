...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.DataGrdView = New System.Windows.Forms.DataGridView()
        ...
        Me.DataGrdView.Location = New System.Drawing.Point(15, 54)
        ...
        Me.Name = "FrmListSource"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Select Source Code"
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = myTXMSRPCD.PosData(TxtPos.Text)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListSource_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTA811.SbpScreen.Text = "ListSource"
    MyUtils.CenterForm(Me.ParentForm, Me)
  End Sub
  Private Sub FrmListSource_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myTXMSRPCD = New TXMSRPCD.MyData(myDBConnect)
    LblCurrent.Text = "(Source Code = " & WrkCode & ")"
    FormatGrid()
  End Sub
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    Select Case WrkScreen
      Case "MV"
        With MyFrmTA8114R
          .TxtSource.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
          .Ttp1.SetToolTip(.TxtSource, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
          .Show()
        End With
      Case "SU"
        With MyFrmTA8115R
          If WrkField = "" Then
            ...
            .Ttp1.SetToolTip(.TxtSource, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
          Else
            .TxtCRSource.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
            .Ttp1.SetToolTip(.TxtCRSource, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
          End If
          .Show()
        End With
    End Select
  ...
  Private Sub FrmListSource_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    'Memory Cleanup
    myTXMSRPCD = Nothing
    MyFrmListSource = Nothing
  End Sub
End Class

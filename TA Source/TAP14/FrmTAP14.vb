...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP14))
...
Me.Text = "Mfg & Equip - Lessor Maintainence"
...
#End Region
 ...
 Private Sub FrmTAP14_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmTAP14B = New FrmTAP14B
   MyFrmTAP14B.MdiParent = Me
   MyFrmTAP14B.Show()
 End Sub
...
Private Sub FrmTAP14_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TAP14B" Then
    MyFrmTAP14.Close()
  Else
    MyFrmTAP14C.Close()
    MyFrmTAP14B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTAP14C.DeleteData()
  MyFrmTAP14C.Close()
End Sub
Private Sub DoBtnNew()
  MyFrmTAP14C = New FrmTAP14C
  MyFrmTAP14C.MdiParent = MyFrmTAP14B.ParentForm
  MyFrmTAP14C.WrkLease = ""
  MyFrmTAP14C.Show()
  MyFrmTAP14B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTAP14B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTAP14C.SaveData()
End Sub

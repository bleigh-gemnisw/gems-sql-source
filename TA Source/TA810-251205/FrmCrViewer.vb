Public Class FrmCrViewer
  ...
  Dim myreportMVCR As New CrystalDecisions.CrystalReports.Engine.ReportDocument  'added 9-25-25 ken

  Dim dsTXPROF As New DataSet
  Friend Wrkds As DataSet
    Friend WithEvents TabCtl1 As TabControl
    Friend WithEvents TabPgCC As TabPage
    Friend WithEvents Crv1 As CrystalDecisions.Windows.Forms.CrystalReportViewer
    Friend WithEvents TabPgMVCR As TabPage
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TabCtl1.Location = New System.Drawing.Point(4, 7)
...
#End Region
    ...
    Select Case WrkType
      ...
      Case "M"
        RunReportMV()
      Case "S"
        MyAppSettings.CopiesCR = 1    'Added 9-25-25 Ken   Ask mark about frmsettings... from ta811
        RunReportSU()
        RunReportMVCR()
    End Select
    If MyAppSettings.Printer <> "" Then
  ...
  Private Sub RunReportSU()
    ...
    End With
  End Sub
  ' begin Added 9/25/25  KEn
  Private Sub RunReportMVCR()
    Dim ReportPath As String
    Dim AddrLine() As String

    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtTA810MVCR.rpt", myTOWN._TOWNBR)
    'MV Credit
    With myreportMVCR
      .Load(ReportPath)
      If MyAppSettings.Printer <> "" Then
      ...
      End If
      .SetDataSource(Wrkds)
      .SetParameterValue("myreportTitle", "SUPPLEMENTAL MOTOR VEHICLE TAX CREDIT")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      With MyFrmTA8105R
        AddrLine = MyUtils.SetAddrLine(.TxtName.Text, .TxtSname.Text, .TxtAdd1.Text,

...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA138))
...
#End Region
 ...
 Private Sub FrmTA138_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmTA138B = New FrmTA138B
   MyFrmTA138B.MdiParent = Me
   MyFrmTA138B.Show()
 End Sub
...
Private Sub FrmTA138_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA138B" Then
    MyFrmTA138.Close()
  Else
    MyFrmTA138C.Close()
    MyFrmTA138B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTA138C.DeleteData()
  MyFrmTA138C.Close()
End Sub
Private Sub DoBtnNew()
  MyFrmTA138C = New FrmTA138C
  MyFrmTA138C.MdiParent = MyFrmTA138B.ParentForm
  MyFrmTA138C.WrkDesc = ""
  MyFrmTA138C.Show()
  MyFrmTA138B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTA138B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTA138C.SaveData()
End Sub

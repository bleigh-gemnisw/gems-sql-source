...
Friend WithEvents ErrProv As System.Windows.Forms.ErrorProvider
    ...
    Me.TxtMin.Location = New System.Drawing.Point(154, 74)
    Me.TxtMin.MaxLength = 5
    Me.TxtMin.Name = "TxtMin"
    Me.TxtMin.Size = New System.Drawing.Size(45, 20)
...
End Sub
  Private Sub ShowError(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
    ErrProv.SetError(TxtMin, "")
    Dim I As Integer

    For I = 0 To ErrorField.GetUpperBound(0)
      Select Case ErrorField(I)
      Case "min"
        ErrProv.SetError(TxtMin, ErrorMsg(I))
      End Select
    Next
  End Sub
  Private Sub EditChecks(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
    ...
    If TxtMin.Text = "" Then
      ErrorField(I) = "min"
      ErrorMsg(I) = "Minimum cannot be blank"
      I = I + 1
    End If

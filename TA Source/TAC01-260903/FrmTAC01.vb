...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAC01))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarImport, Me.TBarSave})
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 522)
...
Me.TBarSave.Text = "Save Settings"
'
'FrmTAC01
'
Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
Me.BackColor = System.Drawing.SystemColors.Control
Me.ClientSize = New System.Drawing.Size(768, 550)
...
#End Region
    ...
    Private Sub FrmTAC01_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        MyFrmTAC01B = New FrmTAC01B
        MyFrmTAC01B.MdiParent = Me
        MyFrmTAC01B.Show()
    End Sub
 Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
   ...
   End If
 End Sub
Private Sub FrmTX101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TAC01B" Then
    MyFrmTAC01.Close()
  End If
End Sub
...
Private Sub DoBtnSave()
  MyFrmTAC01B.SaveSettings()
  MsgBox("Next time you run this program the saved settings will be loaded (Company, Data to Update, Path)", MsgBoxStyle.Information, "Program settings saved")
End Sub

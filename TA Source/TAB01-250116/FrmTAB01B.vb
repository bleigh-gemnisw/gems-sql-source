...
Friend WithEvents ErrProv As System.Windows.Forms.ErrorProvider
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAB01B))
    ...
    Me.ChkFrozenFile.Location = New System.Drawing.Point(24, 138)
    ...
    Me.ChkBAA.Location = New System.Drawing.Point(24, 94)
    ...
    Me.ChkCC.Location = New System.Drawing.Point(24, 116)
    Me.ChkCC.Name = "ChkCC"
    ...
    Me.ClientSize = New System.Drawing.Size(189, 169)
    Me.ControlBox = False
...
#End Region
  ...
  End Sub
Private Sub FrmTAB01B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Windows.Forms.Cursor.Current = Cursors.WaitCursor
  BufferExem()
  SetGLYear()
  Windows.Forms.Cursor.Current = Cursors.Default
...
End Sub
Private Sub FrmTAB01B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTAB01.SbpScreen.Text = "TAB01B"
End Sub
Private Sub FrmTAB01B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub

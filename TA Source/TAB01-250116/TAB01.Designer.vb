...
Partial Public Class TAB01
    ...
    Partial Public Class mytableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddmytableRow(ByVal group As String, ByVal code As String, ByVal desc As String, ByVal re As Long, ByVal mv As Long, ByVal pp As Long, ByVal tot As Long) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {group, code, desc, re, mv, pp, tot}

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA111))
...
Me.Text = "Local Benefit Codes Maintenance"
...
#End Region
 ...
 Private Sub FrmTA111_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmTA111B = New FrmTA111B
   MyFrmTA111B.MdiParent = Me
   MyFrmTA111B.Show()
 End Sub
...
Private Sub FrmTA111_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA111B" Then
    MyFrmTA111.Close()
  Else
    MyFrmTA111C.Close()
    MyFrmTA111B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTA111C.DeleteData()
  MyFrmTA111C.Close()
End Sub
Private Sub DoBtnNew()
  MyFrmTA111C = New FrmTA111C
  MyFrmTA111C.MdiParent = MyFrmTA111B.ParentForm
  MyFrmTA111C.wrkbncode = ""
  MyFrmTA111C.Show()
  MyFrmTA111B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTA111B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTA111C.SaveData()
End Sub

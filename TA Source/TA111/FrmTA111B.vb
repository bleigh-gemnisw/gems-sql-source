...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(408, 270)
...
#End Region
Private Sub FrmTA111B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myTXLOCCD = New TXLOCCD.mydata(MyDBConnect)
  wrkbncode = ""
  Call FormatGrid()
End Sub
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
  wrkbncode = TxtPos.Text
  FormatGrid()
  TxtPos.Text = ""
End Sub
...
Public Sub ShowGrid()
  ...
  myTXLOCCD.CloseFile()
End Sub
Private Sub FrmTA111B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTA111.SbpScreen.Text = "TA111B"
  MyFrmTA111.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmTA111C = New FrmTA111C
  MyFrmTA111C.MdiParent = Me.ParentForm
  MyFrmTA111C.wrkbncode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTA111C.wrkbndsc = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
  MyFrmTA111C.Show()
  Me.Hide()
End Sub
End Class

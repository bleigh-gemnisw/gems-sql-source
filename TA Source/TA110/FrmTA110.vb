...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA110))
...
Private Sub FrmTA110_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA110B = New FrmTA110B
  MyFrmTA110B.MdiParent = Me
  MyFrmTA110B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA110_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA110B" Then
    MyFrmTA110.Close()
  Else
    MyFrmTA110C.Close()
    MyFrmTA110B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTA110C.DeleteData()
  MyFrmTA110C.Close()
  MyFrmTA110B.ShowGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTA110C = New FrmTA110C
  MyFrmTA110C.MdiParent = MyFrmTA110B.ParentForm
  MyFrmTA110C.Wrkoid = ""
  MyFrmTA110C.Show()
  MyFrmTA110B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTA110B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTA110C.SaveData()
End Sub

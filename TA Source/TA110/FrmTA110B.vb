...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(536, 344)
...
Private Sub FrmTA110B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub ShowGrid()
  If WrkOid = "" Then
    ds = myTXOWN.GetAllData
  Else
    ds = myTXOWN.PosData(TxtPos.Text)
  End If
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
 End Sub
Private Sub FrmTA110B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTA110.SbpScreen.Text = "TA110B"
  MyFrmTA110.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    If DataGrdView.Rows.Count > 0 Then
      ...
      MyFrmTA110C.MdiParent = Me.ParentForm
      MyFrmTA110C.Wrkoid = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      MyFrmTA110C.Show()
      Me.Hide()
    End If
  End Sub

...
End Sub
  Private Sub RunReport()
   ...
   Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtTA525.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      .SetDataSource(Wrkds)
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("myreportTitle", "Supplement MV on MV List")
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTA525B.TxtCurrYear.Text))
    End With
    With Crv1
     .DisplayToolbar = True

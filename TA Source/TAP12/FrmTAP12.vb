...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP12))
...
Me.Text = "PP Declaration Exemptions"
...
#End Region
Private Sub FrmTAP12_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  HelpProvider1.HelpNamespace = MyUtils.GetHelpFile(WrkProgName)
	...
	set_security() '#set
	MyFrmTAP12B = New FrmTAP12B
	MyFrmTAP12B.MdiParent = Me
	MyFrmTAP12B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
	...
	End If
End Sub
Private Sub FrmTAP12_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
	If Me.SbpScreen.Text = "TAP12B" Then
		MyFrmTAP12.Close()
	Else
		MyFrmTAP12C.Close()
		MyFrmTAP12B.Show()
...
Private Sub DoBtnDelete()
	...
	MyFrmTAP12C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
	...
	MyFrmTAP12C.MdiParent = MyFrmTAP12B.ParentForm
  MyFrmTAP12C.WrkYear = MyUtils.CnvSng(MyFrmTAP12B.LblYear.Text)
	MyFrmTAP12C.WrkCode = ""
	MyFrmTAP12C.Show()
	MyFrmTAP12B.Hide()
End Sub
Private Sub DoBtnPrint()
	...
	MyCRViewer.Wrkds = MyFrmTAP12B.ds
	MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
	MyFrmTAP12C.SaveData()
End Sub

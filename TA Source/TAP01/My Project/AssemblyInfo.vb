...
'MK 8/11/25 Change hard coded depreciation year to use filing year instead
'MK 8/18/25 Add line to copy TXDCDV MSRP from previous year
'MK 9/23/25 Fix summary rounding by writing records after writing detail records
'MK 9/29/25 Remove hard coded year use depr year instead
'MK 10/1/25 Write Summary 9 record if there are TXDCMV records 
'MK 2/23/26 Check for Depr Year < 1 
Imports System

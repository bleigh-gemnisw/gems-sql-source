...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP11))
...
Me.Text = "PP Declaration Depreciation Table"
...
#End Region
Private Sub FrmTAP11_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTAP11B = New FrmTAP11B
  MyFrmTAP11B.MdiParent = Me
  MyFrmTAP11B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTAP11_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TAP11B" Then
    MyFrmTAP11.Close()
  Else
    MyFrmTAP11C.Close()
    MyFrmTAP11B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTAP11C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmTAP11C.MdiParent = MyFrmTAP11B.ParentForm
  MyFrmTAP11C.WrkYear = MyUtils.CnvSng(MyFrmTAP11B.LblYear.Text)
	'MyFrmTAP11C.Wrkdecode = 0
  'MyFrmTAP11C.WrkTxType = ""
  MyFrmTAP11C.Show()
  MyFrmTAP11B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTAP11B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTAP11C.SaveData()
End Sub

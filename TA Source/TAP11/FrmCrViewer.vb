Public Class FrmCrViewer
  ...
  Dim myreport As New PrtTXDCDEP
...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
	With myreport
	 .SetDataSource(Wrkds)
	 .SetParameterValue("MyReportTitle", "PP Declaration Depreciation Table")
	 .SetParameterValue("MyUserID", MyUserID)
	 .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
	 .SetParameterValue("MyYear", Wrkds.Tables(0).Rows(0).Item("year"))
	End With
   With Crv1
     .DisplayToolbar = True

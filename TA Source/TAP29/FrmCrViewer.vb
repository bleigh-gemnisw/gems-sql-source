...
#End Region
	...
	Private Sub RunReport1()
		...
		ReportPath = MyUtils.GetReportPath("PrtTAP29.rpt", myTOWN._TOWNBR)

		With myreport
			.Load(ReportPath)
			.SetDataSource(wrkds)
			.SetParameterValue("myreportTitle", "Remove Local Benefits")
			.SetParameterValue("MyUserID", MyUserID)
			.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
			.SetParameterValue("MyGLYear", MyUtils.CnvSng(MyFrmTAP29B.TxtYear.Text))

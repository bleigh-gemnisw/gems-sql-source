Public Class FrmListLocalCodes
...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(127, 5)
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(256, 260)
    ...
    Me.Name = "FrmListLocalCodes"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Select Local Code"
...
#End Region
  ...
  Public Sub ShowGrid()
    If TxtPos.Text = "" Then
      ds = MyTXLOCCD.GetAllData
    Else
      ds = MyTXLOCCD.PosData(TxtPos.Text)
    End If
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListLocalCodes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTAP29.SbpScreen.Text = "ListLocalCodes"
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
  Private Sub FrmListLocalCodes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Private Sub FrmListLocalCodes_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  'Memory Cleanup
  MyTXLOCCD = Nothing
  MyFrmListLocalCodes = Nothing
End Sub
End Class

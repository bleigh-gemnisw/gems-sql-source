...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA222))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarClear})
...
Me.Text = "Extract Real Estate Grand List Information"
...
#End Region
    ...
    Private Sub FrmTA222_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
       ...
       TBarClear.Enabled = True
        
       MyFrmTA222B = New FrmTA222B
       MyFrmTA222B.MdiParent = Me
       MyFrmTA222B.Show()
    End Sub
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA222B" Then
    MyFrmTA222.Close()
  End If
End Sub
Private Sub DoBtnClear()
  MyFrmTA222B.runClear()
End Sub

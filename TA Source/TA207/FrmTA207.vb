...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA207))
...
Me.Text = "Local Tax Credit Benefit"
...
Private Sub FrmTA207_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTA207B = New FrmTA207B
  MyFrmTA207B.MdiParent = Me
  MyFrmTA207B.Show()
End Sub
...
End Sub
Private Sub FrmTA207_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTA207.TBarPrint.Enabled = False
   MyFrmTA207B.RunReport()
   MyFrmTA207.TBarPrint.Enabled = True
End Sub

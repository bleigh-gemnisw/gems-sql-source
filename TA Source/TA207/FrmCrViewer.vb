...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTA207.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      ...
      End If
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", "Local Tax Credit Benefit")
  ...
  Private Sub RunReport2()
    ...
    With myreport2
      ...
      .SetParameterValue("myreportTitle", "Local Errors")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyGLYear", WrkGLYear)
    End With

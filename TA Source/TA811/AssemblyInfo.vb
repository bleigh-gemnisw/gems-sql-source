...
'MK  1/ 8/26 Add suppl to Source Lookup
'MK  2/12/26 Change Hard Coded year to Tax Year in CalcValue
'MK  5/18/26 Real Estate: Update Phase In adjusted fields 
'MK  6/ 8/26 Change CalcValue call from Tax Year to Vehicle Year, Phase in Handle negative FulGrs 
'MK  6/29/26 TXPHIN: change fields from ADJ to AFT  
'MK  7/ 2/26 Replace GetGNET
'MK  9/ 3/26 Add AppConfig, use to determine if username or computername is used for XML file name
Imports System

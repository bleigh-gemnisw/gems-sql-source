...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(512, 350)
...
#End Region
Private Sub FrmTA102B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myTXEXEM = New TXEXEM.mydata(MyDBConnect)
  WrkTxCode = ""
  Call FormatGrid()
End Sub
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
  WrkTxCode = TxtPos.Text
  FormatGrid()
 TxtPos.Text() = ""
End Sub
...
Public Sub ShowGrid()
  ...
  myTXEXEM.CloseFile()
End Sub
Private Sub FrmTA102B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTA102.SbpScreen.Text = "TA102B"
  MyFrmTA102.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmTA102C.MdiParent = Me.ParentForm
  MyFrmTA102C.WrkTxCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmTA102C.Show()
  Me.Hide()
End Sub
End Class

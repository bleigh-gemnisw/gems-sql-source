...
Friend WithEvents TBarFiller1 As System.Windows.Forms.ToolBarButton
...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA102))
...
Me.TBarFiller1 = New System.Windows.Forms.ToolBarButton
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarPrint, Me.TBarFiller1, Me.TBarUpdate})
...
Me.ImageList1.Images.SetKeyName(5, "export_png_194.png")
'
'SbMain
'
...
'TBarFiller1
'
Me.TBarFiller1.Name = "TBarFiller1"
Me.TBarFiller1.Style = System.Windows.Forms.ToolBarButtonStyle.Separator
'
'TBarUpdate
'
Me.TBarUpdate.ImageIndex = 5
Me.TBarUpdate.Name = "TBarUpdate"
Me.TBarUpdate.Text = "Mass Update RE"
'
'FrmTA102
'
...
Me.Text = "Tax Exemption Codes Maintainence"
...
#End Region
Private Sub FrmTA102_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA102B = New FrmTA102B
  MyFrmTA102B.MdiParent = Me
  MyFrmTA102B.Show()
End Sub
...
Private Sub SbMain_PanelClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.StatusBarPanelClickEventArgs) Handles SbMain.PanelClick
  ...
  End If
End Sub
Private Sub FrmTA102_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA102B" Then
    MyFrmTA102.Close()
  Else
    MyFrmTA102C.Close()
    MyFrmTA102B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTA102C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmTA102C.Close()
  MyFrmTA102B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTA102C = New FrmTA102C
  MyFrmTA102C.MdiParent = MyFrmTA102B.ParentForm
  MyFrmTA102C.WrkTxCode = ""
  MyFrmTA102C.Show()
  MyFrmTA102B.Hide()
End Sub
Private Sub DoBtnPrint()
  MyCrViewer = New FrmCrViewer
  MyCrViewer.Wrkds = MyFrmTA102B.ds
  MyCrViewer.wrkrptid = "File"
  MyCrViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTA102C.SaveData()
End Sub
Private Sub DoBtnUpdate()
  Dim Answer As Integer

  Answer = MsgBox("This will update all exemptions in Real Estate with the exemption" & _
    " amount on this screen. Continue with Mass update?", _
    MsgBoxStyle.YesNo + MsgBoxStyle.Exclamation, "Mass Update RE")

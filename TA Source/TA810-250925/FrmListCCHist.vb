...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(1, 1)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(408, 247)
    Me.DataGrdView.TabIndex = 42
    '
    'FrmListCCHist
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(409, 248)
  ...
  Private Sub BuildDS()
    ...
    With myTable
      ...
      .Columns.Add("Nnet", Type.GetType("System.Int32"))
			.Columns.Add("Change", Type.GetType("System.Int32"))
		End With
...
Private Sub AddRecords()
  ...
  Dim WrkCurrYear As Integer
	Dim SaveNet As Integer

  WrkCurrYear = Date.Now.Year
  If Date.Now.Month < 10 Then
    WrkCurrYear = WrkCurrYear - 1
  End If

	SaveNet = 0
	'Only Show Original amount for current year
  If WrkYear = WrkCurrYear Then
    Select Case WrkType
    Case "R"
    ...
    Case "M"
			...
			With myTXMVDC
				...
				myDr("nnet") = ._VALUE - WrkExam + ._BTR
				myDr("change") = 0
				ds.Tables(0).Rows.Add(myDr)
				SaveNet = ._VALUE - WrkExam + ._BTR
			End With
			End If
    End Select
  End If
  ...
  For I = 0 To dsTXCOEBL4.Tables(0).Rows.Count - 1
    With dsTXCOEBL4.Tables(0).Rows(I)
    myDr = ds.Tables(0).NewRow
    myDr("ccno") = .Item("ccno")
    myDr("cdate") = MyUtils.GetDBDate(.Item("cdate"))
    myDr("rsndesc") = GetTXCResnDesc(.Item("rsncd"))
    myDr("nnet") = .Item("ntnet")
		If SaveNet > 0 Then
			myDr("change") = .Item("ntnet") - SaveNet
		Else
			myDr("change") = 0
		End If
		SaveNet = .Item("ntnet")
...
End Sub
  Public Sub FormatGrid()
    ...
    With DataGrdView
      ...
      .Columns(2).Width = 100
      .Columns(3).HeaderText = "Net"
      .Columns(3).Width = 70
      .Columns(4).HeaderText = "Change"
      .Columns(4).Width = 70
    End With

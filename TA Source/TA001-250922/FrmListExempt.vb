...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents TxtPos As System.Windows.Forms.TextBox
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(15, 70)
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    If WrkFile = "RE" Then
    With MyFrmTA001RE
      .TxtExemptCd.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .Ttp1.SetToolTip(.TxtExemptCd, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With
    End If

    If WrkFile = "Trans" Then
    With MyFrmTA001RE
      .TxtTranExemptCd.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .Ttp1.SetToolTip(.TxtTranExemptCd, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With
    End If

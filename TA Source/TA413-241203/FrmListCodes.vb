...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(128, 4)
...
#End Region
  ...
  Private Sub FrmListCodes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTA413.SbpScreen.Text = "ListCodes"
  ...
  Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    End If
  End Sub
Private Sub FrmListCodes_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
  MyFrmTA413B.Show()
End Sub
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTA413B
      If WrkField = "From" Then
        .TxtFromClass.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtFromClass, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtToClass.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .Ttp1.SetToolTip(.TxtToClass, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

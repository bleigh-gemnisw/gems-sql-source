...
Partial Public Class TA509
    ...
    Partial Public Class mytableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddmytableRow(ByVal LISTNO As Long, ByVal ONAME As String, ByVal _CLASS As Long, ByVal MAKE As String, ByVal YEAR As Long, ByVal IDNO As String, ByVal MODEL As String, ByVal NADA As String, ByVal MSRP As Long, ByVal LASTYRVAL As Long, ByVal VALUE As Long) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {LISTNO, ONAME, _CLASS, MAKE, YEAR, IDNO, MODEL, NADA, MSRP, LASTYRVAL, VALUE}

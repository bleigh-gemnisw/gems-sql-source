...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA509))
        ...
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarSave, Me.TBarPrint, Me.TbarSettings})
        Me.TbMain.DropDownArrows = True
        Me.TbMain.ImageList = Me.ImageList1
        Me.TbMain.Location = New System.Drawing.Point(0, 0)
        Me.TbMain.Name = "TbMain"
        Me.TbMain.ShowToolTips = True
        Me.TbMain.Size = New System.Drawing.Size(862, 50)
        ...
        Me.SbMain.Size = New System.Drawing.Size(862, 28)
        ...
        Me.ClientSize = New System.Drawing.Size(862, 614)
        ...
        Me.Text = "Unpriced Vehicles (Click on refresh to start)"
...
Private Sub FrmTA509_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTA509B = New FrmTA509B
  MyFrmTA509B.MdiParent = MyFrmTA509
  MyFrmTA509B.Show()
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
	...
	End If
End Sub
Private Sub FrmTA509_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTA509B.PrintData()
End Sub
Private Sub DoBtnSave()
	MyFrmTA509B.SaveData()
End Sub
Private Sub DoBtnSettings()
	MyFrmSettings = New FrmSettings
	MyFrmSettings.MdiParent = Me.ParentForm

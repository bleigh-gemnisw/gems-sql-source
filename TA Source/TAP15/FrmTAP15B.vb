...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents TxtPos As System.Windows.Forms.TextBox
    ...
    'TxtPos
    '
    Me.TxtPos.Location = New System.Drawing.Point(85, 30)
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(125, 30)
    ...
    Me.LblYear.Location = New System.Drawing.Point(63, 7)
    ...
    'Label29
    '
    Me.Label29.Location = New System.Drawing.Point(22, 7)
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(198, 366)
    Me.DataGrdView.TabIndex = 217
    '
    'FrmTAP15B
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(222, 438)
    Me.ControlBox = False
...
#End Region
Private Sub FrmTAP15B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub FormatGrid()
  ...
  With DataGrdView
    ...
    .Columns(1).Width = 40
    .Columns(2).HeaderText = "Ltr"
    .Columns(2).Width = 35
    .Columns(3).HeaderText = "Asm Code"
    .Columns(3).Width = 35
...
Public Sub ShowGrid()
  If WrkCode = "" Then
    ds = myTXDMCD.GetAllYear(WrkYear)
  Else
    ds = myTXDMCD.PosData(WrkYear, MyUtils.CnvSng(TxtPos.Text), WrkTxltr)
  End If
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
End Sub
Private Sub FrmTAP15B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTAP15.SbpScreen.Text = "TAP15B"
  MyFrmTAP15.TBarPrint.Enabled = True
...
Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtPos.KeyPress
  ...
  If e.KeyChar = MyUtils.VbKeyEnter Then
    ds = myTXDMCD.PosData(WrkYear, Val(TxtPos.Text), WrkTxltr)
    WrkFind = True
    FormatGrid()
    WrkFind = False
    TxtPos.Text() = ""
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmTAP15C = New FrmTAP15C
  MyFrmTAP15C.MdiParent = Me.ParentForm
  MyFrmTAP15C.WrkYear = WrkYear
  MyFrmTAP15C.WrkTXDMCD = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
  MyFrmTAP15C.WrktxLtr = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
  MyFrmTAP15C.Show()
  Me.Hide()
End Sub
End Class

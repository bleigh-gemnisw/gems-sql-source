...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP15))
...
Me.Text = "PP Mfg & Equip - Property Codes"
...
#End Region
Private Sub FrmTAP15_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTAP15B = New FrmTAP15B
  MyFrmTAP15B.MdiParent = Me
  MyFrmTAP15B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTAP15_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TAP15B" Then
    MyFrmTAP15.Close()
  Else
    MyFrmTAP15C.Close()
    MyFrmTAP15B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTAP15C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmTAP15C.MdiParent = MyFrmTAP15B.ParentForm
  MyFrmTAP15C.WrkYear = MyUtils.CnvSng(MyFrmTAP15B.LblYear.Text)
	'MyFrmTAP15C.WrkTXDMCD = 0
  'MyFrmTAP15C.WrkTxType = ""
  MyFrmTAP15C.Show()
  MyFrmTAP15B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTAP15B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTAP15C.SaveData()
End Sub

...
Friend WithEvents SbpFiller As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA135))
    ...
    Me.TbMain.Size = New System.Drawing.Size(654, 50)
    ...
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 415)
    ...
    Me.SbMain.Size = New System.Drawing.Size(654, 28)
    ...
    Me.Text = "Maintain Local Exemption Income"
...
Private Sub FrmTA135_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA135B = New FrmTA135B
  MyFrmTA135B.MdiParent = Me
  MyFrmTA135B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA135_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA135B" Then
    If MyUtils.CnvSng(MyFrmTA135B.TxtYear.Text) > 0 Then
      MyFrmTA135B.GrpData.Enabled = False
      MyFrmTA135B.TxtYear.Enabled = True
      MyFrmTA135B.TxtYear.Text = ""
    Else
      MyFrmTA135.Close()
    End If
  Else
...
Private Sub DoBtnSave()
  ...
  WrkError = MyFrmTA135B.CheckErrors
  If WrkError Then Exit Sub

  WrkYear = MyUtils.CnvSng(MyFrmTA135B.TxtYear.Text)
  With MyFrmTA135B
    .SaveData(WrkYear, "DAC", MyUtils.CnvSng(.TxtDACSingle.Text), MyUtils.CnvSng(.TxtDACMarried.Text), _
     MyUtils.CnvSng(.TxtDACAmount.Text))
    If MyLocEld = "084" Then
      .SaveData(WrkYear, "LOC", MyUtils.CnvSng(.TxtLOCSingle.Text), MyUtils.CnvSng(.TxtLOCMarried.Text), _
        MyUtils.CnvSng(.TxtLOCAmount.Text))
      .SaveData(WrkYear, "EBC", MyUtils.CnvSng(.TxtEBCSingle.Text), MyUtils.CnvSng(.TxtEBCMarried.Text), _
        MyUtils.CnvSng(.TxtEBCAmount.Text))
      .SaveData(WrkYear, "FBC", MyUtils.CnvSng(.TxtFBCSingle.Text), MyUtils.CnvSng(.TxtFBCMarried.Text), _
       MyUtils.CnvSng(.TxtFBCAmount.Text))
    End If

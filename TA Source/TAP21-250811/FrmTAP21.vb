...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP21))
...
Me.Text = "Copy Tables to NewYear"
...
Private Sub FrmTAP21_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  HelpProvider1.HelpNamespace = MyUtils.GetHelpFile(WrkProgName)
	...
	MyFrmTAP21B = New FrmTAP21B
	MyFrmTAP21B.MdiParent = Me
	MyFrmTAP21B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
	...
	End If
End Sub
Private Sub FrmTAP21_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnProcess()
	 MyFrmTAP21.TBarProcess.Enabled = False
	 MyFrmTAP21B.RunReport()
	 MyFrmTAP21.TBarProcess.Enabled = True
End Sub

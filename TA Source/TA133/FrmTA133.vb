...
Friend WithEvents SbpFiller As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA133))
...
Private Sub FrmTA133_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA133B = New FrmTA133B
  MyFrmTA133B.MdiParent = Me
  MyFrmTA133B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA133_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA133B" Then
    If MyUtils.CnvSng(MyFrmTA133B.TxtYear.Text) > 0 Then
      MyFrmTA133B.GrpData.Enabled = False
      MyFrmTA133B.TxtYear.Enabled = True
      MyFrmTA133B.TxtYear.Text = ""
    Else
      MyFrmTA133.Close()
    End If
  Else
...
Private Sub DoBtnSave()
  ...
  WrkError = MyFrmTA133B.CheckErrors
  If WrkError Then Exit Sub

    WrkYear = MyUtils.CnvSng(MyFrmTA133B.TxtYear.Text)
    If WrkYear > 0 Then
      With MyFrmTA133B
        .SaveData(WrkYear, 1, .TxtLimit1.Text, .TxtMPct1.Text, .TxtUPct1.Text)
        .SaveData(WrkYear, 2, .TxtLimit2.Text, .TxtMPct2.Text, .TxtUPct2.Text)
        .SaveData(WrkYear, 3, .TxtLimit3.Text, .TxtMPct3.Text, .TxtUPct3.Text)
        .SaveData(WrkYear, 4, .TxtLimit4.Text, .TxtMPct4.Text, .TxtUPct4.Text)
        .SaveData(WrkYear, 5, .TxtLimit5.Text, .TxtMPct5.Text, .TxtUPct5.Text)

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA216B))
...
Me.TxtDist.Location = New System.Drawing.Point(112, 37)
...
Me.ChkFrozenFile.Location = New System.Drawing.Point(27, 72)
...
'LnkDist
'
Me.LnkDist.Location = New System.Drawing.Point(28, 37)
...
#End Region
  ...
  End Sub
Private Sub FrmTA216B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTA216.SbpScreen.Text = "TA216B"
End Sub
Private Sub FrmTA216B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
  ...
  Private Sub EditChecks(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
    ...
    If MyTXCDSF.RecordNotFound Then
      ErrorField(I) = "code"
      ErrorMsg(I) = "State Forester Table is NOT setup"
      I = I + 1
    End If
...
Private Sub FrmTA216B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

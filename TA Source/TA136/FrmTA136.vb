...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA136))
...
#End Region
 ...
 Private Sub FrmTA136_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmTA136B = New FrmTA136B
   MyFrmTA136B.MdiParent = Me
   MyFrmTA136B.Show()
 End Sub
...
Private Sub FrmTA136_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA136B" Then
    MyFrmTA136.Close()
  Else
    MyFrmTA136C.Close()
    MyFrmTA136B.Show()
...
Private Sub DoBtnDelete()
  MyFrmTA136C.DeleteData()
  MyFrmTA136C.Close()
End Sub
Private Sub DoBtnNew()
  MyFrmTA136C = New FrmTA136C
  MyFrmTA136C.MdiParent = MyFrmTA136B.ParentForm
  MyFrmTA136C.WrkDesc = ""
  MyFrmTA136C.Show()
  MyFrmTA136B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTA136B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTA136C.SaveData()
End Sub

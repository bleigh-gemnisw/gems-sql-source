...
Friend WithEvents TBarSep1 As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA234))
    ...
    Me.Text = "Print Compare Change of Assessment List"
...
Private Sub FrmTA234_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  HelpProvider1.HelpNamespace = MyUtils.GetHelpFile(WrkProgName)
	...
	set_security() '#set
	MyFrmTA234B = New FrmTA234B
	MyFrmTA234B.MdiParent = Me
	MyFrmTA234B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
	...
	End If
End Sub
Private Sub FrmTA234_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
	 MyFrmTA234.TBarPrint.Enabled = False
	 MyFrmTA234B.RunReport()
	 MyFrmTA234.TBarPrint.Enabled = True
End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA203))
...
Me.Text = "(Highest) Assessment List by descending value"
...
Private Sub FrmTA203_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTA203B = New FrmTA203B
  MyFrmTA203B.MdiParent = Me
  MyFrmTA203B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA203_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTA203.TBarPrint.Enabled = False
   MyFrmTA203B.RunReport()
   MyFrmTA203.TBarPrint.Enabled = True
End Sub

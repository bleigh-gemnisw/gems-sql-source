...
Friend WithEvents TBarPS As System.Windows.Forms.ToolBarButton
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAD05))
    ...
    Me.HelpProvider1 = New System.Windows.Forms.HelpProvider()
        ...
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarPrint, Me.TBarPS})
        ...
        'SbMain
        '
        Me.SbMain.Location = New System.Drawing.Point(0, 651)
        ...
        Me.ClientSize = New System.Drawing.Size(783, 679)
        ...
        Me.Text = "Tax Assessor Archive - RE, PP, MV, SU"
...
#End Region
  ...
  Private Sub FrmTAD05_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security()   '#sec
    MyFrmTAD05B = New FrmTAD05B
    MyFrmTAD05B.MdiParent = Me
    MyFrmTAD05B.Show()
  End Sub
  ...
  Private Sub FrmTAD05_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    ...
    Select Case Me.SbpScreen.Text
      ...
      Case "TAD05DMV"
        MyFrmTAD05DMV.Close()
        If MyFrmTAD05B.RbMV.Checked Then
          MyFrmTAD05MV.Show()
        Else
          MyFrmTAD05SU.Show()
        End If

Public Class FrmCrViewer
  ...
  Friend WrkToClassDesc As String
  Friend WrkFromYear As Integer
	Friend WrkToYear As Integer
	Friend WrkUnpriced As Boolean
  ...
  Private Sub CrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
   Dim ReportPath As String
    ...
    With WrkMargin
     ...
     .bottomMargin = 150
   End With
    If MyFrmTA413B.ChkNonTax.Checked Then
      ReportTitle = "MV Class List - Non Tax"
    Else
      ReportTitle = "MV Class List"
    End If
    Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTA413.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    .SetParameterValue("MyToClass", WrkToClass)
    .SetParameterValue("MyToClassDesc", WrkToClassDesc)
    .SetParameterValue("MyFromYear", WrkFromYear)
    .SetParameterValue("MyToYear", WrkToYear)
		.SetParameterValue("MyUnpriced", WrkUnpriced)
	 End With
   With Crv1
     .DisplayToolbar = True

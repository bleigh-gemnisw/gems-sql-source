...
Dim SavePct As Integer
	Dim myTXMVDQJ As TXMVDQJ.MyData
	...
	Public Sub PrtReport(ByVal WrkClassDesc As String)
		...
		myTXMVDQJ = New TXMVDQJ.MyData(myDBConnect)
...
Done:
	...
	Private Sub BuildDS()
		...
		With myTable
			...
			.Columns.Add("complete", Type.GetType("System.String"))
		End With
	...
	Private Sub GetDetail()
		...
		If WrkUnpriced Then
			...
			End If
		End If
		' added nontax 12/3/24
		If WrkNonTax Then
			If WrkQry = String.Empty Then
				WrkQry = "cat=2"
			Else
				WrkQry = WrkQry & WrkAnd & "cat=2"
			End If
		Else
			If WrkQry = String.Empty Then
				WrkQry = "cat<>2"
		...
		Select Case WrkSortby
			...
			Case "Name"
				WrkSort = "NAME, LIST#"
		End Select
		myTXMVDQJ.OpenQry(WrkSort, WrkQry)

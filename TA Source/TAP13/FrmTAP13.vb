...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP13))
...
Me.TbMain.Size = New System.Drawing.Size(538, 50)
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 364)
...
Me.SbMain.Size = New System.Drawing.Size(538, 28)
...
Me.Text = "Maintain Default Form Information"
...
Private Sub FrmTAP13_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTAP13B = New FrmTAP13B
  MyFrmTAP13B.MdiParent = Me
  MyFrmTAP13B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTAP13_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TAP13B" Then
    MyFrmTAP13.Close()
  Else
    MyFrmTAP13B.Show()
  End If

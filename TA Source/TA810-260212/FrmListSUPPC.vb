...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.DataGrdView = New System.Windows.Forms.DataGridView()
        ...
        'BtnNext
        '
        Me.BtnNext.Location = New System.Drawing.Point(272, 8)
        ...
        'BtnFind
        '
        Me.BtnFind.Location = New System.Drawing.Point(216, 8)
        ...
        Me.DataGrdView.Location = New System.Drawing.Point(11, 63)
        Me.DataGrdView.MultiSelect = False
        Me.DataGrdView.Name = "DataGrdView"
        Me.DataGrdView.ReadOnly = True
        Me.DataGrdView.RowTemplate.Height = 16
        Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
        Me.DataGrdView.Size = New System.Drawing.Size(569, 259)
        ...
        Me.Name = "FrmListSUPPC"
        Me.Text = "Select Suppl MV List Number"
...
#End Region
  ...
  Public Sub FormatGrid()
    ...
    With DataGrdView
      ...
      .Columns(4).Width = 50
      .Columns(5).HeaderText = "Model"
      .Columns(5).Width = 70
    End With

  End Sub
  Public Sub ShowGrid()
    ds = myTXSUPPCL5.GetViewbyName(TxtPos.Text, 50)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListSuppc_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTA810.SbpScreen.Text = "ListSUPPC"
    MyUtils.CenterForm(Me.ParentForm, Me)
  End Sub
  Private Sub FrmListSuppc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

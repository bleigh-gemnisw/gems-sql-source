'MK 7/14/25 Add incomplete report, change total report from ds2 to dsTot 
Public Class FrmCrViewer
  ...
  Friend WithEvents TpIncomplete As TabPage
...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.TabControl1.Controls.Add(Me.TpComplete)
    Me.TabControl1.Controls.Add(Me.TpIncomplete)
    ...
    'TpComplete
    '
    Me.TpComplete.Controls.Add(Me.Crv1)
    Me.TpComplete.Location = New System.Drawing.Point(4, 22)
    Me.TpComplete.Name = "TpComplete"
    Me.TpComplete.Size = New System.Drawing.Size(636, 350)
    Me.TpComplete.TabIndex = 0
    Me.TpComplete.Text = "Complete"
    '
    'Crv1
    '
    ...
    'TpIncomplete
    '
    Me.TpIncomplete.Controls.Add(Me.crv2)
    Me.TpIncomplete.Location = New System.Drawing.Point(4, 22)
    Me.TpIncomplete.Name = "TpIncomplete"
    Me.TpIncomplete.Size = New System.Drawing.Size(636, 350)
    Me.TpIncomplete.TabIndex = 2
    Me.TpIncomplete.Text = "Incomplete"
    Me.TpIncomplete.UseVisualStyleBackColor = True
    '
    'crv2
    '
    ...
    Me.TpComplete.ResumeLayout(False)
    Me.TpTotals.ResumeLayout(False)
    Me.TpIncomplete.ResumeLayout(False)
...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTA523.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", "Price Unpriced Suppl. MV using MSRP Complete")
  ...
  Private Sub RunReport2()
    ...
    With myreport2
      ...
      .SetParameterValue("myreportTitle", "Price Unpriced Suppl. MV using MSRP Incomplete")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    End With
    With Crv2
  ...
  Private Sub RunReport3()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtTA523Tot.rpt", myTOWN._TOWNBR)
    With myreport3
      .Load(ReportPath)
      .SetDataSource(wrkdsTot)
      .SetParameterValue("myreportTitle", "Price Unpriced Suppl. MV using MSRP Totals")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    End With
    With crv3

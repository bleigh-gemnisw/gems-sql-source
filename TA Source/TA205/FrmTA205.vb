...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA205))
...
Me.Text = "Print Change of Assessment Notices"
...
Private Sub FrmTA205_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA205B = New FrmTA205B
  MyFrmTA205B.MdiParent = Me
  MyFrmTA205B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA205_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTA205.TBarPrint.Enabled = False
   MyFrmTA205B.RunReport()
   MyFrmTA205.TBarPrint.Enabled = True
End Sub

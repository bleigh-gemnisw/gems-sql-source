...
Module PrintReportREarch
  ...
  Dim RptGross(6) As Integer
  Dim Wrkccrs As String

  Public Sub PrtReportREarch()
...
ReadNext:
    ...
    If Not myTXREALcQ.IsEOF Then
      With myTXREALcQ
        Counter = Counter + 1
        ' If no cama, skip if no cama record is found
        If MyNoCAMA Then
        ...
        myTXREAA.GetOneRecordP(._LISTNO, WrkGLYear - 1)
        ...
        dr.Item("ngross") = ._CCGRS
        dr.Item("nexam") = ._CEXA1 + ._CEXA2 + ._CEXA3 + ._CEXA4 + ._CEXA5 + ._CEXA6 + ._CEXA7
        dr.Item("nmap") = ._MAP

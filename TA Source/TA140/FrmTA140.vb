...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA140))
    ...
    Me.TbMain.Size = New System.Drawing.Size(760, 50)
    ...
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 578)
    ...
    Me.SbMain.Size = New System.Drawing.Size(760, 28)
    ...
    Me.Text = "MSRP Deprecation Percentage/Amount"
...
#End Region
  ...
  Private Sub FrmTA140_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmTA140B = New FrmTA140B
    MyFrmTA140B.MdiParent = Me
    MyFrmTA140B.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
  Private Sub FrmTA140_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    If Me.SbpScreen.Text = "TA140B" Then
      MyFrmTA140.Close()
    Else
      MyFrmTA140C.Close()
      MyFrmTA140B.Show()
  ...
  Private Sub DoBtnDelete()
    ...
    MyFrmTA140C.DeleteData(Wrkcancel)
    If Wrkcancel Then Exit Sub
    MyFrmTA140C.Close()
    MyFrmTA140B.FormatGrid()
  End Sub
  Private Sub DoBtnNew()
    MyFrmTA140C = New FrmTA140C
    MyFrmTA140C.MdiParent = MyFrmTA140B.ParentForm
    'MyFrmTA140C.Wrkcrperc = 0
    MyFrmTA140C.Show()
    MyFrmTA140B.Hide()
  End Sub
  Private Sub DoBtnPrint()
    ...
    MyCRViewer.Wrkds = MyFrmTA140B.ds
    MyCRViewer.Show()
  End Sub
  Private Sub DoBtnSave()
    MyFrmTA140C.SaveData()
  End Sub

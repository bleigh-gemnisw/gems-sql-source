...
Me.Crv1.Size = New System.Drawing.Size(670, 388)
Me.Crv1.TabIndex = 2
...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Case "R"
      WrkType = "REAL ESTATE"
    Case "P"
      WrkType = "PERSONAL PROPERTY"
    Case "M"
      WrkType = "MOTOR VEHICLE"
    Case "S"
      WrkType = "SUPPL MV"
    End Select
...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA331.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Print Change Log")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmTA331B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmTA331B.DtPckTo.Value)

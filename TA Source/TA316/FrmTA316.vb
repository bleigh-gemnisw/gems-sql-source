...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA316))
...
Private Sub FrmTA316_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTA316B = New FrmTA316B
  MyFrmTA316B.MdiParent = Me
  MyFrmTA316B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA316_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  ...
  Case "TA316"
    MyFrmTA316.Close()
  Case "ListBusty"
    MyFrmListBusty.Close()
  End Select
End Sub
Private Sub DoBtnPrint()
   MyFrmTA316.TBarPrint.Enabled = False
   MyFrmTA316B.RunReport()
   MyFrmTA316.TBarPrint.Enabled = True
End Sub

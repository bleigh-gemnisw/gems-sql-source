...
Public Sub PrtReport()
    ...
    'Write Letter Totals
    For I = 0 To 200
      If IsNothing(WrkLtrEx(I)) Then Exit For
      dr = dsLtr.Tables(0).NewRow
      dr.Item("ltr") = WrkLtrEx(I)
      dr.Item("desc") = WrkLtrDesc(I)
      dr.Item("re") = WrkLtrExRE(I)
      dr.Item("mv") = WrkLtrExMV(I)
      dr.Item("pp") = WrkLtrExPP(I)
      dr.Item("tot") = WrkLtrExRE(I) + WrkLtrExMV(I) + WrkLtrExPP(I)
      dsLtr.Tables(0).Rows.Add(dr)
    Next I

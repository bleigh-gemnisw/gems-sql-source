...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.TabCtl1.Controls.Add(Me.TabLetter)
    ...
    'TabLetter
    '
    Me.TabLetter.Controls.Add(Me.Crv3)
    Me.TabLetter.Location = New System.Drawing.Point(4, 22)
    Me.TabLetter.Name = "TabLetter"
    Me.TabLetter.Size = New System.Drawing.Size(648, 354)
    Me.TabLetter.TabIndex = 6
    Me.TabLetter.Text = "Letter Totals"
    ...
    Me.Crv3.Size = New System.Drawing.Size(632, 340)
    Me.Crv3.TabIndex = 3
...
#End Region
  ...
  Private Sub RunReport()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTAB01.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      ...
      .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTAB01B.TxtGLYear.Text))
      .SetParameterValue("MyCC", WrkCC)
      .SetParameterValue("MyBTR", WrkBTR)
      .SetParameterValue("MyFrozen", WrkFrozen)
      .SetParameterValue("MyREExempt", WrkREExempt)
      .SetParameterValue("MyPPExempt", WrkPPExempt)
      .SetParameterValue("MyMVExempt", WrkMVExempt)
    End With
    With Crv1
      .DisplayToolbar = True
  ...
  Private Sub RunReportEld()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtTAB01Eld.rpt", myTOWN._TOWNBR)
    With myreport2
      .Load(ReportPath)
      If MyReportLandscape Then
        .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
  ...
  Private Sub RunReportLtr()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtTAB01Ltr.rpt", myTOWN._TOWNBR)
    With myreport3
      .Load(ReportPath)
      If MyReportLandscape Then
        .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape

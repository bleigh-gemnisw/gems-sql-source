...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP20))
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 475)
...
Me.ClientSize = New System.Drawing.Size(768, 503)
...
Me.Text = "Update Personal Property Data from Declarations"
...
Private Sub FrmTAP20_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTAP20B = New FrmTAP20B
  MyFrmTAP20B.MdiParent = Me
  MyFrmTAP20B.Show()
End Sub
...
End Sub
Private Sub FrmTAP20_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

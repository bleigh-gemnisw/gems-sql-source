Public Class FrmCrViewer
 ...
 Friend WithEvents TpInactive As System.Windows.Forms.TabPage
...
Friend WithEvents TpMissing As System.Windows.Forms.TabPage
    ...
    Me.TpInactive = New System.Windows.Forms.TabPage()
    ...
    Me.TabControl1.Controls.Add(Me.TpInactive)
    ...
    'TpInactive
    '
    Me.TpInactive.Controls.Add(Me.Crv4)
    Me.TpInactive.Location = New System.Drawing.Point(4, 22)
    Me.TpInactive.Name = "TpInactive"
    Me.TpInactive.Size = New System.Drawing.Size(636, 350)
    Me.TpInactive.TabIndex = 5
    Me.TpInactive.Text = "Inactive"
    Me.TpInactive.UseVisualStyleBackColor = True
    '
    'Crv4
    '
    ...
    Me.TpInactive.ResumeLayout(False)
...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTAP20.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds)
    ...
    .SetParameterValue("MyPost", MyFrmTAP20B.ChkPost.Checked)
    .SetParameterValue("MyUpdCode", MyFrmTAP20B.ChkPropCode.Checked)
    .SetParameterValue("MyUpdExempt", MyFrmTAP20B.ChkExemptCode.Checked)
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTAP20B.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetDataSource(Wrkds)
  ...
  Private Sub RunReport4()
   ...
   With myreport4
    ...
    .SetParameterValue("myreportTitle", "Inactive Personal Property Declarations")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyPost", MyFrmTAP20B.ChkPost.Checked)
    .SetParameterValue("MyUpdCode", MyFrmTAP20B.ChkPropCode.Checked)
  ...
  Private Sub RunReport5()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTAP20Err.rpt", myTOWN._TOWNBR)
   With myreport5
    .Load(ReportPath)
  ...
  Private Sub RunReportTot()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTAP20Tot.rpt", myTOWN._TOWNBR)
   With myreportTot
    .Load(ReportPath)

...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents Cr1 As CrystalDecisions.Windows.Forms.CrystalReportViewer
    ...
    Me.TabCtl1.Controls.Add(Me.TpErr)
...
End Sub
  ...
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA404.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Update Exemptions")
  ...
  Private Sub RunReport2()
   ...
   With myreport2
    ...
    .SetParameterValue("myreportTitle", "Exemptions Error List")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyPost", WrkPost)
   End With

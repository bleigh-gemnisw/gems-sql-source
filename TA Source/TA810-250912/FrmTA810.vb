...
Friend WithEvents TBarPS As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA810))
    ...
    Me.TBarDelete = New System.Windows.Forms.ToolBarButton()
        ...
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarAttach, Me.TBarSep1, Me.TBarHist, Me.TBarSep2, Me.TBarPrint, Me.TBarPrinters, Me.TBarPS})
        ...
        'TBarAttach
        '
        Me.TBarAttach.ImageKey = "Paperclip.png"
        ...
        Me.ImageList1.Images.SetKeyName(5, "history.png")
        Me.ImageList1.Images.SetKeyName(6, "Printer Setup.png")
        Me.ImageList1.Images.SetKeyName(7, "Paperclip.png")
        '
        'SbMain
        '
        Me.SbMain.Location = New System.Drawing.Point(0, 656)
        ...
        Me.ClientSize = New System.Drawing.Size(979, 684)
        ...
        Me.Text = "Before Bill C/C Maintainence"
...
#End Region
    ...
    Private Sub FrmTA810_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    End If
    MyFrmTA8101R = New FrmTA8101R
    MyFrmTA8101R.MdiParent = Me
    MyFrmTA8101R.Show()
  End Sub
...
Private Sub FrmTA810_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
End Sub
  ...
  Dim Cancel As Boolean
    ...
    Select Case Me.SbpScreen.Text
      Case "TA8102R"
        MyFrmTA8102R.DeleteData(Cancel)
        If Cancel Then Exit Sub
        MyFrmTA8102R.Close()
      Case "TA8103R"
        MyFrmTA8103R.DeleteData(Cancel)
        If Cancel Then Exit Sub
        MyFrmTA8103R.Close()
      Case "TA8104R"
        MyFrmTA8104R.DeleteData(Cancel)
        If Cancel Then Exit Sub
        MyFrmTA8104R.Close()
      Case "TA8105R"
        MyFrmTA8105R.DeleteData(Cancel)
        If Cancel Then Exit Sub
        MyFrmTA8105R.Close()
    End Select
    MyFrmTA8101R.FormatGrid(True)
...
End Sub
  Private Sub DoBtnAttach()
    ...
    Select Case SbpScreen.Text
      Case "TA8102R"
        WrkKey = MyFrmTA8102R.WrkCCNo
      Case "TA8103R"
        WrkKey = MyFrmTA8103R.WrkCCNo
      Case "TA8104R"
        WrkKey = MyFrmTA8104R.WrkCCNo
      Case "TA8105R"
        WrkKey = MyFrmTA8104R.WrkCCNo
    End Select
    ShowAttachit("CCBEFORE", WrkKey)
    WrkAttachcount = GetAttachcount("CCBEFORE", WrkKey)
    MyFrmTA810.TBarAttach.Text = WrkAttachcount & " Attachment(s)"
  End Sub
  Private Sub DoBtnHist()
    Select Case Me.SbpScreen.Text
      Case "TA8102R"
        MyFrmTA8102R.ShowCCHist()
      Case "TA8103R"
        MyFrmTA8103R.ShowCCHist()
      Case "TA8104R"
        MyFrmTA8104R.ShowCCHist()
      Case "TA8105R"
        MyFrmTA8105R.ShowCCHist()
    End Select
  End Sub
  Private Sub DoBtnNew()
  MyFrmTA810_NEW = New FrmTA810_NEW
  MyFrmTA810_NEW.MdiParent = MyFrmTA8101R.ParentForm
  MyFrmTA810_NEW.Show()
  MyFrmTA8101R.Hide()
End Sub
  Private Sub DoBtnPrint()
    Select Case Me.SbpScreen.Text
      Case "TA8102R"
        MyFrmTA8102R.PrintData()
      Case "TA8103R"
        MyFrmTA8103R.PrintData()
      Case "TA8104R"
        MyFrmTA8104R.PrintData()
      Case "TA8105R"
        MyFrmTA8105R.PrintData()
    End Select
  End Sub
  Private Sub DoBtnSave()
    Select Case Me.SbpScreen.Text
      Case "TA8102R"
        MyFrmTA8102R.SaveData()
      Case "TA8103R"
        MyFrmTA8103R.SaveData()
      Case "TA8104R"
        MyFrmTA8104R.SaveData()
      Case "TA8105R"
        MyFrmTA8105R.SaveData()
    End Select
  End Sub
  Private Sub DoBtnPS()

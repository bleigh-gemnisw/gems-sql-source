...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA904))
...
#End Region
    ...
    Private Sub FrmTA904_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        MyFrmTA904B = New FrmTA904B
        MyFrmTA904B.MdiParent = Me
        MyFrmTA904B.Show()
    End Sub

...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA204.rpt", myTOWN._TOWNBR)
   ...
   With myreport
    .Load(ReportPath)
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "BOARD OF ASSESSMENT APPEALS NOTICE")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyTownAddr", Trim(myTOWN._ADDR1))
		.SetParameterValue("MyTownStZip", sb.ToString)
    .SetParameterValue("MyGLYear", MyUtils.CnvSng(MyFrmTA204B.TxtGLYear.Text))
    .SetParameterValue("MyBAAPhone", MyFrmTA204B.TxtBAAPhone.Text)
   End With
   With Crv1
     .DisplayToolbar = True

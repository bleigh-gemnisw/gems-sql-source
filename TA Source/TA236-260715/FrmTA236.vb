...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA236))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarProcess, Me.TBarRecalc})
...
'TBarRecalc
'
Me.TBarRecalc.ImageIndex = 1
Me.TBarRecalc.Name = "TBarRecalc"
Me.TBarRecalc.Text = "Recalc Benefits"
'
'FrmTA236
'
...
Me.Text = "Mass Update or Recalc Local Benefit"
...
Private Sub FrmTA236_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTA236B = New FrmTA236B
  MyFrmTA236B.MdiParent = Me
  MyFrmTA236B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA236_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  ...
  Case "TA236B"
    MyFrmTA236.Close()
  Case "ListLocalCodes"
    MyFrmListLocalCodes.Close()
  End Select
End Sub
Private Sub DoBtnProcess()
   MyFrmTA236.TBarProcess.Enabled = False
   MyFrmTA236.TBarRecalc.Enabled = False
   MyFrmTA236B.RunReport()
   MyFrmTA236.TBarProcess.Enabled = True
   MyFrmTA236.TBarRecalc.Enabled = True
End Sub
Private Sub DoBtnRecalc()
   MyFrmTA236.TBarProcess.Enabled = False
   MyFrmTA236.TBarRecalc.Enabled = False
   Recalc()
   MyFrmTA236.TBarProcess.Enabled = True

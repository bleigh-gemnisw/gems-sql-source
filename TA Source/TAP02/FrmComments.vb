...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.TxtComment.Location = New System.Drawing.Point(8, 31)
    ...
    Me.ClientSize = New System.Drawing.Size(448, 383)
...
#End Region
  ...
  Private Sub FrmComments_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    If s_full = True Or s_add = True Or s_chg = True Then
      ...
      MyFrmTAP02.TBarSave.Visible = True
    End If
  ...
  Private Sub FrmComments_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    ...
    If SaveDelete Then
      ...
      MyFrmTAP02.TBarComments.Enabled = True
  ...
  Private Sub FrmComments_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTAP02.SbpScreen.Text = "Comments"
  ...
  Public Sub SaveData()
    ...
    MyFrmTAP02.TBarComments.ImageKey = ""
    If WrkRecs > 0 Then
      MyFrmTAP02.TBarComments.ImageKey = "comment_24.png"
    End If
    Me.Close()
  End Sub
  Private Sub BuildDS()

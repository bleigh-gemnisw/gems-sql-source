...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.ClientSize = New System.Drawing.Size(444, 383)
...
#End Region
  ...
  Private Sub FrmComments_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    If s_full = True Or s_add = True Or s_chg = True Then
      MyFrmTAP03.TBarSave.Enabled = True
      MyFrmTAP03.TBarSave.Visible = True
    End If
  ...
  Private Sub FrmComments_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTAP03.SbpScreen.Text = "Comments"
  ...
  Public Sub SaveData()
    ...
    MyFrmTAP03.TBarComments.ImageKey = ""
    If WrkRecs > 0 Then
      MyFrmTAP03.TBarComments.ImageKey = "comment_24.png"
    End If
    Me.Close()
  End Sub
  Private Sub BuildDS()

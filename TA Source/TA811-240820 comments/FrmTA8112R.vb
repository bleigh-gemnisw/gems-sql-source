...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    'Label28
    '
    Me.Label28.Location = New System.Drawing.Point(336, 104)
...
NextCC:
  ...
  Private Sub MoveToFile()
    Dim wrklessamt As Decimal
    Dim wrklesshalf As Decimal
    With MyTXCOEA
      ._CCNO = WrkCCNo
      ._LISTNo = WrkListNo
      ._YEAR = WrkYear
    ...
    With MyTXINV
      ...
      If myTOWN._TOWNBR = 162 And WrkType = "R" And WrkYear = 2023 Then
        MyTXINV.GetOneRecordP(WrkListNo, WrkYear, WrkType)
        If Not MyTXINV.RecordNotFound Then
          If MyUtils.Round(MyTPAYMNT.Out_TaxT, 2) > MyTXINV._TAXT Then
            ...
            ._CCTX4 = 0
          Else
            wrklessamt = MyTXINV._TAXT - MyUtils.Round(MyTPAYMNT.Out_TaxT, 2)  'ken
            wrklesshalf = MyUtils.Round(wrklessamt / 2, 2)  'ken

            ._CCETAX = MyUtils.Round(MyTPAYMNT.Out_TaxT, 2)
            ._CCTX1 = MyUtils.Round(MyTXINV._TAX1 - wrklesshalf, 2)   'ken
            ._CCTX2 = MyUtils.Round(MyTXINV._TAX2 - wrklesshalf, 2)  'ken
        ...
        End If
      End If
      'ken - copied to here too in case getting wiped out above
      ._NAME = TxtName.Text
      ._LETT = Mid$(TxtName.Text, 1, 1)
      ._SNAME = TxtSname.Text
      ._ADD1 = TxtAdd1.Text
      ...
      ._VOL = TxtVol.Text
      ._IPAGE = TxtPage.Text
      ._CCNO = WrkCCNo   'ken - copied to here too in case getting wiped out above
      ._CDATE = MyUtils.SetDBDate(LblCCDate.Text)
      ' end copy
      ._CGRS = MyUtils.CnvSng(LblNewGross.Text)

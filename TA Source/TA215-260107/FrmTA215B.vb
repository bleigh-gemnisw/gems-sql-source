...
Friend WithEvents Label3 As System.Windows.Forms.Label
    Friend WithEvents BtnSelExCodes As Button
    Friend WithEvents LblExCodes As Label
    ...
    Me.LblExCodes = New System.Windows.Forms.Label()
    Me.BtnSelExCodes = New System.Windows.Forms.Button()
    ...
    'LblExCodes
    '
    Me.LblExCodes.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
    Me.LblExCodes.ForeColor = System.Drawing.Color.Fuchsia
    Me.LblExCodes.Location = New System.Drawing.Point(12, 228)
    Me.LblExCodes.Name = "LblExCodes"
    Me.LblExCodes.Size = New System.Drawing.Size(202, 68)
    Me.LblExCodes.TabIndex = 209
    Me.LblExCodes.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
    '
    'BtnSelExCodes
    '
    Me.BtnSelExCodes.Location = New System.Drawing.Point(38, 178)
    Me.BtnSelExCodes.Name = "BtnSelExCodes"
    Me.BtnSelExCodes.Size = New System.Drawing.Size(142, 35)
    Me.BtnSelExCodes.TabIndex = 210
    Me.BtnSelExCodes.Text = "Select Exempt Codes"
    Me.BtnSelExCodes.UseVisualStyleBackColor = True
    '
    'FrmTA215B
    '
    ...
    Me.ControlBox = False
    Me.Controls.Add(Me.BtnSelExCodes)
    Me.Controls.Add(Me.LblExCodes)
...
#End Region
  ...
  Private Sub FrmTA215B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    TxtTaxExempt.Text = "X"
    LblExCodes.Text = "* ALL Codes *"
  End Sub

  Private Sub BtnSelExCodes_Click(sender As Object, e As EventArgs) Handles BtnSelExCodes.Click
    'ken added 8/19/25
    MyFrmListExempt = New FrmListExempt

    MyFrmListExempt.ShowDialog()
    If MySelCodes = "" Then
      LblExCodes.Text = "* ALL Codes *"
    Else
      LblExCodes.Text = MySelCodes
    End If

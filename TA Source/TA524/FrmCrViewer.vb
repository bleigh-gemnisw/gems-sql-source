Public Class FrmCrViewer
  ...
  Friend WithEvents TabPg1 As TabPage
  Friend WithEvents Crv1 As CrystalDecisions.Windows.Forms.CrystalReportViewer
  Friend WithEvents TabPg2 As TabPage
...
#End Region
  ...
  Private Sub RunReport()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTA524.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      .SetDataSource(Wrkds)
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("myreportTitle", "Supplement MV on previous MV List: Match CustID")
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTA524B.TxtPrevYear.Text))
      .SetParameterValue("MyPost", MyFrmTA524B.ChkUpdate.Checked)
    End With
    With Crv1
      .DisplayToolbar = True
  ...
  Private Sub RunReport2()
    ...
    With myreport2
      ...
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("myreportTitle", "Supplement MV on previous MV List: No Match")
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTA524B.TxtPrevYear.Text))

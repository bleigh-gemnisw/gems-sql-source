...
Friend WithEvents TxtPrevYear As System.Windows.Forms.TextBox
...
Friend WithEvents ErrProv As System.Windows.Forms.ErrorProvider
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA524B))
    Me.ImageList1 = New System.Windows.Forms.ImageList(Me.components)
    Me.TTp1 = New System.Windows.Forms.ToolTip(Me.components)
    Me.ErrProv = New System.Windows.Forms.ErrorProvider(Me.components)
    Me.TxtDist = New System.Windows.Forms.TextBox()
    Me.TxtPrevYear = New System.Windows.Forms.TextBox()
    ...
    Me.TxtDist.Location = New System.Drawing.Point(77, 81)
    ...
    'TxtPrevYear
    '
    Me.TxtPrevYear.Location = New System.Drawing.Point(126, 27)
    Me.TxtPrevYear.MaxLength = 4
    Me.TxtPrevYear.Name = "TxtPrevYear"
    Me.TxtPrevYear.Size = New System.Drawing.Size(32, 20)
    Me.TxtPrevYear.TabIndex = 0
    '
    'Label4
    '
    ...
    Me.Label4.Text = "Previous G/L Year"
    '
    'LnkDist
    '
    Me.LnkDist.AutoSize = True
    Me.LnkDist.Location = New System.Drawing.Point(25, 84)
    ...
    'TxtCurrYear
    '
    Me.TxtCurrYear.Location = New System.Drawing.Point(126, 56)
    ...
    Me.ChkUpdate.Location = New System.Drawing.Point(28, 113)
    Me.ChkUpdate.Name = "ChkUpdate"
    Me.ChkUpdate.Size = New System.Drawing.Size(154, 17)
    Me.ChkUpdate.TabIndex = 72
    Me.ChkUpdate.Text = "Update Assmnt Code to A?"
    ...
    Me.Controls.Add(Me.TxtPrevYear)
...
#End Region
  ...
  End Sub
Private Sub FrmTA524B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTA524.SbpScreen.Text = "TA524B"
End Sub
Private Sub FrmTA524B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
  Private Sub ShowError(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
    Dim I As Integer
    ErrProv.SetError(TxtPrevYear, "")
...
Private Sub LnkDist_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LnkDist.LinkClicked
  ...
  Me.Hide()
End Sub
Private Sub TxtPrevYear_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtPrevYear.KeyPress

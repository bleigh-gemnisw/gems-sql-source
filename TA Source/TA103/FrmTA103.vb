...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA103))
...
Me.Text = "Tax Codes Maintainence"
...
#End Region
Private Sub FrmTA103_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA103B = New FrmTA103B
  MyFrmTA103B.MdiParent = Me
  MyFrmTA103B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA103_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA103B" Then
    MyFrmTA103.Close()
  Else
    MyFrmTA103C.Close()
    MyFrmTA103B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTA103C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmTA103C.MdiParent = MyFrmTA103B.ParentForm
  'MyFrmTA103C.WrkTxCode = 0
  'MyFrmTA103C.WrkTxType = ""
  MyFrmTA103C.Show()
  MyFrmTA103B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTA103B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTA103C.SaveData()
End Sub

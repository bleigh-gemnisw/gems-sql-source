...
End Sub
  ...
  Private Sub RunReport()
   ...
   Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtTAP25.rpt", myTOWN._TOWNBR)
    With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Apply Penalty")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyPenCode", WrkPenCode)

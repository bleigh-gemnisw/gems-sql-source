...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAB03))
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 611)
...
Me.ClientSize = New System.Drawing.Size(768, 639)
...
Private Sub FrmTAB03_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTAB03B = New FrmTAB03B
  MyFrmTAB03B.MdiParent = Me
  MyFrmTAB03B.Show()
End Sub
...
End Sub
Private Sub FrmTAB03_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  ...
  Case "ListDist"
    MyFrmListDist.Close()
  Case "ListExempt"
    MyFrmListExempt.Close()
  Case "ListExemption"
    MyFrmListExemption.Close()
  Case "ListLocalCodes"
...
Private Sub PreDefinedLabelsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PreDefinedLabelsToolStripMenuItem.Click

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA600))
...
Me.ImageList1.Images.SetKeyName(2, "import_png_789.png")
'
'SbMain
'
...
Me.Text = "Update Tax Invoice Property Locations"
...
Private Sub FrmTA600_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTA600B = New FrmTA600B
  MyFrmTA600B.MdiParent = Me
  MyFrmTA600B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA600_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnProcess()
   MyFrmTA600.TBarProcess.Enabled = False
   MyFrmTA600B.RunReport()
   MyFrmTA600.TBarProcess.Enabled = True
End Sub

Public Class FrmCrViewer
  ...
  Friend WrkFiling As String
  Friend WrkAppStatus As String
...
End Sub
  Private Sub RunReportTot()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTAP24.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(Wrkds)
    .SetParameterValue("myreportTitle", "PP Declarations List")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyYear", MyFrmTAP24B.TxtGLYear.Text)
    .SetParameterValue("MyFiling", GetFilingDesc(WrkFiling))
    .SetParameterValue("MyAppStatus", GetStatusDesc(WrkAppStatus))
   End With
   With Crv1
     .DisplayToolbar = True

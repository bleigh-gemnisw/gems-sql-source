...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP24))
    ...
    Me.Text = "Print Declaration List"
...
Private Sub FrmTAP24_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTAP24B = New FrmTAP24B
  MyFrmTAP24B.MdiParent = Me
  MyFrmTAP24B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTAP24_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTAP24.TBarPrint.Enabled = False
   MyFrmTAP24B.RunReport()
   MyFrmTAP24.TBarPrint.Enabled = True
End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAD02))
...
Private Sub FrmTAD02_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTAD02B = New FrmTAD02B
  MyFrmTAD02B.MdiParent = Me
  MyFrmTAD02B.Show()
End Sub
...
End Sub
Private Sub FrmTAD02_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

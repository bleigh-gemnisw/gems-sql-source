...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA206))
...
Me.Text = "Print Board of Assessment Appeals"
...
Private Sub FrmTA206_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTA206B = New FrmTA206B
  MyFrmTA206B.MdiParent = Me
  MyFrmTA206B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA206_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTA206.TBarPrint.Enabled = False
   MyFrmTA206B.RunReport()
   MyFrmTA206.TBarPrint.Enabled = True
End Sub

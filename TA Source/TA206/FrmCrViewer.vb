...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA206.rpt", myTOWN._TOWNBR)
	 ...
	 With myreport
		...
		End If
		.SetDataSource(wrkds)
		.SetParameterValue("myreportTitle", "Board of Assessment Appeals")
		.SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyGLYear", MyUtils.CnvSng(MyFrmTA206B.TxtGLYear.Text))

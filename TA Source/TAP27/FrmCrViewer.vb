...
End Sub
  Private Sub RunReportTot()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTAP27.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      ...
      End If
      .SetDataSource(Wrkds)
      .SetParameterValue("myreportTitle", "PP Declarations Depreciated Codes by Year")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyYear", MyFrmTAP27B.TxtGLYear.Text)
    End With
    With Crv1
      .DisplayToolbar = True

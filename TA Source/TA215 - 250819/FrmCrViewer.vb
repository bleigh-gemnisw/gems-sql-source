Public Class FrmCrViewer
  ...
  Friend WrkCategory As String
  Friend WrkSubdivision As String
  Friend WrkIncomeLevel As String
  Friend WrkTaxExempt As String
...
Me.Crv1.Location = New System.Drawing.Point(16, 21)
Me.Crv1.Name = "Crv1"
...
End Sub
  Private Sub RunReport()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA215.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(Wrkds)
    .SetParameterValue("MyReportName", "Tax Exempt Property List")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyCategory", WrkCategory)
    .SetParameterValue("MySubdivision", WrkSubdivision)
    .SetParameterValue("MyIncomeLevel", WrkIncomeLevel)
    .SetParameterValue("MyTaxExempt", WrkTaxExempt)
   End With
   With Crv1
     .DisplayToolbar = True

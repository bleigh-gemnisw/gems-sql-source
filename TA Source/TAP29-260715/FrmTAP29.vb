...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP29))
    ...
    Me.Text = "Remove Local Benefit Amount"
...
#End Region
  ...
  Private Sub FrmTAP29_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmTAP29B = New FrmTAP29B
  MyFrmTAP29B.MdiParent = Me
  MyFrmTAP29B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTAP29_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnProcess()
   MyFrmTAP29.TBarProcess.Enabled = False
   MyFrmTAP29B.RunReport()
   MyFrmTAP29.TBarProcess.Enabled = True
End Sub

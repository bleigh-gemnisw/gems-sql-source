...
Friend WithEvents SbpFiller As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA137))
    ...
    Me.Text = "Maintain Homeowners Qualifying Income"
...
Private Sub FrmTA137_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA137B = New FrmTA137B
  MyFrmTA137B.MdiParent = Me
  MyFrmTA137B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA137_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA137B" Then
    If MyUtils.CnvSng(MyFrmTA137B.TxtYear.Text) > 0 Then
      MyFrmTA137B.GrpData.Enabled = False
      MyFrmTA137B.TxtYear.Enabled = True
      MyFrmTA137B.TxtYear.Text = ""
    Else
      MyFrmTA137.Close()
    End If
  Else
...
End Sub
  Private Sub DoBtnSave()
    ...
    WrkError = MyFrmTA137B.CheckErrors
    If WrkError Then Exit Sub

    WrkYear = MyUtils.CnvSng(MyFrmTA137B.TxtYear.Text)
    With MyFrmTA137B
      .SaveData(WrkYear, 1, MyUtils.CnvSng(.TxtLimit1.Text), MyUtils.CnvSng(.TxtBenamt1.Text))
      .SaveData(WrkYear, 2, MyUtils.CnvSng(.TxtLimit2.Text), MyUtils.CnvSng(.TxtBenamt2.Text))
      .SaveData(WrkYear, 3, MyUtils.CnvSng(.TxtLimit3.Text), MyUtils.CnvSng(.TxtBenamt3.Text))
      .SaveData(WrkYear, 4, MyUtils.CnvSng(.TxtLimit4.Text), MyUtils.CnvSng(.TxtBenamt4.Text))
      .SaveData(WrkYear, 5, MyUtils.CnvSng(.TxtLimit5.Text), MyUtils.CnvSng(.TxtBenamt5.Text))

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA104))
...
Me.TbMain.Size = New System.Drawing.Size(309, 50)
...
Me.SbMain.Size = New System.Drawing.Size(309, 28)
...
Private Sub FrmTA104_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA104B = New FrmTA104B
  MyFrmTA104B.MdiParent = Me
  MyFrmTA104B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA104_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA104B" Then
    MyFrmTA104.Close()
  Else
    MyFrmTA104B.Show()
  End If

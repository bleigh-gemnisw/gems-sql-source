...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA941))
...
Me.Text = "Update values from VIN Decoder File"
...
Private Sub FrmTA941_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA941B = New FrmTA941B
  MyFrmTA941B.MdiParent = Me
  MyFrmTA941B.Show()
End Sub
...
End Sub
Private Sub FrmTA941_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  ...
  Case "TA941C"
    MyFrmTA941C.Close()
    MyFrmTA941B.BtnContinue.Enabled = False

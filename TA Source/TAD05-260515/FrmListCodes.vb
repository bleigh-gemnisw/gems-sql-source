...
#End Region
  ...
  Private Sub FrmListCodes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTAD05.SbpScreen.Text = "ListCodes"
...
Private Sub C1DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
    Windows.Forms.Cursor.Current = Cursors.WaitCursor
		...
		If WrkType = "M" Then
			With MyFrmTAD05MV
				.TxtClass.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
				.Ttp1.SetToolTip(.TxtClass, C1DataGrdList.Item(C1DataGrdList.Row, 2))
				.Show()
			End With
		End If
		...
		If WrkType = "S" Then
			With MyFrmTAD05SU
				If WrkFieldNo = 1 Then
					...
					.Ttp1.SetToolTip(.TxtClass, C1DataGrdList.Item(C1DataGrdList.Row, 2))
				Else
					.TxtOClass.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
					.Ttp1.SetToolTip(.TxtOClass, C1DataGrdList.Item(C1DataGrdList.Row, 2))
				End If
				.Show()
			End With
		End If

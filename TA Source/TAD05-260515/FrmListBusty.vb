...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmListBusty))
...
Me.C1DataGrdList.Location = New System.Drawing.Point(12, 60)
...
Me.Name = "FrmListBusty"
Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
Me.Text = "Select Business Type"
...
#End Region
  ...
  Public Sub ShowGrid()
    If TxtPos.Text = "" Then
      ds = myTXBusty.GetAllData
    Else
      ds = myTXBusty.PosData(TxtPos.Text)
    End If
    C1DataGrdList.DataSource = ds.Tables(0)
    C1DataGrdList.Refresh()

  End Sub
  Private Sub FrmListBusty_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTAD05.SbpScreen.Text = "ListBusty"
...
Private Sub C1DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
    ...
    With MyFrmTAD05PP
      .TxtBusty.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
      .Ttp1.SetToolTip(.TxtBusty, C1DataGrdList.Item(C1DataGrdList.Row, 1))
      .Show()
    End With
...
Private Sub FrmListBusty_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
  'Memory Cleanup
  myTXBusty = Nothing
  MyfrmListBusty = Nothing
End Sub
End Class

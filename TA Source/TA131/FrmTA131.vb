...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA131))
...
Me.Text = "Maintain State Forester Codes"
...
Private Sub FrmTA131_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA131B = New FrmTA131B
  MyFrmTA131B.MdiParent = Me
  MyFrmTA131B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA131_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA131B" Then
    MyFrmTA131.Close()
  Else
    MyFrmTA131B.Show()
  End If
...
Private Sub DoBtnSave()
  ...
  WrkError = MyFrmTA131B.CheckErrors
  If WrkError Then Exit Sub

  With MyFrmTA131B
    .SaveData("ALL", MyUtils.CnvSng(.TxtCodeAll.Text))
    .SaveData("FARM", MyUtils.CnvSng(.TxtCodeFarm.Text))
    .SaveData("FORE", MyUtils.CnvSng(.TxtCodeForest.Text))
    .SaveData("OPEN", MyUtils.CnvSng(.TxtCodeOpen.Text))
    .SaveData("10ML", MyUtils.CnvSng(.TxtCode10Mil.Text))
  End With
  Me.Close()
End Sub

...
#End Region
  ...
  Private Sub FrmListCodes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTA131.SbpScreen.Text = "ListCodes"
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTA131B
      Select Case WrkField
        Case "ALL"
          .TxtCodeAll.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        Case "FARM"
          .TxtCodeFarm.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        Case "FORE"
          .TxtCodeForest.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        Case "OPEN"
          .TxtCodeOpen.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        Case "10ML"
          .TxtCode10Mil.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      End Select
      .Show()
    End With

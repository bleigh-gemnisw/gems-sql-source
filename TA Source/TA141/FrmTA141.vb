...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA141))
...
Private Sub FrmTA141_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA141B = New FrmTA141B
  MyFrmTA141B.MdiParent = Me
  MyFrmTA141B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA141_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA141B" Then
    MyFrmTA141.Close()
  Else
    MyFrmTA141C.Close()
    MyFrmTA141B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTA141C.DeleteData(wrkcancel)
  If wrkcancel Then Exit Sub
  MyFrmTA141C.Close()
  MyFrmTA141B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmTA141C = New FrmTA141C
  MyFrmTA141C.MdiParent = MyFrmTA141B.ParentForm
  MyFrmTA141C.WrkCode = ""
  MyFrmTA141C.Show()
  MyFrmTA141B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTA141B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTA141C.SaveData()
End Sub

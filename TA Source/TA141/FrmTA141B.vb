...
#End Region
  ...
  Private Sub FrmTA141B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  Public Sub ShowGrid()
    ...
    DataGrdView.Refresh()
    myTXMSRPCD.CloseFile()
  End Sub
  Private Sub FrmTA141B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTA141.SbpScreen.Text = "TA141B"
    MyFrmTA141.TBarPrint.Enabled = True
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    MyFrmTA141C.MdiParent = Me.ParentForm
    MyFrmTA141C.WrkCode = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    MyFrmTA141C.Show()
  Me.Hide()
End Sub
End Class

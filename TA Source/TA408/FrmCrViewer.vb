...
#End Region
  ...
  Private Sub CrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   ReportPath = MyUtils.GetReportPath("PrtTA408.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(Wrkds)
    .SetParameterValue("MyReportTitle", "MV Capacity List")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyClass", WrkClass)
    .SetParameterValue("MyClassDesc", WrkClassDesc)
   End With
   With Crv1
     .DisplayToolbar = True

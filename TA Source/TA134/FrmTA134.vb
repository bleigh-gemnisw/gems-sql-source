...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA134))
    ...
    Me.Text = "Maintain Local Qualifying Income"
...
#End Region
  ...
  Private Sub FrmTA134_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmTA134B = New FrmTA134B
    MyFrmTA134B.MdiParent = Me
    MyFrmTA134B.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
  Private Sub FrmTA134_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    If Me.SbpScreen.Text = "TA134B" Then
      If MyUtils.CnvSng(MyFrmTA134B.TxtYear.Text) > 0 Then
        MyFrmTA134B.GrpData.Enabled = False
        MyFrmTA134B.TxtYear.Enabled = True
        MyFrmTA134B.TxtYear.Text = ""
      Else
        MyFrmTA134.Close()
      End If
    Else
  ...
  Private Sub DoBtnSave()
    ...
    WrkError = MyFrmTA134B.CheckErrors
    If WrkError Then Exit Sub

    WrkYear = MyUtils.CnvSng(MyFrmTA134B.TxtYear.Text)
    With MyFrmTA134B
      .SaveData(WrkYear, .LblPgm1.Text, .TxtSinglePgm1.Text, .TxtMarriedPgm1.Text, MyUtils.CnvSng(.TxtAmountPgm1.Text))
      .SaveData(WrkYear, .LblPgm2.Text, .TxtSinglePgm2.Text, .TxtMarriedPgm2.Text, MyUtils.CnvSng(.TxtAmountPgm2.Text))

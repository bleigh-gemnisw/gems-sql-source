...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(354, 366)
    Me.DataGrdView.TabIndex = 217
    '
    'FrmTAP17B
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(378, 438)
    Me.ControlBox = False
...
#End Region
Private Sub FrmTAP17B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub ShowGrid()
   If WrkCode = "" Then
     ds = myTXDVCD.GetAllYear(WrkYear)
   Else
     ds = myTXDVCD.PosData(WrkYear, MyUtils.CnvSng(TxtPos.Text))
   End If
   DataGrdView.DataSource = ds.Tables(0)
   DataGrdView.Refresh()
End Sub
Private Sub FrmTAP17B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTAP17.SbpScreen.Text = "TAP17B"
  MyFrmTAP17.TBarPrint.Enabled = True
...
Private Sub TxtSearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtPos.KeyPress
  ...
  If e.KeyChar = MyUtils.VbKeyEnter Then
    ds = myTXDVCD.PosData(WrkYear, Val(TxtPos.Text))
    WrkFind = True
    FormatGrid()
    WrkFind = False
    TxtPos.Text() = ""
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmTAP17C = New FrmTAP17C
  MyFrmTAP17C.MdiParent = Me.ParentForm
  MyFrmTAP17C.WrkYear = WrkYear
  MyFrmTAP17C.WrkTXDVCD = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
  MyFrmTAP17C.Show()
  Me.Hide()
End Sub
End Class

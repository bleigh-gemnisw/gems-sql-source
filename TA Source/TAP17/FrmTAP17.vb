...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP17))
...
Me.Text = "PP Decl MV - Property Codes"
...
#End Region
Private Sub FrmTAP17_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  HelpProvider1.HelpNamespace = MyUtils.GetHelpFile(WrkProgName)
	...
	set_security() '#set
	MyFrmTAP17B = New FrmTAP17B
	MyFrmTAP17B.MdiParent = Me
	MyFrmTAP17B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
	...
	End If
End Sub
Private Sub FrmTAP17_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
	If Me.SbpScreen.Text = "TAP17B" Then
		MyFrmTAP17.Close()
	Else
		MyFrmTAP17C.Close()
		MyFrmTAP17B.Show()
...
Private Sub DoBtnDelete()
	...
	MyFrmTAP17C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
	...
	MyFrmTAP17C.MdiParent = MyFrmTAP17B.ParentForm
  MyFrmTAP17C.WrkYear = MyUtils.CnvSng(MyFrmTAP17B.LblYear.Text)
	'MyFrmTAP17C.WrkTXDVCD = 0
	'MyFrmTAP17C.WrkTxType = ""
	MyFrmTAP17C.Show()
	MyFrmTAP17B.Hide()
End Sub
Private Sub DoBtnPrint()
	...
	MyCRViewer.Wrkds = MyFrmTAP17B.ds
	MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
	MyFrmTAP17C.SaveData()
End Sub

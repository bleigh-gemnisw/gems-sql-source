...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA901))
...
#End Region
    ...
    Private Sub FrmTA901_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    HelpProvider1.HelpNamespace = MyUtils.GetHelpFile(WrkProgName)
        ...
        MyFrmTA901B = New FrmTA901B
        MyFrmTA901B.MdiParent = Me
        MyFrmTA901B.Show()
    End Sub

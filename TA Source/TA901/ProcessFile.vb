...
Module ProcessFile
  ...
  Dim WrkFixed As Boolean
  Dim WrkCSV As Boolean
  Dim WrkAll As Boolean
  Dim WrkExcel As Boolean
...
NextRec:
  ...
  Private Function DownloadFixed() As String
    ...
    With myTXREALQ
      ...
      sb.Append(._VOL)
      If WrkTrans Then
        myTXTRANS.GetOneRecordP(._LISTNO)
        If Not myTXTRANS.RecordNotFound Then
          sb.Append(myTXTRANS._TPAGE)
        Else
          sb.Append(._PGE)
        End If
      Else
  ...
  Private Function DownloadCSV() As String
    ...
    With myTXREALQ
      ...
      If WrkTrans Then
        myTXTRANS.GetOneRecordP(._LISTNO)
        If Not myTXTRANS.RecordNotFound Then
          sb.Append(Trim(myTXTRANS._TPAGE))
        Else
          sb.Append(Trim(._PGE))
        End If
      Else

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAD01))
...
Private Sub FrmTAD01_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTAD01B = New FrmTAD01B
  MyFrmTAD01B.MdiParent = Me
  MyFrmTAD01B.Show()
End Sub
...
End Sub
Private Sub FrmTAD01_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnProcess()
  MyFrmTAD01.TBarProcess.Enabled = False
  MyFrmTAD01B.RunProcess()
  MyFrmTAD01.TBarProcess.Enabled = False
End Sub

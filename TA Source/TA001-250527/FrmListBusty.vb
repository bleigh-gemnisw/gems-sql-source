...
#End Region
  ...
  Private Sub FrmListBusty_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTA001.SbpScreen.Text = "ListBusty"
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTA001PP
      .TxtBusty.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .Ttp1.SetToolTip(.TxtBusty, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With

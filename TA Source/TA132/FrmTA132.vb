...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTA132))
...
Me.Text = "Maintain Elderly Adjusted Gross (Exclude)"
...
Private Sub FrmTA132_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTA132B = New FrmTA132B
  MyFrmTA132B.MdiParent = Me
  MyFrmTA132B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTA132_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TA132B" Then
    MyFrmTA132.Close()
  Else
    MyFrmTA132B.Show()
  End If
...
Private Sub DoBtnSave()
  ...
  WrkError = MyFrmTA132B.CheckErrors
  If WrkError Then Exit Sub

  With MyFrmTA132B
    .SaveData(1, MyUtils.CnvSng(.TxtCode1.Text))
    .SaveData(2, MyUtils.CnvSng(.TxtCode2.Text))
    .SaveData(3, MyUtils.CnvSng(.TxtCode3.Text))
    .SaveData(4, MyUtils.CnvSng(.TxtCode4.Text))
  End With
  Me.Close()
End Sub

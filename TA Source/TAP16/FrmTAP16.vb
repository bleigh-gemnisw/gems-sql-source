...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTAP16))
...
#End Region
Private Sub FrmTAP16_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTAP16B = New FrmTAP16B
  MyFrmTAP16B.MdiParent = Me
  MyFrmTAP16B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTAP16_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "TAP16B" Then
    MyFrmTAP16.Close()
  Else
    MyFrmTAP16C.Close()
    MyFrmTAP16B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmTAP16C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmTAP16C.MdiParent = MyFrmTAP16B.ParentForm
  MyFrmTAP16C.WrkYear = MyUtils.CnvSng(MyFrmTAP16B.LblYear.Text)
	'MyFrmTAP16C.Wrkdecode = 0
  'MyFrmTAP16C.WrkTxType = ""
  MyFrmTAP16C.Show()
  MyFrmTAP16B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmTAP16B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTAP16C.SaveData()
End Sub

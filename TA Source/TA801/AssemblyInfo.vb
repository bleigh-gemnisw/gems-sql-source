...
' 11/12/25 kb  add logic for Supple on before 
'MK 11/17/25 Adjust Supp MV Orig Net
'MK 12/ 4/25 Supp MV Orig Net use PVAL if PNET is zero
'MK  2/28/26 Assign value to newnet (not working for non MV types) 
Imports System

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO203))
...
Me.Text = "M35 Exemption Breakout"
...
Private Sub FrmTO203_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTO203B = New FrmTO203B
  MyFrmTO203B.MdiParent = Me
  MyFrmTO203B.Show()
End Sub
...
End Sub
Private Sub FrmTO203_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  Select Case MyFrmTO203.SbpScreen.Text
  Case "TO203B"
    MyFrmTO203.Close()
  Case "TO203C"
    MyFrmTO203C.Close()
...
Private Sub DoBtnDelete()
  Dim WrkCancel As Boolean
    MyFrmTO203C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
    ...
    MyFrmTO203C.MdiParent = MyFrmTO203B.ParentForm
    MyFrmTO203C.WrkCat = MyFrmTO203B.wrkcat
    MyFrmTO203C.WrkExcd = ""
    MyFrmTO203C.Show()
    MyFrmTO203B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyFrmCrViewer.WrkCat = MyFrmTO203B.WrkCat
  MyFrmCrViewer.Wrkds = MyFrmTO203B.ds
  MyFrmCrViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmTO203C.SaveData()
End Sub

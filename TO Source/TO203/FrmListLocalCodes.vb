...
#End Region
  ...
  Private Sub FrmListLocalCodes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTO203.SbpScreen.Text = "ListLocalCodes"
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTO203C
      .TxtExcd.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .TTp1.SetToolTip(.TxtExcd, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With

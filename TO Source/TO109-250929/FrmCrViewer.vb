Public Class FrmCrViewer
  ...
  Friend WrkCurREMillRt As Decimal
...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTO109.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds)
    ...
    .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTO109B.TxtGLYear.Text))
    .SetParameterValue("MyCurMillRate", WrkCurREMillRt)
  ...
  Private Sub RunReport2()
   ...
   Dim WrkTotExAmt As Decimal
   Dim WrkTotRevLoss As Decimal

   WrkTotAccts = WrkCurREAccts + WrkCurMVAccts + WrkPrvAccts
   WrkTotExAmt = WrkCurREExAmt + WrkCurMVExAmt + WrkPrvExAmt
   WrkTotRevLoss = WrkCurRERevLoss + WrkCurMVRevLoss + WrkPrvRevLoss

   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTO109OPM.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTO109B.TxtGLYear.Text))
    .SetParameterValue("MyCurMillRate", WrkCurREMillRt)
    .SetParameterValue("MyMVMillRate", WrkMVMillRt)
    .SetParameterValue("MyDate", Date.Today)
    .SetParameterValue("MyCurREAccts", WrkCurREAccts)
    .SetParameterValue("MyCurREExAmt", WrkCurREExAmt)
    .SetParameterValue("MyCurRERevLoss", WrkCurRERevLoss)
    .SetParameterValue("MyCurMVAccts", WrkCurMVAccts)
    .SetParameterValue("MyCurMVExAmt", WrkCurMVExAmt)
    .SetParameterValue("MyCurMVRevLoss", WrkCurMVRevLoss)
    ...
    .SetParameterValue("MyPrvMillRate", WrkPrvMillRt)
    .SetParameterValue("MyPrvAccts", WrkPrvAccts)
    .SetParameterValue("MyPrvExAmt", WrkPrvExAmt)
    .SetParameterValue("MyPrvRevLoss", WrkPrvRevLoss)
    .SetParameterValue("MyTotAccts", WrkTotAccts)
    .SetParameterValue("MyTotExAmt", WrkTotExAmt)
    .SetParameterValue("MyTotRevLoss", WrkTotRevLoss)
   End With
   With Crv2
     .DisplayToolbar = True
     .ShowGroupTreeButton = False

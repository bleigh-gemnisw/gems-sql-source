...
#End Region
  ...
  Private Sub FrmListCodes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTO116.SbpScreen.Text = "ListCodes"
  ...
  Private Sub FrmListCodes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    LblCurrent.Text = "(Code " & WrkField & " = " & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTO116B
      If WrkField = "a" Then
        .TxtCodea.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtCodea, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtCodeb.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtCodeb, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

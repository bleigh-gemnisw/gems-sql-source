...
Friend WithEvents TBarBlank As System.Windows.Forms.ToolBarButton
    Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.components = New System.ComponentModel.Container()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO222))
        ...
        Me.TBarBlank = New System.Windows.Forms.ToolBarButton()
        ...
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarPrint, Me.TBarBlank})
        ...
        'TBarBlank
        '
        Me.TBarBlank.ImageIndex = 4
        Me.TBarBlank.Name = "TBarLocal"
        Me.TBarBlank.Text = "Blank Form"
        '
        'ImageList1
        '
        ...
        Me.Text = "D-1: Totally Disabled Tax Exemption"
...
#End Region
    ...
    Private Sub FrmTO222_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    TBarBlank.Enabled = False

    MyFrmTO222B = New FrmTO222B
    MyFrmTO222B.MdiParent = Me
    MyFrmTO222B.Show()
  End Sub
...
Private Sub FrmTO222_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
    ...
    If Me.SbpScreen.Text = "TO222B" Then
        MyFrmTO222.Close()
    Else
        MyFrmTO222C.Close()
    End If
...
Private Sub DoBtnNew()
  ...
  MyFrmTO222C.MdiParent = MyFrmTO222B.ParentForm
  MyFrmTO222C.WrkListNo = 0
  MyFrmTO222C.Show()
  MyFrmTO222B.Hide()
...
Private Sub DoBtnPrint()
  PrtReport("State")
End Sub
  Private Sub DoBtnBlank()
    PrtReport("Blank")
  End Sub

  Private Sub DoBtnSave()
  MyFrmTO222C.SaveData()
End Sub
End Class

...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO221))
...
#End Region
    ...
    Private Sub FrmTO221_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmTO221B = New FrmTO221B
    MyFrmTO221B.MdiParent = Me
    MyFrmTO221B.Show()
  End Sub
  ...
  Private Sub FrmTO221_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    ...
    If Me.SbpScreen.Text = "TO221B" Then
      MyFrmTO221.Close()
    Else
      MyFrmTO221C.Close()
    End If
  ...
  Private Sub DoBtnNew()
    ...
    MyFrmTO221C.MdiParent = MyFrmTO221B.ParentForm
    MyFrmTO221C.WrkListNo = 0
    MyFrmTO221C.Show()
    MyFrmTO221B.Hide()
  End Sub

Imports System.Data
Public Class FrmTO220B
  Inherits System.Windows.Forms.Form
  Dim MyTXDEFER As TXDEFERL1.MyData
...
#End Region
  ...
  Private Sub FrmTO220B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    MyTXDEFER = New TXDEFERL1.MyData(myDBConnect)
    Call FormatGrid()
  End Sub
  ...
  End Sub
  Public Sub ShowGrid()
    ds = MyTXDEFER.GetViewName(TxtLName.Text, TxtFName.Text, 50)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()

  End Sub
  Private Sub FrmTO220B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTO220.SbpScreen.Text = "TO220B"
  ...
  Private Sub FastPath()
    ...
    MyFrmTO220C.MdiParent = Me.ParentForm
    MyFrmTO220C.WrkListNo = TxtList.Text
    MyFrmTO220C.WrkType = TxtType.Text
    MyFrmTO220C.WrkYear = TxtYear.Text
    MyFrmTO220C.Show()
    TxtList.Text = ""
    Me.Hide()
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    MyFrmTO220C = New FrmTO220C
    MyFrmTO220C.MdiParent = Me.ParentForm
    MyFrmTO220C.WrkListNo = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    MyFrmTO220C.WrkType = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
    MyFrmTO220C.WrkYear = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
    MyFrmTO220C.Show()
    Me.Hide()

...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO220))
...
#End Region
  ...
  Private Sub FrmTO220_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmTO220B = New FrmTO220B
    MyFrmTO220B.MdiParent = Me
    MyFrmTO220B.Show()
  End Sub
  ...
  Private Sub FrmTO220_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    ...
    If Me.SbpScreen.Text = "TO220B" Then
      MyFrmTO220.Close()
    Else
      MyFrmTO220C.Close()
    End If
  ...
  Private Sub DoBtnNew()
    MyFrmTO220C = New FrmTO220C
    MyFrmTO220C.MdiParent = MyFrmTO220B.ParentForm
    MyFrmTO220C.WrkListNo = 0
    MyFrmTO220C.Show()
    MyFrmTO220B.Hide()
  End Sub

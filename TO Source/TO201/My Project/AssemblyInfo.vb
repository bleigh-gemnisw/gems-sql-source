...
'MK 5/14/26 TXLOCAL if not allowed then check for record and delete it, Milford: Surving spouse age check is 50
'MK 7/16/25 Add YEAR to TXLOCAL
'MK 7/29/26 Missing Year on record add TXLOCAL
'MK 7/30/26 Save/Delete also allowed for previous GLYear
'MK 8/ 3/26 Don't save txreal/c and other files while in previous year if there is a current year record 
'MK 8/ 5/26 RecalcTax remove eldery data only when WrkTax = 0 (handle split Y and N)
'MK 8/ 7/26 Prompt to save when hitting back on form TO201D

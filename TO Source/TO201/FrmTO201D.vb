...
#End Region
  ...
  Private Sub FrmTO201D_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    With MyTXCNTL
      ...
      If MyUtils.CnvSng(TxtYear.Text) <> ._ASRGL And MyUtils.CnvSng(TxtYear.Text) <> ._ASRGL - 1 Then
        'MK 7/30/26 End
        MyFrmTO201.TBarSave.Enabled = False
        MyFrmTO201.TBarDelete.Enabled = False
      End If
      If MyUtils.CnvSng(TxtYear.Text) = ._ASRGL - 1 Then
        WrkIsPrevYear = True
      End If
    End With
  End Sub
  ...
  Public Sub SaveData()
    ...
    WrkSkipReal = False
    If WrkIsPrevYear Then
      MyTXM35H.GetOneRecordP(WrkListNo, WrkYear + 1, 0)
...
NextSeq:
    ...
    'Don't update real or other files is current year record exists
    If WrkSkipReal Then
      Me.Close()
      Exit Sub
    End If

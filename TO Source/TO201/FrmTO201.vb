...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO201))
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarPrint, Me.TbarLocal, Me.TBarPS})
    ...
    Me.ClientSize = New System.Drawing.Size(874, 672)
...
#End Region
  ...
  Private Sub FrmTO201_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    If MyLocEld <> "" Then
      TBarPrint.Text = "State"
    End If
    MyFrmTO201B = New FrmTO201B
    MyFrmTO201B.MdiParent = Me
    MyFrmTO201B.Show()
  End Sub
  ...
  Private Sub FrmTO201_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnBack()
    ...
    Select Case Me.SbpScreen.Text
      ...
      Case "TO201C"
        MyFrmTO201C.Close()
      Case "TO201D"
        If TBarSave.Enabled Then
          If MessageBox.Show("Do you want to save your changes before closing?", "Save Changes", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            MyFrmTO201D.SaveData()
          End If
        End If
        MyFrmTO201D.Close()
      Case "ListHome"
  ...
  Private Sub DoBtnNew()
    ...
    MyFrmTO201D.MdiParent = MyFrmTO201B.ParentForm
    MyFrmTO201D.WrkListNo = 0
    MyFrmTO201D.Show()
    MyFrmTO201B.Hide()
  ...
  Private Sub DoBtnLocal()
    PrtReport(MyFrmTO201D.LblLocPgm.Text)
  End Sub

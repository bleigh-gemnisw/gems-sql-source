...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO202))
...
Me.Text = "Create M35H Electronic File"
...
Private Sub FrmTO202_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "TO202"
  TBarProcess.Enabled = True
  set_security() '#set

  MyFrmTO202B = New FrmTO202B
  MyFrmTO202B.MdiParent = Me
  MyFrmTO202B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTO202_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTO202.TBarProcess.Enabled = False
   MyFrmTO202B.RunReport()
   MyFrmTO202.TBarProcess.Enabled = True
End Sub

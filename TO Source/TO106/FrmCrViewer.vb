...
Me.crv2.Size = New System.Drawing.Size(638, 352)
Me.crv2.TabIndex = 3
...
Private Sub CrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    RunReport1()
    TabControl1.TabPages.Remove(TpOPM)
'    RunReport2()
End Sub
...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTO106.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds)
    ...
    .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTO106B.TxtGLYear.Text))
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   Dim WrkPages As Integer
   Dim ReportPath As String

   Crv1.ShowLastPage()
   WrkPages = Crv1.GetCurrentPageNumber()
   Crv1.ShowFirstPage()

   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtTO106OPM.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    ...
    .SetParameterValue("MyPages", WrkPages)
    .SetParameterValue("MyAccts", WrkAccts)
    .SetParameterValue("MyM35GForms", WrkM35GForms)
    .SetParameterValue("MyReduction", WrkReduction)
   End With
   With crv2
     .DisplayToolbar = True
     .ShowGroupTreeButton = False

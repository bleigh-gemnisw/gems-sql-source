...
End Sub
 ...
 Private Sub RunReport2()
  ...
  Me.Text = "Report Viewer"
  ReportPath = MyUtils.GetReportPath("PrtTO208.rpt", myTOWN._TOWNBR)
  With myreport2
  .Load(ReportPath)
  .SetDataSource(wrkds2)
  .SetParameterValue("myreportTitle", "M59A Disallowed List")
 ...
 Private Sub RunReport3()
  ...
  .SetParameterValue("myreportTitle", "M59A Undecided List")
  .SetParameterValue("MyUserID", MyUserID)
  .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
  .SetParameterValue("MyPost", WrkUpdate)
  End With
 ...
 Private Sub RunReport4()
  ...
  Me.Text = "Report Viewer"
  ReportPath = MyUtils.GetReportPath("PrtTO208B.rpt", myTOWN._TOWNBR)
  With myreport4
  .Load(ReportPath)
  .SetDataSource(wrkds4)
  .SetParameterValue("myreportTitle", "M59A Allowed List")
  .SetParameterValue("MyUserID", MyUserID)
  .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
  .SetParameterValue("MyPost", WrkUpdate)
  End With

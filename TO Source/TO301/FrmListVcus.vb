...
#End Region
  ...
  Private Sub FrmListVCus_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTO301.SbpScreen.Text = "ListVcus"
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmTO301C
      If WrkField = "P" Then
        .TxtPCust.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      Else
        .TxtSCust.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      End If
    End With

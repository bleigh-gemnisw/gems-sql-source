Imports System.Data
Public Class FrmTO204B
  Inherits System.Windows.Forms.Form
  Dim MyTXM59A As TXM59AL1.myData
...
#End Region
  ...
  Private Sub FrmTO204B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    MyTXM59A = New TXM59AL1.mydata(MyDBConnect)
    If MyLocEld = "" Then
      MyFrmTO204.TBarLocal.Visible = False
  ...
  End Sub
  Public Sub ShowGrid()
    ds = MyTXM59A.GetViewName(TxtLName.Text, TxtFName.Text, 50)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()

  End Sub
  Private Sub FrmTO204B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTO204.SbpScreen.Text = "TO204B"
  ...
  Private Sub FastPath()
    ...
    MyFrmTO204C.MdiParent = Me.ParentForm
    MyFrmTO204C.WrkListNo = TxtList.Text
    MyFrmTO204C.WrkType = TxtType.Text
    MyFrmTO204C.WrkYear = TxtYear.Text
    MyFrmTO204C.Show()
    TxtList.Text = ""
    Me.Hide()
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    MyFrmTO204C = New FrmTO204C
    MyFrmTO204C.MdiParent = Me.ParentForm
    MyFrmTO204C.WrkListNo = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    MyFrmTO204C.WrkType = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
    MyFrmTO204C.WrkYear = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
    MyFrmTO204C.Show()
    Me.Hide()

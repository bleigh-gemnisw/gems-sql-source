...
Friend WithEvents TBarLocal As System.Windows.Forms.ToolBarButton
Friend WithEvents TBarEBC As System.Windows.Forms.ToolBarButton
Friend WithEvents TBarFBC As System.Windows.Forms.ToolBarButton
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
Me.components = New System.ComponentModel.Container
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO204))
...
Me.TBarLocal = New System.Windows.Forms.ToolBarButton
...
Me.TBarEBC = New System.Windows.Forms.ToolBarButton
Me.TBarFBC = New System.Windows.Forms.ToolBarButton
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarSep1, Me.TBarPrint, Me.TBarLocal, Me.TBarEBC, Me.TBarFBC})
Me.TbMain.DropDownArrows = True
Me.TbMain.ImageList = Me.ImageList1
Me.TbMain.Location = New System.Drawing.Point(0, 0)
Me.TbMain.Name = "TbMain"
Me.TbMain.ShowToolTips = True
Me.TbMain.Size = New System.Drawing.Size(874, 50)
...
'TBarLocal
'
Me.TBarLocal.ImageIndex = 4
Me.TBarLocal.Name = "TBarLocal"
Me.TBarLocal.Text = "Local"
'
'ImageList1
'
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 671)
...
Me.SbMain.Size = New System.Drawing.Size(874, 28)
...
'TBarEBC
'
Me.TBarEBC.ImageIndex = 4
Me.TBarEBC.Name = "TBarEBC"
Me.TBarEBC.Text = "EBC"
'
'TBarFBC
'
Me.TBarFBC.ImageIndex = 4
Me.TBarFBC.Name = "TBarFBC"
Me.TBarFBC.Text = "FBC"
'
'FrmTO204
'
...
#End Region
  ...
  Private Sub FrmTO204_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    TBarLocal.Enabled = False
    TBarEBC.Enabled = False
    TBarFBC.Enabled = False
    MyFrmTO204B = New FrmTO204B
    MyFrmTO204B.MdiParent = Me
    MyFrmTO204B.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    If e.Button Is TBarLocal Then
      DoBtnLocal()
    End If

    If e.Button Is TBarEBC Then
      DoBtnEBC()
    End If

    If e.Button Is TBarFBC Then
      DoBtnFBC()
    End If
...
Private Sub FrmTO204_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
    ...
    If Me.SbpScreen.Text = "TO204B" Then
        MyFrmTO204.Close()
    Else
        MyFrmTO204C.Close()
    End If
...
Private Sub DoBtnNew()
  MyFrmTO204C = New FrmTO204C
  MyFrmTO204C.MdiParent = MyFrmTO204B.ParentForm
  MyFrmTO204C.WrkListNo = 0
  MyFrmTO204C.Show()
  MyFrmTO204B.Hide()
...
Private Sub DoBtnPrint()
  PrtReport("State")
End Sub
Private Sub DoBtnLocal()
  PrtReport("Local")
End Sub
Private Sub DoBtnEBC()
  PrtReport("EBC")
End Sub
Private Sub DoBtnFBC()
  PrtReport("FBC")
End Sub
Private Sub DoBtnSave()
  MyFrmTO204C.SaveData()
End Sub
End Class

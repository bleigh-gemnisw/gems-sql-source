...
Friend WithEvents LnkDist As System.Windows.Forms.LinkLabel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO102B))
    ...
    Me.LnkDist = New System.Windows.Forms.LinkLabel()
        ...
        Me.ChkFrozenFile.Location = New System.Drawing.Point(25, 152)
        ...
        Me.ChkBAA.Location = New System.Drawing.Point(25, 107)
        ...
        Me.ChkOPM.Size = New System.Drawing.Size(140, 16)
        ...
        Me.LnkDist.Location = New System.Drawing.Point(25, 46)
        ...
        Me.ChkPhaseIn.Location = New System.Drawing.Point(25, 129)
        Me.ChkPhaseIn.Name = "ChkPhaseIn"
        Me.ChkPhaseIn.Size = New System.Drawing.Size(140, 17)
        Me.ChkPhaseIn.TabIndex = 4
        Me.ChkPhaseIn.Text = "Phase In values?"
        '
        'FrmTO102B
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(189, 188)
        Me.ControlBox = False
...
#End Region
  ...
  End Sub
  Private Sub FrmTO102B_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    Windows.Forms.Cursor.Current = Cursors.WaitCursor
    SetGLYear()
    ...
    Windows.Forms.Cursor.Current = Cursors.Default
  End Sub
  Private Sub FrmTO102B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTO102.SbpScreen.Text = "TO102B"
End Sub
Private Sub FrmTO102B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub

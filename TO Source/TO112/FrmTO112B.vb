...
Friend WithEvents LnkCodeFrom As System.Windows.Forms.LinkLabel
...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO112B))
Me.ImageList1 = New System.Windows.Forms.ImageList(Me.components)
Me.TTp1 = New System.Windows.Forms.ToolTip(Me.components)
Me.ErrProv = New System.Windows.Forms.ErrorProvider(Me.components)
Me.TxtDist = New System.Windows.Forms.TextBox
Me.LnkDist = New System.Windows.Forms.LinkLabel
Me.LnkCodeFrom = New System.Windows.Forms.LinkLabel
...
Me.TxtDist.Location = New System.Drawing.Point(128, 84)
...
'LnkDist
'
Me.LnkDist.Location = New System.Drawing.Point(28, 84)
...
'LnkCodeFrom
'
Me.LnkCodeFrom.Location = New System.Drawing.Point(28, 56)
Me.LnkCodeFrom.Name = "LnkCodeFrom"
Me.LnkCodeFrom.Size = New System.Drawing.Size(35, 20)
Me.LnkCodeFrom.TabIndex = 175
Me.LnkCodeFrom.TabStop = True
Me.LnkCodeFrom.Text = "Code"
'
'TxtCode
'
Me.TxtCode.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
Me.TxtCode.Location = New System.Drawing.Point(128, 53)
...
Me.ClientSize = New System.Drawing.Size(187, 113)
Me.ControlBox = False
Me.Controls.Add(Me.TxtGLYear)
Me.Controls.Add(Me.Label4)
Me.Controls.Add(Me.LnkCodeFrom)
...
#End Region
  ...
  End Sub
Private Sub FrmTO112B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTO112.SbpScreen.Text = "TO112B"
End Sub
Private Sub FrmTO112B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
  ...
  Private Sub EditChecks(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
    ...
    If MyUtils.CnvSng(TxtCode.Text) = 0 Then
      ErrorField(I) = "code"
...
Private Sub LnkDist_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LnkDist.LinkClicked
  ...
  Me.Hide()
End Sub
Private Sub LnkCodeFrom_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LnkCodeFrom.LinkClicked
...
Private Sub FrmTO112B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  TxtCode.Text = "200"
End Sub
End Class

...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    WrkCodeDesc = GetTXCodeDesc(WrkCode, "P")
    RunReport1()
 End Sub
...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTO112.rpt", myTOWN._TOWNBR)
   With myreport
    .Load(ReportPath)
    .SetDataSource(wrkds)
    ...
    .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTO112B.TxtGLYear.Text))
    .SetParameterValue("MyCode", WrkCode)
    .SetParameterValue("MyCodeDesc", WrkCodeDesc)

...
Friend WithEvents ChkOPM As System.Windows.Forms.CheckBox
...
Friend WithEvents LnkDist As System.Windows.Forms.LinkLabel
    Friend WithEvents ChkPhaseIn As CheckBox
    Friend WithEvents ErrProv As System.Windows.Forms.ErrorProvider
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    Me.components = New System.ComponentModel.Container()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO101B))
    ...
    Me.ChkBAA.Location = New System.Drawing.Point(26, 107)
    ...
    Me.ChkOPM.CheckAlign = System.Drawing.ContentAlignment.MiddleRight
    Me.ChkOPM.Enabled = False
    Me.ChkOPM.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
    Me.ChkOPM.Location = New System.Drawing.Point(25, 85)
    Me.ChkOPM.Name = "ChkOPM"
    Me.ChkOPM.Size = New System.Drawing.Size(118, 17)
    Me.ChkOPM.TabIndex = 2
    Me.ChkOPM.Text = "Create O.P.M. File?"
    '
    'ChkLocal
    '
    Me.ChkLocal.AutoSize = True
    Me.ChkLocal.CheckAlign = System.Drawing.ContentAlignment.MiddleRight
    Me.ChkLocal.Location = New System.Drawing.Point(24, 153)
    Me.ChkLocal.Name = "ChkLocal"
    Me.ChkLocal.Size = New System.Drawing.Size(153, 17)
    Me.ChkLocal.TabIndex = 5
    Me.ChkLocal.Text = "Include Local Exemptions?"
    '
    'ChkCC
    '
    Me.ChkCC.AutoSize = True
    Me.ChkCC.CheckAlign = System.Drawing.ContentAlignment.MiddleRight
    Me.ChkCC.Location = New System.Drawing.Point(25, 130)
    Me.ChkCC.Name = "ChkCC"
    Me.ChkCC.Size = New System.Drawing.Size(133, 17)
    Me.ChkCC.TabIndex = 4
    ...
    Me.LnkDist.Location = New System.Drawing.Point(23, 46)
    Me.LnkDist.Name = "LnkDist"
    Me.LnkDist.Size = New System.Drawing.Size(39, 13)
    Me.LnkDist.TabIndex = 70
    ...
    Me.ChkPhaseIn.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
    Me.ChkPhaseIn.Location = New System.Drawing.Point(27, 175)
    Me.ChkPhaseIn.Name = "ChkPhaseIn"
    Me.ChkPhaseIn.Size = New System.Drawing.Size(108, 17)
    Me.ChkPhaseIn.TabIndex = 6
    Me.ChkPhaseIn.Text = "Phase In values?"
    '
    'FrmTO101B
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(197, 227)
    Me.ControlBox = False
...
#End Region
  ...
  End Sub
Private Sub FrmTO101B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Windows.Forms.Cursor.Current = Cursors.WaitCursor
    SetGLYear()
    ChkPhaseIn.Visible = False
    If MyPhaseIn Then
      ChkPhaseIn.Visible = True
    End If
    Windows.Forms.Cursor.Current = Cursors.Default

End Sub
Private Sub FrmTO101B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTO101.SbpScreen.Text = "TO101B"
End Sub
Private Sub FrmTO101B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
...
End Sub
  Private Sub ChkLocal_Click(sender As Object, e As EventArgs) Handles ChkLocal.Click
'    ChkOPM.Enabled = Not ChkOPM.Enabled
  End Sub
End Class

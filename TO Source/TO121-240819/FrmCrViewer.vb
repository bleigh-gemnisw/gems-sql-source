...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTO121.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      .SetDataSource(Wrkds)
      ...
      .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTO121B.TxtGLYear.Text))
  ...
  Private Sub RunReport2()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtTO121OPM.rpt", myTOWN._TOWNBR)
    With myreport2
      .Load(ReportPath)
      ...
      .SetParameterValue("MyNumExem", WrkNumExem)
      .SetParameterValue("MyRELoss", WrkRELoss)
      .SetParameterValue("MyPPLoss", WrkPPLoss)

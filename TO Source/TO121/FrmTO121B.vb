...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO121B))
...
Me.TxtDist.Location = New System.Drawing.Point(113, 54)
...
'TxtGLYear
'
Me.TxtGLYear.Location = New System.Drawing.Point(113, 30)
...
Me.ChkFrozenFile.Location = New System.Drawing.Point(28, 89)
...
'LnkDist
'
Me.LnkDist.Location = New System.Drawing.Point(29, 54)
...
#End Region
	...
	End Sub
Private Sub FrmTO121B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmTO121.SbpScreen.Text = "TO121B"
End Sub
Private Sub FrmTO121B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
...
Private Sub FrmTO121B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

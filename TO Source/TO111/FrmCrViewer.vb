...
Me.Crv1.Size = New System.Drawing.Size(667, 382)
Me.Crv1.TabIndex = 2
...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtTO111.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds)
    ...
    .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTO111B.TxtGLYear.Text))

...
#End Region
  ...
  Private Sub RunReport()
    ...
    ReportPath = MyUtils.GetReportPath("PrtTO107.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      .SetDataSource(Wrkds)
      ...
      .SetParameterValue("MyYear", MyUtils.CnvSng(MyFrmTO107B.TxtGLYear.Text))
      .SetParameterValue("MyZeros", MyFrmTO107B.ChkZeroes.Checked)
    End With
    With Crv1
      .DisplayToolbar = True

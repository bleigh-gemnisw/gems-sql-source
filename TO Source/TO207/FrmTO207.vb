...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO207))
    ...
    Me.Text = "Create M59A Electronic File and Form"
...
Private Sub FrmTO207_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  Me.SbpPgmID.Text = "TO207"
  TBarProcess.Enabled = True
  set_security() '#set

  MyFrmTO207B = New FrmTO207B
  MyFrmTO207B.MdiParent = Me
  MyFrmTO207B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTO207_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmTO207.TBarProcess.Enabled = False
   MyFrmTO207B.RunReport()
   MyFrmTO207.TBarProcess.Enabled = True
End Sub

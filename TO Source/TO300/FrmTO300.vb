...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTO300))
...
Me.Text = "Maintain DMV Customer Data"
...
#End Region
  ...
  Private Sub FrmTO300_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security()   '#sec
    MyFrmTO300B = New FrmTO300B
    MyFrmTO300B.MdiParent = Me
    MyFrmTO300B.Show()
  End Sub
  ...
  Private Sub FrmTO300_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnNew()
    ...
    MyFrmTO300C.MdiParent = MyFrmTO300B.ParentForm
    MyFrmTO300C.WrkCustID = 0
    MyFrmTO300C.Show()
    MyFrmTO300B.Hide()
  End Sub
  Private Sub DoBtnSave()
    MyFrmTO300C.SaveData()
  End Sub
End Class

Imports System.Data
Public Class FrmTO221B
  Inherits System.Windows.Forms.Form
  Dim MyTXFREEZE As TXFREEZEL1.MyData
...
#End Region
  ...
  Private Sub FrmTO221B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    MyTXFREEZE = New TXFREEZEL1.MyData(myDBConnect)
    Call FormatGrid()
  End Sub
  ...
  End Sub
  Public Sub ShowGrid()
    ds = MyTXFREEZE.GetViewName(TxtLName.Text, TxtFName.Text, 50)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()

  End Sub
  Private Sub FrmTO221B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmTO221.SbpScreen.Text = "TO221B"
  ...
  Private Sub FastPath()
    ...
    MyFrmTO221C = New FrmTO221C
    MyFrmTO221C.MdiParent = Me.ParentForm
    MyFrmTO221C.WrkListNo = TxtList.Text
    MyFrmTO221C.WrkType = TxtType.Text
    MyFrmTO221C.WrkYear = TxtYear.Text
    MyFrmTO221C.Show()
    TxtList.Text = ""
    Me.Hide()
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    MyFrmTO221C = New FrmTO221C
    MyFrmTO221C.MdiParent = Me.ParentForm
    MyFrmTO221C.WrkListNo = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    MyFrmTO221C.WrkType = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
    MyFrmTO221C.WrkYear = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
    MyFrmTO221C.Show()
    Me.Hide()

...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmAR101))
    ...
    'TbMain
    '
    Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarCreate, Me.TBarSep1, Me.TBarDelete, Me.TBarSep2, Me.TBarPrtEdits, Me.TBarPost, Me.TBarPrinters})
    ...
    Me.Text = "Maintain Cash Receipts"
...
#End Region
  ...
  Private Sub FrmAR101_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmAR101B = New FrmAR101B
    MyFrmAR101B.MdiParent = Me
    MyFrmAR101B.Show()
  ...
  Private Sub tbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    If MyFrmAR101B.C1DataGrdList.VisibleRows = 0 Then Exit Sub

    If e.Button Is TBarDelete Then
      '        PassSecurity = GetFNDSEC(MyFrmAR101B.C1DataGrdList.Item(MyFrmAR101B.C1DataGrdList.Row, 4))
    ...
    If e.Button Is TBarPrtEdits Then
      ...
      WrkBatchNo = MyFrmAR101B.C1DataGrdList.Item(MyFrmAR101B.C1DataGrdList.Row, 0)
      ProcBatch(WrkBatchNo, False)
  ...
  Private Sub FrmAR101_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    Dim Cancel As Boolean

    If MyFrmAR101.SbpScreen.Text = "AR101C" Then
      If Cancel Then
        e.Cancel = True
      End If
      Exit Sub
  ...
  Private Sub DoBtnDelete()
    ...
    Select Case Me.SbpScreen.Text
      Case "AR101B"
        MyFrmAR101B.DeleteData(Cancel)
    End Select
  End Sub
  Private Sub DoBtnCreate()
    MyFrmAR101B_New = New FrmAR101B_New
    MyFrmAR101B_New.MdiParent = MyFrmAR101B.ParentForm
    MyFrmAR101B_New.Show()
    MyFrmAR101B.Hide()
  End Sub
  Private Function DoBtnPrtEdits(ByVal Post As Boolean) As Boolean
    ...
    ProcBatch(WrkBatchNo, Post)
    Return Errors
  End Function
  Private Sub DoBtnProcBatch(ByVal Post As Boolean)
    Dim WrkBatchNo As Integer
  ...
  Private Sub FrmAR101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

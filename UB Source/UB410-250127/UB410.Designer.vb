...
Partial Public Class UB410
    ...
    Partial Public Class mytableDataTable
        ...
        Public Overloads Function AddmytableRow( _
                    ...
                    ByVal BILLAMTB As Decimal) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {LISTNO, YEAR, BILLTYPE, RATECODE, ADDR1, ADDR2, ADDR3, ADDR4, ADDR5, PROPLOC, UNITS, USAGE, BILLAMT, BALANCE, INTEREST, LIEN, TAXTOT, BILLAMTA, BILLAMTB}

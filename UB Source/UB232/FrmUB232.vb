...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB232))
    ...
    Me.ToolStripLabel1 = New System.Windows.Forms.ToolStripLabel()
        ...
        Me.Text = "Usage Commercial/Residential/Etc. List"
...
Private Sub FrmUB232_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmUB232B = New FrmUB232B
  MyFrmUB232B.MdiParent = Me
  MyFrmUB232B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmUB232_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmUB232.TBarPrint.Enabled = False
   MyFrmUB232B.RunReport()
   MyFrmUB232.TBarPrint.Enabled = True
End Sub

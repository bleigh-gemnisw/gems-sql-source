...
End Sub
  Private Sub RunReport1()
   ...
   Select Case WrkRpt
   Case "Exempt"
     ReportPath = MyUtils.GetReportPath("PrtUB232B.rpt", myTOWN._TOWNBR)
   Case Else
     ReportPath = MyUtils.GetReportPath("PrtUB232.rpt", myTOWN._TOWNBR)
   End Select
   With myreport
    .Load(ReportPath)
    ...
    End If
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", WrkBillType & " " & WrkRpt & " List")

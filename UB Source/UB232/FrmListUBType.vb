...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmListUBType))
...
#End Region
  ...
  Private Sub FrmListUBType_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmUB232.SbpScreen.Text = "ListUBType"
...
Private Sub C1DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
  ...
  With MyFrmUB232B
    .TxtUBType.Text = C1DataGrdList.Item(C1DataGrdList.Row, 0)
'    .TxtUTTP.Text = C1DataGrdList.Item(C1DataGrdList.Row, 3)
    .TTp1.SetToolTip(.TxtUBType, C1DataGrdList.Item(C1DataGrdList.Row, 1))
  End With

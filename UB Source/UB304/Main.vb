Module Main
  ...
  Public MyFrmUB304 As FrmUB304
	Public MyFrmUB304B As FrmUB304B
...
Sub Main()
  ...
  If GetGNET("NOSWR") = "Y" Then
    MsgBox("Real Estate Bridge has been disabled. Control File setting NOSWR has been activated.", MsgBoxStyle.Exclamation, "Program UB304 is disabled")
    End
  End If
...
#End If
  ...
  MyFrmUB304 = New FrmUB304
  Application.Run(MyFrmUB304)
End Sub

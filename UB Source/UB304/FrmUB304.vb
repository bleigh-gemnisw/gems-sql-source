...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB304))
    ...
    Me.Text = "Update/Add Customers from Assessor File"
...
Private Sub FrmUB304_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB304B = New FrmUB304B
  MyFrmUB304B.MdiParent = Me
  MyFrmUB304B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  If e.Button Is TBarSaveSettings Then
    DoBtnSave()
  End If

End Sub
Private Sub FrmUB304_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnProcess()
  MyFrmUB304B.RunImport()
End Sub
Private Sub DoBtnSave()
  MyFrmUB304B.SaveSettings()

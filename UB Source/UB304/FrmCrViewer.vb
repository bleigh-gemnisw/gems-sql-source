...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  If Wrkds2.Tables(0).Rows.Count > 0 Then
    RunReport2()
  Else
    TabControl1.TabPages.Remove(TpAdd)
  End If
  RunReport3()
...
End Sub
  ...
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtUB304.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds1)
    .SetParameterValue("myreportTitle", "Real Estate to UB - Updated Records")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyPost", MyFrmUB304B.ChkPost.Checked)
    .SetParameterValue("MyTransfer", MyFrmUB304B.ChkTransfer.Checked)
    .SetParameterValue("MyAddList", MyFrmUB304B.ChkAdd.Checked)
    .SetParameterValue("MyUpdName", MyFrmUB304B.ChkName.Checked)
    .SetParameterValue("MyUpdLoc", MyFrmUB304B.ChkLoc.Checked)
    .SetParameterValue("MyUpdMap", MyFrmUB304B.ChkMap.Checked)
    .SetParameterValue("MyUpdDist", MyFrmUB304B.ChkDist.Checked)
    .SetParameterValue("MyUpdVol", MyFrmUB304B.ChkVol.Checked)
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB304B.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    .SetDataSource(Wrkds2)
    .SetParameterValue("myreportTitle", "Real Estate to UB - Added Records")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyPost", MyFrmUB304B.ChkPost.Checked)
    .SetParameterValue("MyTransfer", MyFrmUB304B.ChkTransfer.Checked)
  ...
  Private Sub RunReport3()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB304C.rpt", myTOWN._TOWNBR)
   With myreport3
    .Load(ReportPath)
    .SetDataSource(Wrkds3)
    .SetParameterValue("myreportTitle", "Real Estate to UB - Skipped Records")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
   End With
   With Crv3

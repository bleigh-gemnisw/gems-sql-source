Public Class FrmCrViewer
  ...
  Friend WrkReadDate1 As Date
  Friend WrkReadDate2 As Date
  Friend WrkReadDate3 As Date
  Friend WrkReadDate4 As Date
...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtUB307.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", WrkCompany & " Meter Deducts")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyPost", WrkPost)
      .SetParameterValue("MyReadDate1", WrkReadDate1)
      .SetParameterValue("MyReadDate2", WrkReadDate2)
      .SetParameterValue("MyReadDate3", WrkReadDate3)
      .SetParameterValue("MyReadDate4", WrkReadDate4)
      .SetParameterValue("MyPost", WrkPost)
    End With
    With Crv1
      .DisplayToolbar = True
  ...
  Private Sub RunReport2()
    ...
    With myreport2
      ...
      .SetParameterValue("myreportTitle", WrkCompany & " Meter Deduct Errors")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyReadDate1", WrkReadDate1)
      .SetParameterValue("MyReadDate2", WrkReadDate2)

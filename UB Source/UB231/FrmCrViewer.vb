...
End Sub
  Private Sub RunReport1()
   ...
   ReportTitle = "Assessment Benefit Notices"
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB231.rpt", myTOWN._TOWNBR)
    With myreport
    .Load(ReportPath)
    .SetDataSource(wrkds)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyTownCounty", Trim(myTOWN._COUNTY))
    .SetParameterValue("MyNoticeDate", MyUtils.StripTime(MyFrmUB231B.DtPckNotice.Value))
    .SetParameterValue("MyDueDate", WrkDueDate)
    .SetParameterValue("MyPayoffDate", MyUtils.StripTime(MyFrmUB231B.DtPckPayoff.Value))
    .SetParameterValue("MyProjectDesc", MyFrmUB231B.TxtRptTitle.Text)
   End With
   With Crv1
     .DisplayToolbar = True

...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtUB431.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      .SetDataSource(Wrkds1)
      .SetParameterValue("myreportTitle", "Sold Properties")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyPost", MyFrmUB431B.ChkPost.Checked)
    End With
    With Crv1
      .DisplayToolbar = True

...
Friend WithEvents TBarSaveSettings As System.Windows.Forms.ToolBarButton
...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB431))
    ...
    Me.TbMain.Size = New System.Drawing.Size(761, 50)
    ...
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 378)
    ...
    Me.SbMain.Size = New System.Drawing.Size(761, 28)
    ...
    Me.Text = "Update Sold Properties Billing Codes"
...
#End Region
  ...
  Private Sub FrmUB431_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB431B = New FrmUB431B
  MyFrmUB431B.MdiParent = Me
  MyFrmUB431B.Show()
End Sub
...
End Sub
  ...
  End Sub
  Private Sub FrmUB431_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnProcess()
  MyFrmUB431B.RunImport()
End Sub
Private Sub DoBtnSave()
  MyFrmUB431B.SaveSettings()
  MsgBox("Next time you run this program the saved settings will be loaded", MsgBoxStyle.Information, "Program settings saved")
End Sub

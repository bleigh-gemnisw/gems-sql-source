...
Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmUB105))
...
Private Sub FrmUB105_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB105B = New FrmUB105B
  MyFrmUB105B.MdiParent = Me
  MyFrmUB105B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmUB105_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "UB105B" Then
    MyFrmUB105.Close()
  Else
    MyFrmUB105C.Close()
    MyFrmUB105B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmUB105C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmUB105C.MdiParent = MyFrmUB105B.ParentForm
  MyFrmUB105C.Wrkcresn = ""
  MyFrmUB105C.Show()
  MyFrmUB105B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmUB105B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmUB105C.SaveData()
End Sub

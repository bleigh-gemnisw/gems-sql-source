...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(342, 358)
    Me.DataGrdView.TabIndex = 20
    '
    'FrmUB105B
    '
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(366, 408)
    Me.ControlBox = False
...
Private Sub FrmUB105B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub ShowGrid()
  ...
  myUTCRESN.CloseFile()
End Sub
Private Sub FrmUB105B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmUB105.SbpScreen.Text = "UB105B"
  MyFrmUB105.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmUB105C = New FrmUB105C
  MyFrmUB105C.MdiParent = Me.ParentForm
  MyFrmUB105C.Wrkcresn = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmUB105C.Show()
  Me.Hide()
End Sub
End Class

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB340))
...
Me.ImageList1.Images.SetKeyName(1, "print_24.png")
'
'SbMain
'
...
Me.Text = "Print EZRoute Meter Repair Letters"
...
Private Sub FrmUB340_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmUB340B = New FrmUB340B
  MyFrmUB340B.MdiParent = Me
  MyFrmUB340B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmUB340_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmUB340.TBarPrint.Enabled = False
   MyFrmUB340B.RunReport()
   MyFrmUB340.TBarPrint.Enabled = True
End Sub

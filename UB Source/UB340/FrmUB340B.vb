...
Me.GroupBox1.Text = "EZRoute Reports File"
'
'LblFilePath
'
...
Me.ClientSize = New System.Drawing.Size(434, 79)
Me.ControlBox = False
...
#End Region
  ...
  End Sub
Private Sub FrmUB340B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    MyFrmUB340.SbpPgmID.Text = "UB340B"
    MyFrmUB340.SbpEnvironment.Text = myDBConnect.PgmDB
    LblFilePath.Text = ""

End Sub
Private Sub FrmUB340B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmUB340.SbpScreen.Text = "UB340B"
End Sub
Private Sub FrmUB340B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
  ...
  End Sub
Private Sub FrmUB340B_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB412))
...
Me.Text = "Print Payoff Report/Letter"
...
Private Sub FrmUB412_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB412B = New FrmUB412B
  MyFrmUB412B.MdiParent = Me
  MyFrmUB412B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmUB412_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "UB412B" Then
    MyFrmUB412.Close()
  End If
End Sub
Private Sub DoBtnPrint()
   MyFrmUB412B.RunReport()
End Sub

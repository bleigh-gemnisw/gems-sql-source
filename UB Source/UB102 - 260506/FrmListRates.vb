...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmListRates))
...
Me.C1DataGrdList.Location = New System.Drawing.Point(20, 56)
...
Me.C1DataGrdList.Size = New System.Drawing.Size(236, 260)
...
Me.ClientSize = New System.Drawing.Size(276, 326)
...
Me.Name = "FrmListRates"
Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
Me.Text = "Select Rate Code"
...
#End Region
  ...
  Public Sub ShowGrid()
    ...
    Case "A"
      If TxtPos.Text = "" Then
        ds = MyUTRATEAS.GetAllType(WrkUBType, 50)
      Else
        ds = MyUTRATEAS.PosData(TxtPos.Text, WrkUBType)
      End If
    Case "M"
      If TxtPos.Text = "" Then
        ds = MyUTRATEMT.GetAllType(WrkUBType, 50)
      Else
        ds = MyUTRATEMT.PosData(TxtPos.Text, WrkUBType, 0)
      End If
    Case "U"
      If TxtPos.Text = "" Then
        ds = MyUTRATEUS.GetAllType(WrkUBType)
      Else
        ds = MyUTRATEUS.PosData(TxtPos.Text, WrkUBType)
      End If
    End Select
  ...
  End Sub
  Private Sub FrmListRates_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmUB102.SbpScreen.Text = "ListRates"
  ...
  Private Sub BtnNext_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    TxtPos.Text = ""
  End Sub
  Private Sub FrmListRates_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    FormatGrid()
    LblCurrent.Text = "(Code " & WrkUBType & " = " & WrkCode & ")"
  End Sub
Private Sub C1DataGrdList_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles C1DataGrdList.DoubleClick
    ...
    Case "A"
      With MyFrmUB102AS
        ...
        .Ttp1.SetToolTip(.TxtCode, C1DataGrdList.Item(C1DataGrdList.Row, 2))
      End With
    Case "M"
      With MyFrmUB102MT
        .TxtCode.Text = C1DataGrdList.Item(C1DataGrdList.Row, 1)
...
Private Sub FrmListRates_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed

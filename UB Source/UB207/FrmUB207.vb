...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB207))
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 480)
...
Me.Text = "UB Customer District/Phase Listing/Labels"
...
Private Sub FrmUB207_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB207B = New FrmUB207B
  MyFrmUB207B.MdiParent = Me
  MyFrmUB207B.Show()
End Sub
...
End Sub
Private Sub FrmUB207_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

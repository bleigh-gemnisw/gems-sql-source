...
Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmUB204))
...
Private Sub FrmUB204_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB204B = New FrmUB204B
  MyFrmUB204B.MdiParent = Me
  MyFrmUB204B.Show()
End Sub
...
End Sub
Private Sub FrmUB204_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

...
Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmUB108))
...
Me.Text = "Utility Billing Type Codes"
...
Private Sub FrmUB108_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB108B = New FrmUB108B
  MyFrmUB108B.MdiParent = Me
  MyFrmUB108B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmUB108_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If MyFrmUB108.SbpScreen.Text = "UB108B" Then
     MyFrmUB108.Close()
  Else
    MyFrmUB108C.Close()
    MyFrmUB108B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmUB108C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmUB108C.Close()
  MyFrmUB108B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmUB108C = New FrmUB108C
  MyFrmUB108C.MdiParent = MyFrmUB108B.ParentForm
  MyFrmUB108C.Wrktype = ""
  MyFrmUB108C.Wrktyuttp = "A"
  MyFrmUB108C.Show()
  MyFrmUB108B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmUB108B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmUB108C.SaveData()
End Sub

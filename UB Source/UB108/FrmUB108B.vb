...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(408, 358)
...
Private Sub FrmUB108B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub FormatGrid()
  ...
  With DataGrdView
    ...
    .Columns(1).Width = 200
    .Columns(2).HeaderText = "Tax Cd"
    .Columns(2).Width = 50
    .Columns(3).HeaderText = "Utility Type"
    .Columns(3).Width = 60
  End With
End Sub
Public Sub ShowGrid()
  If Wrktype = "" Then
    ds = myUTTYPE.GetAllData
    Else
  ...
  myUTTYPE.CloseFile()
End Sub
Private Sub FrmUB108B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmUB108.SbpScreen.Text = "UB108B"
  MyFrmUB108.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmUB108C.MdiParent = Me.ParentForm
  MyFrmUB108C.Wrktype = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmUB108C.Show()
  Me.Hide()
End Sub

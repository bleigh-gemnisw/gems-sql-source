...
ReadNext:
    ...
    If Not myUTCUSTQ.IsEOF Then
      With myUTCUSTQ
        WrkList = ._CUACCT
        If myTOWN._TOWNBR = 219 Or myTOWN._TOWNBR = 220 Then 'Kensington/Worthington
        ...
        sb.Append("000000")
        '18: Meter Key (20)
        If myTOWN._TOWNBR = 220 Then 'Worthington
          WrkStr = MyUtils.JustifyLeft(._CUSERN, 20)
        Else

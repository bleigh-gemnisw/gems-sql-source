...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents Cr1 As CrystalDecisions.Windows.Forms.CrystalReportViewer
    ...
    Me.TabControl1.Size = New System.Drawing.Size(662, 376)
    ...
    Me.TpReport.Size = New System.Drawing.Size(654, 350)
    ...
    Me.Crv1.Size = New System.Drawing.Size(658, 355)
    Me.Crv1.TabIndex = 2
    ...
    Me.TpTotals.Size = New System.Drawing.Size(654, 350)
    ...
    Me.Crv2.Size = New System.Drawing.Size(658, 352)
    Me.Crv2.TabIndex = 1
...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtUB234.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      ...
      End If
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", WrkBillType & " Accounts by Meter Size")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyDistrict", MyUtils.CnvSng(MyFrmUB234B.TxtDist.Text))
      .SetParameterValue("MyPhase", MyUtils.CnvSng(MyFrmUB234B.TxtPhase.Text))
      .SetParameterValue("MySize", MyFrmUB234B.TxtMeterSize.Text)
      .SetParameterValue("MyPropCat", MyFrmUB234B.TxtPropCat.Text)
    End With
    With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB234Tot.rpt", myTOWN._TOWNBR)
    With myreport2
      .Load(ReportPath)
      If MyReportLandscape Then
        .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
      ...
      End If
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", WrkBillType & " Accounts by Meter Size Totals")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyDistrict", MyUtils.CnvSng(MyFrmUB234B.TxtDist.Text))
      .SetParameterValue("MyPhase", MyUtils.CnvSng(MyFrmUB234B.TxtPhase.Text))

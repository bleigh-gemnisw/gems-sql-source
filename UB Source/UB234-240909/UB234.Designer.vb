...
Partial Public Class UB234
    ...
    Partial Public Class mytableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddmytableRow(ByVal LISTNO As Long, ByVal CUMSIZ As String, ByVal ZONE As String, ByVal ROUTE As String, ByVal NAME As String, ByVal NAME2 As String, ByVal ADDR1 As String, ByVal ADDR2 As String, ByVal ADDR3 As String) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {LISTNO, CUMSIZ, ZONE, ROUTE, NAME, NAME2, ADDR1, ADDR2, ADDR3}

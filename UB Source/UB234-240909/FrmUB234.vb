...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB234))
    ...
    Me.Text = "Accounts by Meter Size"
...
Private Sub FrmUB234_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  MyFrmUB234B = New FrmUB234B
  MyFrmUB234B.MdiParent = Me
  MyFrmUB234B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmUB234_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   MyFrmUB234.TBarPrint.Enabled = False
   MyFrmUB234B.RunReport()
   MyFrmUB234.TBarPrint.Enabled = True
End Sub

...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtUB202.rpt", myTOWN._TOWNBR)
    With myreport
    .Load(ReportPath)
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", WrkBillType & " Worksheet")
    ...
    .SetParameterValue("MyCode", MyFrmUB202B.TxtCode.Text)
   End With
   With Crv1
     .DisplayToolbar = True

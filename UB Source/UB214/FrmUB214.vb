...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB214))
...
Me.Text = "Print Meter Usage Variances"
...
Private Sub FrmUB214_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB214B = New FrmUB214B
  MyFrmUB214B.MdiParent = Me
  MyFrmUB214B.Show()
End Sub
...
End Sub
Private Sub FrmUB214_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

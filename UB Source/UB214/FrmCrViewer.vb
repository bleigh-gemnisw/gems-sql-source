...
Me.Crv1.Location = New System.Drawing.Point(6, 5)
Me.Crv1.Name = "Crv1"
...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtUB214.rpt", myTOWN._TOWNBR)
    With myreport
    .Load(ReportPath)
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", WrkBillType & " Meter Usage Variances")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MySort", Wrksort)
    .SetParameterValue("Mydistphase", Wrkdistphase)
    .SetParameterValue("MyReadingDate", MyFrmUB214B.DtPckReading.Value)
    .SetParameterValue("MyPreviousDate", MyFrmUB214B.DtPckPrevious.Value)
    .SetParameterValue("MyVarPct", MyUtils.CnvSng(MyFrmUB214B.TxtPct.Text))
   End With
   With Crv1
     .DisplayToolbar = True

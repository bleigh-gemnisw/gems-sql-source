...
Me.TpLetter.Size = New System.Drawing.Size(636, 381)
Me.TpLetter.TabIndex = 0
...
Me.Crv2.Size = New System.Drawing.Size(640, 383)
Me.Crv2.TabIndex = 1
...
Me.TabControl1.Size = New System.Drawing.Size(644, 407)
...
Me.TpReport.Size = New System.Drawing.Size(636, 381)
...
Me.Crv1.Size = New System.Drawing.Size(640, 383)
Me.Crv1.TabIndex = 2
...
End Sub
	Private Sub RunReport1()
	 ...
	 ReportTitle = "Deferred Report"
	 If MyFrmUB210B.RbSortList.Checked Then
		ReportTitle = ReportTitle & " by List No"
	 End If
	 If MyFrmUB210B.RbSortName.Checked Then
		ReportTitle = ReportTitle & " by Name"
	 End If
	 If MyFrmUB210B.RbSortLocation.Checked Then
		ReportTitle = ReportTitle & " by Location"
	 End If

	 Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB210.rpt", myTOWN._TOWNBR)
		With myreport
		.Load(ReportPath)
		.SetDataSource(wrkds)
    ...
    .SetParameterValue("MyDistrict", MyUtils.CnvSng(MyFrmUB210B.TxtDist.Text))
    .SetParameterValue("MyPhase", MyUtils.CnvSng(MyFrmUB210B.TxtPhase.Text))
	 End With
	 With Crv1
     .DisplayToolbar = True
   ...
   End With
	...
	Private Sub RunReport2()
	 ...
	 Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB210Ltr.rpt", myTOWN._TOWNBR)
		With myreport2
		.Load(ReportPath)
		.SetDataSource(wrkds)

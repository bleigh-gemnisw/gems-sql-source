...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(499, 218)
...
#End Region
 ...
 Private Sub FrmUB111B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub FormatGrid()
  ...
  With DataGrdView
    ...
    .Columns(0).Width = 10
    .Columns(1).HeaderText = "Description 1"
    .Columns(1).Width = 150
    .Columns(2).Visible = False
    .Columns(3).HeaderText = "Description 2"
    .Columns(3).Width = 150
    .Columns(4).Visible = False
    .Columns(5).HeaderText = "Description 2"
    .Columns(5).Width = 150
...
Public Sub ShowGrid()
  If Wrktype = "" Then
    ds = myUTBREAK.GetAllData
    Else
    ds = myUTBREAK.PosData(TxtPos.Text)
  End If
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
  myUTBREAK.CloseFile()
End Sub
Private Sub FrmUB111B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmUB111.SbpScreen.Text = "UB111B"
  MyFrmUB111.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmUB111C = New FrmUB111C
  MyFrmUB111C.MdiParent = Me.ParentForm
  MyFrmUB111C.Wrktype = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmUB111C.WrkAddMode = False
  MyFrmUB111C.Show()
  Me.Hide()
End Sub
End Class

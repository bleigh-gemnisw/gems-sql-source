...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB111))
...
#End Region
 ...
 Private Sub FrmUB111_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  TBarSave.Enabled = False
   ...
   set_security() '#set
   MyFrmUB111B = New FrmUB111B
   MyFrmUB111B.MdiParent = Me
   MyFrmUB111B.Show()
 End Sub
...
Private Sub FrmUB111_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "UB111B" Then
    MyFrmUB111.Close()
  Else
    MyFrmUB111C.Close()
    MyFrmUB111B.Show()
...
Private Sub DoBtnDelete()
  MyFrmUB111C.DeleteData()
  MyFrmUB111C.Close()
  MyFrmUB111B.Show()
End Sub
Private Sub DoBtnNew()
  MyFrmUB111C = New FrmUB111C
  MyFrmUB111C.MdiParent = MyFrmUB111B.ParentForm
  MyFrmUB111C.Wrktype = ""
  MyFrmUB111C.WrkAddMode = True
  MyFrmUB111C.Show()
  MyFrmUB111B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmUB111B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmUB111C.SaveData()
End Sub

...
'MK  9/ 2/25 Annual 2nd Half (both): Omit current year from Delq amounts 
'MK  9/12/25 Annual 2nd Balance: Adjust delq balance in csv file
'MK  4/22/26 Due date was not correct for periods 2,3 & 4
'MK  9/21/26 Add UBDED to control file value for Deduct Meters (GNET)
Imports System

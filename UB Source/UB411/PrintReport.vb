...
Module PrintReport
  ...
  Dim MyUBCalcDeduct As UBCalcDeduct.MyData
  ...
  Dim WrkReadingDate As String
  Dim WrkReadingDate2 As String
  'Usage Calcs
  ...
  Public Sub PrtReport()
    ...
    MyUBCalcDeduct = New UBCalcDeduct.MyData(myDBConnect)
    ...
    With MyFrmUB411B
      ...
      End If
      If MyFrmUB411B.RbPerSemi1.Checked Then
        WrkPeriod = 1
        WrkPeriodDesc = "Semi-Annual 1st Period"
      End If
      If MyFrmUB411B.RbPerSemi2.Checked Then
        WrkPeriod = 2
        WrkPeriodDesc = "Semi_Annual 2nd Period"
      End If
...
Report:
      ...
      Select Case WrkFamily
        ...
        Case "M"
          dr.Item("meterno") = Trim(myUTCUSTQ._CUMETN)
  ...
  Private Sub CalcMetered()
    With MyUBCalcReading
      ...
      Else
        .In_AnnualBill = False
      End If
      If MyFrmUB411B.RbPerSemi1.Checked Or MyFrmUB411B.RbPerSemi2.Checked Then
        .In_SemiAnnualBill = True
      Else
        .In_SemiAnnualBill = False
      End If
      ...
      WrkReadingDate = .Out_MeterDateCurr
      WrkReadingDate2 = .Out_MeterDateCurr2
    End With
    ...
    With MyUBCalcBillMeter
      ...
      End If
      .CalcMeteredUse()
      WrkTotalUse = .Out_TotalUse - WrkDeduct
      If WrkTotalUse < 0 Then
        WrkTotalUse = 0
      End If
 ...
 ByVal WrkTax2nd As Decimal, ByVal WrkBackTax As String) As String
  ...
  Private Function DownloadCSV(ByVal AddrLine As String()) As String
    ...
    With myUTCUSTQ
      ...
      sb.Append(CComma)
      sb.Append(WrkReadingDate)
      sb.Append(CComma)
      sb.Append(WrkReadingDate2)
    End With
    Return sb.ToString
  End Function
  Private Function HeadingsCSV() As String
    ...
    sb.Append(CComma)
    sb.Append("Meter Reading Date 1")
    sb.Append(CComma)
    sb.Append("Meter Reading Date 2")
    Return sb.ToString
  End Function

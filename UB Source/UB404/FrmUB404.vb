...
Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmUB404))
...
Me.Text = "Calculate Average Billing Amounts"
...
Private Sub FrmUB404_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB404B = New FrmUB404B
  MyFrmUB404B.MdiParent = Me
  MyFrmUB404B.Show()
End Sub
...
End Sub
Private Sub FrmUB404_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

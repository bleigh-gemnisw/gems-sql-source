...
Friend WithEvents ImageList1 As System.Windows.Forms.ImageList
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB109B))
    ...
    Me.TxtList.Location = New System.Drawing.Point(46, 28)
    Me.TxtList.MaxLength = 7
    Me.TxtList.Name = "TxtList"
    Me.TxtList.Size = New System.Drawing.Size(62, 22)
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(12, 84)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(530, 344)
...
#End Region
  ...
  Private Sub FrmUB109B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  End Sub
  Private Sub FrmUB109B_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    End
  End Sub
  ...
  Private Sub RbReg_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    FormatGrid()
  End Sub
  Private Sub FrmUB109B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmUB109.SbpScreen.Text = "UB109B"
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    MyFrmUB109C = New FrmUB109C

    MyFrmUB109C.WrkListNo = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    MyFrmUB109C.WrkName = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
    MyFrmUB109C.MdiParent = Me.ParentForm
    MyFrmUB109C.Show()
    Me.Hide()
  End Sub

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB109))
...
'TbMain
'
Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSave, Me.TBarDelete})
...
#End Region
  ...
  Private Sub FrmUB109_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security()   '#sec
    MyFrmUB109B = New FrmUB109B
    MyFrmUB109B.MdiParent = Me
    MyFrmUB109B.Show()
  End Sub
  ...
  Private Sub FrmUB109_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnSave()
    Select Case Me.SbpScreen.Text
      Case "UB109C"
        MyFrmUB109C.SaveData()
      Case "UB109D"
        MyFrmUB109D.SaveData()
    End Select
  End Sub
End Class

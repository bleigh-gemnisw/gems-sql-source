...
Module PrintReport
  ...
  'MK 11/24/25 Begin
  Dim WrkBaseChgA As Decimal
  Dim WrkBaseChgB As Decimal
  Dim WrkMinChgA As Decimal
  Dim WrkMinChgB As Decimal
  Dim WrkUsageChgA As Decimal
  Dim WrkUsageChgB As Decimal
  Dim WrkEDUChgA As Decimal
  Dim WrkEDUChgB As Decimal
  Dim WrkUserChgA As Decimal
  Dim WrkUserChgB As Decimal
  'MK 11/24/25 End
  ...
  Dim WrkBaseChg As Decimal
  Dim WrkMinChg As Decimal
  Dim WrkEDUChg As Decimal
  Dim WrkUsageChg As Decimal
  ...
  Public Sub PrtReport()
    ...
    With MyFrmUB410B
      ...
      If MyFrmUB410B.RbPerAnnual1.Checked Then
        WrkPeriod = 1
        WrkPeriodDesc = "Annual 1st Half"
      End If
      If MyFrmUB410B.RbPerAnnual2.Checked Then
        WrkPeriod = 1
        WrkPeriodDesc = "Annual 2nd Half"
      End If
      If MyFrmUB410B.RbPer1st.Checked Then
        WrkPeriod = 1
        WrkPeriodDesc = "1st Period"
      End If
      If MyFrmUB410B.RbPer2nd.Checked Then
        WrkPeriod = 2
        WrkPeriodDesc = "2nd Period"
      End If
      If MyFrmUB410B.RbPer3rd.Checked Then
        WrkPeriod = 3
        WrkPeriodDesc = "3rd Period"
      End If
      If MyFrmUB410B.RbPer4th.Checked Then
        WrkPeriod = 4
...
Done:
    ...
    With MyCrViewer
      ...
      If myTOWN._TOWNBR = 219 Then 'Kensington
        If MyFrmUB410B.RbPerAnnual.Checked Then
          .WrkDueDate1 = Format(ProfTxDt(0), "M/d/yyyy")
          .WrkDueDate2 = Format(ProfTxDt(0), "M/d/yyyy")
          .WrkGraceDate1 = Format(ProfGrDt(0), "M/d/yyyy")
          .WrkGraceDate2 = Format(ProfGrDt(0), "M/d/yyyy")
        End If
        If MyFrmUB410B.RbPer1st.Checked Then
          .WrkDueDate1 = Format(ProfTxDt(0), "M/d/yyyy")
          .WrkDueDate2 = Format(ProfTxDt(0), "M/d/yyyy")
  ...
  Private Sub GetDetail()
    ...
    If MyFrmUB410B.LblFilePath.Text <> String.Empty Then
      sw = New StreamWriter(MyFrmUB410B.LblFilePath.Text)
...
ReadNext:
    ...
    If Not myUTCUSTQ.IsEOF Then
      With myUTCUSTQ
        ...
        If Not MyFrmUB410B.ChkBills.Checked Then
          GoTo Report
        End If
        ...
        drBill.Item("billamtc") = WrkBillAmtC
...
Report:
      'Filter - No Report
      If Not MyFrmUB410B.ChkReport.Checked Then
        GoTo WriteInvoice
      End If
      ...
      End Select
      'Kensington: Take User charge 1 from Bill B and put into Bill C (seperate user charge 1)
      If myTOWN._TOWNBR = 219 Then
        WrkBillAmtA = WrkBillAmtA - WrkUserChgA
        WrkBillAmtB = WrkBillAmtB - WrkUserChgB
        WrkBillAmtC = WrkUserChgA + WrkUserChgB
      End If
      ...
      dr.Item("interest") = WrkDelqInterestA + WrkDelqInterestB
      'MK 8/25/25 End
...
WriteInvoice:
      ...
      End If
      If WrkUpdate Then
        WriteInvoice(WrkTaxTypeA, WrkBillAmtA, 0, WrkTax1stA, WrkTax2ndA, WrkTax3rdA, WrkTax4thA, WrkDelqPrincipalA)
        WriteInvoice(WrkTaxTypeB, WrkBillAmtB, WrkBillAmtC, WrkTax1stB, WrkTax2ndB, WrkTax3rdB, WrkTax4thB, WrkDelqPrincipalB)
        If WrkCancel Then
          ds.Clear()
          dsBill.Clear()
          GoTo Cleanup
        End If
        WriteUTBLHS(WrkTaxTypeA, WrkBaseChgA, WrkMinChgA, WrkUsageChgA, WrkEDUChgA, WrkUserChgA, WrkBillAmtA)
        WriteUTBLHS(WrkTaxTypeB, WrkBaseChgB, WrkMinChgB, WrkUsageChgB, WrkEDUChgB, WrkUserChgB, WrkBillAmtB)
      End If
...
Cleanup:
  ...
  Private Sub CalcBillAmounts(ByVal WrkLtr As String, ByVal WrkType As String)
    ...
    If MyFrmUB410B.RbPerAnnual.Checked Or MyFrmUB410B.RbPerAnnual1.Checked Or MyFrmUB410B.RbPerAnnual2.Checked Then
      With myTPaymnt
        .In_ListNo = WrkListNo
        .In_Type = WrkType
        .In_Year = WrkYear
    ...
    If MyFrmUB410B.RbPerAnnual2.Checked Then
      WrkTax1st = 0
      myTXINV.GetOneRecordP(myUTCUSTQ._CUACCT, WrkYear, WrkType)
    ...
    If WrkLtr = "A" Then
      ...
      'MK 11/24/25 Begin
      WrkBaseChgA = WrkBaseChg
      WrkMinChgA = WrkMinChg
      WrkUsageChgA = WrkUsageChg
      WrkEDUChgA = WrkEDUChg
      WrkUserChgA = WrkMeterUserChg1
      'MK 11/24/25 End
    ...
    Else
      ...
      'MK 11/24/25 Begin
      WrkBaseChgB = WrkBaseChg
      WrkMinChgB = WrkMinChg
      WrkUsageChgB = WrkUsageChg
      WrkEDUChgB = WrkEDUChg
      WrkUserChgB = WrkMeterUserChg1
      'MK 11/24/25 End
    ...
    End If
  End Sub
  Private Sub WriteInvoice(ByVal WrkTaxType As String, ByVal WrkBillAmt As Decimal, ByVal WrkBillAmtC As Decimal, ByVal WrkTax1st As Decimal, ByVal WrkTax2nd As Decimal,
    ...
    With myUTCUSTQ
      ...
      If WrkDelqPrincipal > 0 Then
        If MyFrmUB410B.RbPerAnnual.Checked Or MyFrmUB410B.RbPerAnnual1.Checked Or MyFrmUB410B.RbPer1st.Checked Then
          myTXINV._ICODE = "B"
        End If
      End If
      ...
      myTXINV._TAXT = myTXINV._TAXT + WrkBillAmt + WrkBillAmtC
      ...
      If myTXINV._CCNO > 0 Then
        If MyFrmUB410B.RbPer2nd.Checked Or MyFrmUB410B.RbPer3rd.Checked Or MyFrmUB410B.RbPer4th.Checked Then
          myTXINV._CCETAX = myTXINV._CCETAX + WrkBillAmt + WrkBillAmtC
          myTXINV._CCTX2 = myTXINV._CCTX2 + WrkTax2nd
          myTXINV._CCTX3 = myTXINV._CCTX3 + WrkTax3rd
          myTXINV._CCTX4 = myTXINV._CCTX4 + WrkTax4th
        End If
      End If
      myTXINV._BALD = myTXINV._BALD + WrkBillAmt + WrkBillAmtC
      myTXINV._BOND = 0
  ...
  End Sub
  Private Sub WriteUTBLHS(ByVal WrkTaxType As String, ByVal WrkBaseChg As Decimal, ByVal WrkMinChg As Decimal,
   ByVal WrkUsageChg As Decimal, ByVal WrkEDUChg As Decimal, ByVal WrkUserChg As Decimal, ByVal WrkBillAmt As Decimal)
    ...
    With myUTBLHS
      ...
      ._AMT5 = WrkUserChg
      ._AMT6 = 0
      ._BILDT = MyUtils.SetDBDate(WrkInterestDate)
      ._BLAMT = WrkBillAmt
      ._CODE1 = "BASE"
      ._CODE2 = "MIN"
      ._CODE3 = "USAGE"
...
CloseFiles:
  ...
  Private Sub CalcMetered(ByVal WrkLtr As String, ByVal WrkType As String, ByRef OutBillAmt As Decimal)
    ...
    'MK 9/10/25 Begin
    If WrkLtr = "A" Then
      If Trim(WrkCodeA) = "" Then
        Exit Sub
      End If
    Else
      If Trim(WrkCodeB) = "" Then
        Exit Sub
      End If
    End If
    'MK 9/10/25 End
    ...
    With MyUBCalcBillM
      ...
      If .In_RateCode <> "" Then
        ...
        'MK 11/24/25 Begin
        WrkBaseChg = .Out_BasePart
        WrkMinChg = .Out_MinBillPart
        WrkUsageChg = .Out_UsagePart
        WrkEDUChg = .Out_EDUPart
        'MK 11/24/25 End
    ...
    If myTOWN._TOWNBR = 219 And {"S", "W"}.Contains(WrkType) Then
      CalcInterestListNo_219SW(WrkLtr, WrkType)
    Else
      CalcInterestListNo(WrkLtr, WrkType)
    End If
    'MK 8/25/25 End
  ...
  End Sub
  'MK 8/25/25 Begin
  Private Sub CalcInterestListNo_219SW(ByVal WrkLtr As String, ByVal WrkType As String)
    Dim ds2 As DataSet = New DataSet
    ...
    For I = 0 To ds2.Tables(0).Rows.Count - 1
      ...
      If WrkOrigInterest > 0 And WrkInterest <> WrkOrigInterest Then
        With myCashInt
          ...
          Else
            WrkDelqInterest = WrkDelqInterest + WrkOrigInterest
          End If
        End With
      Else
        WrkDelqInterest = WrkDelqInterest + WrkInterest
    ...
    If WrkLtr = "A" Then
      WrkDelqInterestA = Format(WrkDelqInterest, "standard")
      WrkDelqFeeA = WrkDelqFee
      WrkDelqLienA = WrkDelqLien
      WrkDelqPrincipalA = WrkDelqPrincipal
    Else
      WrkDelqInterestB = Format(WrkDelqInterest, "standard")
      WrkDelqFeeB = WrkDelqFee
      WrkDelqLienB = WrkDelqLien
      WrkDelqPrincipalB = WrkDelqPrincipal
    End If

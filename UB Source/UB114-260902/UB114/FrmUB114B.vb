...
Private Sub BtnNext_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnNext.Click
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    If RbMeter.Checked Then
      MeterNo = Trim(CStr(DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value))
      CustName = Trim(CStr(DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value))
    Else
      CustName = Trim(CStr(DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value))
      'Name/location search identifies the customer.  Use the customer's current
      'meter number; Meter # search can be used when a specific meter is needed.
      myUTCUST.GetOneRecordP(Acct)
      If Not myUTCUST.RecordNotFound Then MeterNo = Trim(myUTCUST._CUMETN)
    End If

...
#End Region
  ...
  Private Sub RunReport1()
    ...
    ReportPath = MyUtils.GetReportPath("PrtUB305.rpt", myTOWN._TOWNBR)
    With myreport1
      .Load(ReportPath)
      .SetDataSource(wrkds)
      If WrkRoutes Then
        .SetParameterValue("myreportTitle", "Neptune - Create Routes")
      Else
        .SetParameterValue("myreportTitle", "Neptune - Get Readings")
      End If
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyDistrict", WrkDist)
      .SetParameterValue("MyRoutes", WrkRoutes)
  ...
  Private Sub RunReport2()
    ...
    With myreport2
      ...
      .SetParameterValue("myreportTitle", "Neptune - Readings Errors")
      .SetParameterValue("MyUserID", MyUserID)
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyDistrict", WrkDist)
      .SetParameterValue("MyRoutes", WrkRoutes)

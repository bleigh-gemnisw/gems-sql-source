...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB104))
...
Private Sub FrmUB104_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB104B = New FrmUB104B
  MyFrmUB104B.MdiParent = Me
  MyFrmUB104B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmUB104_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "UB104B" Then
    MyFrmUB104.Close()
  Else
    MyFrmUB104C.Close()
    MyFrmUB104B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmUB104C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmUB104C.MdiParent = MyFrmUB104B.ParentForm
  MyFrmUB104C.Wrkmttype = ""
  MyFrmUB104C.Show()
  MyFrmUB104B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmUB104B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmUB104C.SaveData()
End Sub

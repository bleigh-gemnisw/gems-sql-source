...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    'Label8
    '
    Me.Label8.Location = New System.Drawing.Point(402, 276)
    ...
    'Label13
    '
    Me.Label13.Location = New System.Drawing.Point(386, 348)
    ...
    Me.Label12.Location = New System.Drawing.Point(442, 324)
    ...
    'Label10
    '
    Me.Label10.Location = New System.Drawing.Point(442, 300)
    ...
    Me.Label28.Location = New System.Drawing.Point(430, 420)
    ...
    Me.Label18.Location = New System.Drawing.Point(420, 396)
    Me.Label18.Name = "Label18"
    Me.Label18.Size = New System.Drawing.Size(62, 13)
    Me.Label18.TabIndex = 275
    Me.Label18.Text = "Zone / Unit"
    '
    'TxtPropCat
    '
    ...
    Me.Label16.Location = New System.Drawing.Point(408, 372)
...
#End Region
  ...
  Public Sub SaveData()
    ...
    Dim WrkAutoGen As Boolean     'added 5-6-26
    ...
    If AddMode Then
      ...
      ' added 5-6-26   logic to get next number if they do not enter a list#
      If WrkListNo = 0 Then
        WrkListNo = myUTCUST.AutoGenKey()
        TxtListNo.Text = WrkListNo
        WrkAutoGen = True
      End If
    ...
    Else
      ...
      If IsNothing(ErrorMsg(0)) Then
        ...
        End If
        myLOGUT.AddOneRecordP()
        ' added 5-6-26 message on account number autogenerated
        If WrkAutoGen Then
          MsgBox("Account has been assigned list number " & WrkListNo, MsgBoxStyle.Information, "System Generated Account Number")
        End If
      Else
        If WrkAutoGen = True Then ' added 5-6-26 ken    autogen   clear as there was a nerror
          WrkListNo = 0
          TxtListNo.Text = ""
        End If
        ShowError(ErrorField, ErrorMsg)

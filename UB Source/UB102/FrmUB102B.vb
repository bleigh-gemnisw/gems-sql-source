Public Class FrmUB102B
  ...
  Dim WrkBlocking As Boolean
    Friend WithEvents RbRout As RadioButton
...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.RbRout = New System.Windows.Forms.RadioButton()
    ...
    Me.ImageList1 = New System.Windows.Forms.ImageList(Me.components)
        ...
        Me.groupBox2.Location = New System.Drawing.Point(464, 10)
        ...
        Me.groupBox1.Controls.Add(Me.RbRout)
        ...
        'RbRout
        '
        Me.RbRout.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.RbRout.Location = New System.Drawing.Point(212, 44)
        Me.RbRout.Name = "RbRout"
        Me.RbRout.Size = New System.Drawing.Size(64, 16)
        Me.RbRout.TabIndex = 10
        Me.RbRout.Text = "R&oute"
        '
        'BtnScan
        '
        ...
        Me.BtnScan.Location = New System.Drawing.Point(350, 10)
        ...
        Me.RbLoc.Location = New System.Drawing.Point(104, 44)
        Me.RbLoc.Name = "RbLoc"
        Me.RbLoc.Size = New System.Drawing.Size(106, 16)
        Me.RbLoc.TabIndex = 9
        ...
        Me.RbName.Location = New System.Drawing.Point(8, 44)
        Me.RbName.Name = "RbName"
        Me.RbName.Size = New System.Drawing.Size(94, 16)
        ...
        Me.C1DataGrdList.Size = New System.Drawing.Size(700, 348)
        ...
        Me.RbMeter.Location = New System.Drawing.Point(280, 44)
        Me.RbMeter.Name = "RbMeter"
        Me.RbMeter.Size = New System.Drawing.Size(64, 16)
        Me.RbMeter.TabIndex = 201
...
#End Region
    ...
    ElseIf RbLoc.Checked Then
      GridLocName(WrkReadForward)
    ElseIf RbRout.Checked Then
      GridRout(WrkReadForward)
    ElseIf RbMeter.Checked Then
      GridMeter(WrkReadForward)
    End If
  End Sub
    Public Sub ShowGrid()
        ...
        End If
    If RbRout.Checked Then
      ds = myUTCUSTL1.GetViewbyRout(WrkPos, WrkLoc, WrkLocNo, cMax, WrkBlocking)
    End If
    If RbMeter.Checked Then
      ds = myUTCUSTL1.GetViewbyMeter(WrkPos, WrkLoc, WrkLocNo, cMax, WrkBlocking)
    End If
  ...
  Public Sub ShowGridScan()
    ...
    End If
    If RbRout.Checked Then
      ds = myUTCUSTL1.GetViewbyRoutScan(TxtPos.Text, WrkMaxScan)
    End If
    If RbMeter.Checked Then
      ds = myUTCUSTL1.GetViewbyMeterScan(TxtPos.Text, WrkMaxScan)
    End If
    C1DataGrdList.DataSource = ds.Tables(0)
    C1DataGrdList.Refresh()

  End Sub
  Private Sub GridRout(ByVal WrkForward As Boolean)
    With C1DataGrdList
      .Rebind(True)
      .Columns(0).Caption = "Account"
      .Splits(0).DisplayColumns(0).Width = 70
      .Columns(1).Caption = "Route"
      .Splits(0).DisplayColumns(1).Width = 100
      If WrkForward Then
        .Columns(2).Caption = "Name"
      Else
        .Columns(2).Caption = "Name (Reverse order)"
      End If
      .Splits(0).DisplayColumns(2).Width = 220
      .Columns(3).Caption = "Loc #"
  ...
  End Sub
  Private Sub GridMeter(ByVal WrkForward As Boolean)
    With C1DataGrdList
      .Rebind(True)
      .Columns(0).Caption = "Account"
      .Splits(0).DisplayColumns(0).Width = 70
      .Columns(1).Caption = "Meter"
  ...
  Private Sub RbName_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RbName.Click
    ...
    FormatGrid(True, False, False)
  End Sub
  Private Sub RbRout_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RbRout.Click
    TxtPosNo.Visible = False
    FormatGrid(True, False, False)
  End Sub
  Private Sub RMeter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RbMeter.Click
    TxtPosNo.Visible = False
    FormatGrid(True, False, False)
  End Sub

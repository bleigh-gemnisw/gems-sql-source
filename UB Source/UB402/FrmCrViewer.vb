...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtUB402.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(Wrkds1)
    .SetParameterValue("myreportTitle", "Move Pre-Paid payments to next Grand List Year")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmUB402B.TxtFromGLYear.Text))
    .SetParameterValue("MyDesc", WrkTypeDesc)
    .SetParameterValue("MyPost", MyFrmUB402B.ChkPost.Checked)
    .SetParameterValue("MyPostDate", MyFrmUB402B.DtPckPost.Value)
   End With
   With Crv1
     .DisplayToolbar = True

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB212))
...
Private Sub FrmUB212_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB212B = New FrmUB212B
  MyFrmUB212B.MdiParent = Me
  MyFrmUB212B.Show()
End Sub
...
End Sub
Private Sub FrmUB212_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(136, 4)
    ...
    Me.LblCurrent.Size = New System.Drawing.Size(208, 17)
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(11, 64)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(213, 250)
    ...
    Me.Name = "FrmListType_U"
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Select Usage Type"
...
#End Region
  ...
  Public Sub ShowGrid()
    If TxtPos.Text = "" Then
      ds = MyUTTYPE.GetMetered("U", 100)
    Else
      ds = MyUTTYPE.PosData(TxtPos.Text)
    End If
  ...
  End Sub
  Private Sub FrmListType_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmUB103.SbpScreen.Text = "ListType_U"
  ...
  Private Sub BtnNext_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    TxtPos.Text = ""
  End Sub
  Private Sub FrmListType_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    MyFrmUB103.TBarSave.Enabled = False

    MyUTTYPE = New UTTYPE.mydata(MyDBConnect)

    FormatGrid()
    LblCurrent.Text = Wrkrutype
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  With MyFrmUB103C_US
    .Txtrutype.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  End With
...
Private Sub DataGrdView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

End Sub

Private Sub FrmListType_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed

...
Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmUB103))
...
'SbMain
'
Me.SbMain.Font = New System.Drawing.Font("Arial", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
Me.SbMain.Location = New System.Drawing.Point(0, 582)
...
Me.SbMain.Size = New System.Drawing.Size(768, 32)
...
Private Sub FrmUB103_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB103B = New FrmUB103B
  MyFrmUB103B.MdiParent = Me
  MyFrmUB103B.Show()
End Sub
...
End Sub
Private Sub FrmUB103_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  Select MyFrmUB103.SbpScreen.Text
  Case "UB103B"
    MyFrmUB103.Close()
  Case "UB103C_AS"
    MyFrmUB103C_AS.Close()
  Case "UB103C_MT"
    MyFrmUB103C_MT.Close()
  Case "UB103C_US"
    MyFrmUB103C_US.Close()
  Case "ListType_A"
    myFrmListType_A.Close()
  Case "ListType_M"
    myFrmListType_M.Close()
  Case "ListType_U"
    myFrmListType_U.Close()
  End Select
End Sub
Private Sub DoBtnDelete()
  Dim WrkCancel As Boolean
  If MyFrmUB103.SbpScreen.Text = "UB103C_AS" Then
    MyFrmUB103C_AS.DeleteData(WrkCancel)
    If WrkCancel Then Exit Sub
    MyFrmUB103C_AS.Close()
    MyFrmUB103B.FormatGrid()
  ElseIf MyFrmUB103.SbpScreen.Text = "UB103C_MT" Then
    MyFrmUB103C_MT.DeleteData(WrkCancel)
    If WrkCancel Then Exit Sub
    MyFrmUB103C_MT.Close()
    MyFrmUB103B.FormatGrid()
  ElseIf MyFrmUB103.SbpScreen.Text = "UB103C_US" Then
    MyFrmUB103C_US.DeleteData(WrkCancel)
    If WrkCancel Then Exit Sub
    MyFrmUB103C_US.Close()
    MyFrmUB103B.FormatGrid()
  End If
...
Private Sub DoBtnNew()
  If MyFrmUB103B.RbAssess.Checked = True Then
    MyFrmUB103B.Hide()
    MyFrmUB103C_AS = New FrmUB103C_AS
    MyFrmUB103C_AS.MdiParent = MyFrmUB103B.ParentForm
    MyFrmUB103C_AS.Wrkratype = ""
    MyFrmUB103C_AS.Show()
    MyFrmUB103B.Hide()
  ElseIf MyFrmUB103B.RbMeter.Checked = True Then
    MyFrmUB103B.Hide()
    MyFrmUB103C_MT = New FrmUB103C_MT
    MyFrmUB103C_MT.MdiParent = MyFrmUB103B.ParentForm
    MyFrmUB103C_MT.Wrkrmtype = ""
    MyFrmUB103C_MT.Show()
    MyFrmUB103B.Hide()
  ElseIf MyFrmUB103B.RbUsage.Checked = True Then
    MyFrmUB103B.Hide()
    MyFrmUB103C_US = New FrmUB103C_US
    MyFrmUB103C_US.MdiParent = MyFrmUB103B.ParentForm
    MyFrmUB103C_US.Wrkrutype = ""
    MyFrmUB103C_US.Show()
    MyFrmUB103B.Hide()
  End If
End Sub
Private Sub DoBtnPrint()
  ...
  If MyFrmUB103B.RbAssess.Checked = True Then
    MyFrmCrViewer.WrkUBType = "A"
  End If
  If MyFrmUB103B.RbMeter.Checked = True Then
    MyFrmCrViewer.WrkUBType = "M"
  End If
  If MyFrmUB103B.RbUsage.Checked = True Then
    MyFrmCrViewer.WrkUBType = "U"
  End If
  MyFrmCrViewer.Wrkds = MyFrmUB103B.ds
  MyFrmCrViewer.Show()
End Sub
Private Sub DoBtnSave()
  If MyFrmUB103.SbpScreen.Text = "UB103C_AS" Then
    MyFrmUB103C_AS.SaveData()
  ElseIf MyFrmUB103.SbpScreen.Text = "UB103C_MT" Then
    MyFrmUB103C_MT.SaveData()
  ElseIf MyFrmUB103.SbpScreen.Text = "UB103C_US" Then
    MyFrmUB103C_US.SaveData()
  End If
End Sub

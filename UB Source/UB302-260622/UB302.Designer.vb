...
Partial Public Class UB302
    ...
    Partial Public Class mytableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddmytableRow(ByVal LISTNO As Long, ByVal UBNAME As String, ByVal LOCATION As String, ByVal NAME As String, ByVal TAXTOTAL As Decimal, ByVal ERRMSG As String) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {LISTNO, UBNAME, LOCATION, NAME, TAXTOTAL, ERRMSG}

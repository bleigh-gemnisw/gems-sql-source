...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.TxtPosNo.Location = New System.Drawing.Point(79, 38)
    Me.TxtPosNo.MaxLength = 7
    Me.TxtPosNo.Name = "TxtPosNo"
    Me.TxtPosNo.Size = New System.Drawing.Size(64, 22)
    Me.TxtPosNo.TabIndex = 207
    Me.TxtPosNo.Visible = False
    '
    'TxtPos
    '
    Me.TxtPos.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
    Me.TxtPos.Location = New System.Drawing.Point(149, 40)
    Me.TxtPos.MaxLength = 25
    Me.TxtPos.Name = "TxtPos"
    Me.TxtPos.Size = New System.Drawing.Size(128, 20)
    Me.TxtPos.TabIndex = 208
    '
    'BtnNext
    '
...
#End Region
  ...
  Public Sub ShowGridbyLoc()
    ...
    If (Trim(TxtPosNo.Text) > "") Then
      wrksearch = "LTRIM(RTRIM(CULOC)) LIKE '" + Replace(TxtPos.Text, "'", "''") + "%'"
      wrksearch = wrksearch + " AND LTRIM(RTRIM(CULOC#)) = '" + Trim(TxtPosNo.Text) + "'"

    Else
      wrksearch = "LTRIM(RTRIM(CULOC)) >= '" + Replace(TxtPos.Text, "'", "''") + "'"

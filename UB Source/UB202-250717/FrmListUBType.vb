...
#End Region
  ...
  Private Sub FrmListUBType_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmUB202.SbpScreen.Text = "ListUBType"
  ...
  End Sub
Private Sub DataGrdView_decimalClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  Windows.Forms.Cursor.Current = Cursors.WaitCursor

  With MyFrmUB202B
    .TxtType.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    .Ttp1.SetToolTip(.TxtType, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
  End With

...
#End Region
  ...
  Private Sub FrmListDist_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmUB235.SbpScreen.Text = "ListDist"
  ...
  End Sub
Private Sub DataGrdList_DoubleView(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick

...
Partial Public Class UB234
    ...
    Partial Public Class mytableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddmytableRow(ByVal LISTNO As Long, ByVal NAME As String, ByVal LOCNO As String, ByVal LOC As String, ByVal SERIAL As String, ByVal ROUTE As String) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {LISTNO, NAME, LOCNO, LOC, SERIAL, ROUTE}

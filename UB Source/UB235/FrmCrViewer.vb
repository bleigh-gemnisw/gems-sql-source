...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtUB235.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(ds)
    .SetParameterValue("myreportTitle", WrkBillType & " Meter Serial Numbers")
    .SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyDistrict", MyUtils.CnvSng(MyFrmUB235B.TxtDist.Text))
    .SetParameterValue("MyPhase", MyUtils.CnvSng(MyFrmUB235B.TxtPhase.Text))
   End With
   With Crv1
     .DisplayToolbar = True

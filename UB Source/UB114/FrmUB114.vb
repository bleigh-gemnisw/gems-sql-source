...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents TBarAttach As System.Windows.Forms.ToolBarButton
...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB114))
    ...
    Me.HelpProvider1 = New System.Windows.Forms.HelpProvider()
        ...
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarPrint, Me.TBarSave, Me.TBarDelete, Me.TBarComments, Me.TBarAttach, Me.TBarPS})
...
#End Region
    ...
    Private Sub FrmUB114_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security()   '#sec
    MyFrmUB114B = New FrmUB114B
    MyFrmUB114B.MdiParent = Me
    MyFrmUB114B.Show()
  End Sub
  ...
  Private Sub FrmUB114_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnSave()
    Select Case Me.SbpScreen.Text
      ...
      Case "UB114C"
        MyFrmUB114C.SaveData()
    End Select
  End Sub

  Private Sub DoBtnComments()
    If Me.SbpScreen.Text <> "UB114C" Then Exit Sub
    MyFrmUB114C.Hide()
    MyFrmComments = New FrmComments
    MyFrmComments.MdiParent = MyFrmUB114B.ParentForm
    MyFrmComments.WrkListNo = MyFrmUB114C.WrkListNo
    MyFrmComments.WrkType = "U"
    MyFrmComments.WrkYear = 0
    MyFrmComments.WrkPrevScreen = "UB114C"
    MyFrmComments.Show()
  End Sub

  Private Sub DoBtnAttach()
    If Me.SbpScreen.Text <> "UB114C" Then Exit Sub
    Dim WrkKey As String = MyUtils.CnvSng(MyFrmUB114C.WrkListNo)
    'Use UB102's attachment bucket so Utility Billing attachments remain account-level/shared.
    ShowAttachit("UB102", WrkKey)
    Dim WrkAttachCount As Integer = GetAttachcount("UB102", WrkKey)
    TBarAttach.Text = WrkAttachCount & " Attachment(s)"
    Me.Refresh()
  End Sub
  Private Sub DoBtnDelete()
    If Me.SbpScreen.Text <> "UB114C" Then Exit Sub
    Dim Cancel As Boolean
    MyFrmUB114C.DeleteData(Cancel)
  End Sub

...
Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmUB101))
...
Private Sub FrmUB101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB101B = New FrmUB101B
  MyFrmUB101B.MdiParent = Me
  MyFrmUB101B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmUB101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "UB101B" Then
    MyFrmUB101.Close()
  Else
    MyFrmUB101C.Close()
    MyFrmUB101B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmUB101C.DeleteData(WrkCancel)
...
Private Sub DoBtnNew()
  ...
  MyFrmUB101C.MdiParent = MyFrmUB101B.ParentForm
  MyFrmUB101C.Wrkdistr = 0
  MyFrmUB101C.Show()
  MyFrmUB101B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmUB101B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmUB101C.SaveData()
End Sub

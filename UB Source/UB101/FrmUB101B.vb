...
#Region " Windows Form Designer generated code "
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(8, 40)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(403, 344)
    Me.DataGrdView.TabIndex = 19
    '
    'FrmUB101B
    '
...
Private Sub FrmUB101B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
Public Sub ShowGrid()
  ...
  myUTDIST.CloseFile()
End Sub
Private Sub FrmUB101B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmUB101.SbpScreen.Text = "UB101B"
  MyFrmUB101.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  MyFrmUB101C = New FrmUB101C
  MyFrmUB101C.MdiParent = Me.ParentForm
  MyFrmUB101C.Wrkdistr = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmUB101C.Wrkdiphas = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
  MyFrmUB101C.Show()
  Me.Hide()
End Sub

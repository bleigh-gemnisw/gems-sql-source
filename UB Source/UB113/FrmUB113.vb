...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
  Friend WithEvents Filler As StatusBarPanel
  Friend WithEvents HelpProvider1 As System.Windows.Forms.HelpProvider
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    Me.components = New System.ComponentModel.Container()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB113))
    ...
    Me.Filler = New System.Windows.Forms.StatusBarPanel()
    ...
    Me.TbMain.Size = New System.Drawing.Size(498, 50)
    ...
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 357)
    Me.SbMain.Name = "SbMain"
    Me.SbMain.Panels.AddRange(New System.Windows.Forms.StatusBarPanel() {Me.SbpPgmID, Me.SbpScreen, Me.SbpEnvironment, Me.Filler, Me.SbpVersion})
    Me.SbMain.ShowPanels = True
    Me.SbMain.Size = New System.Drawing.Size(498, 28)
    ...
    Me.ClientSize = New System.Drawing.Size(498, 385)
...
#End Region
  ...
  Private Sub FrmUB113_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB113B = New FrmUB113B
  MyFrmUB113B.MdiParent = Me
  MyFrmUB113B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmUB113_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "UB113B" Then
    MyFrmUB113.Close()
  Else
    MyFrmUB113B.Show()
  End If

...
Private Sub FrmUB112B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  myUTMRESN = New UTMRESN.mydata(MyDBConnect)
  WrkMresn = ""
  Call FormatGrid()
End Sub
Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
  WrkMresn = TxtPos.Text
  FormatGrid()
  TxtPos.Text = ""
End Sub
...
End Sub
Public Sub ShowGrid()
  ds = myUTMRESN.PosData(TxtPos.Text)
  DataGrdView.DataSource = ds.Tables(0)
  DataGrdView.Refresh()
  myUTMRESN.CloseFile()
End Sub
Private Sub FrmUB112B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmUB112.SbpScreen.Text = "UB112B"
  MyFrmUB112.TBarPrint.Enabled = True
...
Private Sub DataGrdView_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
  ...
  MyFrmUB112C.MdiParent = Me.ParentForm
  MyFrmUB112C.WrkMresn = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
  MyFrmUB112C.Show()
  Me.Hide()
End Sub
End Class

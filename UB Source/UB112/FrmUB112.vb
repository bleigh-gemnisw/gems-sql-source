...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB112))
...
Private Sub FrmUB112_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB112B = New FrmUB112B
  MyFrmUB112B.MdiParent = Me
  MyFrmUB112B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmUB112_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "UB112B" Then
    MyFrmUB112.Close()
  Else
    MyFrmUB112C.Close()
    MyFrmUB112B.Show()
...
Private Sub DoBtnDelete()
  ...
  MyFrmUB112C.DeleteData(WrkCancel)
  If WrkCancel Then Exit Sub
  MyFrmUB112C.Close()
  MyFrmUB112B.FormatGrid()
End Sub
Private Sub DoBtnNew()
  MyFrmUB112C = New FrmUB112C
  MyFrmUB112C.MdiParent = MyFrmUB112B.ParentForm
  MyFrmUB112C.WrkMRESN = ""
  MyFrmUB112C.Show()
  MyFrmUB112B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmUB112B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmUB112C.SaveData()
End Sub

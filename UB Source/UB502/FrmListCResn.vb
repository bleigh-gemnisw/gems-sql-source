...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents TxtPos As System.Windows.Forms.TextBox
    ...
    Me.LblCurrent.Location = New System.Drawing.Point(13, 32)
    ...
    Me.DataGrdView.Size = New System.Drawing.Size(297, 260)
    ...
    Me.Name = "FrmListCResn"
    Me.Text = "Select Adjustment Reason Code"
...
#End Region
  ...
  Public Sub ShowGrid()
    If TxtPos.Text = "" Then
      ds = myUTCRESN.GetAllData
    Else
      ds = myUTCRESN.PosData(TxtPos.Text)
    End If
  ...
  Private Sub FrmListCResn_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmUB502.SbpScreen.Text = "ListCResn"
  ...
  Private Sub FrmListCodes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    LblCurrent.Text = "(" & WrkField & " Code = " & WrkCode & ")"
    FormatGrid()
  End Sub
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmUB502B
      ...
      Case "From"
        ...
        .TTp1.SetToolTip(.TxtFromReason, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
      Case "To"
        .TxtToReason.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
        .TTp1.SetToolTip(.TxtToReason, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
      End Select
    End With
...
End Sub
Private Sub FrmListCResn_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    With MyFrmUB502B
      .Show()
    End With
End Sub

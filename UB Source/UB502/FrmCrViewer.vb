...
Me.TabPg1.Text = "Adjustment Register"
'
'TabPg2
'
...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtUB502.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", "Adjustment Register")
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyFromDate", MyFrmUB502B.DtPckFrom.Value)
    .SetParameterValue("MyToDate", MyFrmUB502B.DtPckTo.Value)
    .SetParameterValue("MyFromGLYear", MyUtils.CnvSng(MyFrmUB502B.TxtFromGLYear.Text))
    .SetParameterValue("MyToGLYear", MyUtils.CnvSng(MyFrmUB502B.TxtToGLYear.Text))
    .SetParameterValue("MyFromReason", MyFrmUB502B.TxtFromReason.Text)
    .SetParameterValue("MyToreason", MyFrmUB502B.TxtToReason.Text)
    .SetParameterValue("MyDist", MyFrmUB502B.TxtDist.Text)
   End With
   With Crv1
     .DisplayToolbar = True
  ...
  Private Sub RunReport2()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB502Tot.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)

...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB230))
...
Me.TbMain.Size = New System.Drawing.Size(770, 50)
...
'SbMain
'
Me.SbMain.Location = New System.Drawing.Point(0, 428)
...
Me.SbMain.Size = New System.Drawing.Size(770, 28)
...
Private Sub FrmUB230_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  HelpProvider1.HelpNamespace = MyUtils.GetHelpFile(WrkProgName)
	...
	set_security() '#set
	MyFrmUB230B = New FrmUB230B
	MyFrmUB230B.MdiParent = Me
	MyFrmUB230B.Show()
End Sub
...
End Sub
Private Sub FrmUB230_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

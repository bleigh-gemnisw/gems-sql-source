Public Class FrmCrViewer
  ...
  Friend WrkUser1Desc As String
  Friend WrkUser2Desc As String
  Friend WrkUser3Desc As String
...
#End Region
  ...
  Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    If MyFrmUB409B.ChkReport.Checked Then
      RunReport()
      RunReportTot()
    ...
    If MyFrmUB409B.ChkBills.Checked Then
  ...
  Private Sub RunReportTot()
    ...
    ReportPath = MyUtils.GetReportPath("PrtUB409Tot.rpt", myTOWN._TOWNBR)
    With myreport
      .Load(ReportPath)
      .SetDataSource(wrkds)
      ...
      .SetParameterValue("MyInterestDate", MyFrmUB409B.DtPckInterest.Value)
      .SetParameterValue("MyFamily", WrkFamily)
      ' .SetParameterValue("MyDistrict", MyUtils.CnvSng(MyFrmUB409B.TxtDist.Text))
      '.SetParameterValue("MyPhase", MyUtils.CnvSng(MyFrmUB409B.TxtPhase.Text))
      If MyFrmUB409B.ChkUpdate.Checked Then
        .SetParameterValue("MyPost", True)
      Else
        .SetParameterValue("MyPost", False)
      End If
      .SetParameterValue("MyPeriodDesc", WrkPeriodDesc)
      .SetParameterValue("MyUser1Desc", WrkUser1Desc)
      .SetParameterValue("MyUser2Desc", WrkUser2Desc)
      .SetParameterValue("MyUser3Desc", WrkUser3Desc)
    End With
    With Crv1
      .DisplayToolbar = True
  ...
  Private Sub RunReport()
    ...
    If MyFrmUB409B.RbSortList.Checked Then
      ReportTitle = ReportTitle & " by List No"
    End If
    If MyFrmUB409B.RbSortName.Checked Then
      ReportTitle = ReportTitle & " by Name"
    End If
    If MyFrmUB409B.RbSortLocation.Checked Then
      ReportTitle = ReportTitle & " by Location"
    End If

    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtUB409.rpt", myTOWN._TOWNBR)
    With myreport2
      .Load(ReportPath)
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", ReportTitle)
      ...
      .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
      .SetParameterValue("MyInterestDate", MyFrmUB409B.DtPckInterest.Value)
      .SetParameterValue("MyAddress", MyFrmUB409B.ChkAddress.Checked)
      .SetParameterValue("MyFamily", WrkFamily)
      '  .SetParameterValue("MyDistrict", MyUtils.CnvSng(MyFrmUB409B.TxtDist.Text))
      '   .SetParameterValue("MyPhase", MyUtils.CnvSng(MyFrmUB409B.TxtPhase.Text))
      If MyFrmUB409B.ChkUpdate.Checked Then
  ...
  Private Sub RunReportMT()
    ...
    If myTOWN._TOWNBR = 219 And WrkPeriod = 0 Then
      ReportPath = MyUtils.GetReportPath("PrtUB409MT-FL.rpt", myTOWN._TOWNBR)
    Else
      ReportPath = MyUtils.GetReportPath("PrtUB409MT.rpt", myTOWN._TOWNBR)
    End If
    With myreport5
      .Load(ReportPath)
  ...
  Private Sub RunReportUS()
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtUB409US.rpt", myTOWN._TOWNBR)
    With myreport5
      .Load(ReportPath)
      .SetDataSource(wrkds2)
      .SetParameterValue("MyUserID", MyUserID)

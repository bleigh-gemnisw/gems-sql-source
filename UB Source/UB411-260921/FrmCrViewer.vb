Public Class FrmCrViewer
  ...
  Friend WrkBrkDesc1 As String
  Friend WrkBrkDesc2 As String
  Friend WrkBrkDesc3 As String
  Friend WrkBrkDesc4 As String
  Friend WrkBrkDesc5 As String
  Friend WrkBrkDesc6 As String
  Friend WrkBrkDesc7 As String
  Dim WrkBillType As String
  Friend WithEvents TpTotals As System.Windows.Forms.TabPage
  Friend WithEvents Crv1 As CrystalDecisions.Windows.Forms.CrystalReportViewer
  Friend WithEvents TpBondVar As System.Windows.Forms.TabPage
  Friend WithEvents crv4 As CrystalDecisions.Windows.Forms.CrystalReportViewer
  Friend WithEvents TpBreakout As System.Windows.Forms.TabPage
...
Me.TpBondVar = New System.Windows.Forms.TabPage
...
Me.TpBreakout = New System.Windows.Forms.TabPage
...
Me.TpBondVar.SuspendLayout()
Me.TpBills.SuspendLayout()
Me.TpBreakout.SuspendLayout()
Me.SuspendLayout()
'
'TabCtl1
'
...
Me.TabCtl1.Controls.Add(Me.TpBreakout)
Me.TabCtl1.Controls.Add(Me.TpBondVar)
...
'TpBondVar
'
Me.TpBondVar.Controls.Add(Me.crv4)
Me.TpBondVar.Location = New System.Drawing.Point(4, 22)
Me.TpBondVar.Name = "TpBondVar"
Me.TpBondVar.Size = New System.Drawing.Size(636, 350)
Me.TpBondVar.TabIndex = 3
Me.TpBondVar.Text = "Bond Variance"
Me.TpBondVar.UseVisualStyleBackColor = True
'
'crv4
'
...
'TpBreakout
'
Me.TpBreakout.Controls.Add(Me.crv3)
Me.TpBreakout.Location = New System.Drawing.Point(4, 22)
Me.TpBreakout.Name = "TpBreakout"
Me.TpBreakout.Size = New System.Drawing.Size(636, 350)
Me.TpBreakout.TabIndex = 4
Me.TpBreakout.Text = "Breakout"
Me.TpBreakout.UseVisualStyleBackColor = True
'
'crv3
'
...
Me.TpBondVar.ResumeLayout(False)
Me.TpBills.ResumeLayout(False)
Me.TpBreakout.ResumeLayout(False)
...
Private Sub FrmCrViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    If MyFrmUB411B.ChkReport.Checked Then
      RunReport()
      RunReportTot()
      RunReportBreakout()
      ...
      Case "A"
        RunReportBondVar()
      Case Else
        TabCtl1.TabPages.Remove(TpBondVar)
      End Select
    Else
    ...
    If MyFrmUB411B.ChkBills.Checked Then
      Select Case WrkFamily
      Case "A"
        RunReportAS()
      Case "M"
...
End Sub
  Private Sub RunReportTot()
   ...
   ReportPath = MyUtils.GetReportPath("PrtUB411Tot.rpt", myTOWN._TOWNBR)
    With myreport
    .Load(ReportPath)
    .SetDataSource(wrkds)
    ...
    .SetParameterValue("MyInterestDate", MyFrmUB411B.DtPckInterest.Value)
    .SetParameterValue("MyFamily", WrkFamily)
    .SetParameterValue("MyDistrict", MyUtils.CnvSng(MyFrmUB411B.TxtDist.Text))
    .SetParameterValue("MyPhase", MyUtils.CnvSng(MyFrmUB411B.TxtPhase.Text))
    If MyFrmUB411B.ChkUpdate.Checked Then
  ...
  Private Sub RunReport()
   ...
   If MyFrmUB411B.RbSortList.Checked Then
    ReportTitle = ReportTitle & " by List No"
   End If
   If MyFrmUB411B.RbSortName.Checked Then
    ReportTitle = ReportTitle & " by Name"
   End If
   If MyFrmUB411B.RbSortLocation.Checked Then
    ReportTitle = ReportTitle & " by Location"
   End If

   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB411.rpt", myTOWN._TOWNBR)
    With myreport2
    .Load(ReportPath)
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", ReportTitle)
    ...
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyInterestDate", MyFrmUB411B.DtPckInterest.Value)
    .SetParameterValue("MyAddress", MyFrmUB411B.ChkAddress.Checked)
    .SetParameterValue("MyFamily", WrkFamily)
    .SetParameterValue("MyDistrict", MyUtils.CnvSng(MyFrmUB411B.TxtDist.Text))
    .SetParameterValue("MyPhase", MyUtils.CnvSng(MyFrmUB411B.TxtPhase.Text))
    If MyFrmUB411B.ChkUpdate.Checked Then
   ...
   End With
  End Sub
  Private Sub RunReportBreakout()
    Dim ReportPath As String
    Dim ReportTitle As String

    ReportTitle = "Billing - Breakout"
    If MyFrmUB411B.RbSortList.Checked Then
      ReportTitle = ReportTitle & " by List No"
    End If
    If MyFrmUB411B.RbSortName.Checked Then
    ...
    Me.Text = "Report Viewer"
    ReportPath = MyUtils.GetReportPath("PrtUB411Brk.rpt", myTOWN._TOWNBR)
    With myreport3
      .Load(ReportPath)
      .SetDataSource(wrkds)
      .SetParameterValue("myreportTitle", ReportTitle)
      ...
      End If
      .SetParameterValue("MyPeriodDesc", WrkPeriodDesc)
      .SetParameterValue("MyBrkDesc1", WrkBrkDesc1)
      .SetParameterValue("MyBrkDesc2", WrkBrkDesc2)
      .SetParameterValue("MyBrkDesc3", WrkBrkDesc3)
      .SetParameterValue("MyBrkDesc4", WrkBrkDesc4)
      .SetParameterValue("MyBrkDesc5", WrkBrkDesc5)
      .SetParameterValue("MyBrkDesc6", WrkBrkDesc6)
      .SetParameterValue("MyBrkDesc7", WrkBrkDesc7)
    End With
    With crv3
      .DisplayToolbar = True
      .ShowGroupTreeButton = False
    ...
    End With
  End Sub
  Private Sub RunReportBondVar()
   Dim ReportPath As String
   Dim ReportTitle As String

   ReportTitle = "Billing - Bond Variance Report"
   If MyFrmUB411B.RbSortList.Checked Then
    ReportTitle = ReportTitle & " by List No"
   End If
   If MyFrmUB411B.RbSortName.Checked Then
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB411Bond.rpt", myTOWN._TOWNBR)
    With myreport4
    .Load(ReportPath)
    .SetDataSource(wrkds)
    .SetParameterValue("myreportTitle", ReportTitle)
   ...
   End With
  End Sub
  Private Sub RunReportAS()
   Dim ReportPath As String

   Me.Text = "Report Viewer"
   If WrkPeriod = 0 And WrkProfPerd = 2 Then
     ReportPath = MyUtils.GetReportPath("PrtUB411AS2.rpt", myTOWN._TOWNBR)
   Else
     ReportPath = MyUtils.GetReportPath("PrtUB411AS.rpt", myTOWN._TOWNBR)
   End If
   With myreport5
    .Load(ReportPath)
    ...
    Else
      .SetParameterValue("MyDueDate1", WrkDueDate2)
      .SetParameterValue("MyGraceDate1", WrkGraceDate2)
    End If
    If WrkPeriod = 0 And WrkProfPerd = 2 Then
  ...
  Private Sub RunReportMT()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB411MT.rpt", myTOWN._TOWNBR)
   With myreport5
    .Load(ReportPath)
    .SetDataSource(wrkds2)
    .SetParameterValue("MyUserID", MyUserID)
  ...
  Private Sub RunReportUS()
   ...
   Me.Text = "Report Viewer"
   ReportPath = MyUtils.GetReportPath("PrtUB411US.rpt", myTOWN._TOWNBR)
   With myreport5
    .Load(ReportPath)
    .SetDataSource(wrkds2)
    .SetParameterValue("MyUserID", MyUserID)

...
Friend WithEvents TBarPS As System.Windows.Forms.ToolBarButton
    ...
    Me.HelpProvider1 = New System.Windows.Forms.HelpProvider()
        ...
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarNew, Me.TBarSave, Me.TBarDelete, Me.TBarComments, Me.TBarSep1, Me.TBarPS, Me.TBarLog, Me.TBarPrint, Me.TBarAttach})
...
#End Region
    ...
    TBarAttach.Enabled = False  ' added 9-18-25 ken
    set_security()   '#sec
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    If e.Button Is TBarAttach Then   '9-18-25 added ken 
      DoBtnAttach()
      Exit Sub
    End If
...
End Sub
  ...
  Private Sub DoBtnAttach()
    ...
    If Trim(MyFrmUB102C.WrkListNo) > "" Then
      WrkKey = MyUtils.CnvSng(MyFrmUB102C.WrkListNo)
    Else
      WrkKey = MyUtils.CnvSng(MyFrmUB102C.TxtListNo.Text)
    End If

    ShowAttachit("UB102", WrkType & WrkKey)
    WrkAttachcount = GetAttachcount("UB102", WrkType & WrkKey)
    MyFrmUB102.TBarAttach.Text = WrkAttachcount & " Attachment(s)"
    MyFrmUB102.Refresh()
  End Sub
  ' 9-18-25 end add subroutine Ken 
End Class

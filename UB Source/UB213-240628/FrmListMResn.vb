...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents TxtPos As System.Windows.Forms.TextBox
    ...
    Me.Name = "FrmListMResn"
    Me.Text = "Select Meter Reason Code"
...
#End Region
  ...
  End Sub
  Private Sub FrmListMResn_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmUB213.SbpScreen.Text = "ListMResn"
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmUB213B
      .TxtReason.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
      .Ttp1.SetToolTip(.TxtReason, DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
      .Show()
    End With
    Me.Close()

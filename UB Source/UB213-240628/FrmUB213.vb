...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB213))
...
Private Sub FrmUB213_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmUB213B = New FrmUB213B
  MyFrmUB213B.MdiParent = Me
  MyFrmUB213B.Show()
End Sub
...
End Sub
Private Sub FrmUB213_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

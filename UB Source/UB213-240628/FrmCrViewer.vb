...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtUB213.rpt", myTOWN._TOWNBR)
    With myreport
    .Load(ReportPath)
    .SetDataSource(wrkds)
    ...
    .SetParameterValue("MyFrom", MyFrmUB213B.DtPckFrom.Value)
    .SetParameterValue("MyTo", MyFrmUB213B.DtPckTo.Value)
    .SetParameterValue("MyReason", MyFrmUB213B.TxtReason.Text)
    .SetParameterValue("MyCode", MyFrmUB213B.TxtCode.Text)
    .SetParameterValue("MySize", MyFrmUB213B.TxtMeterSize.Text)
   End With
   With Crv1
     .DisplayToolbar = True

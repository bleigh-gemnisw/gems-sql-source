...
End Sub
  Private Sub RunReport1()
   ...
   ReportPath = MyUtils.GetReportPath("PrtUB341.rpt", myTOWN._TOWNBR)
	 With myreport1
		.Load(ReportPath)
		.SetDataSource(wrkds)
		If WrkExport Then
			.SetParameterValue("myreportTitle", "Interface Meter Usage (EDU) - Export")
		Else
			.SetParameterValue("myreportTitle", "Interface Meter Usage (EDU) - Import")
		End If
		.SetParameterValue("MyUserID", MyUserID)
		.SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
		.SetParameterValue("MyDistrict", WrkDist)
		.SetParameterValue("MyExport", WrkExport)

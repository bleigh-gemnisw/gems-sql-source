...
Friend WithEvents LblFilePath As System.Windows.Forms.Label
    ...
    Me.RbExport.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
    Me.RbExport.Location = New System.Drawing.Point(32, 8)
    Me.RbExport.Name = "RbExport"
    Me.RbExport.Size = New System.Drawing.Size(96, 20)
    Me.RbExport.TabIndex = 0
    Me.RbExport.TabStop = True
    Me.RbExport.Text = "Export Data"
    '
    'RbImport
    '
    Me.RbImport.CheckAlign = System.Drawing.ContentAlignment.MiddleRight
    Me.RbImport.Font = New System.Drawing.Font("Microsoft Sans Serif", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
    Me.RbImport.Location = New System.Drawing.Point(160, 8)
    Me.RbImport.Name = "RbImport"
    Me.RbImport.Size = New System.Drawing.Size(97, 20)
    Me.RbImport.TabIndex = 1
    Me.RbImport.Text = "Import Units"
    '
    'GroupBox1
    '
    ...
    Me.Label5.Text = "Ending Reading Date"
    '
    'DtPckRead
    '
    Me.DtPckRead.Format = System.Windows.Forms.DateTimePickerFormat.[Short]
    Me.DtPckRead.Location = New System.Drawing.Point(161, 122)
...
#End Region
  ...
  End Sub
Private Sub FrmUB341B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    MyFrmUB341.SbpPgmID.Text = "UB341B"
    MyFrmUB341.SbpEnvironment.Text = myDBConnect.PgmDB
    LblFilePath.Text = MyUtils.GetDataPath() & "Meter Usage EDU.csv"
    RbExport.Checked = True

End Sub
Private Sub FrmUB341B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
  MyFrmUB341.SbpScreen.Text = "UB341B"
End Sub
Private Sub FrmUB341B_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
  Me.Refresh()
End Sub
  ...
  End Sub
Private Sub FrmUB341B_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub RbExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles RbExport.Click
  ...
  LnkUBType.Enabled = True
  TxtUBType.Enabled = True
...
Private Sub RbImport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles RbImport.Click
  ...
  LnkUBType.Enabled = False
  TxtUBType.Enabled = False

...
#Region "Variables"
  ...
  Dim mvarOut_MeterDateCurr As String
  Dim mvarOut_MeterDateCurr2 As String
...
#Region "Subroutines"
  ...
  Public Sub GetMeterReadings()
    ...
    sb.Append("Read From " & WrkDBStrDate & " to " & WrkDBEndDate)
    ...
    If ds2.Tables(0).Rows.Count = 0 Then
      ...
      sb.Append("Rate Type: ")
    Else
      sb.Append("Rate Type: " & In_RateType)
    End If
    ...
    ElseIf In_SemiAnnualBill Then
      WrkBillDate1 = DateAdd(DateInterval.Month, -6, In_BillDate)
      WrkBillDate2 = DateAdd(DateInterval.Month, -12, In_BillDate)
    Else
      WrkBillDate1 = DateAdd(DateInterval.Month, -3, In_BillDate)
      WrkBillDate2 = DateAdd(DateInterval.Month, -6, In_BillDate)
    End If

    'Get readings for past x months 
    For I = 0 To MaxI
      With ds2.Tables(0).Rows(I)
        ...
        If WrkDate <= In_BillDate And WrkDate > WrkBillDate1 Then
          ...
          If Out_MeterDateCurr = "" Then
            Out_MeterDateCurr = GetDBDate(.Item("cmdate"))
          Else
            Out_MeterDateCurr2 = GetDBDate(.Item("cmdate"))
          End If
          sb = New StringBuilder
          sb.Append("Current: ")
...
#Region "Properties"
  ...
  Public Property Out_MeterRead3() As Integer
    ...
    End Set
  End Property
  Public Property Out_MeterDateCurr() As String
    Get
      Out_MeterDateCurr = mvarOut_MeterDateCurr
    End Get
    Set(ByVal Value As String)
      mvarOut_MeterDateCurr = Value
    End Set
  End Property
  Public Property Out_MeterDateCurr2() As String
    Get
      Out_MeterDateCurr2 = mvarOut_MeterDateCurr2
    End Get
    Set(ByVal Value As String)
      mvarOut_MeterDateCurr2 = Value
    End Set
  End Property

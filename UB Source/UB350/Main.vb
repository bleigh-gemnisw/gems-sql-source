Module Main
  ...
  Public MyFrmUB350 As FrmUB350
	Public MyFrmUB350B As FrmUB350B
...
Sub Main()
  ...
  If GetGNET("NOSWR") = "Y" Then
    MsgBox("Real Estate Bridge has been disabled. Control File setting NOSWR has been activated.", MsgBoxStyle.Exclamation, "Program UB350 is disabled")
    End
  End If
...
#End If
  ...
  MyFrmUB350 = New FrmUB350
  Application.Run(MyFrmUB350)
End Sub

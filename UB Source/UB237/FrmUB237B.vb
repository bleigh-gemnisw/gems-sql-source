...
#End Region
  ...
  Private Sub FrmUB237B_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    Wrkdistr = 0
    Wrkdiphas = 0
  ...
  Private Sub FrmUB237B_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmUB237.SbpScreen.Text = "UB237B"
    MyFrmUB237.TBarPrint.Enabled = True
  ...
  Private Sub EditChecks(ByVal ErrorField() As String, ByVal ErrorMsg() As String)
    ...
    If MyUtils.CnvSng(TxtDist.Text) > MyUtils.CnvSng(TxtDistTo.Text) Then
      ...
      I = I + 1
    End If
    If MyUtils.CnvSng(TxtDist.Text) = MyUtils.CnvSng(TxtDistTo.Text) And

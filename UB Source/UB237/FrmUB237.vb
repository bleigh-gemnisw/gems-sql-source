...
Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmUB237))
...
#End Region
  ...
  Private Sub FrmUB237_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    set_security() '#set
    MyFrmUB237B = New FrmUB237B
    MyFrmUB237B.MdiParent = Me
    MyFrmUB237B.Show()
  End Sub
  ...
  End Sub
  Private Sub FrmUB237_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

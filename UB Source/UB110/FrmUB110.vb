...
Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmUB110))
...
Me.Text = "UB Form - Bill Information"
...
#End Region
 ...
 Private Sub FrmUB110_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  TBarSave.Enabled = False
   ...
   set_security() '#set
   MyFrmUB110B = New FrmUB110B
   MyFrmUB110B.MdiParent = Me
   MyFrmUB110B.Show()
 End Sub
...
Private Sub FrmUB110_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "UB110B" Then
    MyFrmUB110.Close()
  Else
    MyFrmUB110C.Close()
    MyFrmUB110B.Show()
...
Private Sub DoBtnDelete()
  MyFrmUB110C.DeleteData()
  MyFrmUB110C.Close()
  MyFrmUB110B.Show()
End Sub
Private Sub DoBtnNew()
  MyFrmUB110C = New FrmUB110C
  MyFrmUB110C.MdiParent = MyFrmUB110B.ParentForm
  MyFrmUB110C.Wrktype = ""
  MyFrmUB110C.WrkAddMode = True
  MyFrmUB110C.Show()
  MyFrmUB110B.Hide()
End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmUB110B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmUB110C.SaveData()
End Sub

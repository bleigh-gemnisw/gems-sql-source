...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX301))
        ...
        'SbMain
        '
        Me.SbMain.Location = New System.Drawing.Point(0, 621)
        ...
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarPrint, Me.TBarSep2, Me.TBarLayout})
        ...
        Me.ClientSize = New System.Drawing.Size(768, 649)
        ...
        Me.Text = "Winchester 2nd half RE Tax Bills"
...
Private Sub FrmTX301_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmTX301B = New FrmTX301B
  MyFrmTX301B.MdiParent = Me
  MyFrmTX301B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
	...
	End If
End Sub
Private Sub FrmTX301_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnPrint()
   ...
   MyFrmTX301B.RunReport()
   TBarPrint.Enabled = True
End Sub
Private Sub DoBtnLayout()
   Dim WrkType As String

   WrkType = String.Empty
   With MyFrmTX301B
     If .RbRE.Checked Or .RbRESwr.Checked Then
       WrkType = "R"
     End If
   ...
   End With
	 ...
	 If MyFrmTX301B.ChkAlternative.Checked Then
		 PrntAltLayout(WrkType)
	 Else
		 PrntLayout(WrkType)
	 End If
End Sub

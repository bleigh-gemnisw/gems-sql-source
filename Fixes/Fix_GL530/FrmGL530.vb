...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmGL530))
    ...
    Me.Text = "Import Budget File (Fix)"
...
#End Region
  ...
  Private Sub FrmGL530_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmGL530B = New FrmGL530B
    MyFrmGL530B.MdiParent = Me
    MyFrmGL530B.Show()
  End Sub
  ...
  Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    End If
  End Sub
  Private Sub FrmGL530_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
  ...
  Private Sub DoBtnPrint()
    MyFrmGL530.TBarProcess.Enabled = False
    MyFrmGL530B.RunReport()
    If Not MyFrmGL530B.ChkPost.Checked Then
      MyFrmGL530.TBarProcess.Enabled = True
    End If
  End Sub

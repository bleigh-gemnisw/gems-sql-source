...
Partial Public Class Rpt
    ...
    Partial Public Class mytableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddmytableRow(ByVal BATCH As Long, ByVal SEQNO As Long, ByVal LIST As Long, ByVal TYPE As String, ByVal YEAR As Long, ByVal PAMT As Decimal, ByVal IAMT As Decimal, ByVal LAMT As Decimal, ByVal PCAMT As Decimal, ByVal MSG As String) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {BATCH, SEQNO, LIST, TYPE, YEAR, PAMT, IAMT, LAMT, PCAMT, MSG}

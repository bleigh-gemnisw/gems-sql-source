...
Module PrintReadings
  ...
  Dim myUTXREF As UTXREFL1.MyData
  ...
  Public Sub PrtReadings()
    ...
    myUTXREF = New UTXREFL1.MyData(myDBConnect)
...
Cleanup:
  ...
  ByVal WrkReading As Integer, ByVal WrkName As String, ByVal WrkLocation As String)
    ...
    DsUTXREF = myUTXREF.GetXRef(SaveXref)
  ...
  Private Sub ProcAnnual(ByVal SaveXref As String, ByVal WrkReading1 As Integer, ByVal WrkReading2 As Integer,
   ByVal WrkReading3 As Integer, ByVal WrkReading4 As Integer, ByVal WrkName As String, ByVal WrkLocation As String)
    ...
    WriteReading(WrkAcct, WrkReadDate1, WrkReading1, WrkPost)
    WriteReading(WrkAcct, WrkReadDate2, WrkReading2, WrkPost)
    WriteReading(WrkAcct, WrkReadDate3, WrkReading3, WrkPost)
    WriteReading(WrkAcct, WrkReadDate4, WrkReading4, WrkPost)
  ...
  Private Sub WriteReading(ByVal WrkAcct As Integer, ByVal WrkReadDate As Date,

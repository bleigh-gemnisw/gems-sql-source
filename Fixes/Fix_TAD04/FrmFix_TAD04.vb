...
Friend WithEvents TBarProcess As System.Windows.Forms.ToolBarButton
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmFix_TAD04))
    ...
    Me.TbMain.Size = New System.Drawing.Size(443, 50)
    ...
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 455)
    ...
    Me.SbMain.Size = New System.Drawing.Size(443, 28)
    ...
    Me.ClientSize = New System.Drawing.Size(443, 483)
    ...
    Me.Name = "FrmFix_TAD04"
    Me.HelpProvider1.SetShowHelp(Me, True)
    Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
    Me.Text = "Archive Assessor files"
...
Private Sub FrmFix_TAD04_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmFix_TAD04B = New FrmFix_TAD04B
  MyFrmFix_TAD04B.MdiParent = Me
  MyFrmFix_TAD04B.Show()
End Sub
...
End Sub
Private Sub FrmFix_TAD04_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  ...
  Case "Fix_TAD04B"
    MyFrmFix_TAD04.Close()

  End Select

End Sub
Private Sub DoBtnProcess()
  MyFrmFix_TAD04B.RunProcess()
End Sub

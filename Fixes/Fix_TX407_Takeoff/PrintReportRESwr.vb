...
Sewer:
        ...
        If WrkSewerUse > 0 Then
          WrkTotCount(6) = WrkTotCount(6) + 1
          WrkTotTax(6) = WrkTotTax(6) + WrkSewerUse
          WrkTot1st(6) = WrkTot1st(6) + WrkSewerUse1st
          WrkTot2nd(6) = WrkTot2nd(6) + WrkSewerUse2nd
        End If

...
Partial Public Class TX810
    ...
    Partial Public Class mytableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddmytableRow(ByVal SORTDATA As String, ByVal LISTNO As Long, ByVal YEAR As Long, ByVal TYPEDESC As String, ByVal NAME As String, ByVal AMTDUE As Decimal, ByVal INTEREST As Decimal, ByVal FEES As Decimal, ByVal LIENS As Decimal, ByVal BOND As Decimal, ByVal TOTAL As Decimal) As mytableRow
            Dim rowmytableRow As mytableRow = CType(Me.NewRow,mytableRow)
            Dim columnValuesArray() As Object = New Object() {SORTDATA, LISTNO, YEAR, TYPEDESC, NAME, AMTDUE, INTEREST, FEES, LIENS, BOND, TOTAL}

...
Friend WithEvents TBarLayout As System.Windows.Forms.ToolBarButton
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmTX810))
    ...
    Me.Text = "Create Delinquent Bill (DQBILL) File"
...
#End Region
  ...
  Private Sub FrmTX810_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    Me.SbpPgmID.Text = "TX810"
    TBarProcess.Enabled = True
    set_security() '#set
    GetReportOrientation()
    ShowReportOrientation()

    MyFrmTX810B = New FrmTX810B
    MyFrmTX810B.MdiParent = Me
    MyFrmTX810B.Show()
  End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmTX810_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
End Sub
  Private Sub DoBtnPrint()
    TBarProcess.Enabled = False
    MyFrmTX810B.RunReport()
    TBarProcess.Enabled = True
  End Sub
  Private Sub DoBtnLayout()
   Dim WrkFormat As String

   WrkFormat = String.Empty
   With MyFrmTX810B
     If .RbFmtOrig.Checked Then WrkFormat = "Original"
     If .RbFmtExtendFixed.Checked Then WrkFormat = "Extended"
     If .RbFmtMailSol.Checked Then WrkFormat = "MailSol"
   End With
   PrntLayout(WrkFormat)
End Sub

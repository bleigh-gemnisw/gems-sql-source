...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPO103))
    ...
    Me.Text = "Maintain Purchase Order Control"
...
#End Region
 ...
 Private Sub FrmPO103_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmPO103B = New FrmPO103B
   MyFrmPO103B.MdiParent = Me
   MyFrmPO103B.Show()
 End Sub
...
Private Sub FrmPO103_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmPO103C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmPO103C = New FrmPO103C
  MyFrmPO103C.MdiParent = MyFrmPO103B.ParentForm
  MyFrmPO103C.Show()
  MyFrmPO103B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  For I = 0 To MyFrmPO103B.ds.Tables(0).Rows.Count - 1
    With MyFrmPO103B.ds.Tables(0).Rows(I)
      dr = ds2.Tables(0).NewRow
      dr.Item(0) = .Item(0)
      dr.Item(1) = MyUtils.GetDBDateMDY(.Item(1))
      dr.Item(2) = MyUtils.GetDBDateMDY(.Item(2))
      dr.Item(3) = .Item(3)
      dr.Item(4) = .Item(4)

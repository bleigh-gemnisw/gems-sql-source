...
Friend WithEvents SbpEnvironment As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPO306))
    ...
    Me.ToolStripLabel1 = New System.Windows.Forms.ToolStripLabel()
        ...
        'TbMain
        '
        Me.TbMain.Buttons.AddRange(New System.Windows.Forms.ToolBarButton() {Me.TBarBack, Me.TBarSep1, Me.TBarPrint, Me.TBarSettings})
        ...
        Me.TBarPrint.Text = "&Print PO"
        '
        'TBarSettings
        '
        Me.TBarSettings.Name = "TBarSettings"
        Me.TBarSettings.Text = "Set Printers"
        '
        'ImageList1
        '
        ...
        Me.Text = "Print/Inquiry Purchase Orders"
...
#End Region
    ...
    Private Sub FrmPO306_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    MyFrmPO306B = New FrmPO306B
    MyFrmPO306B.MdiParent = MyFrmPO306
    MyFrmPO306B.Show()

  End Sub
  Private Sub FrmPO306_FromClosing(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.FormClosing
    Dim WrkYear As Integer
    WrkYear = MyUtils.CnvSng(MyFrmPO306B.TxtFscyr.Text)
    If WrkYear > 0 And WrkYear <> MyAppSettings.Year Then
      MyAppSettings.Year = MyUtils.CnvSng(MyFrmPO306B.TxtFscyr.Text)
      SaveAppSettings()
    End If
  End Sub
  ...
  End If
End Sub
Private Sub FrmPO306_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
End Sub
  ...
  Private Sub DoBtnPrint()
    ...
    Select Case SbpScreen.Text
      Case "PO306B"
        MyFrmPO306B.PrintData()
        If MyFrmPO306B.ChkUnprintedOnly.Checked Then
          Answer = MsgBox("Do you want flag these PO's as printed?", MsgBoxStyle.YesNo + MsgBoxStyle.Question, "Flag Accounts?")
          If Answer = MsgBoxResult.Yes Then
            MyFrmPO306B.ProcessFlag()
          End If
        End If
      Case "PO306C"
        MyFrmPO306C.PrintData()
    End Select
  End Sub

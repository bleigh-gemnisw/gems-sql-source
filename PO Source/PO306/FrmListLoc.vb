...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    'BtnFind
    '
    Me.BtnFind.Location = New System.Drawing.Point(114, 5)
    ...
    Me.TxtPos.Location = New System.Drawing.Point(72, 7)
    ...
    'BtnClear
    '
    Me.BtnClear.Location = New System.Drawing.Point(285, 4)
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(11, 36)
    Me.DataGrdView.MultiSelect = False
    Me.DataGrdView.Name = "DataGrdView"
    Me.DataGrdView.ReadOnly = True
    Me.DataGrdView.RowTemplate.Height = 16
    Me.DataGrdView.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect
    Me.DataGrdView.Size = New System.Drawing.Size(327, 278)
    Me.DataGrdView.TabIndex = 198
    '
    'FrmListLoc
    '
...
#End Region
  ...
  End Sub
  Public Sub ShowGrid()
    ds = myLOCATN.PosData(TxtPos.Text)
    DataGrdView.DataSource = ds.Tables(0)
    DataGrdView.Refresh()
  End Sub
  Private Sub FrmListLoc_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmPO306.SbpScreen.Text = "ListLoc"
    '    CenterForm(Me.ParentForm, Me)
  End Sub
  Private Sub FrmListLoc_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    myLOCATN = New LOCATN.MyData()
    myLOCATN.MyDBConn = myDBConnect
    LblCurrent.Text = "(Location Code = " & WrkCode & ")"
    FormatGrid()
  End Sub
  ...
  Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    MySelLoc = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
    Me.Close()
    Windows.Forms.Cursor.Current = Cursors.Default

  End Sub

  Private Sub FrmListLoc_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    MyFrmPO306.SbpScreen.Text = "PO306B"
    'Memory Cleanup
    myLOCATN = Nothing
    MyFrmListLoc = Nothing
  End Sub

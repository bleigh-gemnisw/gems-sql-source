...
#End Region
  ...
  Public Sub RunReport()
    ...
    wrkds.Merge(wrkds2)
    RunReport1(MyPrinter)
    If MyDrawers Then
      RunReport2(MyPrinter2)
      RunReport3(MyPrinter3)
    Else
      If MyPrinter2 <> String.Empty Then
        RunReport2(MyPrinter2)
      End If
      If MyPrinter3 <> String.Empty Then
        RunReport3(MyPrinter3)
      End If
    End If
  End Sub
  Public Sub RunReportDtl()

    wrkds.Merge(wrkds2)
    RunReport1(MyPrinter)
  End Sub
  Private Sub RunReport1(Optional ByVal WrkPrinter As String = "")
    Dim ReportPath As String

    Me.Text = "Report Viewer"
    If wrkPrtPO Then
      ReportPath = MyUtils.GetReportPath("PrtPO306.rpt", myTOWN._TOWNBR, MyCustomDir)
    Else
      ReportPath = MyUtils.GetReportPath("PrtPO306Dtl.rpt", myTOWN._TOWNBR, MyCustomDir)
    End If
    With myreport
      .Load(ReportPath)
      If MyReportLandscape Then
        ...
        If WrkPrinter <> String.Empty Then
          .PrintOptions.PrinterName = WrkPrinter
          If MyDrawers Then
            .PrintOptions.PaperSource = CrystalDecisions.Shared.PaperSource.Upper
          End If
  ...
  End Sub
  Private Sub RunReport2(Optional ByVal WrkPrinter As String = "")
    Dim ReportPath As String
    ...
    With myreport2
      ...
      If WrkPrinter <> String.Empty Then
        .PrintOptions.PrinterName = WrkPrinter
        If MyDrawers Then
          .PrintOptions.PaperSource = CrystalDecisions.Shared.PaperSource.Middle
        End If
        .PrintToPrinter(1, False, 0, 0)
        .Close()
        .Dispose()
    ...
    End With
  End Sub
  Private Sub RunReport3(Optional ByVal WrkPrinter As String = "")
    Dim ReportPath As String

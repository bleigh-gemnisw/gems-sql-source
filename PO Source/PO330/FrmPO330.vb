...
Friend WithEvents SbpFiller As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPO330))
    ...
    Me.TbMain.Size = New System.Drawing.Size(686, 50)
    ...
    'SbMain
    '
    Me.SbMain.Location = New System.Drawing.Point(0, 476)
    ...
    Me.SbMain.Size = New System.Drawing.Size(686, 28)
...
Private Sub FrmPO330_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  set_security() '#set
  MyFrmPO330B = New FrmPO330B
  MyFrmPO330B.MdiParent = Me
  MyFrmPO330B.Show()
End Sub
...
Private Sub TbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
  ...
  End If
End Sub
Private Sub FrmPO330_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnBack()
  If Me.SbpScreen.Text = "PO330B" Then
    MyFrmPO330.Close()
  Else
    MyFrmPO330B.Show()
  End If

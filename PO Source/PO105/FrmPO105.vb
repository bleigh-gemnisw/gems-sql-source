...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPO105))
    ...
    Me.TbMain.Size = New System.Drawing.Size(477, 50)
    ...
    Me.SbMain.Size = New System.Drawing.Size(477, 28)
    ...
    Me.ClientSize = New System.Drawing.Size(477, 614)
...
#End Region
 ...
 Private Sub FrmPO105_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmPO105B = New FrmPO105B
   MyFrmPO105B.MdiParent = Me
   MyFrmPO105B.Show()
 End Sub
...
Private Sub FrmPO105_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmPO105C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmPO105C = New FrmPO105C
  MyFrmPO105C.MdiParent = MyFrmPO105B.ParentForm
  MyFrmPO105C.Show()
  MyFrmPO105B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmPO105B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmPO105C.SaveData()
End Sub

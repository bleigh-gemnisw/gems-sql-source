...
#End Region
  ...
  Private Sub FrmListFund_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmPO320.SbpScreen.Text = "ListFund"
  End Sub
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmPO320B
      If WrkField = "From" Then
        .TxtFundFrom.Text = MyUtils.CnvSng(DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
        .TTp1.SetToolTip(.TxtFundFrom, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      Else
        .TxtFundTo.Text = MyUtils.CnvSng(DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value)
        .TTp1.SetToolTip(.TxtFundTo, DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value)
      End If
      .Show()
    End With

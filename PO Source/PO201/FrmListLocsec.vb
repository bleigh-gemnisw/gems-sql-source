...
End Sub
  Private Sub FrmListLocsec_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmPO201.SbpScreen.Text = "ListLocsec"
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    MyFrmPO201.TBarPrtEdits.Enabled = True
    MyFrmPO201.TBarPost.Enabled = True
    With MyFrmPO201B
      .LblLlocn.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
      .LblLocDesc.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
      .Show()
    End With
    Windows.Forms.Cursor.Current = Cursors.Default
    Me.Close()

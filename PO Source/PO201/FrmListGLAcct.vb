...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents LblCurrent As System.Windows.Forms.Label
    ...
    Me.DataGrdView.Location = New System.Drawing.Point(12, 36)
...
#End Region
 ...
 End Sub
  ...
  Private Sub FrmListGLAcct_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    MyFrmPO201.SbpScreen.Text = "ListGLAcct"
  End Sub
  ...
  Private Sub FrmListGLAcct_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    MyFrmPO201.TBarSave.Enabled = WrkSave
    MyFrmPO201.TBarDelete.Enabled = WrkDelete
    MyFrmPO201E.Show()
  End Sub
  Private Sub FrmListGLAcct_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    WrkSave = MyFrmPO201.TBarSave.Enabled
    WrkDelete = MyFrmPO201.TBarDelete.Enabled
...
Private Sub DataGrdView_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrdView.DoubleClick
    ...
    With MyFrmPO201E
      Select Case WrkField
        Case "BD"
          .TxtFdnbd.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
          .TxtSfudd.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
          .TxtDpnbd.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
          .TxtObnbd.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
          .TxtFnpgd.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
          .TxtSubfd.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
          .Ttp1.SetToolTip(.TxtFdnbd, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
        Case "BS"
          .TxtFdnbs.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
          .TxtSfuns.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
          .TxtDpnbs.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
          .TxtObnbs.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
          .TxtFnpgs.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
          .TxtSubfs.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
          .Ttp1.SetToolTip(.TxtFdnbs, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
        Case Else
          .TxtFund.Text = DataGrdView.Item(0, DataGrdView.CurrentRow.Index).Value
          .TxtSFund.Text = DataGrdView.Item(1, DataGrdView.CurrentRow.Index).Value
          .TxtDept.Text = DataGrdView.Item(2, DataGrdView.CurrentRow.Index).Value
          .TxtObj.Text = DataGrdView.Item(3, DataGrdView.CurrentRow.Index).Value
          .TxtFcn.Text = DataGrdView.Item(4, DataGrdView.CurrentRow.Index).Value
          .TxtSfcn.Text = DataGrdView.Item(5, DataGrdView.CurrentRow.Index).Value
          .Ttp1.SetToolTip(.TxtFund, DataGrdView.Item(6, DataGrdView.CurrentRow.Index).Value)
      End Select
    End With
    Me.Close()

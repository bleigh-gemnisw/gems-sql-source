...
End Sub
  Private Sub RptEditAP()
   ...
   ReportPath = MyUtils.GetReportPath("PrtPO201.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    ...
    .SetParameterValue("MyReportTitle", "Requisition Edit List")
  ...
  Private Sub RptEditGL()
   ...
   ReportPath = MyUtils.GetReportPath("PrtPO201B.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
  ...
  Private Sub RptEditOverExp()
   ...
   ReportPath = MyUtils.GetReportPath("PrtPO201C.rpt", myTOWN._TOWNBR)
   With myreport3
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape

...
Friend WithEvents HelpProvider1 As System.Windows.Forms.HelpProvider
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPO301))
    ...
    Me.ToolStripLabel1 = New System.Windows.Forms.ToolStripLabel()
        ...
        Me.Text = "Maintain Purchase Orders"
...
#End Region
    ...
    Private Sub FrmPO301_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      ...
      MyFrmPO301B = New FrmPO301B
      MyFrmPO301B.MdiParent = Me
      MyFrmPO301B.Show()
...
End Sub
  ...
  Private Sub tbMain_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles TbMain.ButtonClick
    ...
    If e.Button Is TBarSave Then
      If SbpScreen.Text = "PO301E" Then
        MyFrmPO301E.SaveData(True)
        Exit Sub
      End If
    End If
    ...
    If MyFrmPO301B.DataGrdView.RowCount = 0 Then Exit Sub

    If e.Button Is TBarDelete Then
      '        PassSecurity = GetFNDSEC(MyFrmPO301B.DataGrdList.Item(MyFrmPO301B.DataGrdList.Row, 4))
    ...
    If e.Button Is TBarPrtEdits Then
      ...
      WrkBatchNo = MyFrmPO301B.DataGrdView.Item(0, MyFrmPO301B.DataGrdView.CurrentRow.Index).Value()
      Errors = DoBtnPrtEdits(False, False)
    ...
    If e.Button Is TBarPost Then
      If MyFrmPO301B.DataGrdView.Item(1, MyFrmPO301B.DataGrdView.CurrentRow.Index).Value() = "H" Then
        Exit Sub
      End If
      '        PassSecurity = GetFNDSEC(MyFrmPO301B.DataGrdList.Item(MyFrmPO301B.DataGrdList.Row, 4))
      '        If Not PassSecurity Then Exit Sub
      ...
      WrkBatchNo = MyFrmPO301B.DataGrdView.Item(0, MyFrmPO301B.DataGrdView.CurrentRow.Index).Value()
      WrkRecovery = False
      If MyFrmPO301B.DataGrdView.Item(1, MyFrmPO301B.DataGrdView.CurrentRow.Index).Value() = "P" Then
        WrkRecovery = True
      End If
      Errors = DoBtnPrtEdits(True, WrkRecovery)
      If Errors Then
      ...
      If Answer = vbNo Then
        ...
        Exit Sub
      End If
      MyPostDate = MyUtils.GetDBDateMDY(MyFrmPO301B.DataGrdView.Item(4, MyFrmPO301B.DataGrdView.CurrentRow.Index).Value())
  ...
  Private Sub FrmPO301_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    Dim Cancel As Boolean

    If MyFrmPO301.SbpScreen.Text = "PO301B" Then
      If Cancel Then
        e.Cancel = True
      End If
      Exit Sub
...
Private Sub DoBtnBack()
  ...
  Case "ListLocsec"
    MyFrmListLocsec.Close()
  Case "ListVendor"
    MyFrmListVendor.Close()
 End Select
End Sub
Private Sub DoBtnDelete()
  ...
  Select Case Me.SbpScreen.Text
  Case "PO301B"
    MyFrmPO301B.DeleteData(Cancel)
  Case "PO301E"
    MyFrmPO301E.DeleteData(Cancel)
...
Private Sub DoBtnNew()
 Select Case Me.SbpScreen.Text
 Case "PO301B"
  MyFrmPO301B_New = New FrmPO301B_New
  MyFrmPO301B_New.MdiParent = MyFrmPO301B.ParentForm
  MyFrmPO301B_New.Show()
  MyFrmPO301B.Hide()
 Case "PO301D"
  MyFrmPO301E = New FrmPO301E
  MyFrmPO301E.MdiParent = MyFrmPO301D.ParentForm
  MyFrmPO301E.WrkBatchNo = MyFrmPO301D.WrkBatchNo
  MyFrmPO301E.WrkPOnbr = 0
  MyFrmPO301E.Show()
  MyFrmPO301D.Hide()
 End Select
End Sub
  Private Function DoBtnPrtEdits(ByVal Post As Boolean, ByVal Recovery As Boolean) As Boolean
    Dim WrkBatchNo As Integer
    Dim Errors As Boolean

    WrkBatchNo = MyFrmPO301B.DataGrdView.Item(0, MyFrmPO301B.DataGrdView.CurrentRow.Index).Value()
    Errors = PrtEdits(WrkBatchNo, Post, Recovery)

    Return Errors
  End Function

  Private Sub FrmPO301_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown

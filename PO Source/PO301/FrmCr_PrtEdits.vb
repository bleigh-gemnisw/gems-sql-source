...
Friend WithEvents Crv2 As CrystalDecisions.Windows.Forms.CrystalReportViewer
    ...
    'TpPO
    '
    Me.TpPO.Controls.Add(Me.Crv1)
    Me.TpPO.Location = New System.Drawing.Point(4, 22)
    Me.TpPO.Name = "TpPO"
    Me.TpPO.Size = New System.Drawing.Size(632, 318)
    Me.TpPO.TabIndex = 0
    Me.TpPO.Text = "PO Edit List"
...
End Sub
  Private Sub RptEditAP()
   ...
   ReportPath = MyUtils.GetReportPath("PrtPO301.rpt", myTOWN._TOWNBR)
   With myreport1
    .Load(ReportPath)
    ...
    .SetParameterValue("MyReportTitle", "Purchase Order List")
  ...
  Private Sub RptEditGL()
   ...
   ReportPath = MyUtils.GetReportPath("PrtPO301B.rpt", myTOWN._TOWNBR)
   With myreport2
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape
    ...
    .SetParameterValue("MyUserID", MyUserID)
    .SetParameterValue("MyTownName", Trim(myTOWN._TOWN))
    .SetParameterValue("MyReportTitle", "Summary of entries to be transferred to Purchase Order")
    .SetParameterValue("MyPost", WrkPost)
  ...
  Private Sub RptEditOverExp()
   ...
   ReportPath = MyUtils.GetReportPath("PrtPO301C.rpt", myTOWN._TOWNBR)
   With myreport3
    .Load(ReportPath)
    If MyReportLandscape Then
      .PrintOptions.PaperOrientation = CrystalDecisions.[Shared].PaperOrientation.Landscape

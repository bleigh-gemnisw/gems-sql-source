...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPO101))
...
#End Region
 ...
 Private Sub FrmPO101_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmPO101B = New FrmPO101B
   MyFrmPO101B.MdiParent = Me
   MyFrmPO101B.Show()
 End Sub
...
Private Sub FrmPO101_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmPO101C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmPO101C = New FrmPO101C
  MyFrmPO101C.MdiParent = MyFrmPO101B.ParentForm
  MyFrmPO101C.Show()
  MyFrmPO101B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmPO101B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmPO101C.SaveData()
End Sub

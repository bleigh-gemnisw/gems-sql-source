...
Friend WithEvents SbpVersion As System.Windows.Forms.StatusBarPanel
    ...
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPO104))
    ...
    Me.TbMain.Size = New System.Drawing.Size(694, 50)
    ...
    Me.SbMain.Size = New System.Drawing.Size(694, 28)
...
#End Region
 ...
 Private Sub FrmPO104_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   set_security() '#set
   MyFrmPO104B = New FrmPO104B
   MyFrmPO104B.MdiParent = Me
   MyFrmPO104B.Show()
 End Sub
...
Private Sub FrmPO104_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
...
Private Sub DoBtnDelete()
  MyFrmPO104C.DeleteData()
End Sub
Private Sub DoBtnNew()
  MyFrmPO104C = New FrmPO104C
  MyFrmPO104C.MdiParent = MyFrmPO104B.ParentForm
  MyFrmPO104C.Show()
  MyFrmPO104B.Hide()
  End Sub
Private Sub DoBtnPrint()
  ...
  MyCRViewer.Wrkds = MyFrmPO104B.ds
  MyCRViewer.Show()
End Sub
Private Sub DoBtnSave()
  MyFrmPO104C.SaveData()
End Sub
